object Cuttingschedulemain: TCuttingschedulemain
  Left = 175
  Top = 117
  Width = 1700
  Height = 965
  Caption = 'Cuttingschedulemain'
  Color = clBtnFace
  ...
  object Panel4: TPanel
    ...
    object Panel8: TPanel
      ...
      Height = 45
      Align = alTop
      Caption = 'Unfinish Task / '#26410#23436#25104#20219#21209' '
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -25
      Font.Name = 'Arial'
  ...
  object ADOConnection1: TADOConnection
    ...
    ConnectionString = 
      ...
      '6;Workstation ID=DESKTOP-21TPL97;Use Encryption for Data=False;T' +
  ...
  object Query1: TADOQuery
    ...
    SQL.Strings = (
      ...
      '    left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        ', 111) AND ShoeTest.CutDate IS NULL     and ypzl.GSDH = '#39'CDC'#39
      ') AS main'
      'LEFT JOIN ('
  ...
  object Query2: TADOQuery
    ...
    object Query2CuttingPlan: TStringField
      FieldName = 'CuttingPlan'
      ReadOnly = True
      Size = 30
    end
  ...
  object Query3: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        'NVERT(varchar(8), CutDate, 108)  <> '#39'00:00:00'#39'     and ypzl.GSDH' +
        ' = '#39'CDC'#39
      '  ) AS main'
      '  left join ('
      '    select shoetest2.testno,SUM(Qty) Qty from shoetest2 '
  ...
  object Query5: TADOQuery
    ...
    SQL.Strings = (
        ...
        'rchar,main.AssembleOK, 111) AS AssembleOK,CuttingPlan,CuttingOK,'
        ...
        'lecomplete AssembleOK,ShoeTest.CutDate_first AS CuttingPlan, Sho' +
        'eTest.CutDate AS CuttingOK  from ShoeTest'
      
        '    left join ShoeTestPlan on ShoeTestPlan.TestNo=ShoeTest.TestN' +
        'o'
      
        '    where  convert(varchar, CutDate_first, 111) BETWEEN CONVERT(' +
        'VARCHAR, GetDate()-10, 111) AND CONVERT(VARCHAR, GetDate(), 111)' +
        ' and (ShoeTest.CutDate>= CONVERT(VARCHAR, GetDate(), 111) or Sho' +
        'eTest.CutDate is null) '
      '  ) AS main'
      '  left join ('
      '    select shoetest2.testno,SUM(Qty) Qty from shoetest2 '
        ...
        #9'WHERE YWSM IN ('#39'Finished Shoe'#39', '#39'Half Stitching Upper'#39', '#39'Stitch' +
        'ing Upper'#39', '#39'Lasted upper'#39', '#39'Upper Component'#39', '#39'CFM sample'#39', '#39'Up' +
  ...
  object Query4: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        '  WHERE CONVERT(VARCHAR, ShoeTest.CutDate_first, 111) BETWEEN CO' +
        'NVERT(VARCHAR, GetDate()-10, 111) AND CONVERT(VARCHAR, GetDate()' +
        '-1, 111) AND ShoeTest.CutDate IS NULL and ypzl.GSDH = '#39'CDC'#39
      ') AS main'
      'LEFT JOIN ('
      '  SELECT ShoeTest2.TestNo, SUM(Qty) AS Qty FROM ShoeTest2 '
