...
type
  TCuttingschedulemain = class(TForm)
    DBGridEh1: TDBGridEh;
    DS1: TDataSource;
    ...
    Query2CuttingPlan: TStringField;
...
var
  Cuttingschedulemain: TCuttingschedulemain;

implementation

{$R *.dfm}

procedure TCuttingschedulemain.ReadIni();
var MyIni :Tinifile;
...
procedure TCuttingschedulemain.FormCreate(Sender: TObject);
begin
  ReadIni();
  Query1.Active := true;
  Query2.Active := true;
...
procedure TCuttingschedulemain.Timer1Timer(Sender: TObject);
var
  m: TMessage;
begin
