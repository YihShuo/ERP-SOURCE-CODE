object RWeightp: TRWeightp
  ...
  object GSPFS: TQuery
    ...
    SQL.Strings = (
      ...
      'left join clzl on clzlsl.cldhz = clzl.cldh'
        ...
        'left join (select * from GSPFS where GSBH = :GSBH) GSPFS on GSPF' +
        'S.PFBH2 = clzlsl.cldh  and GSPFS.CLBH = clzlsl.cldhz'
      'where clzlsl.cldh = :PFBH2'
      'order by  GSPFS.yn desc,cldhz asc'
      '')
    UpdateObject = UPDet
    Left = 420
    Top = 312
  ...
  object GSPF: TQuery
    ...
    SQL.Strings = (
        ...
        'select GSPF.*, (select top 1 GSPFS.CLBH  from GSPFS where GSPF.G' +
        'SBH = GSPFS.GSBH and GSPF.PFBH2 = GSPFS.PFBH2) as CLBH'
      'from GSPF'
      '')
    UpdateObject = UpMas
    Left = 308
