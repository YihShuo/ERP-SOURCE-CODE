...
interface
uses
  Windows, SysUtils, ERDeclare, ERConst;

const
  EastRiver_API = 'ERDriver02.dll';
...
//      修改设备序列号
function SetClockSerialNo(hPort: THandle; SerialNo: PChar): Boolean; stdcall; external EASTRIVER_API
//参数说明:
// hPort        : 端口句柄, 需要联机
// Version      : 返回序号号缓冲区, 长度至少要大于30个字符
//返回值:
...
//          flag = 5     :透支消费
    ...
    reserved2: DWORD;
    reserved3: array[0..19] of Char; // 保留
    reserved4: array[0..200] of Char; // 保留
...
//		  写 EEPROM 1字节数值
function WriteEEPROMByte(hPort: THandle; address: Integer; Value: Byte): Boolean; stdcall; external EASTRIVER_API
//		address   : EEPROM 地址, 只允许使用0x100 -- 0x0FFF的单元地址
//		value     : 1字节数据
...
{******************************************************************************
 ...
 False        : 联机失败
 ******************************************************************************}
function SimRequest(hPort: THandle; SerialNo: PChar): Boolean; stdcall; external EASTRIVER_API;
...
function GetClockParam(hPort: THandle; var Model: Integer; var Fireware: Double; var ICID: BOOL): Boolean; stdcall; external EASTRIVER_API;
function SetClockParam(hPort: THandle; Model: Integer; Fireware: Double; ICID: BOOL): Boolean; stdcall; external EASTRIVER_API;


//      查询指定端口上的设备
function SearchClock(Port, BaudRate: Integer; Clocks: PChar): Integer; stdcall; external EASTRIVER_API;

function GetDLLTimeString(TD: PChar): Boolean; stdcall; external EASTRIVER_API
function GetClockTypeStr(hPort: THandle; ClockType: PChar): Boolean; stdcall; external EASTRIVER_API

function SetClockVersion(hPort: THandle; Version: PChar): Boolean; stdcall; external EASTRIVER_API
function ReadMaxPassRecordTotal(hPort: THandle; var Value: Integer): Boolean; stdcall; external EASTRIVER_API

function RestoreData(hPort: THandle; Model: Integer = 690; Flag: Boolean = False): Integer; stdcall; external EASTRIVER_API
function BatchReadStrRecord(hPort: THandle; Action: Integer; Bytes: Integer; var Count: Integer; Data: PChar): Integer; stdcall; external EASTRIVER_API
//检查门禁通行名单是否下载成功(890)
function CheckDoorPassCard(hPort: THandle; Style: Byte; Card: PChar; Code: PChar; Right: Integer = 0; BeginPass: PChar = nil; EndPass: PChar = nil; EmpId: PChar = nil): Boolean; stdcall; external EASTRIVER_API



function SetDevice(CP: ConnParam; hPort: THandle; dt: DeviceType; Fun: FunSendCmd; Fun2: FunSendCmdNoAnswer; fun3: FunSendCmdUDPBroadCast): Integer; stdcall; external EASTRIVER_API //调用Dll前,需要赋值
function CloseDevice(): Integer; stdcall; external EASTRIVER_API
