object StitchingSchedulemain: TStitchingSchedulemain
  Left = 225
  Top = 62
  Width = 1700
  Height = 965
  Caption = 'StitchingSchedulemain'
  Color = clBtnFace
  ...
  object Query1: TADOQuery
    ...
    SQL.Strings = (
      ...
      '    left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        'Date(), 111) AND ShoeTest.StitchingDate IS NULL    and ypzl.GSDH' +
        ' = '#39'CDC'#39
      ') AS main'
      'LEFT JOIN ('
  ...
  object Query3: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        'and CONVERT(varchar(8), StitchingDate, 108)  <> '#39'00:00:00'#39'  and ' +
        'ypzl.GSDH = '#39'CDC'#39
      '  ) AS main'
      '  left join ('
      '    select shoetest2.testno,SUM(Qty) Qty from shoetest2 '
  ...
  object Query5: TADOQuery
    ...
    SQL.Strings = (
        ...
        ', 111) and (ShoeTest.StitchingDate>= CONVERT(VARCHAR, GetDate(),' +
        ' 111) or ShoeTest.StitchingDate is null) '
      '  ) AS main'
      '  left join ('
      '    select shoetest2.testno,SUM(Qty) Qty from shoetest2 '
        ...
        'ing Upper'#39','#39'Lasted upper'#39','#39'Upper Component'#39','#39'CFM sample'#39','#39'Upper ' +
        'And Bottom(CE)'#39')'
      '    group by shoetest2.testno'
      '  ) AS SQplan on SQplan.TestNo=main.testno'
      ') AS main2 '
  ...
  object Query4: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        '  WHERE CONVERT(VARCHAR, ShoeTest.StitchingDate_first, 111) BETW' +
        'EEN CONVERT(VARCHAR, GetDate()-10, 111) AND CONVERT(VARCHAR, Get' +
        'Date()-1, 111) AND ShoeTest.StitchingDate IS NULL and ypzl.GSDH ' +
        '= '#39'CDC'#39
      ') AS main'
      'LEFT JOIN ('
      '  SELECT ShoeTest2.TestNo, SUM(Qty) AS Qty FROM ShoeTest2 '
