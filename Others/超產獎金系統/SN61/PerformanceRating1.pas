...
begin
  ...
  begin
    ...
    SQL.Add('	      LYN_PerformanceRating.Year + '''' + LYN_PerformanceRating.Month + ''る'' TimePR, LYN_PerformanceRating.PNO, LYN_PerformanceRating.Year, LYN_PerformanceRating.Month ');
...
procedure TPerformanceRating.cbCFMChange(Sender: TObject);
begin
  with Qtemp do
  begin
    Active:=false;
