object IT_NHANVIEN_DONVI: TIT_NHANVIEN_DONVI
  Left = 0
  Top = 0
  Caption = 'IT_NHANVIEN_DONVI'
  ClientHeight = 329
  ClientWidth = 411
  Color = clBtnFace
  ...
  object IT_NHANVIEN_DONVIQry: TMyADOQuery
    CacheSize = 100
    Connection = DM2.ADOConn
    CursorType = ctStatic
    LockType = ltReadOnly
    AfterOpen = IT_NHANVIEN_DONVIQryAfterOpen
    BeforeClose = IT_NHANVIEN_DONVIQryBeforeClose
    CommandTimeout = 50
    DataSource = ST_DONVI.DS1
    Parameters = <>
    SQL.Strings = (
      'select * from IT_NHANVIEN_DONVI')
    Left = 176
    Top = 129
    object IT_NHANVIEN_DONVIQryDV_MA: TWideStringField
      FieldName = 'DV_MA'
      Size = 50
    end
    object IT_NHANVIEN_DONVIQryNV_MA: TWideStringField
      FieldName = 'NV_MA'
      Size = 50
    end
    object IT_NHANVIEN_DONVIQryUserID: TStringField
      FieldName = 'UserID'
      Size = 10
    end
    object IT_NHANVIEN_DONVIQryUserDate: TDateTimeField
      FieldName = 'UserDate'
    end
    object IT_NHANVIEN_DONVIQryYN: TStringField
      FieldName = 'YN'
      Size = 1
    end
  end
  object DS1: TDataSource
    DataSet = IT_NHANVIEN_DONVIQry
    Left = 176
    Top = 175
  end
  object UpdIT_NHANVIEN_DONVI: TMyADOUpdateSQL
    DataSet = IT_NHANVIEN_DONVIQry
