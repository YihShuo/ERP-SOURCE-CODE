...
type
  TLYN_USERGROUPS = class(TForm)
    ...
    USERGROUPSQryPositionCheck: TBooleanField;
    USERGROUPSQryArea: TWideStringField;
    ...
    case USERGROUPSQry.UpdateStatus of
      ...
      begin
        ...
        begin
          Active:=false;
          SQL.Clear;
          SQL.Add(' IF EXISTS (SELECT 1 FROM LYN_USERGROUPS ');
          SQL.Add(' where YN='''+USERGROUPSQry.FieldByName('YN').AsString+''' ');
          SQL.Add(' UserID='''+USERGROUPSQry.FieldByName('UserID').AsString+''') ');
          SQL.Add(' BEGIN ');
          SQL.Add(' DELETE FROM LYN_USERGROUPS ');
          SQL.Add(' where YN='''+USERGROUPSQry.FieldByName('YN').AsString+''' ');
          SQL.Add(' UserID='''+USERGROUPSQry.FieldByName('UserID').AsString+''' ');
