object AssembleSchedulemain: TAssembleSchedulemain
  Left = 182
  Top = 74
  Width = 1734
  Height = 965
  ...
  object Query1: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        'ate(), 111) AND ShoeTest.Assemblecomplete IS NULL  and ypzl.GSDH' +
        ' = '#39'CDC'#39'  '
      ') AS main'
      'LEFT JOIN ('
  ...
  object Query4: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  left join ypzl on shoetest.YPDH = ypzl.YPDH'
        ...
        '  WHERE CONVERT(VARCHAR, ShoeTest.AssembiyDate_first, 111) BETWE' +
        'EN CONVERT(VARCHAR, GetDate()-10, 111) AND CONVERT(VARCHAR, GetD' +
        'ate()-1, 111) AND ShoeTest.Assemblecomplete IS NULL  and ypzl.GS' +
        'DH = '#39'CDC'#39
      ') AS main'
      'LEFT JOIN ('
      '  SELECT ShoeTest2.TestNo, SUM(Qty) AS Qty FROM ShoeTest2 '
  ...
  object Query6: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select top 3 CONVERT(VARCHAR,initialEstimatedShipDate,111) ShipD' +
        'ate,SUM(total) Pairs,SUM(CuttingOK) CuttingOK'
      ...
      'ShipDate from CBY_Orders'
        ...
        'ate between CONVERT(VARCHAR, GetDate()+1, 111)  and CONVERT(VARC' +
        'HAR, GetDate()+5, 111)'
