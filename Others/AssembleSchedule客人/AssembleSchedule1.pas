...
type
  TAssembleSchedulemain = class(TForm)
    DBGridEh1: TDBGridEh;
    DS1: TDataSource;
...
var
  AssembleSchedulemain: TAssembleSchedulemain;

implementation

{$R *.dfm}

procedure TAssembleSchedulemain.ReadIni();
var MyIni :Tinifile;
...
procedure TAssembleSchedulemain.FormCreate(Sender: TObject);
begin
  ReadIni();
  Query1.Active := true;
  Query2.Active := true;
...
procedure TAssembleSchedulemain.Timer1Timer(Sender: TObject);
var
  m: TMessage;
begin
