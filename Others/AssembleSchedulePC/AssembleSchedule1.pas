...
type
  TAssembleSchedulemainPC = class(TForm)
    DBGridEh1: TDBGridEh;
    DS1: TDataSource;
    ...
    Panel3: TPanel;
    DBGridEh2: TDBGridEh;
    Query1StitchingOK: TDateTimeField;
    Query1AMatOK: TDateTimeField;
    Query1AMatGet: TDateTimeField;
    Query1AssemblePlan: TDateTimeField;
    DS5: TDataSource;
    Query5: TADOQuery;
    Panel1: TPanel;
    Label1: TLabel;
    ...
    Panel11: TPanel;
    Panel12: TPanel;
    Query2AssemblePlan: TStringField;
...
var
  AssembleSchedulemainPC: TAssembleSchedulemainPC;

implementation

{$R *.dfm}

procedure TAssembleSchedulemainPC.ReadIni();
var MyIni :Tinifile;
...
procedure TAssembleSchedulemainPC.FormCreate(Sender: TObject);
begin
  ReadIni();
  Query1.Active := true;
  Query2.Active := true;
...
procedure TAssembleSchedulemainPC.Timer1Timer(Sender: TObject);
var
  m: TMessage;
begin
