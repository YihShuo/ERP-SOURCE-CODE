...
var
  YearOrderQty1: TYearOrderQty1;

implementation

{$R *.dfm}

procedure TYearOrderQty1.Button1Click(Sender: TObject);
var a,b :integer;
begin
...
procedure TYearOrderQty1.FormCreate(Sender: TObject);
var a,b:integer;
   // b:string;
begin
    a:=12;
...
procedure TYearOrderQty1.ComboBox1Change(Sender: TObject);
var a,b:integer;
begin
    a:=5;
...
procedure TYearOrderQty1.CheckBox1Click(Sender: TObject);
begin
...
procedure TYearOrderQty1.DBGridEh1DrawColumnCell(Sender: TObject;
...
procedure TYearOrderQty1.Button2Click(Sender: TObject);
...
procedure TYearOrderQty1.Query1AfterOpen(DataSet: TDataSet);
var i:word;
begin
 with DBGrideh1 do
   begin
