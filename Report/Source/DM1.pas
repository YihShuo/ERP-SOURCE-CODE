...
procedure TDM.dbMainLogin(Database: TDatabase; LoginParams: TStrings);
...
begin
  ...
  dbMain.aliasname:=sline;
  dbMain.Connected:=true;
end;

procedure TDM.DBSHIPLogin(Database: TDatabase; LoginParams: TStrings);
var textfilevar:textfile;
    ad,i:integer;
    tempstr:string;
    a,susername,spassword,sline,pp:string;
