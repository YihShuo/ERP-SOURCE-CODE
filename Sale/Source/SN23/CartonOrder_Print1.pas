...
type
  TCartonOrder_Print = class(TForm)
    QuickRep1: TQuickRep;
...
var
  CartonOrder_Print: TCartonOrder_Print;
...
procedure TCartonOrder_Print.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
//free;
end;

procedure TCartonOrder_Print.QRCompositeReport1AddReports(Sender: TObject);
begin
...
procedure TCartonOrder_Print.ReadIni();
var MyIni :Tinifile;
    AppDir:string;
begin
...
procedure TCartonOrder_Print.FormCreate(Sender: TObject);
var
  i:integer;
...
procedure TCartonOrder_Print.FormDestroy(Sender: TObject);
begin
  cartonorder_print:=nil;
end;

procedure TCartonOrder_Print.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var textvar:textfile;
    sline:string;
begin
   PageHeaderBand1.Frame.DrawBottom:= true;
   CartonOrder_Print.L1.Caption:=ComName;
end;

procedure TCartonOrder_Print.QRCompositeReport1Finished(Sender: TObject);
begin
  CartonOrder_Print.QRLabel50.Caption:=SaleN23_ISO;
  CartonOrder_Print.QRLabel17.Caption:=SaleN23_ISO;
end;
