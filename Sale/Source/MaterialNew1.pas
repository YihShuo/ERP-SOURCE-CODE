...
uses main1, MaterialNew_LB1, MaterialNew_ZS1, MaterialNew_ZSZL1;
...
begin
  ...
  begin
    active:=false;
    sql.clear;
    sql.add('select CLZL.*,KFZL.KFJC,ZSZL.ZSYWJC from CLZL');
    ...
    sql.add('and CLZL.CLDH like ''U1%'' ');
    sql.add('and CLZL.YWPM like ''%'+edit2.text+'%''');
    sql.add('and CLZL.YWPM like ''%'+edit3.text+'%''');
    sql.add('and (CLZL.YN=''2'' or CLZL.YN=''3'') ');
...
begin
  ...
  DBGrid1.Columns[6].ButtonStyle:=cbsellipsis;
...
begin
  if DBGrid1.selectedfield.fieldname='cllb' then
  begin
    BBTT1click(nil);
  end else if DBGrid1.selectedfield.fieldname='ZSDH' then
  begin
    MaterialNew_ZSZL:=TMaterialNew_ZSZL.create(self);
    MaterialNew_ZSZL.Show;
  end else if DBGrid1.selectedfield.fieldname='kfdh' then
  begin
    MaterialNew_ZS:=TMaterialNew_ZS.create(self);
    MaterialNew_ZS.show;
  end;
end;
