...
procedure TSpecMas.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TSpecMas.FormCreate(Sender: TObject);
begin
DTP1.Date:=date;
end;

procedure TSpecMas.BB4Click(Sender: TObject);
begin
close;
end;

procedure TSpecMas.BB1Click(Sender: TObject);
begin
edit1.Text:='1';
with QTW do
  begin
    active:=false;
    SQL.Clear;
    sql.Add('select * from LY_SHOE.dbo.zlzl l');
...
procedure TSpecMas.QVNAfterOpen(DataSet: TDataSet);
begin
...
procedure TSpecMas.BD1Click(Sender: TObject);
var i:integer;
begin
...
procedure TSpecMas.BD4Click(Sender: TObject);
begin
QVN.first;
...
procedure TSpecMas.BD3Click(Sender: TObject);
begin
...
procedure TSpecMas.BD5Click(Sender: TObject);
begin
QVN.Active:=false;
QVn.CachedUpdates:=false;
QVN.RequestLive:=false;
...
procedure TSpecMas.BD2Click(Sender: TObject);
var i:integer;
begin
QVN.CachedUpdates:=true;
QVN.RequestLive:=true;
...
procedure TSpecMas.BB2Click(Sender: TObject);
begin
edit1.Text:='0';
with QTW do
  begin
    active:=false;
    SQL.Clear;
    sql.Add('select * from LY_ERP.dbo.zlzl l');
    sql.add('where not exists(select zlbh from LY_SHOE.dbo.zlzl d ');
