object CarttonModel: TCarttonModel
  Left = 288
  Top = 177
  Width = 870
  Height = 500
  Caption = 'CarttonModel'
  Color = clBtnFace
  ...
  object UPYWWX2: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into YWWX2'
        ...
        '  (CLBH, Length, Width, Height, OWeigh,Capacity, Memo, USERDATE,' +
        ' USERID, YN)'
      'values'
      
        '  (:CLBH, :Length, :Width, :Height,:Capacity, :OWeigh, :Memo, :U' +
        'SERDATE, :USERID, '
      '   :YN)')
    DeleteSQL.Strings = (
      'delete from YWWX2'
