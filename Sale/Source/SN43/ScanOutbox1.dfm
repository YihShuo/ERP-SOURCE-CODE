object ScanOutbox: TScanOutbox
  ...
  object Panel4: TPanel
    ...
    object ExcelDBGridEh: TDBGridEh
      ...
      TitleFont.Style = []
      OnGetCellParams = ExcelDBGridEhGetCellParams
    end
  end
  ...
  object YWCP: TQuery
    ...
    SQL.Strings = (
        ...
        'select  CARTONBAR,CARTONNO,YWCP.DDBH,XH,LPNBarCode,DDZL.KHPO fro' +
        'm YWCP,DDZL'
      'where DDZL.DDBH=YWCP.DDBH '
      ' and YWCP.DDBH = '#39'Y1710-0290'#39' '
      ' and YWCP.XH = '#39'035'#39' '
      'Order by CARTONNO,LPNBarCode')
    UpdateObject = UPDet
    Left = 160
    Top = 105
