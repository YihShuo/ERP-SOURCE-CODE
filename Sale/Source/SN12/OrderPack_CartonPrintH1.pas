...
type
  TOrderPack_CartonPrintH = class(TForm)
    QuickRep1: TQuickRep;
    YWDDBZ: TQuery;
    DetailBand1: TQRBand;
    QRShape1: TQRShape;
...
var
  OrderPack_CartonPrintH: TOrderPack_CartonPrintH;

implementation
   uses OrderList1, FunUnit;
{$R *.dfm}
//
procedure TOrderPack_CartonPrintH.OtherSingalCode(Index:String);
var i,j:integer;
          ...
          begin
             ...
             begin
               ...
               begin
                 ...
                 begin
                    tmpQRImage.Left:=tmpQRDBText.Left+51;
                    tmpQRImage.Top:=tmpQRDBText.Top-4;
                    //
...
//產生DataSet
function TOrderPack_CartonPrintH.CreateDataSet(FieldNM:TStringlist;FielSize:TStringlist): TDataSet;
var
  dsTemp:TDataSet;
...
//新增資料到DataSet
Function TOrderPack_CartonPrintH.AddDataToSet(AdsData: TDataSet;FieldValue:TStringlist): TDataSet;
var i:integer;
begin
  //
  AdsData.Open;
...
//
procedure TOrderPack_CartonPrintH.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  PrintDataSet1:=nil;
  PrintDataSet2:=nil;
  OrderPack_CartonPrintH:=nil;
end;

procedure TOrderPack_CartonPrintH.FormCreate(Sender: TObject);
begin
...
//
procedure TOrderPack_CartonPrintH.InitYWDDBZ();
var i:integer;
begin
  //
  with TmpQry do
...
function TOrderPack_CartonPrintH.InitYWBZPOS_Single():boolean;
...
function TOrderPack_CartonPrintH.InitYWBZPOS_Multi():boolean;
var FieldList,SizeList,FieldValueList:TStringlist;
    i,j,k:integer;
    QRDBText:TQRDBText;
begin
...
procedure TOrderPack_CartonPrintH.QRCompositeReport1AddReports(
  Sender: TObject);
begin
  if IsExistSingleSize=true then
  OrderPack_CartonPrintH.QRCompositeReport1.reports.Add(OrderPack_CartonPrintH.QuickRep1);
  {
  if IsExistsMulitSize=true then
  OrderPack_CartonPrintH.QRCompositeReport1.reports.Add(OrderPack_CartonPrintH.QuickRep2);
  }
end;
