object Orderpack_Label: TOrderpack_Label
  Left = 339
  Top = 155
  Width = 844
  Height = 383
  BorderIcons = [biSystemMenu]
  Caption = 'Orderpack_Label'
  Color = clBtnFace
  ...
  object ZLZLS2: TQuery
    AfterOpen = ZLZLS2AfterOpen
    OnNewRecord = ZLZLS2NewRecord
    DatabaseName = 'DB'
    ...
    SQL.Strings = (
      ...
      'where ZLZLS2.ZLBH=:YSBH'
      '      and (ZLZLS2.CLBH like '#39'L09%'#39
      '           or ZLZLS2.CLBH like '#39'H15%'#39)
    ...
    object ZLZLS2YN: TStringField
      FieldName = 'YN'
      FixedChar = True
      Size = 1
    end
    object ZLZLS2ZWPM: TStringField
      FieldName = 'ZWPM'
      FixedChar = True
      Size = 200
    end
