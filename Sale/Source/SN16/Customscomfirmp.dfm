object CustomsComfirm: TCustomsComfirm
  Left = 390
  Top = 345
  Width = 1131
  Height = 500
  Caption = 'Customs Comfirm'
  Color = clBtnFace
  ...
  object YWDD: TQuery
    ...
    SQL.Strings = (
        ...
        'select YWDD.DDBH,YWDD.Qty,YWDD.ETD,YWDD.SB,YWDD.EXESB,YWDD.xfloc' +
        'k,YWDD.xfUSERID,YWDD.xfUSERDATE,YWDD.USERID,YWDD.USERDATE'
      
        '       ,DDZL.XieXing,DDZL.SheHao, XXZL.XieMing,LBZLS.YWSM,DDZL.K' +
        'HPO'
      
        '       ,DDZL.Article,DDZL.ShipDate,XXZL.CCGB as XXCC,DDZL.CCGB a' +
        's DDCC,INVOICE_D.INV_NO'
      'from YWDD'
      ...
      'left join LBZLS on LBZLS.LB='#39'06'#39' and LBZLS.LBDH=DDZL.DDGB'
        ...
        'left join (select RYNO,INV_NO from INVOICE_D Group by RYNO,INV_N' +
        'O ) INVOICE_D on INVOICE_D.RYNO=DDZl.DDBH'
      'where YWDD.DDBH like '#39'%'#39
      '      and XXZL.XieMing like '#39'%%'#39
      
        '      and convert(smalldatetime,convert(varchar,YWDD.ETD,111)) b' +
        'etween '
      '      '#39'2020/09/23'#39' and '#39'2020/10/23'#39
      'order by YWDD.DDBH')
    ...
    object YWDDEXESB: TStringField
      AutoGenerateValue = arAutoInc
      FieldName = 'EXESB'
      Origin = 'DB.ywdd.EXESB'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    ...
    object YWDDxfUserID: TStringField
      FieldName = 'xfUserID'
      FixedChar = True
    end
    object YWDDxfUSERDATE: TDateTimeField
      FieldName = 'xfUSERDATE'
      DisplayFormat = 'YYYY/MM/DD'
    end
    object YWDDINV_NO: TStringField
      FieldName = 'INV_NO'
      FixedChar = True
      Size = 15
    end
