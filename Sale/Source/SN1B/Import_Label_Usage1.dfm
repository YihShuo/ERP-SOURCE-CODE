object Import_Label_Usage: TImport_Label_Usage
  Left = 318
  Top = 243
  Width = 1564
  Height = 675
  Caption = 'Import_Label_Usage'
  Color = clYellow
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'where ZLZLS2.ZLBH='#39'Y2310-1648'#39
      '         and (ZLZLS2.CLBH like '#39'L09%'#39
      '         or ZLZLS2.CLBH like '#39'H15%'#39
      '         or ZLZLS2.CLBH like '#39'H14%'#39
      ')'
      '         and  not exists ('
      '         select *'
      '         from ZLZLS2 A'
