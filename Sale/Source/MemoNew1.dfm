object MemoNew: TMemoNew
  ...
  object Query1: TQuery
    ...
    object Query1MENO: TStringField
      FieldName = 'MENO'
      FixedChar = True
      Size = 8
    end
    ...
    object Query1VNSM: TStringField
      FieldName = 'VNSM'
      FixedChar = True
      Size = 250
    end
  ...
  object UpSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into YWBZZL'
      '  (KHBH, MENO, ZWSM, VNSM, USERID, USERDate, YN)'
      'values'
      '  (:KHBH, :MENO, :ZWSM, :VNSM, :USERID, :USERDate, :YN)')
    DeleteSQL.Strings = (
      'delete from YWBZZL'
