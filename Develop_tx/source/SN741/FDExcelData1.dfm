object FDExcelData: TFDExcelData
              ...
              object YPZLGrid: TDBGridEh
                ...
                Columns = <
                  ...
                  item
                    ...
                    Footers = <>
                    ReadOnly = True
                    Title.Caption = 'TECH|Status'
                  end
                  item
                    EditButtons = <>
                    FieldName = 'KT_CheckDate'
                    Footers = <>
                    ReadOnly = True
              ...
              object YPZLSGrid: TDBGridEh
                ...
                Columns = <
                  ...
                  item
                    ...
                    FieldName = 'cldhflex'
                    Footers = <>
                    Title.Caption = 'WEB|Material_ID'
                  end
                  item
                    EditButtons = <>
                    FieldName = 'Comment'
                    Footers = <>
                    Title.Caption = 'WEB|Comment'
                    Width = 500
                  end>
              end
      ...
      object TabSheet14: TTabSheet
        ...
        object DBGridEh12: TDBGridEh
          ...
          Columns = <
            ...
            item
              EditButtons = <>
              FieldName = 'CustomerApprove'
              Footers = <>
              Width = 123
              OnUpdateData = DBGridEh12Columns20UpdateData
            end
            item
              EditButtons = <>
              FieldName = 'Customer_USERID'
              Footers = <>
              ReadOnly = True
            end
            item
              EditButtons = <>
              FieldName = 'Customer_UserDate'
              Footers = <>
              ReadOnly = True
            end>
        end
  ...
  object YPZL: TQuery
    AfterOpen = YPZLAfterOpen
    AfterClose = YPZLAfterClose
    ...
    object YPZLbgColor: TIntegerField
      FieldName = 'bgColor'
    end
    object YPZLKT_Check: TBooleanField
      FieldName = 'KT_Check'
    end
    object dtmfldYPZLKT_CheckDate: TDateTimeField
      FieldName = 'KT_CheckDate'
    end
  end
  object YPZLS: TQuery
    ...
    object YPZLScldhflex: TStringField
      FieldName = 'cldhflex'
      FixedChar = True
    end
    object YPZLSComment: TStringField
      FieldName = 'Comment'
      FixedChar = True
      Size = 4000
    end
  ...
  object RE_Check: TQuery
    ...
    DataSource = YPZL_DS
    SQL.Strings = (
      'select  ypdh,RE_check,XXZLKF.TRANSFER,XXZLKF.TransferIn'
      
        'from YPzl left join XXZLKF on XXZLKF.XieXing=YPZL.XieXing and XX' +
        'ZLKF.SheHao=ypzl.SheHao'
      'where YPDH=:YPDH'
      'group by ypdh,RE_check,XXZLKF.TRANSFER,XXZLKF.TransferIn')
    ...
    object RE_CheckTRANSFER: TBooleanField
      FieldName = 'TRANSFER'
    end
    object RE_CheckTransferIn: TBooleanField
      FieldName = 'TransferIn'
    end
  end
  ...
  object Sticker2: TQuery
    ...
    SQL.Strings = (
      ...
      #9'from ('
        ...
        ',ypzls.csbh,zszl.zsywjc, kfxxzl.YSSM from ypzls'
      ...
      #9#9'union'
        ...
        'ywpm,clzhzl.zsdh as csbh,zszl.zsywjc, kfxxzl.YSSM from ypzls'
  ...
  object QReport: TQuery
    ...
    SQL.Strings = (
        ...
        'POSE, YPZL.FD, cgzl_color.Result, '
    ...
    object QReportResult: TStringField
      FieldName = 'Result'
      FixedChar = True
      Size = 10
    end
    object QReportCustomerApprove: TBooleanField
      FieldName = 'CustomerApprove'
    end
    object strngfldQReportCustomer_USERID: TStringField
      FieldName = 'Customer_USERID'
    end
    object dtmfldQReportCustomer_UserDate: TDateTimeField
      FieldName = 'Customer_UserDate'
    end
    object strngfldQReportZSYWJC: TStringField
      FieldName = 'ZSYWJC'
      Size = 200
    end
  end
  ...
  object dsCheck_KT_DS: TDataSource
    DataSet = qryCheck_KT
    Left = 1218
    Top = 510
  end
  object qryCheck_KT: TQuery
    DatabaseName = 'DB'
    DataSource = YPZL_DS
    UpdateObject = UpCheck_KT
    Left = 1218
    Top = 542
    object strngfldYYPDH: TStringField
      FieldName = 'YPDH'
    end
    object qryCheck_KTKT_Check: TBooleanField
      FieldName = 'KT_Check'
    end
    object dtmfldYKT_CheckDate: TDateTimeField
      FieldName = 'KT_CheckDate'
    end
  end
  object UpCheck_KT: TUpdateSQL
    ModifySQL.Strings = (
      'Update YPZL Set'
      '      KT_Check=:KT_Check,'
      '      KT_CheckDate=GetDate()'
      'where'
      '  YPDH=:OLD_YPDH')
    Left = 1218
    Top = 574
