...
procedure TDelOther_CL.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure TDelOther_CL.DBGridEh1DrawColumnCell(Sender: TObject;
...
procedure TDelOther_CL.DBGridEh1KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
