object MaterialReadyTime1: TMaterialReadyTime1
  ...
  object Query11: TQuery
    ...
    SQL.Strings = (
        ...
        'null(Status,'#39#39') Status,ETA,Material,MaterialDES,Memo,ywsm,CheckR' +
        'esult from ('
        ...
        'GZLSs1.Memo,ywsm,CGZLInvoiceS.CheckResult from ('
    ...
    object Query11CheckResult: TStringField
      FieldName = 'CheckResult'
      FixedChar = True
      Size = 15
    end
  ...
  object Query12: TQuery
    ...
    object Query12CheckResult: TStringField
      FieldName = 'CheckResult'
      FixedChar = True
      Size = 15
    end
  ...
  object qryc9send: TQuery
    DatabaseName = 'dB'
    Left = 1148
    Top = 239
  end
  object dsc9send: TDataSource
    DataSet = qryc9send
    Left = 1148
    Top = 199
  end
  object qryc9get: TQuery
    DatabaseName = 'dB'
    Left = 1220
    Top = 239
  end
  object dsc9get: TDataSource
    DataSet = qryc9get
    Left = 1220
    Top = 199
  end
