object BasicInformation: TBasicInformation
    ...
    object TabSheet7: TTabSheet
      ...
      object DBGridEh7: TDBGridEh
        ...
        Columns = <
          ...
          item
            EditButtons = <>
            FieldName = 'Inline/Non-Inline'
            Footers = <>
            ReadOnly = True
            Title.Caption = 'Inline/ Non-Inline'
            Width = 90
          end
          item
            EditButtons = <>
          ...
          item
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = 'Planning Level 2'
            Width = 120
          end
          item
            EditButtons = <>
  ...
  object Query7: TQuery
    ...
    SQL.Strings = (
        ...
        'select CFM.XieXing,CFM.SheHao,kfxxzl.XieMing,kfxxzl.DEVCODE,xxzl' +
        '.ARTICLE,kfxxzl.JiJie,ypzl.Subtype'
      
        #9',case kfxxzl.KFLX when '#39'CU'#39' then '#39'NC'#39' when '#39'MU'#39' then '#39'NM'#39' when ' +
        #39'MU+'#39' then '#39'NM+'#39' else kfxxzl.KFLX end  as '#39'Techlevel'#39
      
        #9', case when isnull(ypzl.Subtype,'#39#39') <> '#39#39' and (ypzl.Subtype='#39'In' +
        'line'#39' or ypzl.Subtype='#39'CBY'#39') then '#39'Inline'#39' else '#39'Non-Inline'#39' end' +
        '  as '#39'Inline/Non-Inline'#39
      
        #9',xxzlkf.ProductionType,xxzlkf.category,xxzlkf.CTS,xxzlkf.Planni' +
        'ng_Level_2,XXZLKF.Segment,CFM_Sample.LYN_Order,CFM_Sample.LYI_Or' +
        'der,CFM_Sample.UserID,CFM_Sample.UserDate,CFM_Sample.YN'
      'from CFM'
      ...
      'left join kfzl_GS on kfzl_GS.KHBH=kfxxzl.KHDH'
        ...
        'left join CFM_Sample on CFM.XieXing=CFM_Sample.XieXing and CFM.S' +
        'heHao=CFM_Sample.Shehao'
      'where ypzl.kfjd ='#39'CFM'#39' and kfxxzl.jijie like '#39'%24U%'#39
      'and kfxxzl.devcode <>'#39#39
      'and kfxxzl.xieming not like '#39'%NULLIFY%'#39' '
    ...
    Left = 288
    Top = 320
    object Query7XieXing: TStringField
      FieldName = 'XieXing'
      FixedChar = True
      Size = 15
    end
    object Query7SheHao: TStringField
      FieldName = 'SheHao'
      FixedChar = True
      Size = 5
    end
    object Query7XieMing: TStringField
      FieldName = 'XieMing'
      FixedChar = True
      Size = 50
    end
    object Query7DEVCODE: TStringField
      FieldName = 'DEVCODE'
      FixedChar = True
    end
    object Query7ARTICLE: TStringField
      FieldName = 'ARTICLE'
      FixedChar = True
    end
    object Query7JiJie: TStringField
      FieldName = 'JiJie'
      FixedChar = True
    end
    object Query7Subtype: TStringField
      FieldName = 'Subtype'
      FixedChar = True
      Size = 15
    end
    object Query7Techlevel: TStringField
      FieldName = 'Techlevel'
      FixedChar = True
      Size = 3
    end
    object Query7InlineNonInline: TStringField
      FieldName = 'Inline/Non-Inline'
      FixedChar = True
      Size = 10
    end
    object Query7SS: TStringField
      FieldName = 'SS'
      Size = 5
    end
    object Query7ProductionType: TStringField
      FieldName = 'ProductionType'
      FixedChar = True
      Size = 15
    end
    object Query7category: TStringField
      FieldName = 'category'
      FixedChar = True
      Size = 30
    end
    object Query7CTS: TStringField
      FieldName = 'CTS'
      FixedChar = True
    end
    object Query7Planning_Level_2: TStringField
      FieldName = 'Planning_Level_2'
      FixedChar = True
      Size = 100
    end
    object Query7Segment: TStringField
      FieldName = 'Segment'
      FixedChar = True
      Size = 50
    end
    object Query7LYN_Order: TIntegerField
      FieldName = 'LYN_Order'
    end
    object Query7LYI_Order: TIntegerField
      FieldName = 'LYI_Order'
    end
    object Query7UserID: TStringField
      FieldName = 'UserID'
      FixedChar = True
      Size = 15
    end
    object Query7UserDate: TDateTimeField
      FieldName = 'UserDate'
    end
    object Query7YN: TStringField
      FieldName = 'YN'
      FixedChar = True
      Size = 1
    end
  ...
  object UpdateSQL7: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  SheHao = :OLD_SheHao ')
    InsertSQL.Strings = (
      'INSERT INTO CFM_Sample'
      
        '(XieXing, SheHao, SS,ProductionType,Category ,CTS, LYI_Order, Us' +
        'erID, UserDate, YN)'
      'VALUES'
      
        '(:XieXing, :SheHao,:SS,:ProductionType, :Category,:CTS, :LYI_Ord' +
        'er, :UserID, :UserDate, :YN)')
    Left = 288
    Top = 352
  end
