object CFactoryScan: TCFactoryScan
  Left = 453
  Top = 250
  Width = 1319
  Height = 450
    ...
    object Panel2: TPanel
      ...
      object PageControl1: TPageControl
        ...
        object TabSheet3: TTabSheet
          Caption = 'Packing Complete Time (C Factory)'
          ImageIndex = 2
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select top 1 Testno,Article,Finish,Complete,TBReceive,YPDH,Pendi' +
        'ng_C,CutDate,Pending_S,StitchingDate,Assemblecomplete  '
      'from shoetest')
    Left = 89
    Top = 249
