...
uses
  ...
  Mask, DBCtrlsEh, ComCtrls, fununit;
...
begin
  ...
  begin
      ...
      sql.Clear;
      sql.Add('select * from (');
      sql.Add('select  Lab_shoetest.TestNO,Lab_shoetest.GSBH,Lab_shoetest.CKBH,Lab_shoetest.SCBH,Lab_shoetest.UserID,Lab_shoetest.UserDate,shoetest.article,Lab_shoetest.YN,');
      ...
      sql.Add('Lab_shoetest.QTY,Lab_shoetest.ReceiveID,Lab_shoetest.ReceiveQty,Lab_shoetest.DepName,Lab_shoetest.Parts,Lab_shoetest.RY,Lab_shoetest.PO from Lab_shoetest');
      sql.Add('left join shoetest on shoetest.testno=Lab_shoetest.scbh where  Lab_shoetest.yn is null and isnull(Lab_shoetest.gsbh,Lab_shoetest.ckbh)=''CDC'' ');
      if edit3.text<>'' then
      ...
      if edit5.Text<>'' then
         sql.Add(' and Lab_shoetest.RY like ''%'+edit5.Text+'%'' ');
      if edit4.Text<>'' then
         sql.Add(' and Lab_shoetest.PO like ''%'+edit4.Text+'%'' ');
      ...
      sql.Add('union');
      sql.Add('select  Lab_shoetest.TestNO,Lab_shoetest.GSBH,Lab_shoetest.CKBH,Lab_shoetest.SCBH,Lab_shoetest.UserID,Lab_shoetest.UserDate,ddzl.article,Lab_shoetest.YN,');
      sql.Add('Lab_shoetest.Applicant1,Lab_shoetest.Applicant2,Lab_shoetest.TestPurpose,Lab_shoetest.ReportCCTo,Lab_shoetest.Factory,Lab_shoetest.ProductionLine,');
      sql.Add('Lab_shoetest.CustomerPO,Lab_shoetest.DateOfManufacturing,Lab_shoetest.ReceiveDate,Lab_shoetest.ShipTo,Lab_shoetest.ReportNO,');
      sql.Add('Lab_shoetest.QTY,Lab_shoetest.ReceiveID,Lab_shoetest.ReceiveQty,Lab_shoetest.DepName,Lab_shoetest.Parts,Lab_shoetest.RY,Lab_shoetest.PO from Lab_shoetest');
      sql.Add('left join ddzl on ddzl.ddbh=Lab_shoetest.scbh where Lab_shoetest.yn is null and  isnull(Lab_shoetest.gsbh,Lab_shoetest.ckbh)=''VA12'' ');
      if edit3.text<>'' then
         sql.Add(' and isnull(Lab_shoetest.ckbh,Lab_shoetest.gsbh) like ''%'+ComboBox3.Text+'%'' ');
      if edit1.Text<>'' then
         sql.Add(' and Lab_shoetest.TestNO like ''%'+edit1.Text+'%'' ');
      ...
      sql.Add('union');
      sql.Add('select  Lab_shoetest.TestNO,Lab_shoetest.GSBH,Lab_shoetest.CKBH,Lab_shoetest.SCBH,Lab_shoetest.UserID,Lab_shoetest.UserDate,CBY_Orders.style article,Lab_shoetest.YN,');
      sql.Add('Lab_shoetest.Applicant1,Lab_shoetest.Applicant2,Lab_shoetest.TestPurpose,Lab_shoetest.ReportCCTo,Lab_shoetest.Factory,Lab_shoetest.ProductionLine,');
      sql.Add('Lab_shoetest.CustomerPO,Lab_shoetest.DateOfManufacturing,Lab_shoetest.ReceiveDate,Lab_shoetest.ShipTo,Lab_shoetest.ReportNO,');
      sql.Add('Lab_shoetest.QTY,Lab_shoetest.ReceiveID,Lab_shoetest.ReceiveQty,Lab_shoetest.DepName,Lab_shoetest.Parts,Lab_shoetest.RY,Lab_shoetest.PO from Lab_shoetest');
      sql.Add('left join CBY_Orders on CBY_Orders.workOrderId=Lab_shoetest.scbh where Lab_shoetest.yn is null and  isnull(Lab_shoetest.gsbh,Lab_shoetest.ckbh)=''CBY'' ');
      if edit3.text<>'' then
         sql.Add(' and isnull(Lab_shoetest.ckbh,Lab_shoetest.gsbh) like ''%'+ComboBox3.Text+'%'' ');
      if edit1.Text<>'' then
         sql.Add(' and Lab_shoetest.TestNO like ''%'+edit1.Text+'%'' ');
      ...
      sql.Add(')main order by TestNO desc');
...
begin
  ...
  if (ComboBox3.Text = 'R2') or (ComboBox3.Text = 'C') or (ComboBox3.Text = 'Tech') or (ComboBox3.Text = 'Ref') then
