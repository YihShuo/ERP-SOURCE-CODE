object SampleWarehouse: TSampleWarehouse
        ...
        object DBGridEh7: TDBGridEh
          ...
          Columns = <
            ...
            item
              ...
              FieldName = 'C9'
              Footers = <>
              Title.Caption = 'TB Receive - Planning Team(SINH QUAN)|C9|C9'
            end
            item
              Color = cl3DLight
              EditButtons = <>
            ...
            item
              ...
              FieldName = 'C9_Send'
              Footers = <>
              Title.Caption = 'Warehouse status|Phat C9|C9 Send|'#30332'C9'
            end
            item
              EditButtons = <>
              FieldName = 'C9_Get'
              Footers = <>
              Title.Caption = 'Warehouse status|C9 Ve|C9 Get|'#38936'C9'
            end
            item
              EditButtons = <>
  ...
  object shoetest: TQuery
    ...
    SQL.Strings = (
      ...
      ',ypzl.YPDH,ypzl.YPCC,isnull(bw01.qty,0) FinishedShoe'
      'from shoetest'
    ...
    object shoetestC9: TBooleanField
      FieldName = 'C9'
    end
    object dtmfldC9_Send: TDateTimeField
      FieldName = 'C9_Send'
    end
    object dtmfldC9_Get: TDateTimeField
      FieldName = 'C9_Get'
    end
  ...
  object QryTmpMemo2: TQuery
    DatabaseName = 'DB'
    UpdateObject = updateQryTmpMemo2
    Left = 581
    Top = 373
  end
  object updateQryTmpMemo2: TUpdateSQL
    ModifySQL.Strings = (
      'update shoetest'
      'set'
      '  Memo2=:Memo2'
