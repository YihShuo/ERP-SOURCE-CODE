object MaterialArticle: TMaterialArticle
  ...
  object Panel1: TPanel
    ...
    object ShowDetail5: TCheckBox
      Left = 853
      Top = 53
      Width = 166
      Height = 17
      Caption = 'Show CBY Order'
      TabOrder = 12
      OnClick = ShowDetail5Click
    end
  end
    ...
    object Panel11: TPanel
      ...
      object DBGridEh5: TDBGridEh
        ...
        Columns = <
          ...
          item
            EditButtons = <>
            FieldName = 'factoryAcceptDate'
            Footers = <>
            Width = 70
          end
          item
            EditButtons = <>
            FieldName = 'initialEstimatedShipDate'
            Footers = <>
            Width = 70
          end
          item
  ...
  object Query5: TQuery
    ...
    SQL.Strings = (
        ...
        'select top 10 workOrderId,style,factoryAcceptDate,initialEstimat' +
        'edShipDate, CASE WHEN CBY_Orders.Cancel = 1 THEN '#39'Y'#39' ELSE '#39#39' END' +
        ' AS Cancel'
      'from CBY_Orders'
      'where factoryAcceptDate>GETDATE()-180'
      
        'and exists (Select CBY_Orders.workOrderId From CBY_Orders_ZLZLS2' +
        ' ZlZLS2 Where CBY_Orders.workOrderId=ZLZLS2.workorderId and clbh' +
        '=:CLDH)'
      '')
    Left = 456
    Top = 272
    ...
    object Query5workOrderId: TStringField
      FieldName = 'workOrderId'
      FixedChar = True
      Size = 15
    end
    object Query5style: TStringField
      FieldName = 'style'
      FixedChar = True
    end
    object Query5factoryAcceptDate: TDateTimeField
      FieldName = 'factoryAcceptDate'
    end
    object Query5initialEstimatedShipDate: TDateTimeField
      FieldName = 'initialEstimatedShipDate'
    end
    object Query5Cancel: TStringField
      FieldName = 'Cancel'
      FixedChar = True
      Size = 1
    end
