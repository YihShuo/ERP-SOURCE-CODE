...
type
  TMaterialArticle = class(TForm)
    ...
    Query5workOrderId: TStringField;
    Query5style: TStringField;
    Query5factoryAcceptDate: TDateTimeField;
    Query5initialEstimatedShipDate: TDateTimeField;
    Query5Cancel: TStringField;
    ShowDetail5: TCheckBox;
    ...
    procedure YWPMEditKeyDown(Sender: TObject; var Key: Word;
      Shift: TShiftState);
    procedure ShowDetail5Click(Sender: TObject);
  private
...
begin
  ...
  if ShowDetail5.Checked=true then Query5.Active:=true;
...
procedure TMaterialArticle.ShowDetail5Click(Sender: TObject);
begin
  if ShowDetail5.Checked=false then
  begin
    Query5.Active:=false;
  end else
  begin
