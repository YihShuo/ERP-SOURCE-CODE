object DeveloperName: TDeveloperName
  ...
  object Qry3: TQuery
    ...
    SQL.Strings = (
        ...
        'select GSBH,FDTeam,TeamLeader,TeamLeader2 from FDGroup where FDT' +
        'eam is not null')
    UpdateObject = UdQry3
    Left = 412
    Top = 224
    object Qry3GSBH: TStringField
      FieldName = 'GSBH'
      Origin = 'DB.FDGroup.GSBH'
      FixedChar = True
      Size = 5
    end
  ...
  object UdQry3: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into FDGroup'
      '(GSBH,FDTeam,TeamLeader,TeamLeader2)'
      'Values'
      '(:GSBH,:FDTeam,:TeamLeader,:TeamLeader2)')
    Left = 412
    Top = 264
