...
begin
      ...
      begin
        ...
        if edit5.text<>'' then
           sql.Add('and FDGroups.FDTeam like '''+edit5.text+'%''');
        if edit4.text<>'' then
...
begin
      ...
      begin
        active:=false;
        sql.Clear;
        sql.add('select GSBH,FDTeam,TeamLeader,TeamLeader2 from FDGroup where FDTeam is not null');
