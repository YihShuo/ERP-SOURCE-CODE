object ProductionPlan: TProductionPlan
  ...
  object workplan: TQuery
    ...
    DatabaseName = 'DB'
    SQL.Strings = (
      'select * from LIY_DD.dbo.workplan workplan'
      
        'where convert(smalldatetime,convert(varchar,workStartDate,111)) ' +
        'between '
      '      '#39'2020/06/25'#39' and '#39'2020/07/02'#39
      
        ' and workplan.workID in (select workID from LIY_DD.dbo.workplans' +
        's workplanss where workplanss.DDBH like '#39'Y1801-0052%'#39')'
  ...
  object WorkPlanSS: TQuery
    ...
    SQL.Strings = (
      'select *'
      'from LIY_DD.dbo.workplanss as wpss'
      'where workid=:workid ')
    UpdateObject = upwpss
    Left = 338
    Top = 361
