object PMR: TPMR
  ...
  object U_PMRList: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO PMRList'
        ...
        ', BOMCheck, UserID, UserDate, YN, PMRDONE)'
      'VALUES'
        ...
        'yCost, :PMRFile, :BOMCheck, :UserID, GETDATE(), :YN, :PMRDONE)')
    DeleteSQL.Strings = (
      'DELETE FROM PMRList'
      'WHERE'
      'PMRNo = :OLD_PMRNo')
  ...
  object U_PMRListSS: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO PMRListSS'
        ...
        ' Cost, Remark, UserID, UserDate, YN, BOMCheck, DEVCheck)'
      'VALUES'
  ...
  object Q_PMRList: TQuery
    ...
    object Q_PMRListPMRDONE: TBooleanField
      FieldName = 'PMRDONE'
    end
  end
  ...
  object Q_PMRListSS: TQuery
    ...
    object Q_PMRListSSDEVCheck: TBooleanField
      FieldName = 'DEVCheck'
    end
  end
