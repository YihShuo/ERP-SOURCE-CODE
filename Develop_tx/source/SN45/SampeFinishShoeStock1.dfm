object SampeFinishShoeStock: TSampeFinishShoeStock
    ...
    object TS2: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object DTP1: TDateTimePicker
          ...
          Width = 97
          Height = 24
          Date = 44538.464808530090000000
          Format = 'yyyy/MM/dd'
          Time = 44538.464808530090000000
          TabOrder = 11
        end
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'Select ShoeTestMonth.*,YPZL.Article,ShoeTestMonth_Memo.Memo,Shoe' +
        'Test.YPDH '
      'from ShoeTestMonth'
  ...
  object Query2: TQuery
    ...
    SQL.Strings = (
        ...
        't.YPDH,YPZL.Article,YPZL.GSDH,YPZL.Quantity,YPZL.JHRQ,Case when ' +
        'ShoeTest.TBCancel=1 then '#39'C'#39' else '#39'Y'#39' end as DDZT,ShoeTestMonth_' +
        'Memo.Memo,kfxxzl.XieMing,kfzl.kfjc as Customer from ('
      ...
      'Left join YPZL on YPZL.YPDH=ShoeTest.YPDH'
        ...
        'kfxxzl.SheHao'
      'left join kfzl on kfzl.kfdh=kfxxzl.KHDH'
      'where 1=1 '
