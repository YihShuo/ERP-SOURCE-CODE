...
type
  TSampleFinishStock_Print = class(TForm)
    QuickRep1: TQuickRep;
...
var
  SampleFinishStock_Print: TSampleFinishStock_Print;

implementation

uses  main1, SampeFinishShoeStock1;

{$R *.dfm}

procedure TSampleFinishStock_Print.ReadIni();
var MyIni :Tinifile;
...
procedure TSampleFinishStock_Print.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=caFree;
end;

procedure TSampleFinishStock_Print.FormDestroy(Sender: TObject);
begin
  SampleFinishStock_Print:=nil;
end;

procedure TSampleFinishStock_Print.FormCreate(Sender: TObject);
var iYear,iMonth,iDay,nYear,nMonth,nDay:word;
    sYear,sMonth,Year1,Month1,Day1:string;
begin
  ReadIni();
  decodedate(SampeFinishShoeStock.DTP.Date,iYear,iMonth,iDay);
  ...
  begin
     QRLabel45.Caption := 'C2';
  end else
  begin
     QRLabel45.Caption := 'A1A2';
  end;
end;
