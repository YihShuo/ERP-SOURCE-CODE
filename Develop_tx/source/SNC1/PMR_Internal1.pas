        ...
        begin
          ...
          begin
            begin
              ...
              Params.ParamByName('TableName').AsString := 'PMR_INTERNAL';
              Params.ParamByName('TNO').AsString := Q_PMRList.FieldByName('PMRNo').AsString;
              Params.ParamByName('CLBH').AsString := '';
              Params.ParamByName('OldID').AsString := Q_PMRList.FieldByName('USERID').AsString;
