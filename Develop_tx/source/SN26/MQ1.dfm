object MQ: TMQ
      ...
      object Panel3: TPanel
        ...
        object DBGridEh2: TDBGridEh
          ...
          Columns = <
            ...
            item
              EditButtons = <>
              FieldName = 'CLBH_Child'
              Footers = <>
              Title.Caption = 'Material Child'
            end
            item
              EditButtons = <>
              FieldName = 'NCU_CLBH_Child'
              Footers = <>
              ReadOnly = True
              Title.Caption = 'NCU Material Child'
            end
            item
              EditButtons = <>
              FieldName = 'ywsm'
  ...
  object MaterialQry: TQuery
    ...
    SQL.Strings = (
        ...
        'xzl.jijie,ypzl.KFJD,ypzls.CLBH'
      
        ',case when clzhzl.cldh1 is not null then clzhzl.cldh1 else ypzls' +
        '.clbh end as CLBH_Child'
      ',clzl.ywpm,clzl.zwpm,'
      ...
      'and ypzl.KFJD like  '#39'%cr2%'#39
        ...
        'fxxzl.jijie,ypzl.KFJD,ypzls.CLBH,clzhzl.cldh1,clzl.ywpm,clzl.zwp' +
        'm,'
    ...
    object MaterialQryCLBH_Child: TStringField
      FieldName = 'CLBH_Child'
      FixedChar = True
      Size = 15
    end
    object strngfldMaterialQryNCU_CLBH_Child: TStringField
      FieldName = 'NCU_CLBH_Child'
    end
  end
