object FlexCode: TFlexCode
  ...
  object UpFC: TUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '  (cldhflex, cldhflexdes, Memo, USERID, USERDATE, YN)'
      'values'
      '  (:cldhflex, :cldhflexdes, :Memo, :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
  ...
  object PopupMenu_His: TPopupMenu
    Left = 119
    Top = 315
    object MenuItem1: TMenuItem
      Caption = 'History Updated'
