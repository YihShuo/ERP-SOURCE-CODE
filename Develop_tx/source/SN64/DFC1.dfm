object DFC: TDFC
    ...
    object TabSheet6: TTabSheet
      ...
      object Panel4: TPanel
        ...
        object DTP8: TDateTimePicker
          ...
          Width = 113
          Height = 21
          Date = 45463.653671550930000000
          Time = 45463.653671550930000000
          TabOrder = 7
        end
        ...
        object cbk_excluding: TCheckBox
          Left = 376
          Top = 190
          Width = 129
          Height = 17
          Caption = 'Excluding C2 and MP'
          TabOrder = 9
          OnClick = cbk_excludingClick
        end
      end
        ...
        object DBGridEh16: TDBGridEh
          ...
          Columns = <
            ...
            item
              ...
              FieldName = 'groups2'
              Footers = <>
              Title.Caption = 'Groups 2'
              Width = 60
            end
            item
              EditButtons = <>
              FieldName = 'SRQtyCuttingPlan'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Cutting|Plan|SR Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'QtyCuttingPlan'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Cutting|Plan|Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'SRQtyCuttingFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Cutting|Finished|SR Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'QtyCuttingFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Cutting|Finished|Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'SRQtyStitchingPlan'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Stitching|Plan|SR Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'QtyStitchingPlan'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Stitching|Plan|Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'SRQtyStitchingFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Stitching|Finished|SR Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'QtyStitchingFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Stitching|Finished|Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'SRQtyAssemblyPlan'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Assembly|Plan|SR Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'QtyAssemblyPlan'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Assembly|Plan|Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'SRQtyAssemblyFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Assembly|Finished|SR Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'QtyAssemblyFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Assembly|Finished|Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'SRQtyPackingFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Packing|Finished|SR Qty'
              Width = 45
            end
            item
              EditButtons = <>
              FieldName = 'QtyPackingFinished'
              Footer.ValueType = fvtSum
              Footers = <>
              Title.Caption = 'Packing|Finished|Qty'
              Width = 45
            end>
        end
      end
  ...
  object SampleQry: TQuery
    ...
    SQL.Strings = (
      'select Groups,'
        ...
        'isnull(SUM(DISTINCT ReceiveSR),0) ReceiveSR,isnull(SUM(DISTINCT ' +
        'CutMaterialOK),0) CutMaterialOK,isnull(SUM(DISTINCT CutMaterialG' +
        'et),0) CutMaterialGet,isnull(SUM(DISTINCT cutdate),0) cutdate,'
      
        'isnull(SUM(DISTINCT StitchingMaterialOK),0) StitchingMaterialOK,' +
        'isnull(sum(DISTINCT StitchingMaterialGet),0) StitchingMaterialGe' +
        't,isnull(SUM(DISTINCT StitchingDate),0) StitchingDate,'
      
        'isnull(SUM(DISTINCT AssemblyMaterialOK),0) AssemblyMaterialOK,is' +
        'null(sum(DISTINCT AssemblyMaterialGet),0) AssemblyMaterialGet,is' +
        'null(SUM(DISTINCT AssemblyDate),0) AssemblyDate,'
      
        'isnull(SUM(DISTINCT PackingMaterialOK),0) PackingMaterialOK,isnu' +
        'll(SUM(DISTINCT PackingMaterialGet),0) PackingMaterialGet,isnull' +
        '(SUM(DISTINCT PackingDate),0) PackingDate from('
      'select DISTINCT shoetestplanshow.Groups,'
      
        'COUNT(DISTINCT shoetestplan.Serino) ReceiveSR,CutMaterialOK.CutM' +
        'aterialOK,CutMaterialGet.CutMaterialGet,cutdate.Cutdate,'
      ...
      'left join ('
        ...
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) CutMaterialOK from shoetestplanshow'
      ...
      #9'where preparationDate is not null'
        ...
        #9'group by shoetestplanshow.Groups) CutMaterialOK on CutMaterialO' +
        'K.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) CutMaterialGet from shoetestplanshow'
      ...
      #9'where FirstMatOutDate is not null'
        ...
        #9'group by shoetestplanshow.Groups) CutMaterialGet on CutMaterial' +
        'Get.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) cutdate from shoetestplanshow'
      ...
      #9'where cutdate is not null'
        ...
        #9'group by shoetestplanshow.Groups) cutdate on cutdate.Groups=sho' +
        'etestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) StitchingMaterialOK from shoetestplanshow'
      ...
      #9'where S_material is not null'
        ...
        #9'group by shoetestplanshow.Groups) StitchingMaterialOK on Stitch' +
        'ingMaterialOK.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) StitchingMaterialGet from shoetestplanshow'
      ...
      #9'where StitchingPhuFinishDate is not null'
        ...
        #9'group by shoetestplanshow.Groups) StitchingMaterialGet on Stitc' +
        'hingMaterialGet.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) stitchingDate from shoetestplanshow'
      ...
      #9'where stitchingDate is not null'
        ...
        #9'group by shoetestplanshow.Groups) stitchingDate on stitchingDat' +
        'e.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) AssemblyMaterialOK from shoetestplanshow'
      ...
      #9'where insole_send is not null'
        ...
        #9'group by shoetestplanshow.Groups) AssemblyMaterialOK on Assembl' +
        'yMaterialOK.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) AssemblyMaterialGet from shoetestplanshow'
      ...
      #9'where insole_get is not null'
        ...
        #9'group by shoetestplanshow.Groups) AssemblyMaterialGet on Assemb' +
        'lyMaterialGet.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) AssemblyDate from shoetestplanshow'
      ...
      #9'where Assemblecomplete is not null'
        ...
        #9'group by shoetestplanshow.Groups) AssemblyDate on AssemblyDate.' +
        'Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) PackingMaterialOK from shoetestplanshow'
      ...
      #9'where lace_send is not null'
        ...
        #9'group by shoetestplanshow.Groups) PackingMaterialOK on PackingM' +
        'aterialOK.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) PackingMaterialGet from shoetestplanshow'
      ...
      #9'where lace_get is not null'
        ...
        #9'group by shoetestplanshow.groups) PackingMaterialGet on Packing' +
        'MaterialGet.Groups=shoetestplanshow.Groups'
      'left join ('
      
        #9'select shoetestplanshow.Groups,COUNT(DISTINCT shoetestplan.Seri' +
        'no) PackingDate from shoetestplanshow'
      ...
      #9'where  Complete is not null'
        ...
        #9'group by shoetestplanshow.groups) PackingDate on PackingDate.Gr' +
        'oups=shoetestplanshow.Groups'
      
        'group by shoetestplanshow.groups,CutMaterialOK,CutMaterialGet,cu' +
        'tdate,'
      
        'AssemblyMaterialOK.AssemblyMaterialOK,AssemblyMaterialGet.Assemb' +
        'lyMaterialGet,AssemblyDate.AssemblyDate,'
      
        'StitchingMaterialOK,StitchingMaterialGet,stitchingDate,PackingMa' +
        'terialOK,PackingMaterialGet,PackingDate )main group by Groups'
      ''
      '')
    Left = 404
    Top = 627
  ...
  object R1_R4_PC_: TQuery
    ...
    SQL.Strings = (
        ...
        '_R4_PC,parts.ywsm,kfxxzl.Article as SKU from shoetest'
      'left join shoetest2 on shoetest2.TestNo=shoetest.TestNo'
      ...
      'left join ypzl on ypzl.YPDH=shoetest.YPDH'
        ...
        'group by shoetest.testno,shoetest.SQTBOKTime,parts.ywsm,kfxxzl.A' +
        'rticle'
    ...
    object R1_R4_PC_SKU: TStringField
      FieldName = 'SKU'
      FixedChar = True
    end
  end
  ...
  object R2_R3_ADD_WearFitTest_: TQuery
    ...
    SQL.Strings = (
        ...
        '_R3_ADD_WearFitTest,parts.ywsm,kfxxzl.Article as SKU from shoete' +
        'st'
      'left join shoetest2 on shoetest2.TestNo=shoetest.TestNo'
    ...
    object R2_R3_ADD_WearFitTest_SKU: TStringField
      FieldName = 'SKU'
      FixedChar = True
    end
  end
  ...
  object MST_EXT_FSR_: TQuery
    ...
    SQL.Strings = (
        ...
        'T_EXT_FSR,parts.ywsm,kfxxzl.Article as SKU from shoetest'
      'left join shoetest2 on shoetest2.TestNo=shoetest.TestNo'
    ...
    object MST_EXT_FSR_SKU: TStringField
      FieldName = 'SKU'
      FixedChar = True
    end
  end
  object SEE_Pullover_: TQuery
    ...
    SQL.Strings = (
        ...
        'E_Pullover,parts.ywsm,kfxxzl.Article as SKU from shoetest'
      'left join shoetest2 on shoetest2.TestNo=shoetest.TestNo'
    ...
    object SEE_Pullover_SKU: TStringField
      FieldName = 'SKU'
      FixedChar = True
    end
  end
  object QUV_OtherTest_: TQuery
    ...
    SQL.Strings = (
        ...
        'V_OtherTest,parts.ywsm,kfxxzl.Article as SKU from shoetest'
      'left join shoetest2 on shoetest2.TestNo=shoetest.TestNo'
    ...
    object QUV_OtherTest_SKU: TStringField
      FieldName = 'SKU'
      FixedChar = True
    end
  end
  object Shoe_: TQuery
    ...
    SQL.Strings = (
        ...
        'oe,parts.ywsm,kfxxzl.Article as SKU from shoetest'
      'left join shoetest2 on shoetest2.TestNo=shoetest.TestNo'
  ...
  object half_: TQuery
    ...
    SQL.Strings = (
        ...
        'lf,parts.ywsm,kfxxzl.Article as SKU from shoetest'
      'left join shoetest2 on shoetest2.TestNo=shoetest.TestNo'
  ...
  object QryHN: TQuery
    ...
    SQL.Strings = (
      '---------------------------'
      'SELECT GROUPS,groups2,'
      
        'SUM(CASE WHEN PlanType = '#39'CuttingPlan'#39' THEN SRQty ELSE 0 END) AS' +
        ' SRQtyCuttingPlan,'
      
        'SUM(CASE WHEN PlanType = '#39'CuttingPlan'#39' THEN Qty ELSE 0 END) AS Q' +
        'tyCuttingPlan,'
      
        'SUM(CASE WHEN PlanType = '#39'CuttingFinished'#39' THEN SRQty ELSE 0 END' +
        ') AS SRQtyCuttingFinished,'
      
        'SUM(CASE WHEN PlanType = '#39'CuttingFinished'#39' THEN Qty ELSE 0 END) ' +
        'AS QtyCuttingFinished,'
      
        'SUM(CASE WHEN PlanType = '#39'StitchingPlan'#39' THEN SRQty ELSE 0 END) ' +
        'AS SRQtyStitchingPlan,'
      
        'SUM(CASE WHEN PlanType = '#39'StitchingPlan'#39' THEN Qty ELSE 0 END) AS' +
        ' QtyStitchingPlan,'
      
        'SUM(CASE WHEN PlanType = '#39'StitchingFinished'#39' THEN SRQty ELSE 0 E' +
        'ND) AS SRQtyStitchingFinished,'
      
        'SUM(CASE WHEN PlanType = '#39'StitchingFinished'#39' THEN Qty ELSE 0 END' +
        ') AS QtyStitchingFinished,'
      
        'SUM(CASE WHEN PlanType = '#39'AssemblyPlan'#39' THEN SRQty ELSE 0 END) A' +
        'S SRQtyAssemblyPlan,'
      
        'SUM(CASE WHEN PlanType = '#39'AssemblyPlan'#39' THEN Qty ELSE 0 END) AS ' +
        'QtyAssemblyPlan,'
      
        'SUM(CASE WHEN PlanType = '#39'AssemblyFinished'#39' THEN SRQty ELSE 0 EN' +
        'D) AS SRQtyAssemblyFinished,'
      
        'SUM(CASE WHEN PlanType = '#39'AssemblyFinished'#39' THEN Qty ELSE 0 END)' +
        ' AS QtyAssemblyFinished,'
      
        'SUM(CASE WHEN PlanType = '#39'PackingFinished'#39' THEN SRQty ELSE 0 END' +
        ') AS SRQtyPackingFinished,'
      
        'SUM(CASE WHEN PlanType = '#39'PackingFinished'#39' THEN Qty ELSE 0 END) ' +
        'AS QtyPackingFinished'
      'FROM ('
      'SELECT groups,groups2,COUNT(Distinct Serino) AS SRQty,'
      
        '(SUM(FinishedShoe) + SUM(HalfStitchingUpper) + SUM(LastedUpper) ' +
        '+ SUM(UpperComponent) + SUM(CFMSample)) AS Qty,'
      #39'CuttingPlan'#39' AS PlanType'
      'FROM ('
      
        'SELECT shoetestplan.Serino,groups,groups2,CutDate_first,CONVERT(' +
        'DATETIME, CONVERT(VARCHAR, Complete, 23)) AS Complete,ISNULL(bw0' +
        '1.qty, 0) AS FinishedShoe,'
      
        'ISNULL(bw02.qty, 0) AS HalfStitchingUpper,ISNULL(bw04.qty, 0) AS' +
        ' LastedUpper,ISNULL(bw05.qty, 0) AS UpperComponent,ISNULL(bw10.q' +
        'ty, 0) AS CFMSample'
      'FROM ShoeTest'
      'LEFT JOIN shoetestplan ON shoetest.testno = shoetestplan.testno'
      
        'LEFT JOIN (SELECT SUM(qty) AS qty, parts, testno FROM shoetest2 ' +
        'WHERE parts = '#39'BW01'#39' GROUP BY parts, testno) bw01 ON bw01.testno' +
        ' = shoetest.testno'
      
        'LEFT JOIN (SELECT SUM(qty) qty, parts, testno FROM shoetest2 WHE' +
        'RE parts = '#39'BW02'#39' GROUP BY parts, testno) bw02 ON bw02.testno = ' +
        'shoetest.testno'
      
        'LEFT JOIN (SELECT SUM(qty) qty, parts, testno FROM shoetest2 WHE' +
        'RE parts = '#39'BW04'#39' GROUP BY parts, testno) bw04 ON bw04.testno = ' +
        'shoetest.testno'
      
        'LEFT JOIN (SELECT SUM(qty) qty, parts, testno FROM shoetest2 WHE' +
        'RE parts = '#39'BW05'#39' GROUP BY parts, testno) bw05 ON bw05.testno = ' +
        'shoetest.testno'
      
        'LEFT JOIN (SELECT SUM(qty) qty, parts, testno FROM shoetest2 WHE' +
        'RE parts = '#39'BW10'#39' GROUP BY parts, testno) bw10 ON bw10.testno = ' +
        'shoetest.testno'
      
        'WHERE 1=1 and shoetest.CutDate_first BETWEEN CONVERT(smalldateti' +
        'me, '#39'2024/06/20 00:00:00'#39')'
      'AND CONVERT(smalldatetime, '#39'2024/06/20 23:59:00'#39')'
      ' ) AS CuttingPlan'
      'GROUP BY GROUPS, groups2'
      'UNION ALL'
      'SELECT groups,groups2,COUNT(Distinct Serino) AS SRQty,'
      
        '(SUM(FinishedShoe) + SUM(HalfStitchingUpper) + SUM(LastedUpper) ' +
        '+ SUM(UpperComponent) + SUM(CFMSample)) AS Qty,'
      ' '#39'CuttingFinished'#39' AS PlanType'
      'FROM ('
      
        'select shoetestplan.Serino,groups,groups2,shoetest.testno,shoete' +
        'st.Article,CutDate, convert (datetime,convert(varchar,Complete, ' +
        '23)) as Complete, isnull(bw01.qty,0) FinishedShoe,'
      ...
      'where 1=1'
        ...
        'and shoetest.CutDate BETWEEN CONVERT(smalldatetime, '#39'2024/06/20 ' +
        '00:00:00'#39')'
      'AND CONVERT(smalldatetime, '#39'2024/06/20 23:59:00'#39')'
      ' ) AS CuttingFinished'
      'GROUP BY GROUPS, groups2'
      ...
      'SELECT groups,groups2,COUNT(Distinct Serino) AS SRQty, '
        ...
        '(SUM(FinishedShoe) + SUM(HalfStitchingUpper) + SUM(LastedUpper) ' +
        '+ SUM(UpperComponent) + SUM(CFMSample)) AS Qty,'
      ' '#39'StitchingPlan'#39' AS PlanType '
      'FROM ('
      
        'select shoetestplan.Serino,groups,groups2,shoetest.testno,shoete' +
        'st.Article,StitchingDate_first, convert (datetime,convert(varcha' +
        'r,Complete, 23)) as Complete, isnull(bw01.qty,0) FinishedShoe,'
      ...
      'where  1=1'
        ...
        'and shoetest.StitchingDate_first BETWEEN CONVERT(smalldatetime, ' +
        #39'2024/06/20 00:00:00'#39')'
      'AND CONVERT(smalldatetime, '#39'2024/06/20 23:59:00'#39')'
      ' ) AS StitchingPlan'
      'GROUP BY GROUPS, groups2'
      'UNION ALL'
      'SELECT groups,groups2,COUNT(Distinct Serino) AS SRQty,'
        ...
        '(SUM(FinishedShoe) + SUM(HalfStitchingUpper) + SUM(LastedUpper) ' +
        '+ SUM(UpperComponent) + SUM(CFMSample)) AS Qty,'
      ' '#39'StitchingFinished'#39' AS PlanType '
      'FROM ('
      
        'select shoetestplan.Serino,groups,groups2,shoetest.testno,shoete' +
        'st.Article,StitchingDate,convert (datetime,convert(varchar,Compl' +
        'ete, 23)) as Complete,isnull(bw01.qty,0) FinishedShoe,'
      ...
      'where  1=1'
        ...
        'and shoetest.StitchingDate BETWEEN CONVERT(smalldatetime, '#39'2024/' +
        '06/20 00:00:00'#39')'
      'AND CONVERT(smalldatetime, '#39'2024/06/20 23:59:00'#39')'
      ' ) AS StitchingFinished'
      'GROUP BY GROUPS, groups2'
      'UNION ALL'
      'SELECT groups,groups2,COUNT(Distinct Serino) AS SRQty,'
      '(SUM(FinishedShoe) + SUM(LastedUpper) + SUM(CFMSample)) AS Qty,'
      ' '#39'AssemblyPlan'#39' AS PlanType '
      'FROM ('
      
        'select shoetestplan.Serino,groups,groups2,shoetest.testno,shoete' +
        'st.Article,AssembiyDate_first,convert (datetime,convert(varchar,' +
        'Complete, 23)) as Complete,isnull(bw01.qty,0) FinishedShoe,'
      
        'ISNULL(bw04.qty, 0) AS LastedUpper,ISNULL(bw10.qty, 0) AS CFMSam' +
        'ple'
      'FROM ShoeTest'
      'left join shoetestplan on shoetest.testno = shoetestplan.testno'
      ...
      'where  1=1'
        ...
        'and shoetest.AssembiyDate_first BETWEEN CONVERT(smalldatetime, '#39 +
        '2024/06/20 00:00:00'#39')'
      'AND CONVERT(smalldatetime, '#39'2024/06/20 23:59:00'#39')'
      ' ) AS AssemblyPlan'
      'GROUP BY GROUPS, groups2'
      'UNION ALL'
      'SELECT groups,groups2,COUNT(Distinct Serino) AS SRQty,'
      '(SUM(FinishedShoe) + SUM(LastedUpper) + SUM(CFMSample)) AS Qty,'
      ' '#39'AssemblyFinished'#39' AS PlanType '
      'FROM ('
      
        'select shoetestplan.Serino,groups,groups2,shoetest.testno,shoete' +
        'st.Article,Assemblecomplete,convert (datetime,convert(varchar,Co' +
        'mplete, 23)) as Complete,isnull(bw01.qty,0) FinishedShoe,'
      ...
      'where  1=1'
        ...
        'and shoetest.Assemblecomplete BETWEEN CONVERT(smalldatetime, '#39'20' +
        '24/06/20 00:00:00'#39')'
      'AND CONVERT(smalldatetime, '#39'2024/06/20 23:59:00'#39')'
      ' ) AS AssemblyFinished'
      'GROUP BY GROUPS, groups2'
      'UNION ALL'
      'SELECT groups,groups2,COUNT(Distinct Serino) AS SRQty,'
      ' (SUM(FinishedShoe) + SUM(CFMSample)) AS Qty,'
      ' '#39'PackingFinished'#39' AS PlanType '
      'FROM ('
      
        'select shoetestplan.Serino,groups,groups2,shoetest.testno,shoete' +
        'st.Article,complete as packingok,convert (datetime,convert(varch' +
        'ar,Complete, 23)) as Complete,isnull(bw01.qty,0) FinishedShoe,'
      'ISNULL(bw10.qty, 0) AS CFMSample'
      'FROM ShoeTest'
      'left join shoetestplan on shoetest.testno = shoetestplan.testno'
      ...
      'where  1=1'
        ...
        'and shoetest.complete BETWEEN CONVERT(smalldatetime, '#39'2024/06/20' +
        ' 00:00:00'#39')'
      'AND CONVERT(smalldatetime, '#39'2024/06/20 23:59:00'#39')'
      ' ) AS PackingFinished'
      'GROUP BY GROUPS, groups2'
      ') AS TotalQuery'
      'GROUP BY GROUPS, groups2'
      'ORDER BY GROUPS, groups2')
    Left = 772
    Top = 297
    object QryHNGROUPS: TStringField
      FieldName = 'GROUPS'
    end
    object QryHNgroups2: TStringField
      FieldName = 'groups2'
    end
    object QryHNSRQtyCuttingPlan: TIntegerField
      FieldName = 'SRQtyCuttingPlan'
    end
    object QryHNQtyCuttingPlan: TFloatField
      FieldName = 'QtyCuttingPlan'
    end
    object QryHNSRQtyCuttingFinished: TIntegerField
      FieldName = 'SRQtyCuttingFinished'
    end
    object QryHNQtyCuttingFinished: TFloatField
      FieldName = 'QtyCuttingFinished'
    end
    object QryHNSRQtyStitchingPlan: TIntegerField
      FieldName = 'SRQtyStitchingPlan'
    end
    object QryHNQtyStitchingPlan: TFloatField
      FieldName = 'QtyStitchingPlan'
    end
    object QryHNSRQtyStitchingFinished: TIntegerField
      FieldName = 'SRQtyStitchingFinished'
    end
    object QryHNQtyStitchingFinished: TFloatField
      FieldName = 'QtyStitchingFinished'
    end
    object QryHNSRQtyAssemblyPlan: TIntegerField
      FieldName = 'SRQtyAssemblyPlan'
    end
    object QryHNQtyAssemblyPlan: TFloatField
      FieldName = 'QtyAssemblyPlan'
    end
    object QryHNSRQtyAssemblyFinished: TIntegerField
      FieldName = 'SRQtyAssemblyFinished'
    end
    object QryHNQtyAssemblyFinished: TFloatField
      FieldName = 'QtyAssemblyFinished'
    end
    object QryHNSRQtyPackingFinished: TIntegerField
      FieldName = 'SRQtyPackingFinished'
    end
    object QryHNQtyPackingFinished: TFloatField
      FieldName = 'QtyPackingFinished'
    end
  end
end
