object SamplePlan: TSamplePlan
  ...
  object PageControl1: TPageControl
        ...
        object Panel4: TPanel
          ...
          object DBGridEh1: TDBGridEh
            ...
            Columns = <
              ...
              item
                EditButtons = <>
                FieldName = 'Cutting_Localtion'
                Footers = <>
                PickList.Strings = (
                  'CDC'
                  'CBY')
                Title.Caption = 'Localtion|Cutting'
                Width = 39
              end
              item
                EditButtons = <>
                FieldName = 'Stitching_Localtion'
                Footers = <>
                PickList.Strings = (
                  'CDC'
                  'CBY')
                Title.Caption = 'Localtion|Stitching'
                Width = 45
              end
              item
                EditButtons = <>
                FieldName = 'Assembly_Localtion'
                Footers = <>
                PickList.Strings = (
                  'CDC'
                  'CBY')
                Title.Caption = 'Localtion|Assembly'
                Width = 51
              end
              item
                EditButtons = <>
                FieldName = 'Packing_Localtion'
                Footers = <>
                PickList.Strings = (
                  'CDC'
                  'CBY')
                Title.Caption = 'Localtion|Packing'
                Width = 44
              end
              item
                Color = cl3DLight
              ...
              item
                EditButtons = <>
                FieldName = 'cutting_priority'
                Footers = <>
                Title.Caption = 'Cutting status|Chat trang thai|'#35009#26039#36914#24230#29376#24907'|Non Priority'
              end
              item
                Color = cl3DLight
                EditButtons = <>
              ...
              item
                EditButtons = <>
                FieldName = 'stiching_priority'
                Footers = <>
                Title.Caption = 'Stitching status|May trang thai|'#37341#36554#36914#24230#29376#24907'|Non Priority'
              end
              item
                EditButtons = <>
              ...
              item
                EditButtons = <>
                FieldName = 'assemble_priority'
                Footers = <>
                Title.Caption = 'Assembly status|Go trang thai|'#25104#22411#36914#24230#29376#24907'|Non Priority'
              end
              item
                DisplayFormat = 'yyyy/MM/dd HH:mm'
                EditButtons = <>
              ...
              item
                ...
                FieldName = 'Cancel_S'
                Footers = <>
                Title.Caption = 'Stitching Cancel'
                Width = 60
              end
              item
                EditButtons = <>
    ...
    object TabSheet2: TTabSheet
      ...
      object Memo4: TMemo
        ...
        Font.Style = []
        Lines.Strings = (
          'Blue color: TB was cancelled'
          #34253#33394#65306#36890#22577#24050#21462#28040
          'Mau xanh bien: TB khai thac thong bao huy')
        ParentFont = False
        TabOrder = 3
      end
      object mmo1: TMemo
  ...
  object shoetest: TQuery
    ...
    SQL.Strings = (
      ...
      'isnull(bw10.qty,0) CFMSample,'
        ...
        'shoetest.Cutting_Localtion,shoetest.Stitching_Localtion,shoetest' +
        '.Assembly_Localtion,shoetest.Packing_Localtion,Cancel_C,Cancel_S' +
        ',Cancel_A,'
      
        'shoetest_priority.cutting_priority, shoetest_priority.stiching_p' +
        'riority, shoetest_priority.assemble_priority'
      'from shoetest'
      
        'left join shoetest_priority on shoetest_priority.testno = shoete' +
        'st.testno'
    ...
    object shoetestCutting_Localtion: TStringField
      FieldName = 'Cutting_Localtion'
      FixedChar = True
      Size = 10
    end
    object shoetestStitching_Localtion: TStringField
      FieldName = 'Stitching_Localtion'
      FixedChar = True
      Size = 10
    end
    object shoetestAssembly_Localtion: TStringField
      FieldName = 'Assembly_Localtion'
      FixedChar = True
      Size = 10
    end
    object shoetestPacking_Localtion: TStringField
      FieldName = 'Packing_Localtion'
      FixedChar = True
      Size = 10
    end
    object shoetestCancel_C: TBooleanField
      FieldName = 'Cancel_C'
    end
    object shoetestCancel_S: TBooleanField
      FieldName = 'Cancel_S'
    end
    object shoetestCancel_A: TBooleanField
      FieldName = 'Cancel_A'
    end
    object shoetestArticleKFXXZL: TStringField
      FieldName = 'ArticleKFXXZL'
    end
    object shoetestCutID: TStringField
      FieldName = 'CutID'
    end
    object shoetestStitchingID: TStringField
      FieldName = 'StitchingID'
    end
    object shoetestAssemblyID: TStringField
      FieldName = 'AssemblyID'
    end
    object shoetestPackingID: TStringField
      FieldName = 'PackingID'
    end
    object shoetestYPCC: TStringField
      FieldName = 'YPCC'
    end
    object shoetestShoetest_NotiChange_TestNo: TIntegerField
      FieldName = 'Shoetest_NotiChange_TestNo'
    end
    object shoetestPlanningMemo: TMemoField
      FieldName = 'PlanningMemo'
      BlobType = ftMemo
    end
    object shoetestcutting_priority: TBooleanField
      FieldName = 'cutting_priority'
    end
    object shoeteststiching_priority: TBooleanField
      FieldName = 'stiching_priority'
    end
    object shoetestassemble_priority: TBooleanField
      FieldName = 'assemble_priority'
    end
  end
  ...
  object updqry1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  Cutting_Localtion=:Cutting_Localtion,'
      '  Stitching_Localtion=:Stitching_Localtion,'
      '  Assembly_Localtion=:Assembly_Localtion,'
      '  Packing_Localtion=:Packing_Localtion,'
      '  Cancel_C=:Cancel_C,'
      '  Cancel_S=:Cancel_S,'
      '  Cancel_A=:Cancel_A,'
      '  CutDate=:CutDate,'
      '  StitchingDate=:StitchingDate,'
      '  Assemblecomplete=:Assemblecomplete,'
      '  Complete=:Complete'
      '  where'
      '   testno = :OLD_testno ')
    Left = 153
  ...
  object PopupMenu_Noti: TPopupMenu
    Left = 149
    Top = 373
    object CreateNoti: TMenuItem
      Caption = 'Create Notification Change'
      OnClick = CreateNotiClick
    end
  end
  object qryShoeTestPriority: TQuery
    DatabaseName = 'DB'
    DataSource = DataSource1
    SQL.Strings = (
      'SELECT * FROM ShoeTest_Priority WHERE TestNo = :TestNo;')
    UpdateObject = updtsqlShoeTestPriority
    Left = 213
    Top = 485
    ParamData = <
      item
    ...
    object qryShoeTestPriorityTestNo: TStringField
      FieldName = 'TestNo'
      FixedChar = True
      Size = 10
    end
    object qryShoeTestPriorityCutting_Priority: TBooleanField
      FieldName = 'Cutting_Priority'
    end
    object qryShoeTestPriorityStiching_Priority: TBooleanField
      FieldName = 'Stiching_Priority'
    end
    object qryShoeTestPriorityAssemble_Priority: TBooleanField
      FieldName = 'Assemble_Priority'
    end
    object dtmfldShoeTestPriorityCutting_Date: TDateTimeField
      FieldName = 'Cutting_Date'
    end
    object dtmfldShoeTestPriorityStiching_Date: TDateTimeField
      FieldName = 'Stiching_Date'
    end
    object dtmfldShoeTestPriorityAssemble_Date: TDateTimeField
      FieldName = 'Assemble_Date'
    end
    object qryShoeTestPriorityUSERID: TStringField
      FieldName = 'USERID'
      FixedChar = True
      Size = 15
    end
    object dtmfldShoeTestPriorityUSERDATE: TDateTimeField
      FieldName = 'USERDATE'
    end
  end
  object updtsqlShoeTestPriority: TUpdateSQL
    ModifySQL.Strings = (
      'update ShoeTest_Priority'
      'set'
      '  TestNo = :TestNo,'
      '  Cutting_Priority = :Cutting_Priority,'
      '  Stiching_Priority = :Stiching_Priority,'
      '  Assemble_Priority = :Assemble_Priority,'
      '  Cutting_Date = :Cutting_Date,'
      '  Stiching_Date = :Stiching_Date,'
      ...
      '  TestNo = :OLD_TestNo;')
    InsertSQL.Strings = (
      'insert into ShoeTest_Priority'
      
        '  (TestNo, Cutting_Priority, Stiching_Priority, Assemble_Priorit' +
        'y, Cutting_Date, '
      '   Stiching_Date, Assemble_Date, USERID, USERDATE)'
      'values'
      
        '  (:TestNo, :Cutting_Priority, :Stiching_Priority, :Assemble_Pri' +
        'ority, '
      
        '   :Cutting_Date, :Stiching_Date, :Assemble_Date, :USERID, :USER' +
        'DATE)')
    DeleteSQL.Strings = (
      'delete from ShoeTest_Priority'
      'where'
      '  TestNo = :OLD_TestNo;')
    Left = 253
    Top = 485
