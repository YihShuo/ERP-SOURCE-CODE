object SampleTracking_Pat: TSampleTracking_Pat
  Left = 229
  Top = 255
  Width = 1007
  Height = 560
  Caption = 'SampleTracking_Pat'
  Color = clBtnFace
    ...
    object DBGridEh1: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          Footers = <>
          ReadOnly = True
          Title.Caption = #32025#26495#35336#30059'|ZBDate'
          Width = 73
        end
        item
          EditButtons = <>
          ...
          Footers = <>
          ReadOnly = True
          Title.Caption = #32025#26495#23526#38555'|ZBExDate'
          Width = 70
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'JDExDate'
          Footers = <>
          Title.Caption = #26028#20992#23526#38555'|JDExDate'
          Width = 73
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'WBExDate'
          Footers = <>
          Title.Caption = #32178#29256#23526#38555'|WBExDate'
          Width = 79
        end>
    end
  end
  ...
  object SPSCMas: TQuery
    ...
    SQL.Strings = (
        ...
        '  SPSCList.ZBDate,(Select MAX(ExeDate) from SPSCRm A where A.SPN' +
        'O=SPSCList.SPNO and ItemNM='#39'ZBExDate'#39') as ZBExDate, '
      
        '  SPSCList.SJDate,(Select MAX(ExeDate) from SPSCRm A where A.SPN' +
        'O=SPSCList.SPNO and ItemNM='#39'SJExDate'#39') as SJExDate, '
      
        '  SPSCList.JDDate,(Select MAX(ExeDate) from SPSCRm A where A.SPN' +
        'O=SPSCList.SPNO and ItemNM='#39'JDExDate'#39') as JDExDate, '
      
        '  SPSCList.WBDate,(Select MAX(ExeDate) from SPSCRm A where A.SPN' +
        'O=SPSCList.SPNO and ItemNM='#39'WBExDate'#39') as WBExDate, '
    ...
    object SPSCMasZBDate: TDateTimeField
      FieldName = 'ZBDate'
    end
    object SPSCMasZBExDate: TDateTimeField
      FieldName = 'ZBExDate'
    end
    ...
    object SPSCMasJDDate: TDateTimeField
      FieldName = 'JDDate'
    end
    object SPSCMasJDExDate: TDateTimeField
      FieldName = 'JDExDate'
    end
    object SPSCMasWBDate: TDateTimeField
      FieldName = 'WBDate'
    end
    object SPSCMasWBExDate: TDateTimeField
      FieldName = 'WBExDate'
    end
  end
  ...
  object SPSCDet: TQuery
    ...
    SQL.Strings = (
      ...
      'Left join SPSCRmS on SPSCRmS.LYBH=SPSCRm.LYBH'
        ...
        'where SPNO=:SPNO and RENO>0  and ((SPSCRm.ItemNM='#39'ZBExDate'#39') or ' +
        '(SPSCRm.ItemNM='#39'SJExDate'#39') or (SPSCRm.ItemNM='#39'JDExDate'#39') or (SPS' +
        'CRm.ItemNM='#39'WBExDate'#39'))'
