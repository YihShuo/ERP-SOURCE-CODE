object SampleTracking_Quo: TSampleTracking_Quo
  Left = 236
  Top = 227
  Width = 985
  Height = 602
  Caption = 'SampleTracking_Quo'
  Color = clBtnFace
    ...
    object DBGridEh1: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          FieldName = 'BOMExDate'
          Footers = <>
          Title.Caption = 'BOM'#34920#23526#38555'|BOMExDate'
          Width = 71
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'YLExDate'
          Footers = <>
          Title.Caption = #29992#37327#35336#31639#23526#38555'|YLExDate'
          Width = 86
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'BGExDate'
          Footers = <>
          Title.Caption = #22577#20729#23526#38555'|BGExDate'
          Width = 76
        end>
    end
  end
  ...
  object SPSCMas: TQuery
    ...
    SQL.Strings = (
        ...
        '  SPSCList.BOMDate,(Select MAX(ExeDate) from SPSCRm A where A.SP' +
        'NO=SPSCList.SPNO and ItemNM='#39'BOMExDate'#39') as BOMExDate,'
      
        '  SPSCList.YLDate,(Select MAX(ExeDate) from SPSCRm A where A.SPN' +
        'O=SPSCList.SPNO and ItemNM='#39'YLExDate'#39') as YLExDate,'
      
        '  SPSCList.BGDate,(Select MAX(ExeDate) from SPSCRm A where A.SPN' +
        'O=SPSCList.SPNO and ItemNM='#39'BGExDate'#39') as BGExDate,'
    ...
    object SPSCMasBOMDate: TDateTimeField
      FieldName = 'BOMDate'
    end
    object SPSCMasBOMExDate: TDateTimeField
      FieldName = 'BOMExDate'
    end
    object SPSCMasYLDate: TDateTimeField
      FieldName = 'YLDate'
    end
    object SPSCMasYLExDate: TDateTimeField
      FieldName = 'YLExDate'
    end
    object SPSCMasBGDate: TDateTimeField
      FieldName = 'BGDate'
    end
    object SPSCMasBGExDate: TDateTimeField
      FieldName = 'BGExDate'
    end
  ...
  object SPSCDet: TQuery
    ...
    SQL.Strings = (
      ...
      'Left join SPSCRmS on SPSCRmS.LYBH=SPSCRm.LYBH'
        ...
        'where SPNO=:SPNO and RENO>0  and ((SPSCRm.ItemNM='#39'BOMExDate'#39') or' +
        ' (SPSCRm.ItemNM='#39'YLExDate'#39') or (SPSCRm.ItemNM='#39'BGExDate'#39') )'
