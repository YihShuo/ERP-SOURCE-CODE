object SampleOrder_Mat: TSampleOrder_Mat
      ...
      object DBGridEh3: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'Engname'
            Footers = <>
            Title.Caption = #33521#25991#21517'|EngName'
            Width = 100
          end>
      end
    end
  ...
  object MatQry: TQuery
    ...
    SQL.Strings = (
        ...
        'zszl.zsdh,zszl.ZSYWJC,CLZL_Memo.Memo from CLZL'
      'left join ( '
    ...
    object MatQryMemo: TStringField
      FieldName = 'Memo'
      FixedChar = True
      Size = 150
    end
  ...
  object ArticleQry: TQuery
    ...
    object ArticleQryEngname: TStringField
      FieldName = 'Engname'
    end
  end
