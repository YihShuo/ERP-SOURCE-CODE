...
begin
  ...
  begin
      ...
      if main.Edit2.Text = 'SKX' then
        ...
        sql.Add('           and cgzl.gsbh=''VC1'')JNGR2 on JNGR2.zlbh=ypzl.ypdh ')
      else
      ...
      if main.Edit2.Text = 'SKX' then
        ...
        sql.Add('           and cgzl.gsbh=''VC1'')JNGR3 on JNGR3.zlbh=ypzl.ypdh ')
      else
      ...
      if CheckBox1.Checked = false then begin
        if main.Edit2.Text = 'SKX' then
          ...
          sql.Add('and substring(ypzl.ypdh, 1, 4) in (''CUIV'')')
        else                                                                                       
