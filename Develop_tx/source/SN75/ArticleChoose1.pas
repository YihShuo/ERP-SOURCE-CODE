...
begin
  ...
  if (edit2.Text='') and (main.edit1.text<>'35376') and (main.edit1.text<>'51270') and (main.edit1.text<>'53029') and (main.edit1.text<>'75993') and (main.edit1.text<>'45091') and (main.edit1.text<>'50785') and (main.edit1.text<>'81212') then
  begin
  ...
  if (main.edit1.text<>'35376') AND (main.edit1.text<>'51022') AND (main.edit1.text<>'51270') AND (main.edit1.text<>'53029') AND (main.edit1.text<>'75993') AND (main.edit1.text<>'45091') AND (main.edit1.text<>'50785') AND (main.edit1.text<>'71442')and (main.edit1.text<>'81212')and (main.edit1.text<>'101598')and (main.edit1.text<>'113292') then //非管理者跟技轉人員只能開自己的型體
     qry1.SQL.Add(' and ypzl.fd= '''+edit2.text+''' ');
  if (main.edit1.text='35376') or (main.edit1.text='75993') or (main.edit1.text='45091') or (main.edit1.text='50785')and (main.edit1.text<>'81212')and (main.edit1.text<>'81212')and (main.edit1.text<>'81212') then   //技轉人員只能開lait
  ...
  if (main.edit1.text<>'35376') AND (main.edit1.text<>'51022') AND (main.edit1.text<>'51270') and (main.edit1.text<>'53029') AND (main.edit1.text<>'75993') AND (main.edit1.text<>'45091') AND (main.edit1.text<>'50785')and (main.edit1.text<>'81212')and (main.edit1.text<>'101598')and (main.edit1.text<>'113292') then  //非管理者跟技轉人員只能開laiv跟laik
