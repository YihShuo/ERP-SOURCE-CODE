object PaperRoom: TPaperRoom
  ...
  object masqry: TQuery
    ...
    SQL.Strings = (
      ...
      ' and shoetest.FD like '#39'SHEEP%'#39
    ...
    object masqryLocationTrial: TStringField
      FieldName = 'LocationTrial'
    end
  end
