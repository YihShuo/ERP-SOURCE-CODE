object ScanBanDo_RY: TScanBanDo_RY
      ...
      object DBGrid1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            Footers = <>
            Title.Caption = '1_Inspection Date'
          end
          item
            EditButtons = <>
            FieldName = 'Status1'
          ...
          item
            ...
            Footers = <>
            Title.Caption = '2_Inspection Date'
          end>
      end
    end
  end
  object YWCPMas: TQuery
    ...
    SQL.Strings = (
        ...
        'Select DDBH,KCBH,KVBH,SUM(Qty) as Pairs,Status, Statusdate, Stat' +
        'us1, Status1date from YWCP'
      'where KCBH='#39'A8'#39' and KVBH='#39'A02'#39' and SB=1'
      
        'Group by DDBH,KCBH,KVBH,Status , Statusdate, Status1, Status1dat' +
        'e'
      'order by DDBH')
    UpdateObject = upMas
    Left = 63
    ...
    object YWCPMasStatusdate: TDateTimeField
      FieldName = 'Statusdate'
    end
    object YWCPMasStatus1: TStringField
      FieldName = 'Status1'
      FixedChar = True
      Size = 10
    end
    object YWCPMasStatus1date: TDateTimeField
      FieldName = 'Status1date'
    end
  end
