object DeliverCon: TDeliverCon
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
        ...
        'select KCLLS.*,CLZL.YWPM,CLZL.DWBH,SCBLYY.YWSM,Convert(varchar,:' +
        'CKBH) as CKBH,KCPK.Declaretion,'
      'Bdepartment_Cost.TypeCost,KCZLS.CWBH'
      'from KCLLS'
      'left join CLZL on CLZL.CLDH=KCLLS.CLBH'
      'left join SCBLYY on SCBLYY.YYBH=KCLLS.YYBH'
      'left join KCPK on KCPK.PKNO=KCLLS.PKNO'
      'left join KCLL on KCLL.LLNO=KCLLS.LLNO'
      'left join Bdepartment_Cost on Bdepartment_Cost.ID=KCLL.DepID'
    ...
    object DelDetTypeCost: TStringField
      FieldName = 'TypeCost'
      Size = 50
    end
