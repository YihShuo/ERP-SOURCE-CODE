...
procedure TPaymentConfirmCancel112.InitTitleClick(IsOpen:boolean);
var i:integer;
begin
...
procedure TPaymentConfirmCancel112.qry2AfterOpen(DataSet: TDataSet);
begin       
...
procedure TPaymentConfirmCancel112.qry2AfterScroll(DataSet: TDataSet);
begin
  if qry2.FieldByName('DONVI_TIENTE').AsString='USD' then
  begin
    DBGridEh1.Columns[5].DisplayFormat:='##,#0.00';
