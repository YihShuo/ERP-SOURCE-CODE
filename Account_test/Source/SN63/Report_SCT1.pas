...
begin
  ...
  begin
    active:=false;
    sql.Clear;
    sql.Add('select kcrk.GSBH,kcrk.CKBH,KCRK.HGLB,KCRKs.CNO,KCRKS.CLBH,CLZL.YWPM,CLZL.DWBH,KCRK.RKNO as SOCHUNGTU,KCRK.USERDATE as CFMDATE,ZSZL.ZSYWJC,');
