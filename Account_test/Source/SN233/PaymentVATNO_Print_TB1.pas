...
type
  TPaymentVATNO_Print_TB = class(TForm)
...
var
  PaymentVATNO_Print_TB: TPaymentVATNO_Print_TB;
...
function TPaymentVATNO_Print_TB.RMBFloatToChinese(ARMBCash: Real): string;
const
...
function TPaymentVATNO_Print_TB.RMBFloatToVietnam(inputNumber: Real): string;
const
...
procedure TPaymentVATNO_Print_TB.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TPaymentVATNO_Print_TB.FormDestroy(Sender: TObject);
begin
  PaymentVATNO_Print_TB:=nil;
end;

procedure TPaymentVATNO_Print_TB.VN_WORDPrint(sender: TObject;
  var Value: String);
  var acc, str:string;
begin
...
procedure TPaymentVATNO_Print_TB.TW_WORDPrint(sender: TObject;
  var Value: String);
  var acc:string;
begin
  acc:=StringReplace(QRExpr11.Value.strResult,',','',[rfReplaceAll, rfIgnoreCase]);
...
procedure TPaymentVATNO_Print_TB.DatePrint(sender: TObject;
  var Value: String);
begin
  date1.Caption:=PaymentVATNO.GetChineseDate(PaymentVATNO.qry_CGPayment.FieldByName('USERDATE').value);
end;

procedure TPaymentVATNO_Print_TB.FormCreate(Sender: TObject);
begin
...
procedure TPaymentVATNO_Print_TB.QRExpr11Print(sender: TObject;
  var Value: String);
begin
  if value='0.00' then
