...
var
  AccountEntry_Det: TAccountEntry_Det;
...
procedure TAccountEntry_Det.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
action:=cafree;
end;

procedure TAccountEntry_Det.FormCreate(Sender: TObject);
begin
with query1 do
  begin
    active:=false;
    ...
    sql.add(''''+formatdatetime('yyyy/MM/dd',AccountEntry.DTP1.date)+''''+' and ' +''''+formatdatetime('yyyy/MM/dd',AccountEntry.DTP2.date)+'''');
...
procedure TAccountEntry_Det.Excel1Click(Sender: TObject);
var
...
procedure TAccountEntry_Det.FormDestroy(Sender: TObject);
begin
AccountEntry_Det:=nil;
end;
