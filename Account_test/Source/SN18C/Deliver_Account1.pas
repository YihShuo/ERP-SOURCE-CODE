...
type
  ...
  public
    ...
    NPVT,CFMID,CFMID1,CFMID2,Change:string;
...
begin
  ...
  begin
    try
      ...
      Change:=MyIni.ReadString('ERP','Account_N18C_Change_'+main.Edit2.Text,'N');
...
begin
  ...
  begin
    if (Change = 'Y') and ((ePD.Text='') or (eCQK.Text='') or (eNPVT.Text='')) then
    begin
    ...
    begin
      ...
      begin
        ...
        SQL.Add('      ,CFMID1='''+ePD.Text+''', CFMDATE1=getdate()  ');
