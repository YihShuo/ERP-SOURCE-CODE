object DelOther_PrintA5: TDelOther_PrintA5
  Left = 539
  Top = 381
  Width = 928
  Height = 630
  Caption = 'DelOther_PrintA5'
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select KCLLS.*,CLZL.YWPM,CLZL.DWBH,SCBLYY.YWSM,'
        ...
        '         ,case when CLHQ.HGPM is not null then CLZL.ywpm+'#39'   // ' +
        '    '#39'+CLHQ.HGPM else CLZL.YWPM end as YWPM_CLHQ'
      'from KCLLS'
