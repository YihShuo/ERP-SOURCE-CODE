object StockShoeMonth: TStockShoeMonth
    ...
    object TS_GC: TTabSheet
      ...
      object Panel9: TPanel
        ...
        object btnQueryGC: TButton
          ...
          Caption = 'Query'
          TabOrder = 0
          OnClick = btnQueryGCClick
        end
        object DTP_form_GC: TDateTimePicker
          Left = 96
          Top = 13
          Width = 116
          Height = 24
  ...
  object DS_GC: TDataSource
    DataSet = queryGC
    Left = 349
    Top = 330
  end
  object queryGC: TQuery
    AfterOpen = queryGCAfterOpen
    DatabaseName = 'DB'
    SQL.Strings = (
      'SELECT '
      
        ' YWCP_OEM.DDBH, YWCP_OEM.CKBH, dbo.DDZL_OEM.Qty AS Pairs, YWCP_O' +
        'EM.Qty AS RKQty, YWCP_OEM.Qty AS XHQty  '
      
        ' , Qty=0, dbo.DDZL_OEM.ShipDate, dbo.DDZL_OEM.Article, YWCP_OEM.' +
        'INDATE, YWCP_OEM.EXEDATE'
      'FROM dbo.YWCP_OEM'
      'LEFT JOIN dbo.DDZL_OEM ON DDZL_OEM.DDBH = YWCP_OEM.DDBH'
      'WHERE ISNULL(SB,'#39#39') <> '#39#39)
    Left = 352
    Top = 363
    object queryGCDDBH: TStringField
      FieldName = 'DDBH'
      FixedChar = True
      Size = 15
    end
    object queryGCCKBH: TStringField
      FieldName = 'CKBH'
      FixedChar = True
      Size = 4
    end
    object queryGCPairs: TIntegerField
      FieldName = 'Pairs'
      DisplayFormat = '#,##0'
    end
    object queryGCRKQty: TIntegerField
      FieldName = 'RKQty'
      DisplayFormat = '#,##0'
    end
    object queryGCXHQty: TIntegerField
      FieldName = 'XHQty'
      DisplayFormat = '#,##0'
    end
    object queryGCQty: TIntegerField
      FieldName = 'Qty'
    end
    object queryGCShipDate: TDateTimeField
      FieldName = 'ShipDate'
    end
    object queryGCArticle: TStringField
      FieldName = 'Article'
      FixedChar = True
    end
    object queryGCINDATE: TDateTimeField
      FieldName = 'INDATE'
    end
    object queryGCEXEDATE: TDateTimeField
      FieldName = 'EXEDATE'
    end
    object queryGCLastRem: TIntegerField
      FieldName = 'LastRem'
    end
    object queryGCMemo: TStringField
      FieldName = 'Memo'
    end
  end
end
