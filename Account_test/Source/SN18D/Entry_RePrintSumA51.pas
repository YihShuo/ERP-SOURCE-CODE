...
begin
  ...
  if Entry_Account.eNVK.Text <> '' then NVK_Img:= Entry_Account.eNVK.Text+'.bmp';
  if Entry_Account.eNVTM.Text <> '' then NVTM_Img:= Entry_Account.eNVTM.Text+'.bmp';     
  if Entry_Account.Change = 'N' then
  begin
