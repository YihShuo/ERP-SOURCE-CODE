...
type
  TFCDelMaterial_PrintA5 = class(TForm)
    Quickrep1: TQuickRep;
    Qry_DelDet: TQuery;
...
var
  FCDelMaterial_PrintA5: TFCDelMaterial_PrintA5;
  sPaperSize: string;
  sHeight: Real;
...
procedure TFCDelMaterial_PrintA5.FormDestroy(Sender: TObject);
begin
  FCDelMaterial_PrintA5 := nil;
end;

procedure TFCDelMaterial_PrintA5.Formclose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFCDelMaterial_PrintA5.ReadIni();
var MyIni :Tinifile;
...
procedure TFCDelMaterial_PrintA5.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TFCDelMaterial_PrintA5.UpLoadQRImg(QRdata:string);
var
...
procedure TFCDelMaterial_PrintA5.Qry_DelDetCalcFields(DataSet: TDataSet);
begin
...
procedure TFCDelMaterial_PrintA5.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  sHeight := sHeight + DetailBand1.size.Height + DetailBand1.Expanded;
end;

procedure TFCDelMaterial_PrintA5.Quickrep1EndPage(Sender: TCustomQuickRep);
begin
