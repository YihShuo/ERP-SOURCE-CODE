object FCDelOther_M_PrintA5: TFCDelOther_M_PrintA5
  Left = 356
  Top = 92
  Width = 865
  Height = 600
  Caption = 'FCDelOther_M_PrintA5'
  Color = clBtnFace
  ...
  object Quickrep1: TQuickRep
    ...
    object PageFooterBand1: TQRBand
      ...
      object QRLabel14: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = #29694#22580#20027#31649
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object QRLabel21: TQRLabel
        ...
        AutoStretch = False
        Caption = 
          'Lien 1: Ke toan - Lien 2: Kho - Lien 3: Nguoi lanh hang - Lien 3' +
          ': Nguoi lanh hang - Lien 4: Luu'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -9
  ...
  object Qry_DelDet: TQuery
    ...
    SQL.Strings = (
        ...
        'select   KCLLS.LLNO,KCLLS.CLBH,KCLLS.SCBH,TempQty,Qty,CLZL.YWPM,' +
        'CLZL.DWBH,KCLLS.CNO,CLHQ.HGPM,CLHQ.UnitC'
      'from KCLLS_1416_Child KCLLS'
      'left join CLZL on CLZL.CLDH= KCLLS.CLBH'
      'LEFT JOIN CLHQ ON CLHQ.HGBH=KCLLS.CNO'
      'where KCLLS.LLNO = :LLNO'
      'order by KCLLS.CLBH,KCLLS.SCBH'
      ' '
      ' ')
    Left = 178
    Top = 427
    ...
    object Qry_DelDetSCBH: TStringField
      FieldName = 'SCBH'
      FixedChar = True
      Size = 15
    end
