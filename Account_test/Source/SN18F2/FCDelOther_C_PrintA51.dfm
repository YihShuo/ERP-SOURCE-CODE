object FCDelother_C_PrintA5: TFCDelother_C_PrintA5
  Left = 481
  Top = 229
  Width = 865
  Height = 600
  Caption = 'FCDelother_C_PrintA5'
  Color = clBtnFace
  ...
  object Qry_DelDet: TQuery
    ...
    SQL.Strings = (
      ...
      #9#9',CLZL.YWPM,CLZL.DWBH,CNO,CLHQ.HGPM,CLHQ.UnitC'
        ...
        '    ,CLZL.YWPM as YWPM_CLHQ,case when ((CNO is not null) or (CNO' +
        '<>'#39#39')) then '#39'V'#39' else '#39#39' end CNO2'
