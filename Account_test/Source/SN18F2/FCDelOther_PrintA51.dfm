object FCDelOther_PrintA5: TFCDelOther_PrintA5
  Left = 539
  Top = 381
  Width = 928
  Height = 480
  VertScrollBar.Position = 22
  Caption = 'FCDelOther_PrintA5'
  Color = clBtnFace
  ...
  object Quickrep1: TQuickRep
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRDBTextCKBH: TQRDBText
        ...
        AutoStretch = False
        Color = clWhite
        DataSet = Deliver_Account_OLD_Child.DelMas
        DataField = 'CKBH'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'NGAY XUAT KHO: '#20986#24235#26085#26399
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -12
  ...
  object DelDet: TQuery
    ...
    CachedUpdates = True
    DatabaseName = 'DB'
    DataSource = Deliver_Account_OLD_Child.DS3
    RequestLive = True
    SQL.Strings = (
      'select KCLLS.*,CLZL.YWPM,CLZL.DWBH,SCBLYY.YWSM,'
        ...
        '         ,CLZL.YWPM as YWPM_CLHQ ,case when ((CNO is not null) o' +
        'r (CNO<>'#39#39')) then '#39'V'#39' else '#39#39' end CNO2'
      'from KCLLS_1416_Child KCLLS'
      'left join KCLL_1416_Child KCLL on KCLLS.LLNO=KCLL.LLNO'
    ...
    object DelDetYWPM_CLHQ: TStringField
      FieldName = 'YWPM_CLHQ'
      FixedChar = True
      Size = 255
    end
    object DelDetCNO2: TStringField
      FieldName = 'CNO2'
      Size = 15
    end
  end
