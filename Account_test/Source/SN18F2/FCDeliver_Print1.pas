...
var
  FCDeliver_Print: TFCDeliver_Print;

implementation
   uses DeliverList1, main1, Deliver_Account_OLD_Child1;
{$R *.dfm}

procedure TFCDeliver_Print.FormDestroy(Sender: TObject);
begin
  FCDeliver_Print:=nil;
end;

procedure TFCDeliver_Print.ReadIni();
var MyIni :Tinifile;
...
procedure TFCDeliver_Print.FormCreate(Sender: TObject);
var i,j:integer;
...
begin
  ...
  GSBHLabel.Caption:=Deliver_Account_OLD_Child.DelMas.fieldByName('GSBH').AsString;
end;

procedure TFCDeliver_Print.UpLoadQRImg(QRdata:string);
var
...
procedure TFCDeliver_Print.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action:=Cafree;
end;
