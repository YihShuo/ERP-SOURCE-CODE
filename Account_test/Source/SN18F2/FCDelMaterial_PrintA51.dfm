object FCDelMaterial_PrintA5: TFCDelMaterial_PrintA5
  Left = 496
  Top = 252
  Width = 952
  Height = 600
  Caption = 'FCDelMaterial_PrintA5'
  Color = clBtnFace
  ...
  object Qry_DelDet: TQuery
    ...
    SQL.Strings = (
      ...
      '       SCBLYY.YWSM,'
      '       SCBLYY.ZWSM,'
      #9'     CLHQ.HGPM,CLHQ.UnitC,'
      
        '       CLZL.YWPM AS YWPM_HGPM, case when ((CNO is not null) or (' +
        'CNO<>'#39#39')) then '#39'V'#39' else '#39#39' end CNO2'
    ...
    object Qry_DelDetperson: TFloatField
      FieldKind = fkCalculated
      FieldName = 'person'
      Calculated = True
    end
    object Qry_DelDetCLSL: TCurrencyField
      FieldName = 'CLSL'
    end
    ...
    object Qry_DelDetYWPM_HGPM: TStringField
      FieldName = 'YWPM_HGPM'
      FixedChar = True
      Size = 255
    end
    ...
    object Qry_DelDetCNO2: TStringField
      FieldName = 'CNO2'
      Size = 15
    end
  end
