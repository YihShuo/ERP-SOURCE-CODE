...
type
  TFCDelOther_PrintA5 = class(TForm)
    Quickrep1: TQuickRep;
...
var
  FCDelOther_PrintA5: TFCDelOther_PrintA5;
  sPaperSize: string;
  sHeight: Real;
...
procedure TFCDelOther_PrintA5.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=Cafree;
end;

procedure TFCDelOther_PrintA5.FormDestroy(Sender: TObject);
begin
  FCDelOther_PrintA5:=nil;
end;

procedure TFCDelOther_PrintA5.ReadIni();
var MyIni :Tinifile;
...
procedure TFCDelOther_PrintA5.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TFCDelOther_PrintA5.UpLoadQRImg(QRdata:string);
var
...
procedure TFCDelOther_PrintA5.Quickrep1EndPage(Sender: TCustomQuickRep);
begin
...
procedure TFCDelOther_PrintA5.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
