object DailyExchange: TDailyExchange
  Left = 452
  Top = 236
  Width = 870
  Height = 500
  Caption = 'DailyExchange'
  Color = clBtnFace
  ...
  object UpSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  YN = :YN'
      'where'
      '  HLYEAR = :OLD_HLYEAR and'
      '  HLMONTH = :OLD_HLMONTH and'
      '  HLDAY = :OLD_HLDAY')
    InsertSQL.Strings = (
      'insert into CWHLS'
      '  (HLYEAR, HLMONTH, HLDAY, CWHL, USERID, USERDATE, YN)'
      'values'
      '  (:HLYEAR, :HLMONTH, :HLDAY, :CWHL, :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
      'delete from CWHLS'
