...
var
  ImportHaiQuanLL: TImportHaiQuanLL;

implementation
uses main1,FunUnit,SemiImportPrice1;
{$R *.dfm}

procedure TImportHaiQuanLL.Button1Click(Sender: TObject);
var
  ExcelApp: Variant;
...
begin
  ...
  begin
    ...
    begin
      ...
      Query1.Close;
      Query1.SQL.Clear;
      Query1.SQL.Add('Select * From KCLLS_1416');
      ...
      begin
        ...
        Query1.SQL.Add('Update KCLLS_1416 set HGLB='''+S_HGLB+''',CNO='''+S_HGBH+''' ,RateC='''+S_TYLE+'''');
        Query1.SQL.Add('Where LLNO ='''+S_LLNO+''' and CLBH= '''+S_CLBH+''' and DFL='''+S_DFL+''' and SCBH='''+S_SCBH+''' ');
        Query1.ExecSQL;
...
procedure TImportHaiQuanLL.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action:=caFree;
end;

procedure TImportHaiQuanLL.FormDestroy(Sender: TObject);
begin
   ImportHaiQuanLL:=nil;
end;

procedure TImportHaiQuanLL.Button2Click(Sender: TObject);
