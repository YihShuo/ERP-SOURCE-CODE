...
type
  TDeliverCheck_PriceA = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
...
var
  DeliverCheck_PriceA: TDeliverCheck_PriceA;
...
procedure TDeliverCheck_PriceA.FormCreate(Sender: TObject);
begin
...
procedure TDeliverCheck_PriceA.Button1Click(Sender: TObject);
begin
...
procedure TDeliverCheck_PriceA.FormDestroy(Sender: TObject);
begin
  delivercheck_priceA:=nil;
end;

procedure TDeliverCheck_PriceA.FormClose(Sender: TObject;
