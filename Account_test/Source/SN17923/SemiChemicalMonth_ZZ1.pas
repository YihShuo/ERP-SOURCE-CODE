...
begin
  ...
  begin
    ...
    begin
      ...
      //2025.05.07
      SQL.Add('       or KCLLS.SCBH like ''CUIT%'' or KCLLS.SCBH like ''CUIK%'' or KCLLS.SCBH like ''UQIT%'' or KCLLS.SCBH like ''UQIK%'' or KCLLS.SCBH like ''VSIT%'' or KCLLS.SCBH like ''VSIK%'' '); //2025.08.07 them lenh VSI
    ...
    begin
      ...
      //2025.05.07
      SQL.Add('       or KCLLS_CB.SCBH_Cost like ''CUIT%'' or KCLLS_CB.SCBH_Cost like ''CUIK%'' or KCLLS_CB.SCBH_Cost like ''UQIT%'' or KCLLS_CB.SCBH_Cost like ''UQIK%'' or KCLLS_CB.SCBH_Cost like ''VSIT%'' or KCLLS_CB.SCBH_Cost like ''VSIK%'' ');   //2025.08.07 them lenh VSI
      SQL.Add('       or KCLLS_CB.SCBH_Cost like ''VJIT%'' or KCLLS_CB.SCBH_Cost like ''VJIK%'')');  //2025.12.03 xet them lenh nhan hang VEJA
    end;
