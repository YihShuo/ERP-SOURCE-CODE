object SemiMaterialMonth_Sample: TSemiMaterialMonth_Sample
  Left = 340
  Top = 241
  Width = 1532
  Height = 675
  Caption = 'SemiMaterialMonth_Sample'
  Color = clBtnFace
      ...
      object DBGridEh3: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'CKBH'
            Footers = <>
            Title.Caption = #24288#21029'|CKBH'
            Width = 60
          end
          item
            EditButtons = <>
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = #35330#21934'|Sample No'
            Width = 120
          end
          item
            EditButtons = <>
  ...
  object TempQry: TQuery
    ...
    SQL.Strings = (
      ...
      #9'   Left join YWDD on YWDD.DDBH=YWCP.DDBH'
        ...
        #9#9#9'and YWCP.CARTONBAR not in (Select YWCP.CARTONBAR from YWCP le' +
        'ft join YWCP_OUT on YWCP_OUT.CARTONBAR=YWCP.CARTONBAR where YWCP' +
        '.SB='#39'3'#39' and convert(varchar,ISNULL(YWCP_OUT.ExeDate,YWCP.ExeDate' +
        '),111) <='#39'2022/07/31'#39')'
  ...
  object PopupMenu1: TPopupMenu
    Left = 321
    Top = 282
    object Adjust_NVL_DK: TMenuItem
      Caption = 'Dieu Chinh Tong Chi Phi NVL Dau Ky'
      OnClick = Adjust_NVL_DKClick
    end
