object main: Tmain
  ...
  object MainMenu1: TMainMenu
    ...
    object SN1: TMenuItem
      ...
      object SN17: TMenuItem
        ...
        object SN179: TMenuItem
          ...
          object SN1793: TMenuItem
            ...
            OnClick = SN1793Click
            object SN17931: TMenuItem
              Caption = 'N17931 Monthly Finish Shoe'
              OnClick = SN17931Click
            end
            object SN17932: TMenuItem
              Caption = 'N17932 Monthly Finish Shoe Cost'
              OnClick = SN17932Click
            end
          end
        end
      ...
      object N17A: TMenuItem
        Caption = 'N17A Check List (13~16)'
        object SN172A: TMenuItem
          Caption = 'N172A Entry Check (13~16)'
          OnClick = SN172AClick
        end
        object SN174A: TMenuItem
          Caption = 'N174A Deliver Check (13~16)'
          OnClick = SN174AClick
        end
        object SN176A: TMenuItem
          Caption = 'N176A Material Month List (13~16)'
          OnClick = SN176AClick
        end
      end
      object SN17B: TMenuItem
        Caption = 'N17B Check List (17~22)'
        object SN172B: TMenuItem
          Caption = 'N172B Entry Check (17~22)'
          OnClick = SN172BClick
        end
        object SN174B: TMenuItem
          Caption = 'N174B Deliver Check (17~22)'
          OnClick = SN174BClick
        end
        object SN176B: TMenuItem
          Caption = 'N176B Material Month List (17~22)'
          OnClick = SN176BClick
        end
      end
      object SN18: TMenuItem
        ...
        object SN18F: TMenuItem
          Caption = 'N18F Print Deliver (13~16)'
          object SN18F1: TMenuItem
            Caption = 'N18F1 Print Deliver (13~16)'
            OnClick = SN18F1Click
          end
          object SN18F2: TMenuItem
            Caption = 'N18F2 Print Deliver Child (13~16)'
            OnClick = SN18F2Click
          end
        end
      end
    ...
    object SN2: TMenuItem
      ...
      object SN23: TMenuItem
        ...
        object SN235: TMenuItem
          Caption = 'N235 Supplier For Payable List'
          OnClick = SN235Click
        end
      end
