object EntryPur: TEntryPur
  ...
  object EnMas: TQuery
    ...
    object EnMasDeclaretion: TStringField
      FieldName = 'Declaretion'
      Size = 50
    end
  ...
  object EnDet: TQuery
    ...
    object EnDetDONGIA: TFloatField
      FieldName = 'DONGIA'
    end
  end
  ...
  object Qry_Price: TQuery
    ...
    SQL.Strings = (
      ...
      'Select XXZL.ARTICLE+'#39';'#39' from CGBJS,XXZL '
        ...
        '  where CLBH=:CLBH'#39' and IsNull(CGBJS.XieXing,'#39'ZZZZZZZZ'#39')<>'#39'ZZZZZ' +
        'ZZZ'#39
      ...
      'left join CLZL on CLZL.CLDH=CGBJS.CLBH'
        ...
        'JS.SheHao '
      'where CGBJS.CLBH=:CLBH and DDZL.DDBH=:CGBH'
      'and CGBJ.GSBH='#39'VA12'#39
      ''
      ') CGBJ ) CGBJ'
    ...
    ParamData = <
      item
        DataType = ftUnknown
        Name = 
          'CLBH'#39' and IsNull(CGBJS.XieXing,'#39'ZZZZZZZZ'#39')<>'#39'ZZZZZZZZ'#39#13#10'        ' +
          'and XXZL.XieXing=CGBJS.XieXing and XXZL.SheHao=CGBJS.SheHao Grou' +
          'p by XXZL.ARTICLE for XML Path ('#39#39')'#13#10')  as varchar(500))  as Not' +
          'SKU'#13#10',IsNull(CGBJS.XieXing,'#39'ZZZZZZZZ'#39')as XieXing,IsNull(CGBJS.Sh' +
          'eHao,'#39'ZZZZZZZZ'#39')as SheHao'#13#10#13#10'from CGBJ'#13#10'left join CGBJS on CGBJ.' +
          'BJNO=CGBJS.BJNO'#13#10'left join ZSZL on ZSZL.ZSDH=CGBJ.ZSBH'#13#10'left joi' +
          'n CLZL on CLZL.CLDH=CGBJS.CLBH'#13#10'where CGBJS.CLBH=:CLBH and IsNul' +
          'l(XieXing,'#39'ZZZZZZZZ'#39')='#39'ZZZZZZZZ'#39#13#10'and CGBJ.GSBH='#39'VA12'#39#13#10'union al' +
          'l '#13#10'select CGBJ.BJNO,CGBJ.USERDate,CGBJ.ZSBH,ZSZL.ZSYWJC,CGBJS.C' +
          'LBH,'#13#10'CGBJS.USPrice,CGBJS.VNPrice,CLZL.YWPM,CLZL.DWBH,CGBJS.Disc' +
          'ount,PayVN,convert(money,0.0) as CWHL,CGBJS.SuppEx,DDZL.Article ' +
          'as SKU,null as NotSKU,'#13#10'IsNull(CGBJS.XieXing,'#39'ZZZZZZZZ'#39')as XieXi' +
          'ng,IsNull(CGBJS.SheHao,'#39'ZZZZZZZZ'#39')as SheHao'#13#10'from CGBJ'#13#10'left joi' +
          'n CGBJS on CGBJ.BJNO=CGBJS.BJNO'#13#10'left join ZSZL on ZSZL.ZSDH=CGB' +
          'J.ZSBH'#13#10'left join CLZL on CLZL.CLDH=CGBJS.CLBH'#13#10'left join DDZL o' +
          'n DDZL.XieXing=CGBJS.XieXing and DDZL.SheHao=CGBJS.SheHao '#13#10'wher' +
          'e CGBJS.CLBH=:CLBH and DDZL.DDBH=:CGBH'#13#10'and CGBJ.GSBH='#39'VA12'#39#13#10#13#10 +
          ') CGBJ ) CGBJ'#13#10'order by Sort,CGBJ.BJNO DESC'#13#10
        ParamType = ptUnknown
      end>
  end
end
