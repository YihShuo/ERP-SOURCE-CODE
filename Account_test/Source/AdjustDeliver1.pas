...
begin
  ...
  begin
    ...
    sql.add('where ISNULL(KCLL.flowflag,'''')<>''X'' ');
  ...
  begin
    Active:=false;
    sql.Clear;
    SQL.Add('select KCLLS.*,CLZL.YWPM,CLZL.DWBH,KCZLS.CWBh,KCPK.Declaretion');
    ...
    sql.Add('left join KCPK on KCPK.PKNO=KCLLS.PKNO');
...
begin
  ...
  begin
    ...
    begin
        ...
        begin
          if ((fieldbyname('CNO').AsString='') and ((fieldbyname('CWBH').AsString<>'153') and (fieldbyname('CWBH').AsString<>'1533'))) then
          begin
      ...
      begin
          ...
          begin
            ...
            UPdet.apply(ukmodify);
             //20240905 cap nhat so luong KCPKLL khi ke toan cap nhat so luong
            ...
            begin
              ...
              begin
                active:=false;
                sql.Clear;
                sql.Add('Update KCPKLL Set Qty='''+DelDet.fieldbyname('Qty').AsString+''' ');
