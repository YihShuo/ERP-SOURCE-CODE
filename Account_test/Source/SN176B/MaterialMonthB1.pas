...
var
  MaterialMonthB: TMaterialMonthB;
...
{$R *.dfm}
procedure TMaterialMonthB.readini();
var MyIni :Tinifile;
    AppDir:string;
begin
...
//
procedure TMaterialMonthB.ExportExcel();
...
procedure TMaterialMonthB.Button2Click(Sender: TObject);
var
...
procedure TMaterialMonthB.FormClose(Sender: TObject;
...
procedure TMaterialMonthB.Button1Click(Sender: TObject);
...
begin
  ...
  begin
    ...
    begin
      ...
      sql.add('from  CWCLZL_HG_1722 CWCLZL');
      sql.add('left join CWCLCOUNT_HG_1722 CWCLCOUNT on CWCLCOUNT.KCYEAR=CWCLZL.KCYEAR and CWCLCOUNT.KCMONTH=CWCLZL.KCMONTH ');
...
procedure TMaterialMonthB.FormCreate(Sender: TObject);
var
...
procedure TMaterialMonthB.Query1CalcFields(DataSet: TDataSet);
begin
    with query1 do
    begin
...
procedure TMaterialMonthB.FormDestroy(Sender: TObject);
begin
  MaterialMonthB:=nil;
end;

procedure TMaterialMonthB.CBX4Change(Sender: TObject);
begin
...
procedure TMaterialMonthB.Query2CalcFields(DataSet: TDataSet);
begin
    with query2 do
    begin
      if fieldbyname('RemQty').value<>0 then
