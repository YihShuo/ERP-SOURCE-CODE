object FDelother_C_PrintA5: TFDelother_C_PrintA5
  Left = 724
  Top = 324
  Width = 865
  Height = 600
  Caption = 'FDelother_C_PrintA5'
  Color = clBtnFace
  ...
  object Qry_DelDet: TQuery
    ...
    SQL.Strings = (
      'select   KCLLS.LLNO,CLBH,SUM(TempQty) AS TempQty,SUM(Qty) AS Qty'
        ...
        #9#9',CLZL.YWPM,CLZL.DWBH,case when ((CNO is not null) or (CNO<>'#39#39')' +
        ') then '#39'V'#39' else '#39#39' end CNO'
      '    ,CLZL.YWPM as YWPM_CLHQ,CLHQ.HGPM,CLHQ.UnitC'
