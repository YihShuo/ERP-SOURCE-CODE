object FDelMaterial_PrintA5: TFDelMaterial_PrintA5
  Left = 496
  Top = 252
  Width = 952
  Height = 600
  Caption = 'FDelMaterial_PrintA5'
  Color = clBtnFace
  ...
  object Quickrep1: TQuickRep
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRDBTextCKBH: TQRDBText
        ...
        AutoStretch = False
        Color = clWhite
        DataSet = Deliver_Account_OLD.DelMas
        DataField = 'CKBH'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
  ...
  object Qry_DelDet: TQuery
    ...
    DatabaseName = 'DB'
    DataSource = Deliver_Account_OLD.DS3
    SQL.Strings = (
      'select KCLLS.*,'
      '       CLZL.YWPM,'
      '       CLZL.DWBH,'
      ...
      #9'     CLHQ.HGPM,CLHQ.UnitC,'
        ...
        '       CLZL.YWPM as YWPM_HGPM,case when ((CNO is not null) or (C' +
        'NO<>'#39#39')) then '#39'V'#39' else '#39#39' end CNO2'
      'from KCLLS_1416 KCLLS'
