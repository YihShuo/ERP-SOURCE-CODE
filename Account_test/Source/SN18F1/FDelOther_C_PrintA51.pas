...
type
  TFDelother_C_PrintA5 = class(TForm)
    Quickrep1: TQuickRep;
    Qry_DelDet: TQuery;
...
var  FDelother_C_PrintA5: TFDelother_C_PrintA5;
  sPaperSize: string;
  sHeight: Real;
...
procedure TFDelother_C_PrintA5.FormDestroy(Sender: TObject);
begin
  FDelother_C_PrintA5 := nil;
end;

procedure TFDelother_C_PrintA5.Formclose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFDelother_C_PrintA5.ReadIni();
var MyIni :Tinifile;
...
procedure TFDelother_C_PrintA5.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TFDelother_C_PrintA5.UpLoadQRImg(QRdata:string);
var
...
procedure TFDelother_C_PrintA5.Qry_DelDetCalcFields(DataSet: TDataSet);
begin
  Qry_DelDetS.Close;
  Qry_DelDetS.Open;
  Qry_DelDetS.First;
...
procedure TFDelother_C_PrintA5.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  sHeight := sHeight + DetailBand1.size.Height + DetailBand1.Expanded;
end;

procedure TFDelother_C_PrintA5.Quickrep1EndPage(Sender: TCustomQuickRep);
begin
