...
type
  TFDelOther_PrintA5 = class(TForm)
    Quickrep1: TQuickRep;
...
var
  FDelOther_PrintA5: TFDelOther_PrintA5;
  sPaperSize: string;
  sHeight: Real;
...
procedure TFDelOther_PrintA5.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=Cafree;
end;

procedure TFDelOther_PrintA5.FormDestroy(Sender: TObject);
begin
  FDelOther_PrintA5:=nil;
end;

procedure TFDelOther_PrintA5.ReadIni();
var MyIni :Tinifile;
...
procedure TFDelOther_PrintA5.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TFDelOther_PrintA5.UpLoadQRImg(QRdata:string);
var
...
procedure TFDelOther_PrintA5.Quickrep1EndPage(Sender: TCustomQuickRep);
begin
...
procedure TFDelOther_PrintA5.DetailBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
