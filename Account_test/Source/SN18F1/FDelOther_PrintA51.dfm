object FDelOther_PrintA5: TFDelOther_PrintA5
  Left = 539
  Top = 381
  Width = 928
  Height = 480
  VertScrollBar.Position = 22
  Caption = 'FDelOther_PrintA5'
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      ...
      'left join KCLL_1416 KCLL on KCLLS.LLNO=KCLL.LLNO'
