...
type
  TFDelOther_M_PrintA5 = class(TForm)
    Quickrep1: TQuickRep;
    Qry_DelDet: TQuery;
...
var
  FDelOther_M_PrintA5: TFDelOther_M_PrintA5;
  sPaperSize: string;
  sHeight: Real;
...
procedure TFDelOther_M_PrintA5.FormDestroy(Sender: TObject);
begin
  FDelOther_M_PrintA5 := nil;
end;

procedure TFDelOther_M_PrintA5.Formclose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TFDelOther_M_PrintA5.ReadIni();
var MyIni :Tinifile;
...
procedure TFDelOther_M_PrintA5.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TFDelOther_M_PrintA5.UpLoadQRImg(QRdata:string);
var
...
procedure TFDelOther_M_PrintA5.Qry_DelDetCalcFields(DataSet: TDataSet);
begin
  Qry_DelDetS.Close;
  Qry_DelDetS.Open;
  Qry_DelDetS.First;
...
procedure TFDelOther_M_PrintA5.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  sHeight := sHeight + DetailBand1.size.Height + DetailBand1.Expanded;
end;

procedure TFDelOther_M_PrintA5.Quickrep1EndPage(Sender: TCustomQuickRep);
begin
