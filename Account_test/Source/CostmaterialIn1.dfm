object CostmaterialIn: TCostmaterialIn
  Left = 321
  Top = 250
  Width = 870
  Height = 500
  Caption = 'CostmaterialIn'
  Color = clBtnFace
  ...
  object KCLLS: TQuery
    OnNewRecord = KCLLSNewRecord
    DatabaseName = 'DB'
    SQL.Strings = (
      
        'select KCLLS.LLNO,KCLLS.CLBH,KCLLS.DFL,KCLLS.Qty,KCLLS.CostID,KC' +
        'LLS.CWSB'
      
        '       ,KCLLS.BLSB,KCLL.GSBH,KCLL.CKBH,BDepartment.DepName,KCLL.' +
        'CFMDate,KCLL.YN '
      '       ,CLZL.YWPM,CLZL.DWBH '
      'from KCLLS '
    ...
    object KCLLSCLBH: TStringField
      DisplayWidth = 13
      FieldName = 'CLBH'
      FixedChar = True
      Size = 15
    end
    object KCLLSDWBH: TStringField
      DisplayWidth = 6
      FieldName = 'DWBH'
      FixedChar = True
      Size = 4
    end
    object KCLLSSCBH: TStringField
      DisplayWidth = 15
      FieldName = 'SCBH'
      FixedChar = True
      Size = 15
    end
    object KCLLSDFL: TStringField
      DisplayWidth = 4
      FieldName = 'DFL'
      FixedChar = True
      Size = 1
    end
    object KCLLSQty: TCurrencyField
      DisplayWidth = 10
      FieldName = 'Qty'
      DisplayFormat = '##,#0.0'
    end
    object KCLLSCWSB: TStringField
      FieldName = 'CWSB'
      FixedChar = True
      Size = 1
    end
    object KCLLSCostID: TStringField
      DisplayWidth = 10
      FieldName = 'CostID'
      FixedChar = True
      Size = 10
  ...
  object KCRKS: TQuery
    ...
    DataSource = DS1
    SQL.Strings = (
      'select KCRKS.CGBH,KCRK.RKNO,KCRK.USERDate,ZSZL.ZSYWJC'
      'from KCRKS'
      'left join KCRK on KCRK.RKNO=KCRKS.RKNO'
      'left join ZSZL on ZSZL.ZSDH=KCRK.ZSBH'
      'where KCRKS.CGBH=:SCBH'
      '         and KCRKS.CLBH=:CLBH'
      'order by ZSZL.ZSYWJC')
    Left = 664
    Top = 232
    ParamData = <
      item
    ...
    object KCRKSZSYWJC: TStringField
      FieldName = 'ZSYWJC'
      FixedChar = True
    end
  end
