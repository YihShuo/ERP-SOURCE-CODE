  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'DDBH'
        Footers = <>
        Title.Caption = 'DDBH|'#27597#35330#21934
        Width = 91
      end
      item
        DisplayFormat = '#,##0'
        ...
        FieldName = 'S_CPPB'
        Footers = <>
        Title.Caption = 'CHI PHI NVL NVLTT PB HC + VC |'#30452#25509#21407#26009#36027#29992
      end
      item
        EditButtons = <>
        FieldName = 'U_CP622'
        Footers = <>
        Title.Caption = 'CHI PHI NCTT (TK622)||'#30452#25509#20154#24037#36027#29992
      end
      item
        EditButtons = <>
        FieldName = 'V_CP627'
        Footers = <>
        Title.Caption = 'CHI PHI SXC (TK627)||'#32317#29983#29986#36027#29992
      end
      item
        EditButtons = <>
        FieldName = 'Memo'
      ...
      item
        ...
        Footers = <>
        ReadOnly = True
        Title.Caption = 'UserDate|'#26356#26032#26085#26399
        Width = 80
      end>
  end
  ...
  object UpdateSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into CW_MatCostMonth_Total_Adjust'
        ...
        ' (KCYEAR,KCMONTH,Factory,DDBH,S_CPPB,U_CP622,V_CP627, Memo,UserI' +
        'D, UserDate,YN)'
      'values'
      
        '  (:KCYEAR,:KCMONTH, :Factory,:DDBH, :S_CPPB, :U_CP622, :V_CP627' +
        ', :Memo, :UserID, :UserDate,:YN)'
      '')
    DeleteSQL.Strings = (
