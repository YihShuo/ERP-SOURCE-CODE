...
uses
  ...
  DBGridEhImpExp, Comobj, ShellAPI, iniFiles, Menus,dateutils;
...
type
  TAccMonthStock = class(TForm)
    ...
    DetailRemQty01T1: TMenuItem;
    DetailRemQty02T1: TMenuItem;
    DetailRemQty03T1: TMenuItem;
    DetailRemQty04T1: TMenuItem;
    DetailRemQty05T1: TMenuItem;
    DetailRemQty06T1: TMenuItem;
    DetailRemQty07T1: TMenuItem;
    N1: TMenuItem;
    DetailRemQty01TTotal1: TMenuItem;
    DetailRemQty02TTotal1: TMenuItem;
    DetailRemQty03TTotal1: TMenuItem;
    DetailRemQty04TTotal1: TMenuItem;
    DetailRemQty05TTotal1: TMenuItem;
    DetailRemQty06TTotal1: TMenuItem;
    DetailRemQty07TTotal1: TMenuItem;
    ...
    procedure DetailRemQty01T1Click(Sender: TObject);
    procedure DetailRemQty02T1Click(Sender: TObject);
    procedure DetailRemQty03T1Click(Sender: TObject);
    procedure DetailRemQty04T1Click(Sender: TObject);
    procedure DetailRemQty05T1Click(Sender: TObject);
    procedure DetailRemQty06T1Click(Sender: TObject);
    procedure DetailRemQty07T1Click(Sender: TObject);
    procedure DetailRemQty01TTotal1Click(Sender: TObject);
    procedure DetailRemQty02TTotal1Click(Sender: TObject);
    procedure DetailRemQty03TTotal1Click(Sender: TObject);
    procedure DetailRemQty04TTotal1Click(Sender: TObject);
    procedure DetailRemQty05TTotal1Click(Sender: TObject);
    procedure DetailRemQty06TTotal1Click(Sender: TObject);
    procedure DetailRemQty07TTotal1Click(Sender: TObject);
  private
...
uses main1, FunUnit, DetailRemQty01T1;
...
procedure TAccMonthStock.DetailRemQty01T1Click(Sender: TObject);
...
begin
  ...
  begin
    showmessage('Vui long chon kho CKBH ');
    abort;
  end;
  RemQty:='RemQty01T';
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate:='and (DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')>0 AND DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')<=30) ';
  end else
  begin
    CheckDate:='and DATEDIFF(MONTH, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''') =0';
  end;       
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate1:='and (DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')>0 AND DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')<=30) ';
  end else
  begin
    CheckDate1:='and DATEDIFF(MONTH, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''') =0';
  end;
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='1';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
  DetailRemQty01T.Edit8.Text:=CBX3.Text;
  DetailRemQty01T.Edit9.Text:=CBX1.Text;
  DetailRemQty01T.Edit10.Text:=CalQuery.fieldbyname('CLBH').AsString;
  DetailRemQty01T.Edit11.Text:=CalQuery.fieldbyname('HGLB').AsString;
  DetailRemQty01T.Button1.Click;
  DetailRemQty01T.show;
end;

procedure TAccMonthStock.DetailRemQty02T1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
  ...
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate:='and (DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')>=31 AND DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')<=60) ';
  end else
  begin
    CheckDate:='and DATEDIFF(MONTH, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''') =1';
  end;          
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate1:='and (DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')>=31 AND DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')<=60) ';
  end else
  begin
    CheckDate1:='and DATEDIFF(MONTH, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''') =1';
  end;
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='1';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
...
procedure TAccMonthStock.DetailRemQty03T1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
  ...
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate:='and (DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')>=61 AND DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')<=90) ';
  end else
  begin
    CheckDate:='and DATEDIFF(MONTH, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''') =2';
  end;       
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate1:='and (DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')>=61 AND DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')<=90) ';
  end else
  begin
    CheckDate1:='and DATEDIFF(MONTH, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''') =2';
  end;
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='1';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
...
procedure TAccMonthStock.DetailRemQty04T1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
  ...
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate:='and (DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')>=91 AND DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')<=120) ';
  end else
  begin
    CheckDate:='and DATEDIFF(MONTH, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''') =3';
  end;     
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate1:='and (DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')>=91 AND DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')<=120) ';
  end else
  begin
    CheckDate1:='and DATEDIFF(MONTH, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''') =3';
  end;
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='1';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
...
procedure TAccMonthStock.DetailRemQty05T1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
  ...
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate:='and (DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')>=121 AND DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')<=180) ';
  end else
  begin
    CheckDate:='and DATEDIFF(MONTH, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''') in (''4'',''5'')';
  end;     
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate1:='and (DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')>=121 AND DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')<=180) ';
  end else
  begin
    CheckDate1:='and DATEDIFF(MONTH, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''') in (''4'',''5'')';
  end;
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='1';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
...
procedure TAccMonthStock.DetailRemQty06T1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
  ...
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate:='and (DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')>=181 AND DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')<=359) ';
  end else
  begin
    CheckDate:='and DATEDIFF(MONTH, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''') in (''6'',''7'',''8'',''9'',''10'',''11'')';
  end;                 
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate1:='and (DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')>=181 AND DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')<=359) ';
  end else
  begin
    CheckDate1:='and DATEDIFF(MONTH, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''') in (''6'',''7'',''8'',''9'',''10'',''11'')';
  end;
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='1';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
...
procedure TAccMonthStock.DetailRemQty07T1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
  ...
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate:='and DATEDIFF(day, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''')>=360  ';
  end else
  begin
    CheckDate:='and DATEDIFF(MONTH, KCRK.USERDATE, '''+formatdatetime('yyyy/MM/dd',edate)+''') >=12';
  end;         
  if (iYear<=2024) and (iMonth<=10) then
  begin
    CheckDate1:='and DATEDIFF(day, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''')=360  ';
  end else
  begin
    CheckDate1:='and DATEDIFF(MONTH, KCPKRK.KCYEAR+''-''+KCPKRK.KCMONTH+''-01'', '''+formatdatetime('yyyy/MM/dd',edate)+''') =12';
  end;
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='1';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
...
procedure TAccMonthStock.DetailRemQty01TTotal1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
  ...
  DetailRemQty01T:=TDetailRemQty01T.create(self);
  DetailRemQty01T.lblFlag.Caption:='All';
  DetailRemQty01T.Edit7.Text:=CBX2.Text;
  DetailRemQty01T.Edit8.Text:=CBX3.Text;
  DetailRemQty01T.Edit9.Text:=CBX1.Text;
  DetailRemQty01T.Button1.Click;
...
procedure TAccMonthStock.DetailRemQty02TTotal1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
...
procedure TAccMonthStock.DetailRemQty03TTotal1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
...
procedure TAccMonthStock.DetailRemQty04TTotal1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
...
procedure TAccMonthStock.DetailRemQty05TTotal1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
...
procedure TAccMonthStock.DetailRemQty06TTotal1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
...
procedure TAccMonthStock.DetailRemQty07TTotal1Click(Sender: TObject);
var sDate,eDate:Tdate;
    iYear,iMonth:Word;
begin
  EDate:=EncodeDate(strtoint(CBX2.Text), strtoint(CBX3.Text), 1);
