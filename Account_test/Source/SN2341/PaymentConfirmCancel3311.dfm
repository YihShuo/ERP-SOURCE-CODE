object PaymentConfirmCancel331: TPaymentConfirmCancel331
  Left = 442
  Top = 111
  Width = 1509
  Height = 874
  Caption = 'PaymentConfirmCancel331'
  Color = clBtnFace
  ...
  object qry1: TQuery
    ...
    SQL.Strings = (
      ...
      #9#9',a.USERID, a.USERDATE, a.YN'
        ...
        '    ,case when (ISNULL(DF1.VATFile_SV, '#39#39') <> '#39#39') OR (ISNULL(DF2' +
        '.VATFile_SV, '#39#39') <> '#39#39') then 1 else 0 end as PLX  '
      ...
      '  LEFT JOIN CGZL_Payment on a.FKBH=CGZL_Payment.FKBH '
        ...
        '  LEFT JOIN [DOCNO_File_SV] DF1 ON ISNULL(DOCNO_File.VATFile, '#39#39 +
        ') = DF1.VATFile_SV'
      
        '  LEFT JOIN [DOCNO_File_SV] DF2 ON ISNULL(DOCNO_File.VATFile1, '#39 +
        #39') = DF2.VATFile_SV'
      '   WHERE a.FKBH=:FKBH')
    Left = 452
    Top = 155
  ...
  object qry2: TQuery
    ...
    SQL.Strings = (
        ...
        '    ,case when (ISNULL(DF1.VATFile_SV, '#39#39') <> '#39#39') OR (ISNULL(DF2' +
        '.VATFile_SV, '#39#39') <> '#39#39') then 1 else 0 end as PLX  , '#39'VND'#39' DONVI_' +
        'TIENTE'
    ...
    object qry2DONVI_TIENTE: TStringField
