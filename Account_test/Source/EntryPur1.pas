...
begin
  ...
  begin
    ...
    sql.add('where  KCRK.CFMID like '+''''+'%NO%'+'''')  ;
    ...
    begin
       ...
       begin
          ...
          begin
               ...
               begin
                 edit;
                 fieldbyname('VNPrice').Value:=trunc((Qtemp.fieldbyname('VNPrice').Value*Qtemp.fieldbyname('Qty').Value+Charge_VNEdit)/Qtemp.fieldbyname('Qty').value+0.5);
                 fieldbyname('VNACC').Value:=trunc(fieldbyname('VNPrice').value*fieldbyname('Qty').value+0.5);
