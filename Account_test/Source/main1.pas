...
type
  Tmain = class(TForm)
    ...
    procedure SN172AClick(Sender: TObject);
    procedure SN174AClick(Sender: TObject);
    procedure SN176AClick(Sender: TObject);
    procedure SN17931Click(Sender: TObject);
    procedure SN17932Click(Sender: TObject);
    procedure SN18F1Click(Sender: TObject);
    procedure SN18F2Click(Sender: TObject);
    procedure SN172BClick(Sender: TObject);
    procedure SN174BClick(Sender: TObject);
    procedure SN176BClick(Sender: TObject);
...
uses DM3,FirstStock1, ExtraCon1, EntryConfirm1, EntryPur1, DeliverList1,
  ...
  MonthSemiFinishProduct1, EntryCheckA1, DeliverCheckA1, MaterialMonthA1,
  StockShoeMonthCost1, Deliver_Account_OLD1, Deliver_Account_OLD_Child1,
  EntryCheckB1, DeliverCheckB1, MaterialMonthB1, SupplierForPayableList1;
...
procedure Tmain.SN172AClick(Sender: TObject);
begin
  showFm(Pointer(EntryCheckA), TEntryCheckA, TMenuItem(Sender).Name);
end;

procedure Tmain.SN174AClick(Sender: TObject);
begin
  showFm(Pointer(DeliverCheckA), TDeliverCheckA, TMenuItem(Sender).Name);
end;

procedure Tmain.SN176AClick(Sender: TObject);
begin
  showFm(Pointer(MaterialMonthA), TMaterialMonthA, TMenuItem(Sender).Name);
end;

procedure Tmain.SN17931Click(Sender: TObject);
begin
  showFm(Pointer(StockShoeMonth), TStockShoeMonth, TMenuItem(Sender).Name);
end;

procedure Tmain.SN17932Click(Sender: TObject);
begin
  showFm(Pointer(StockShoeMonthCost), TStockShoeMonthCost, TMenuItem(Sender).Name);
end;

procedure Tmain.SN18F1Click(Sender: TObject);
begin
  showFm(Pointer(Deliver_Account_OLD), TDeliver_Account_OLD, TMenuItem(Sender).Name);
end;

procedure Tmain.SN18F2Click(Sender: TObject);
begin
  showFm(Pointer(Deliver_Account_OLD_Child), TDeliver_Account_OLD_Child, TMenuItem(Sender).Name);
end;

procedure Tmain.SN172BClick(Sender: TObject);
begin
  showFm(Pointer(EntryCheckB), TEntryCheckB, TMenuItem(Sender).Name);
end;

procedure Tmain.SN174BClick(Sender: TObject);
begin
  showFm(Pointer(DeliverCheckB), TDeliverCheckB, TMenuItem(Sender).Name);
end;

procedure Tmain.SN176BClick(Sender: TObject);
begin
  showFm(Pointer(MaterialMonthB), TMaterialMonthB, TMenuItem(Sender).Name);
end;

procedure Tmain.SN235Click(Sender: TObject);
begin
  showFm(Pointer(SupplierForPayableList), TSupplierForPayableList, TMenuItem(Sender).Name);
end;
