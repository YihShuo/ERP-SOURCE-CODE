  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'Left join ('
        ...
        'Select DDZL.DDBH,Sum(ISNULL(YWCP_OUT.Qty_Out,YWCP.Qty)) as Qty,M' +
        'in(ISNULL(YWCP_OUT.ExeDate,YWCP.ExeDate)) as EXEDATE'
      'from YWCP '
      'left join YWCP_OUT on YWCP_OUT.CARTONBAR=YWCP.CARTONBAR '
      'left join YWDD on YWDD.DDBH=YWCP.DDBH'
      'left join DDZL on YWDD.YSBH=DDZL.DDBH'
      
        'where DDZL.DDBH='#39'Y2208-0167'#39' and ISNULL(YWCP_OUT.ExeDate,YWCP.Ex' +
        'eDate) is not null'
      'Group by DDZL.DDBH'
