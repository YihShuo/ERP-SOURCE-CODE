object ExtraOutCheck: TExtraOutCheck
  Left = 408
  Top = 277
  Width = 1393
  Height = 546
  Caption = 'ExtraOutCheck'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select JGZL.*,JGZLZ.*,CLZL.YWPM,CLZL.DWBH,ZSZL.ZSYWJC,KCZLS.CWBH' +
        ', CLHG.HGBH,CLHG.UnitC,CLHG.RateC'
      
        ' from (select JGZLS.JGNO,JGZLS.ZMLB,JGZLS.Qty as BL,isnull(JGZLS' +
        '.VNPrice,0) as VNPrice,round(convert(float,JGZLS.Qty)*convert(fl' +
        'oat,JGZLSM.Qty),2) as Qty,'
      
        '       convert(bigint,(isnull(JGZLS.VNPrice,0))* (round(JGZLS.Qt' +
        'y*JGZLSM.Qty,2)),0) as VNACC,JGZLS.USERDATE '
      '       from JGZLS '
      
        '       left join (select JGZLS.JGNO,JGZLS.CLBH,JGZLS.Qty from JG' +
        'ZLS '
      
        '       left join JGZL on JGZL.JGNO=JGZLS.JGNO where JGZLS.ZMLB='#39 +
        'ZZZZZZZZZZ'#39
      
        '       and Convert(smalldatetime,convert(varchar,JGZL.CFMDate1,1' +
        '11)) between '
      #39'2017/01/01'#39' and '#39'2017/01/31'#39
      
        '       )  JGZLSM on JGZLSM.JGNO=JGZLS.JGNO  and JGZLS.CLBH=JGZLS' +
        'M.CLBH'
      
        '               left join JGZL on JGZL.JGNO=JGZLS.JGNO where JGZL' +
        'S.ZMLB<>'#39'ZZZZZZZZZZ'#39
      
        '            and Convert(smalldatetime,convert(varchar,JGZL.CFMDa' +
        'te1,111)) between '
      #39'2017/01/01'#39' and '#39'2017/01/31'#39
      '     ) JGZLZ'
      ...
      'left join CLZL on CLZL.CLDH=JGZLZ.ZMLB'
        ...
        'left join CLHG on CLHG.CLBH=JGZLZ.ZMLB and Year(JGZLZ.USERDATE)>' +
        '=2017 '
      'left join ZSZL on ZSZL.ZSDH=JGZL.ZSBH'
      
        'left join KCZLS on KCZLS.CLBH=JGZLZ.ZMLB and KCZLS.CKBH=JGZl.CKB' +
        'H'
      'left join KCCK on KCCK.CKBH=JGZL.CKBH '
      ' where JGZLZ.ZMLB like '#39'%'#39
      '       and CLZL.YWPM like '#39'%%'#39
      '       and CLZL.YWPM like '#39'%%'#39
      '       and isnull(KCZLS.CWBH,'#39#39') like '#39'%'#39
      '       and JGZLZ.JGNO like '#39'%'#39
    ...
    object Query1CFMID2: TStringField
      FieldName = 'CFMID2'
      FixedChar = True
      Size = 15
    end
    object Query1CFMDate2: TDateTimeField
      FieldName = 'CFMDate2'
      DisplayFormat = 'YYYY/MM/DD'
    end
    ...
    object Query1YN_Date: TDateTimeField
      FieldName = 'YN_Date'
    end
