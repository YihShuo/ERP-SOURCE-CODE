object SetupSCBHGT: TSetupSCBHGT
  ...
  object Qry_Deliver: TQuery
    ...
    object Qry_DeliverDFL: TStringField
      FieldName = 'DFL'
    end
  end
  ...
  object PopDeliver: TPopupMenu
    Left = 218
    Top = 484
    object Modifi1: TMenuItem
      Caption = 'Modify'
      OnClick = Modifi1Click
    end
