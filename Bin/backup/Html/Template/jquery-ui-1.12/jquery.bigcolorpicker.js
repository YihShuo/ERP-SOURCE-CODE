(function($){
	var bigColorPicker = new function(){
		...
		var sideLength = 6;
		this.init = function(){
			$("#bodydiv").append('<div id="bigpicker" class="bigpicker"><ul class="bigpicker-bgview-text" ><li><div id="bigBgshowDiv"></div></li><li><input id="bigHexColorText" size="7" maxlength="7" value="#000000" /></li></ul><div id="bigSections" class="bigpicker-sections-color" style="background-image: url(./images/big_bgcolor.jpg);"></div><div id="bigLayout" class="biglayout" ></div></div>');
