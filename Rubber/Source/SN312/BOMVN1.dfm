object BOMVN: TBOMVN
      ...
      object DBGrid3: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = 'ZSYWJC|'#24288#21830'No'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -13
            Title.Font.Name = 'MS Sans Serif'
      ...
      object DBGridEh3: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'KHDH'
            Footers = <>
            Title.Caption = 'KHDH|'#23458#25142#32232#34399
            Width = 70
          end
          item
            EditButtons = <>
            FieldName = 'KHPO'
            Footers = <>
            Title.Caption = 'KHPO|'#23458#25142'PO'
            Width = 78
          end
          item
            EditButtons = <>
            FieldName = 'DDRQ'
            Footers = <>
            Title.Caption = 'DDRQ|'#25509#21934#26085#26399
            Width = 75
          end
          item
            EditButtons = <>
            FieldName = 'SCRQ'
            Footers = <>
            Title.Caption = 'SCRQ|'#29983#29986#19978#32218
            Width = 72
          end
          item
            EditButtons = <>
            FieldName = 'DDLB'
            Footers = <>
            Title.Caption = 'DDLB|'#39006#21029
            Width = 50
          end
          item
            EditButtons = <>
          ...
          item
            ...
            FieldName = 'Totals'
            Footers = <>
            Title.Caption = 'Totals|'#32317#37329#38989' '
          end
          item
            EditButtons = <>
            FieldName = 'CQDH'
            Footers = <>
            Title.Caption = 'CQDH|'#24288#21312
            Width = 55
          end
          item
            Color = clBtnFace
  ...
  object XXZL: TQuery
    ...
    SQL.Strings = (
        ...
        'select XXZL.XieXing,XXZL.SheHao,XXZL.Article,XXZLSVN.VNBOM,XXZL.' +
        'YSSM,CQDH'
  ...
  object XXZLSVN: TQuery
    ...
    object XXZLSVNCQDH: TStringField
      FieldName = 'CQDH'
      FixedChar = True
      Size = 4
    end
  ...
  object UpXXZLSVN: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  CQDH=:OLD_CQDH')
    InsertSQL.Strings = (
      'insert into LIY_DD.dbo.XXZLSVN'
      
        '  (XieXing, SheHao, BWBH, CQDH,CLBH, CSBH, CLSL, USERID, USERDAT' +
        'E,YN)'
      'values'
      
        '  (:XieXing, :SheHao, :BWBH,:CQDH, :CLBH, :CSBH, :CLSL, :USERID,' +
        ':USERDATE, :YN)')
    DeleteSQL.Strings = (
      'delete from LIY_DD.dbo.XXZLSVN'
      'where'
      '  XieXing = :OLD_XieXing and'
      '  SheHao = :OLD_SheHao and'
      '  BWBH = :OLD_BWBH and'
  ...
  object DDZLQry: TQuery
    ...
    SQL.Strings = (
        ...
        'S,XXZLSVN.VNBOM,ZLZLS3.USERDATE as CalDate '
      ...
      'LEFT JOIN LIY_DD.dbo.kfzl kfzl ON DDZL.KHDH = kfzl.kfdh'
        ...
        'om LIY_DD.dbo.XXZLSVN XXZLSVN ) XXZLSVN '
      
        '            on XXZLSVN.XieXing=DDZL.XieXing and XXZLSVN.SheHao=D' +
        'DZL.SheHao'
      
        'left join ( select top 1.* from LIY_DD.dbo.ZLZLS3  ZLZLs3  where' +
        ' LEFT(ZLZLS3.cldh,1)<>'#39'V'#39'   ) ZLZLS3'
      #9'on ZLZLS3.DDBH=DDZL.DDBH'
    ...
    object DDZLQryCalDate: TStringField
      FieldName = 'CalDate'
      FixedChar = True
      Size = 17
    end
