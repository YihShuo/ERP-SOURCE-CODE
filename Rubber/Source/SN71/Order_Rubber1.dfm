object Order_Rubber: TOrder_Rubber
  Left = 192
  Top = 125
  Width = 674
  Height = 480
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select DDZL.DDBH,DDZL.CQDH,DDZL.Pairs,isnull(RK.OKQty,0) as OKQt' +
        'y,DDZL.Pairs - isnull(RK.OKQty,0) as RKQty '
      'from LIY_DD.dbo.DDZL DDZL  '
      
        'left join (select DDBH, sum(Qty) as OKQty from LIY_DD.dbo.OUTSOL' +
