object ScanInRevise: TScanInRevise
  Left = 218
  Top = 136
  Width = 1174
  Height = 484
  Caption = 'ScanInRevise'
  Color = clBtnFace
  ...
  object workscanQry: TQuery
    AfterOpen = workscanQryAfterOpen
    DatabaseName = 'DB'
    SQL.Strings = (
      'select workscan.* from LIY_DD.dbo.workscan workscan'
      
        'where  convert(smalldatetime,convert(varchar,workscan.scandate,1' +
        '11)) between '
      '      '#39'2020/07/14'#39' and '#39'2020/07/21'#39
      '      and workscan.InOut='#39'I'#39)
    UpdateObject = upwsan
    Left = 72
    Top = 360
    ...
    object workscanQryScanDate: TDateTimeField
      FieldName = 'ScanDate'
    end
    ...
    object workscanQrymjname: TStringField
      FieldKind = fkLookup
      FieldName = 'mjname'
    ...
    object workscanQrycolorname: TStringField
      DisplayWidth = 100
      FieldKind = fkLookup
      FieldName = 'colorname'
  ...
  object upwsan: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  ProNo = :OLD_ProNo')
    InsertSQL.Strings = (
      'insert into LIY_DD.dbo.workscan'
      
        '  (CodeBar , ScanDate, InOut, Class , WorkID, MJBH, ColorNo, Siz' +
        'e, DDBH, Qty, UserID, UserDate, YN)'
      'values'
      
        '  (:CodeBar , :ScanDate, :InOut, :Class , :WorkID, :MJBH, :Color' +
        'No, :Size, :DDBH, :Qty, :UserID, :UserDate, :YN)')
    DeleteSQL.Strings = (
      'delete from LIY_DD.dbo.workscan'
      'where'
      '  ProNo = :OLD_ProNo ')
    Left = 72
    Top = 391
