...
begin
  ...
  begin
    try
      ...
      ComNameCH:=MyIni.ReadString('ERP','ComNameCH','货琄砫ヴΤそ');
...
begin
  ...
  if length(sMonth)=1 then
    sMonth:='0'+sMonth;
  L1.Caption:='BANG KIEM KE THANH PHAM NAM - CONG TY TNHH TY BACH';
  QRLabel19.Caption:='货琭砫ヴそΘ珇絃翴';
  QRLabel28.Caption:='Xuong 紅: '+ QRReport.CKBHEdit.Text;
  QRLabel37.Caption:='Bo phan 场: B_Sinh Quan';
  QRLabel35.Caption:='So khu 跋办腹絏 : '+ QRReport.KVBHEdit.Text;
  //
  ...
  if length(Day1)=1 then
    Day1:='0'+Day1;
  QRLabel36.Caption:='Ngayら '+'25'+' thangる '+Month1+' nam '+Year1;
end;
