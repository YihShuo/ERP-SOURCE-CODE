object OutsoleOutWarehouse: TOutsoleOutWarehouse
  Left = 359
  Top = 185
  Width = 928
  Height = 480
  Caption = 'OutsoleOutWarehouse'
  Color = clBtnFace
  ...
  object Query1: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select LLNO,DDBH,GSBH,Qty,LLDate,USERID,USERDATE,YN'
      'from LIY_DD.dbo.OUTSOLE_LL'
      'where 1=2')
  ...
  object UpdateSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  DDBH = :OLD_DDBH')
    InsertSQL.Strings = (
      'insert into  TB_DD.dbo.OUTSOLE_LL'
      '  (LLNO, DDBH, GSBH, Qty, LLDate, USERID, USERDATE,YN)'
      'values'
      '  (:LLNO, :DDBH, :GSBH, :Qty, :LLDate, :USERID, :USERDATE,:YN)')
    DeleteSQL.Strings = (
      'delete from  TB_DD.dbo.OUTSOLE_LL'
      'where'
      '  LLNO = :OLD_LLNO and'
      '  DDBH = :OLD_DDBH')
    Left = 376
