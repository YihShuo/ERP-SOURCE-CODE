object EmbroiderSend: TEmbroiderSend
  Left = 269
  Top = 173
  Width = 870
  Height = 500
  Caption = 'EmbroiderSend'
  Color = clBtnFace
  ...
  object DXBW: TQuery
    AfterOpen = DXBWAfterOpen
    DatabaseName = 'DB'
    DataSource = DS1
    SQL.Strings = (
      'select DXBW.*,BWZL.YWSM'
      'from DXBW'
      'left join BWZL on BWZl.BWDH=DXBW.BWBH'
  ...
  object DXXX: TQuery
    ...
    SQL.Strings = (
      ...
      'DDZLS.Quantity as Qty,DXXX.DXBH'
      ' from DDZLS'
      'left join XXZLS3  on  XXZLS3.XieXing=:XieXing'
      'left join DXXX on DXXX.lineNum=XXZLS3.LineNum')
    Left = 624
    Top = 322
    ParamData = <
      item
    ...
    object DXXXDDBH: TStringField
      FieldName = 'DDBH'
      FixedChar = True
      Size = 15
    end
    object DXXXDDCC: TStringField
      FieldName = 'DDCC'
      FixedChar = True
      Size = 6
    end
    object DXXXXXCC: TStringField
      FieldName = 'XXCC'
      FixedChar = True
      Size = 6
    end
    object DXXXQty: TIntegerField
      FieldName = 'Qty'
      DisplayFormat = '##,#0.0'
    end
  ...
  object SpecMas: TQuery
    ...
    SQL.Strings = (
        ...
        'ZL.DDZT,'
      'SCZL.Qty as Qty,DDZL.Article,DDZL.ShipDate,XXZL.CCGB as XXCC,'
      'DXDD.ZSBH,ZSZL.ZSYWJC,DDZL.CCGB as DDCC,XXZL.XieMing'
      'from SCZL'
      ...
      'left join DDZL  on ZLZL.DDBH=DDZL.DDBH'
        ...
        'L.SheHao'
      'left join DXDD on DXDD.ZLBH=ZLZL.ZLBH'
      'left join ZSZL on ZSZL.ZSDH=DXDD.ZSBH'
      'order by SCZL.SCBH')
    UpdateObject = UpSQL1
    Left = 136
    Top = 216
    ...
    object SpecMasZSBH: TStringField
      FieldName = 'ZSBH'
      FixedChar = True
      Size = 6
    end
    object SpecMasZSYWJC: TStringField
      FieldName = 'ZSYWJC'
      FixedChar = True
    end
  end
