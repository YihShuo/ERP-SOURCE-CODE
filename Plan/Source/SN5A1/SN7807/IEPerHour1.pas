...
begin
  ...
  begin
    ...
    sql.Add('(PerDay.TotQty-SCBZCL1.IEPlanQty) as Variance1,(PerDay.TotQty-SCBZCL.PlanQty) as Variance2,');
    sql.Add('case when isnull(PerDay.TotQty,0)<>0 then round(isnull(SCBZCL1.IEPlanQty*100.0,0)/isnull(PerDay.TotQty,0),0) end Percent1,');
    sql.Add('case when isnull(PerDay.TotQty,0)<>0 then round(isnull(SCBZCL.PlanQty*100.0,0)/isnull(PerDay.TotQty,0),0) end Percent2');
