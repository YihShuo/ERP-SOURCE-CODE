object Departmenttype: TDepartmenttype
  Left = 301
  Top = 198
  Width = 870
  Height = 500
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select BDepartment.*,case when GXC.GXLB is not null then '#39'Yes'#39' e' +
        'lse '#39'0'#39' end as C, '
      ...
      'from BDepartment'
        ...
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'C'#39') GXC'
      '             on GXC.DepNo=BDepartment.ID'
      
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'S'#39') GXS'
      '             on GXS.DepNo=BDepartment.ID'
      
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'O'#39') GXO'
      '             on GXO.DepNo=BDepartment.ID'
      
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'A'#39') GXA'
      '             on GXA.DepNo=BDepartment.ID'
      
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'W'#39') GXW'
      '             on GXW.DepNo=BDepartment.ID'
      
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'I'#39') GXI'
      '             on GXI.DepNo=BDepartment.ID'
      
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'Y'#39') GXY'
      '             on GXY.DepNo=BDepartment.ID'
      
        'left join (select SCBMGX.DepNo,SCBMGX.GXLB from SCBMGX where SCB' +
        'MGX.GXLB='#39'Z'#39') GXZ'
      '             on GXZ.DepNo=BDepartment.ID'
    ...
    object Query1A: TStringField
      FieldName = 'A'
      FixedChar = True
      Size = 3
    end
    object Query1O: TStringField
      FieldName = 'O'
      FixedChar = True
      Size = 3
    end
    object Query1W: TStringField
      FieldName = 'W'
      FixedChar = True
      Size = 3
    end
    object Query1I: TStringField
      FieldName = 'I'
      FixedChar = True
      Size = 3
    end
    object Query1Y: TStringField
      FieldName = 'Y'
      FixedChar = True
      Size = 3
    end
    object Query1Z: TStringField
      FieldName = 'Z'
      FixedChar = True
      Size = 3
    end
  ...
  object UpSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '  (ID, DepName, DepMemo, ProYN, UserID, UserDate, YN)'
      'values'
      '  (:ID, :DepName, :DepMemo, :ProYN, :UserID, :UserDate, :YN)')
    DeleteSQL.Strings = (
