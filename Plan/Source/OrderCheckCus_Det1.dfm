object OrderCheckCus_Det: TOrderCheckCus_Det
  Left = 318
  Top = 224
  Width = 783
  Height = 380
  BorderIcons = [biSystemMenu]
  Caption = 'OrderCheckCus_Det'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'from  (select #SCBBSCus.DDBH,#SCBBSCus.XXCC,#SCBBSCus.Qty '
      '          from #SCBBSCus'
      '          left join DDZL on DDZL.DDBH=#SCBBSCus.DDBH '
      '          left join KFZL on KFZL.KFDH=DDZL.KHBH       '
      
        '          where  #SCBBSCus.GX='#39'L'#39'       and isnull(KFZL.KFJC,'#39#39')' +
        '=:KFJC       ) ZL'
      ...
      '               from #SCBBSCus  '
        ...
        '               where  #SCBBSCus.GX='#39'C'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCus  '
        ...
        '               where #SCBBSCus.GX='#39'Z'#39'                group by DD' +
        'BH,XXCC'
      ...
      '               from #SCBBSCus  '
        ...
        '               where  #SCBBSCus.GX='#39'W'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCus  '
        ...
        '               where  #SCBBSCus.GX='#39'O'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCus  '
        ...
        '               where  #SCBBSCus.GX='#39'A'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCus  '
        ...
        '               where  #SCBBSCus.GX='#39'F'#39'                group by D' +
        'DBH,XXCC'
  ...
  object PrintDBGridEh1: TPrintDBGridEh
    ...
    BeforeGridText_Data = {
      ...
      3032385C66305C6673313620255B437573746F6D65725D0D0A5C706172207D0D
      0A00}
  end
