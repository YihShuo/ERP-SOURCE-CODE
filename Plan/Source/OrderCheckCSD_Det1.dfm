object OrderCheckCSD_Det: TOrderCheckCSD_Det
  Left = 359
  Top = 221
  Width = 779
  Height = 397
  BorderIcons = [biSystemMenu]
  Caption = 'OrderCheckCSD_Det'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'from  (select #SCBBSCSD.DDBH,#SCBBSCSD.XXCC,#SCBBSCSD.Qty '
      '          from #SCBBSCSD'
      '          left join DDZL on DDZL.DDBH=#SCBBSCSD.DDBH    '
      '          left join KFZL on KFZL.KFDH=DDZL.KHBH  '
      
        '          where  #SCBBSCSD.GX='#39'L'#39'       and convert(smalldatetim' +
        'e,convert(varchar,DDZL.ShipDate,111))=:CSD   and  KFZL.KFJC=:KFJ' +
        'C   ) ZL'
      ...
      '               from #SCBBSCSD  '
        ...
        '               where  #SCBBSCSD.GX='#39'C'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCSD  '
        ...
        '               where #SCBBSCSD.GX='#39'Z'#39'                group by DD' +
        'BH,XXCC'
      ...
      '               from #SCBBSCSD  '
        ...
        '               where  #SCBBSCSD.GX='#39'W'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCSD  '
        ...
        '               where  #SCBBSCSD.GX='#39'O'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCSD  '
        ...
        '               where  #SCBBSCSD.GX='#39'A'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCSD  '
        ...
        '               where  #SCBBSCSD.GX='#39'F'#39'                group by D' +
        'DBH,XXCC'
  ...
  object PrintDBGridEh1: TPrintDBGridEh
    ...
    BeforeGridText_Data = {
      ...
      3032385C66305C6673313620255B4353445D0D0A5C706172207D0D0A00}
  end
