...
begin
if ((main.Edit1.text ='313761') or (main.Edit1.text = '321221') or (main.Edit1.text = '316503')) then
 delete.Visible := true;
  delete1.Visible := true;
end;

procedure TSMDDSS2.delete1Click(Sender: TObject);
begin


  if Trim(Edit2.Text) = '' then
  begin
    ShowMessage('Vui long nhap barcode truoc khi xoa!');
    Edit2.SetFocus;
    Exit;
  end;
  ...
  begin
    ...
    begin
      ...
      SQL.Add('CAST(ISNULL(okcts, '''') AS VARCHAR), ');
      SQL.Add('userid, :p_edit, GETDATE()');
      SQL.Add('FROM smddss WHERE CODEBAR = :p_CODEBAR');

      // Gan gia tri tham so (bao gom ca CB1)
      ParamByName('p_CODEBAR').AsString := Edit2.Text;
      ParamByName('p_edit').AsString := Main.Edit1.Text;
      ExecSQL;
      ...
      Close;
      SQL.Clear;
      SQL.Add('DELETE FROM smddss WHERE CODEBAR = :p_CODEBAR');
