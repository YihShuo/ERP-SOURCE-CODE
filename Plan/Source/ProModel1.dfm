object ProModel: TProModel
  ...
  object XXZL: TQuery
    ...
    SQL.Strings = (
        ...
        'select XXZLVN.*,KFZL.KFJC,XXZL.YSSM,XXZl.Article,XXZL.BZCC,XXZL.' +
        'XieXing,XXZl.SheHao,'
      
        '       XXZL.CCGB,XXZL.XTMH,XXZl.DDMH,XXZL.MDMH,XXZL.DAOMH,XXZL.I' +
        'MGName,XXZLVN.XieXing as oldXieXing'
      'from XXZL'
      'left join KFZL on KFZl.KFDH=XXZl.KHDH  '
      
        'left join XXZLVN on XXZL.XieXing=XXZLVN.XieXing and XXZl.SheHao=' +
        'XXZLVN.Shehao '
      'where XXZL.YN='#39'1'#39
      'order by XXZL.XieXing,XXZL.SheHao')
    UpdateObject = UpSQL1
    Left = 280
    Top = 200
    object XXZLXieXing_1: TStringField
      FieldName = 'XieXing_1'
      FixedChar = True
      Size = 15
    end
    object XXZLSheHao_1: TStringField
      FieldName = 'SheHao_1'
      FixedChar = True
      Size = 5
    end
    ...
    object XXZLYN: TStringField
      FieldName = 'YN'
      FixedChar = True
      Size = 1
    end
    object XXZLoldXieXing: TStringField
      FieldName = 'oldXieXing'
      FixedChar = True
      Size = 15
    end
  end
  ...
  object UpSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into XXZLVN'
      '  (XieXing, SheHao, Model, USERID, USERDate, YN)'
      'values'
      '  (:XieXing, :SheHao, :Model, :USERID, :USERDate, :YN)')
    DeleteSQL.Strings = (
      'delete from XXZLVN'
