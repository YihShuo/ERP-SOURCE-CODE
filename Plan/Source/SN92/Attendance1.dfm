object Attendance: TAttendance
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      item
        EditButtons = <>
        FieldName = 'HRDepartment'
        Footers = <>
        ReadOnly = True
        Title.Caption = 'HR|Department'
        Width = 100
      end
      item
        EditButtons = <>
      ...
      item
        ...
        Footers = <>
        ReadOnly = True
        Title.Caption = 'HR|Working Hours'
        Width = 100
      end
      item
        EditButtons = <>
        ...
        Footers = <>
        ReadOnly = True
        Title.Caption = 'HR|Overtime'
      end
      item
        EditButtons = <>
        FieldName = 'LaborType_HR'
        Footers = <>
        Title.Caption = 'HR|LaborType_HR'
        Width = 120
      end
      item
        Color = clYellow
  ...
  object Query1: TQuery
    ...
    object Query1WorkingHours: TFloatField
      FieldName = 'WorkingHours'
    end
    object Query1Overtime: TFloatField
      FieldName = 'Overtime'
    end
    object Query1Department2: TStringField
      FieldName = 'Department'
      Size = 30
    end
    ...
    object Query1LaborType_HR: TStringField
      FieldName = 'LaborType_HR'
    end
  end
