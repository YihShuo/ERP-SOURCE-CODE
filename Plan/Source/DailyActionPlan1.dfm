object DailyActionPlan: TDailyActionPlan
  Left = 225
  Top = 127
  Width = 969
  Height = 500
  Caption = 'DailyActionPlan'
  Color = clBtnFace
    ...
    object DBGrid1: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          FieldName = 'Lack_Qty'
          Footers = <>
          Title.Caption = #35336#21123#29986#37327#27424#25976'|Lack_Qty'
          Width = 84
        end
        item
          EditButtons = <>
          FieldName = 'Person'
          Footers = <>
          Title.Caption = #35336#21123#36948#25104#29575'|Person'
          Width = 82
        end
        item
          EditButtons = <>
          FieldName = 'SCGS'
          Footers = <>
          Title.Caption = #35336#21123#19978#29677#26178#25976'|SCGS'
          Width = 96
        end
        item
          EditButtons = <>
          FieldName = 'SDGS'
          Footers = <>
          Title.Caption = #23526#38555#19978#29677#26178#25976'|SDGS'
          Visible = False
          Width = 87
        end>
    end
  ...
  object scbbs: TQuery
    ...
    SQL.Strings = (
      'select convert(varchar,SCBB.SCDate,111) as SCDate,SCBB.ProNo,'
        ...
        'LB,'
      '         isnull(SCBBS.Qty,0) as ProQty,DDZL.Article'
      'from SCBB'
    ...
    object scbbsArticle: TStringField
      FieldName = 'Article'
      FixedChar = True
    end
  end
  ...
  object PrintDBGridEh1: TPrintDBGridEh
    ...
    BeforeGridText_Data = {
      ...
      3032385C66305C6673313620255B646174655D2020200D0A5C706172207D0D0A
      00}
  end
end
