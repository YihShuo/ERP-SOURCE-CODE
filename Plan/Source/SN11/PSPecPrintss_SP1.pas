...
begin
 if main.Edit2.Text='VDT' then
  begin
     PSpecPrintss_SP.QRLabel4.Caption:='ISO NO : DT-SQ-022A(ERP)';
     PSpecPrintss_SP.QRLabel22.Caption:='ISO NO : DT-SQ-022A(ERP)';
  end else
  begin
     PSpecPrintss_SP.QRLabel4.Caption:='ISO NO : T-KH-QP007-01A (ERP)';
     PSpecPrintss_SP.QRLabel22.Caption:='ISO NO : T-KH-QP007-01A (ERP)';
  end;
end;
