  ...
  object QMatList: TQuery
    ...
    SQL.Strings = (
      ...
      'union all'
        ...
        'Select zlzls2.xh,ZLZLS2.bwbh+'#39'-'#39' as bwbh,clzhzl.cldh1 as clbh,ma' +
        'x(zlzls2.mjbh) AS mjbh ,'
      '              temp.clsl,temp.USAGE,'#39'-----'#39' AS BWMCY ,'
      
        '              max(CLZL.ywpm) AS CLMCY ,max(CLZL.dwbh) AS dwbh,XX' +
        'ZLS.LOSS  ,CLZL.CQDH,XXZLS.JGYWSM'
      '              ,XXZLS.CCQQ,XXZLS.CCQZ'
      'from zlzls2 inner join clzhzl on zlzls2.clbh=clzhzl.cldh'
      'LEFT JOIN BWZL AS BWZL ON ZLZLS2.BWBH = BWZL.bwdh '
      'LEFT JOIN CLZL AS CLZL ON clzhzl.cldh1 = CLZL.cldh '
      'LEFT JOIN DDZL AS DDZL ON ZLZLS2.ZLBH = DDZL.ZLBH '
      'LEFT JOIN XXZLS AS XXZLS ON DDZL.XIEXING = XXZLS.XIEXING '
        ...
        'left join ( select bwbh,clbh,(sum(zlzls2.clsl)/ddzl.pairs) AS US' +
        'AGE,sum(zlzls2.clsl) AS clsl'
      
        #9#9#9'from zlzls2 left join ddzl on zlzls2.zlbh=ddzl.ddbh where zlz' +
        'ls2.zlbh=:ZLBH'
      #9#9#9'group by bwbh,clbh,ddzl.pairs) temp'
      'on temp.clbh=clzhzl.cldh1  and temp.bwbh=zlzls2.bwbh   '
      'where ZLZLS2.ZLBH=:ZLBH and ZLZLS2.MJBH='#39'ZZZZZZZZZZ'#39
      
        'GROUP BY ZLZLS2.XH,zlzls2.zlbh,zlzls2.bwbh,clzhzl.cldh1,XXZLS.CL' +
        'SL,CLZL.CQDH,XXZLS.LOSS,XXZLS.JGYWSM ,XXZLS.CCQQ,XXZLS.CCQZ,temp' +
        '.USAGE,temp.clsl'
      ')zlzls2'
