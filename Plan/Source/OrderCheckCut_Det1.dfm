object OrderCheckCut_Det: TOrderCheckCut_Det
  Left = 317
  Top = 218
  Width = 781
  Height = 392
  BorderIcons = [biSystemMenu]
  Caption = 'OrderCheckCut_Det'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'from  (select #SCBBSCut .DDBH,#SCBBSCut .XXCC,#SCBBSCut .Qty '
      '          from #SCBBSCut'
      
        '          left join XXZL on XXZL.XieXing= #SCBBSCut.XieXing and ' +
        'XXZL.SheHao= #SCBBSCut.SheHao'
      
        '          where  #SCBBSCut.GX='#39'L'#39' and isnull(XXZL.DaoMH,'#39#39')=:Dao' +
        'MH '
      '          ) ZL'
      ...
      '               from #SCBBSCut  '
        ...
        '               where  #SCBBSCut.GX='#39'C'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCut  '
        ...
        '               where #SCBBSCut.GX='#39'Z'#39'                group by DD' +
        'BH,XXCC'
      ...
      '               from #SCBBSCut  '
        ...
        '               where  #SCBBSCut.GX='#39'W'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCut  '
        ...
        '               where  #SCBBSCut.GX='#39'O'#39'               group by DD' +
        'BH,XXCC'
      ...
      '               from #SCBBSCut  '
        ...
        '               where  #SCBBSCut.GX='#39'S'#39'                group by D' +
        'DBH,XXCC'
      ...
      '               from #SCBBSCut  '
        ...
        '               where  #SCBBSCut.GX='#39'A'#39'                group by D' +
        'DBH,XXCC'
  ...
  object PrintDBGridEh1: TPrintDBGridEh
    ...
    BeforeGridText_Data = {
      ...
      3032385C66305C6673313620255B4375744469655D0D0A5C706172207D0D0A00}
  end
