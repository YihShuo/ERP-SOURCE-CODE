...
var
  OrderCheckCus: TOrderCheckCus;

implementation

uses main1, OrderCheckCus_Det1;

{$R *.dfm}

procedure TOrderCheckCus.FormDestroy(Sender: TObject);
begin
OrderCheckCus:=nil;
end;

procedure TOrderCheckCus.FormClose(Sender: TObject;
...
with QTemp do
  begin
    active:=false;
    sql.Clear;
    sql.add('  if object_id('+''''+'tempdb..#SCBBSCus'+''''+') is not null  ');
    sql.add('begin   drop table #SCBBSCus end   ');
    execsql;
  end;
action:=cafree;
end;

procedure TOrderCheckCus.FormCreate(Sender: TObject);
var i:integer;
NDate:TDate;
begin
with Qtemp do
...
procedure TOrderCheckCus.Panel3DblClick(Sender: TObject);
begin
...
procedure TOrderCheckCus.Panel2DblClick(Sender: TObject);
begin
...
procedure TOrderCheckCus.N2Click(Sender: TObject);
begin
...
procedure TOrderCheckCus.N1Click(Sender: TObject);
begin
...
procedure TOrderCheckCus.Print1Click(Sender: TObject);
begin

PrintDBGrideh1.Preview;
end;

procedure TOrderCheckCus.NN2Click(Sender: TObject);
...
procedure TOrderCheckCus.Button1Click(Sender: TObject);
var i:integer;
begin
with QTemp do
  begin
    ...
    sql.add('into #SCBBSCus from SCBBSS ');
...
with query1 do
  begin
    active:=false;
    sql.clear;
    sql.add('select KFJC,sum(Pairs) as Pairs,sum(C_Qty) as C_Qty,sum(Lack_C) as Lack_C');
    ...
    sql.add('left join (select #SCBBSCus.DDBH,sum(#SCBBSCus.Qty) as C_Qty,max(#SCBBSCus.FinDate) as FinDate ');
    sql.add('           from #SCBBSCus ');
    sql.add('           where #SCBBSCus.GX='+''''+'C'+'''');
    sql.add('           group by #SCBBSCus.DDBH) SCBBC on SCBBC.DDBH=DDZL.ZLBH ');
    sql.add('left join (select #SCBBSCus.DDBH,sum(#SCBBSCus.Qty) as S_Qty,max(#SCBBSCus.FinDate) as FinDate ');
    sql.add('           from #SCBBSCus ');
    sql.add('           where #SCBBSCus.GX='+''''+'S'+'''');
    sql.add('           group by #SCBBSCus.DDBH) SCBBS on SCBBS.DDBH=DDZL.ZLBH ');
    sql.add('left join (select #SCBBSCus.DDBH,sum(#SCBBSCus.Qty) as W_Qty ,max(#SCBBSCus.FinDate) as FinDate');
    sql.add('           from #SCBBSCus ');
    sql.add('           where #SCBBSCus.GX='+''''+'W'+'''');
    sql.add('           group by #SCBBSCus.DDBH) SCBBW on SCBBW.DDBH=DDZL.ZLBH ');
    sql.add('left join (select #SCBBSCus.DDBH,sum(#SCBBSCus.Qty) as O_Qty ,max(#SCBBSCus.FinDate) as FinDate');
    sql.add('           from #SCBBSCus ');
    sql.add('           where #SCBBSCus.GX='+''''+'O'+'''');
    sql.add('           group by #SCBBSCus.DDBH) SCBBO on SCBBO.DDBH=DDZL.ZLBH ');
    sql.add('left join (select #SCBBSCus.DDBH,sum(#SCBBSCus.Qty) as Z_Qty ,max(#SCBBSCus.FinDate) as FinDate');
    sql.add('           from #SCBBSCus ');
    sql.add('           where #SCBBSCus.GX='+''''+'Z'+'''');
    sql.add('           group by #SCBBSCus.DDBH) SCBBZ on SCBBZ.DDBH=DDZL.ZLBH ');
    sql.add('left join (select #SCBBSCus.DDBH,sum(#SCBBSCus.Qty) as A_Qty ,max(#SCBBSCus.FinDate) as FinDate');
    sql.add('           from #SCBBSCus ');
    sql.add('           where #SCBBSCus.GX='+''''+'A'+'''');
    sql.add('           group by #SCBBSCus.DDBH) SCBBA on SCBBA.DDBH=DDZL.ZLBH ');
    sql.add('left join (select #SCBBSCus.DDBH,sum(#SCBBSCus.Qty) as F_Qty ,max(#SCBBSCus.FinDate) as FinDate');
    sql.add('           from #SCBBSCus ');
    sql.add('           where #SCBBSCus.GX='+''''+'F'+'''');    
    sql.add('           group by #SCBBSCus.DDBH) SCBBF on SCBBF.DDBH=DDZL.ZLBH ');
...
procedure TOrderCheckCus.DBGrid1GetCellParams(Sender: TObject;
...
procedure TOrderCheckCus.NN1Click(Sender: TObject);
begin

OrderCheckCus_Det:=TOrderCheckCus_Det.create(self);
OrderCheckCus_Det.show;
end;

procedure TOrderCheckCus.PrintDBGridEh1BeforePrint(Sender: TObject);
begin  
if panel2.Visible then
