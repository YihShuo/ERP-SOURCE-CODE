object ScankeyIn: TScankeyIn
  ...
  object SMZL: TQuery
    ...
    DatabaseName = 'DB'
    SQL.Strings = (
      'select SMZL.*,BDepartment.DepName,SMDDSS.DDBH,SMDDSS.GXLB'
      '         ,SMDDSS.XXCC,SMDDSS.XH,SMDDSS.Qty,SMDDSS.CTS as oldCTS'
      'from SMZL '
      'left join BDepartment on BDepartment.ID=SMZL.DepNo '
      'left join SMDDSS on SMDDSS.CODEBAR=SMZL.CODEBAR '
      
        'where  convert(smalldatetime,convert(varchar,SMZL.ScanDate,111))' +
        ' between '
      '      '#39'2009/09/16'#39' and '#39'2009/09/19'#39
  ...
  object UpSMZL: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into SMZL'
      '  (CODEBAR, CTS, DepNO, ScanDate, USERDATE, USERID, YN, SB)'
      'values'
      
        '  ( :CODEBAR, :CTS, :DepNO, :ScanDate, :USERDATE, :USERID, :YN, ' +
        ':SB)')
    DeleteSQL.Strings = (
      'delete from SMZL'
      'where'
  ...
  object SMDDSSOther: TQuery
    ...
    DataSource = DS1
    SQL.Strings = (
      'select SMDDSS.DDBH,sum(SMDDSS.okCTS*SMDDSS.Qty) as okQty'
      'from SMDDSS'
      
        'left join SMDD on SMDD.DDBH=SMDDSS.DDBH and SMDD.SCCX=SMDDSS.GXL' +
        'B'
  ...
  object SMZL2: TQuery
    ...
    object SMZL2SMNO: TFloatField
      FieldName = 'SMNO'
    end
    object SMZL2CODEBAR: TStringField
      FieldName = 'CODEBAR'
      FixedChar = True
    end
    object SMZL2CTS: TIntegerField
      FieldName = 'CTS'
    end
    object SMZL2DepNO: TStringField
      FieldName = 'DepNO'
      FixedChar = True
      Size = 10
    end
    object SMZL2ScanDate: TDateTimeField
      FieldName = 'ScanDate'
    end
    object SMZL2USERDATE: TDateTimeField
      FieldName = 'USERDATE'
    end
    object SMZL2USERID: TStringField
      FieldName = 'USERID'
      FixedChar = True
    end
    object SMZL2YN: TStringField
      FieldName = 'YN'
      FixedChar = True
      Size = 1
    end
    object SMZL2SB: TStringField
      FieldName = 'SB'
      FixedChar = True
      Size = 1
    end
    object SMZL2YSBH: TStringField
      FieldName = 'YSBH'
      FixedChar = True
      Size = 15
    end
    object SMZL2PRONO: TStringField
      FieldName = 'PRONO'
      FixedChar = True
      Size = 10
    end
    object SMZL2XXCC: TStringField
      FieldName = 'XXCC'
      FixedChar = True
      Size = 6
    end
    object SMZL2PerQty: TIntegerField
      FieldName = 'PerQty'
    end
    object SMZL2GXLB: TStringField
      FieldName = 'GXLB'
      FixedChar = True
      Size = 1
    end
