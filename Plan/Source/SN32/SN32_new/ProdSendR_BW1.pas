...
with query1 do
  begin
    ...
    sql.add('select zlzlS2.BWBH,BWZL.YWSM,zlzlS2.CLBH,CLZL.YWPM,CLZL.DWBH, ');
    sql.Add('       Case when DXXZLS.DDBH is null then XXZLS.CCQQ else DXXZLS.CCQQ end as CCQQ,');
    sql.Add('       Case when DXXZLS.DDBH is null then XXZLS.CCQZ else DXXZLS.CCQZ end as CCQZ ');
    sql.add('from zlzlS2');
    ...
    sql.add('group by zlzlS2.BWBH,BWZL.YWSM,zlzlS2.CLBH,CLZL.YWPM,CLZL.DWBH,XXZLS.CCQQ,XXZLS.CCQZ,DXXZLS.DDBH,DXXZLS.CCQQ,DXXZLS.CCQZ  ');
