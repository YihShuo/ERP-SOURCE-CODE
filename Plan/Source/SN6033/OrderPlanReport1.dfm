object OrderPlanReport: TOrderPlanReport
  Left = 436
  Top = 342
  Width = 979
  Height = 563
  Caption = 'Order Produce Plan Report '
  Color = clBtnFace
  ...
  object SMDD: TQuery
    AfterOpen = SMDDAfterOpen
    DatabaseName = 'DB'
    SQL.Strings = (
      
        'select SMDD.*,SCGXDY.MEMO,Bdepartment.DepName,XXZL.DAOMH,DDZL.Sh' +
        'ipDate as CSD,KFZL.KFJC,ywdd.etd,f.fpd,f.fped'
      'from SMDD'
      ...
      'left join KFZL on KFZL.KFDH=DDZL.KHBH '
        ...
        'left join (select ddbh,sccx,plandate as fpd,planedate as fped fr' +
        'om smdd) as f on f.ddbh=smdd.ddbh and f.sccx=smdd.gxlb'
