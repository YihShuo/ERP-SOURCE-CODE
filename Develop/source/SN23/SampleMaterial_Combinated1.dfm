object SampleMaterial_Combinated: TSampleMaterial_Combinated
  Left = 169
  Top = 161
  Width = 1045
  Height = 472
  Caption = 'SampleMaterial_Combinated'
  Color = clBtnFace
  ...
  object CLZHZLVN: TQuery
    ...
    SQL.Strings = (
      'select clzhzl.*,CLZL.ZWPM,CLZL.YWPM,CLZL.DWBH,zszl.zsjc'
      'from clzhzl'
    ...
    object CLZHZLVNcldh1: TStringField
      FieldName = 'cldh1'
      OnSetText = CLZHZLVNcldh1SetText
      FixedChar = True
      Size = 10
    end
