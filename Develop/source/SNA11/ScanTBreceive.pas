...
begin
  ...
  begin
    ...
    begin
      Active:=false;
      SQL.Clear;
      SQL.Add('select stage,shoetest.testno,ETC,Article,TBReceive,TBReceiveDate,lamination,Sublimation,E_embroidery,Printing,lamination_CRMTO,kietphong,Amico,Limao,Laser,DAJU,GCuserid,GCuserdate,shipDate,finish from shoetest');
    ...
    begin
      active:=false;
      SQL.Clear;
      SQL.Add(' Select ypdh From Shoetest  Where Testno='''+edit1.text+''' ');
      active:=true;
    end;
    button1.Click;
    ...
    begin
      ...
      begin
        ...
        SQL.Add('select stage,testno,Article,ETC,TBReceive,TBReceiveDate,lamination,Sublimation,E_embroidery,Printing,lamination_CRMTO,kietphong,Amico,Limao,Laser,DAJU,ShipDate,finish from shoetest where Testno='''+edit1.text+'''');
        Active:=true;
      end;
      //showmessage('Already');
      Edit1.Clear;
