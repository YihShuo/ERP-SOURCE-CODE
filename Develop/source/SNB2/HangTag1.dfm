object HangTag: THangTag
  Left = 731
  Top = 288
  Width = 1305
  Height = 675
  Caption = 'Sample shoe making Location'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select kfxxzl.jijie,kfxxzl.devcode,fd,xxzlkf.remarks,xxzlkf.xiex' +
        'ing,xxzlkf.shehao from kfxxzl'
      
        'left join xxzlkf on kfxxzl.xiexing=xxzlkf.xiexing and kfxxzl.she' +
        'hao=xxzlkf.shehao'
      'where 1=2'
      
        'group by kfxxzl.jijie,xxzlkf.remarks ,kfxxzl.devcode,fd,xxzlkf.x' +
        'iexing,xxzlkf.shehao')
  ...
  object UpdateSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'set'
      'remarks=:remarks'
      'where   XieXing= :OLD_XieXing and SheHao = :OLD_SheHao')
    Left = 105
    Top = 201
  end
