                ...
                begin
                  DelMas.delete;
                   ...
                   begin
                     ...
                     DelMas.fieldbyname('SCBH').Value:='DC' ;
          ...
          usinserted:
            begin  
              ...
              //億雄資料結構不同需加上去的東東
                       query2.Active:=false;
                       query2.sql.Clear;
                       query2.SQL.Add('select name from syscolumns ');
                       query2.SQL.Add('where id in(select id from sysobjects where name='+''''+'KCLLS'+''''+' ) ');
                       query2.SQL.Add('and name='+''''+'GSBH'+'''');
                       query2.Active:=true;
                       if query2.RecordCount > 0  then
                       begin
                          query2.Active:=false;
                          query2.SQL.Add('update KCLLS ');
                          query2.SQL.Add(' set gsbh='+''''+main.Edit2.Text+'''');
                          query2.SQL.Add('where llno='+''''+dbedit9.Text+'''');
                          query2.ExecSQL;
                       end;
                       query2.Active:=false;
              //億雄資料結構不同加上去的東東結束
