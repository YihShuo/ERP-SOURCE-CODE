  ...
  object CLZHZLVNGrid: TDBGridEh
    ...
    Columns = <
      item
        ...
        Font.Style = []
        Footers = <>
        Title.Caption = #27597#26448#26009'|Parent'
      end
      item
        EditButtons = <>
        FieldName = 'cldh1'
  ...
  object CLZHZLVN: TQuery
    ...
    SQL.Strings = (
      ...
      'LEFT JOIN zszl zszl_dev on clzhzl_dev.zsdh = zszl_dev.zsdh'
        ...
        'where clzhzl.cldh in ( select cldh1 from clzhzl,clzl where clzl.' +
        'cldh=clzhzl.cldh and Clzl.CLDH=:clbh and clzl.clzmlb='#39'Y'#39')'
      '')
    UpdateObject = UpSQL1
    Left = 144
    Top = 176
