object PMR_Internal: TPMR_Internal
  Left = 425
  Top = 228
  Width = 928
  Height = 638
  Caption = 'PMR_Internal'
  Color = clBtnFace
  ...
  object Q_PMRList: TQuery
    ...
    object Q_PMRListResponsibility: TStringField
      FieldName = 'Responsibility'
    ...
    object Q_PMRListBeforeChange: TStringField
      FieldName = 'BeforeChange'
      Size = 200
    end
    object Q_PMRListAfterChange: TStringField
      FieldName = 'AfterChange'
      Size = 200
    end
