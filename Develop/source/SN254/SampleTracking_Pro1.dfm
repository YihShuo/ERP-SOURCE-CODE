object SampleTracking_Pro: TSampleTracking_Pro
  Left = 213
  Top = 201
  Width = 985
  Height = 602
  Caption = 'SampleTracking_Pro'
  Color = clBtnFace
    ...
    object DBGridEh1: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          FieldName = 'CutExDate'
          Footers = <>
          Title.Caption = #35009#26039#23526#38555'|CutExDate'
          Width = 71
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'SteExDate'
          Footers = <>
          Title.Caption = #37341#36554#23526#38555'|SteExDate'
          Width = 69
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'AseExDate'
          Footers = <>
          Title.Caption = #25104#22411#23526#38555'|AseExDate'
          Width = 76
        end>
    end
  end
  ...
  object SPSCMas: TQuery
    ...
    SQL.Strings = (
        ...
        '  SPSCList.CutDate,(Select MAX(ExeDate) from SPSCRm A where A.SP' +
        'NO=SPSCList.SPNO and ItemNM='#39'CutExDate'#39') as CutExDate,'
      
        '  SPSCList.SteDate,(Select MAX(ExeDate) from SPSCRm A where A.SP' +
        'NO=SPSCList.SPNO and ItemNM='#39'SteExDate'#39') as SteExDate,'
      
        '  SPSCList.AseDate,(Select MAX(ExeDate) from SPSCRm A where A.SP' +
        'NO=SPSCList.SPNO and ItemNM='#39'AseExDate'#39') as AseExDate,'
    ...
    object SPSCMasCutDate: TDateTimeField
      FieldName = 'CutDate'
    end
    object SPSCMasCutExDate: TDateTimeField
      FieldName = 'CutExDate'
    end
    object SPSCMasSteDate: TDateTimeField
      FieldName = 'SteDate'
    end
    object SPSCMasSteExDate: TDateTimeField
      FieldName = 'SteExDate'
    end
    object SPSCMasAseDate: TDateTimeField
      FieldName = 'AseDate'
    end
    object SPSCMasAseExDate: TDateTimeField
      FieldName = 'AseExDate'
    end
  ...
  object SPSCDet: TQuery
    ...
    SQL.Strings = (
      ...
      'Left join SPSCRmS on SPSCRmS.LYBH=SPSCRm.LYBH'
        ...
        'where SPNO=:SPNO and RENO>0  and ((SPSCRm.ItemNM='#39'CutExDate'#39') or' +
        ' (SPSCRm.ItemNM='#39'SteExDate'#39') or (SPSCRm.ItemNM='#39'AseExDate'#39') )'
