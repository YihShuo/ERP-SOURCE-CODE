...
begin
      ...
      begin
        ...
        begin
           ...
           begin
             Active:=false;
             SQL.Clear;
             SQL.Add('Select cldh1 from CLZHZL where cldh1='''+CLZHZLVN.FieldByName('cldh1').AsString+''' and cldh='''+SampleMaterial.Query1.FieldByName('cldh').AsString+''' ');
             Active:=true;
             ...
             begin
               CLZHZLVN.edit;
               CLZHZLVN.FieldByName('cldh').Value:=SampleMaterial.Query1.FieldByName('cldh').AsString;
  ...
  begin
     ...
     if CLZHZLVN.RecordCount>0 then
        SQL.Add('Update CLZL Set CLZMLB=''Y'' where  cldh='''+SampleMaterial.Query1.FieldByName('cldh').AsString+''' ')
     else
        SQL.Add('Update CLZL Set CLZMLB=''N'' where  cldh='''+SampleMaterial.Query1.FieldByName('cldh').AsString+''' ');
     tmpQuery.ExecSQL;
  end;
