  ...
  begin
   with query1 do
    begin
      Active:=false;
      SQL.Clear;
      SQL.Add('select testno,Article,TBReceive,Finish,Complete from shoetest where Testno='''+edit1.text+'''  ');
      Active:=true;
    end;
...
begin
  if PageControl1.ActivePageIndex = 2 then begin
    ...
    begin
      ...
      SQL.Add('select testno,Article,TBReceive,finish,insole_get from shoetest where Testno='''+edit2.text+'''');
      Active:=true;
    end;
    Edit2.Clear;
  end
    ...
    begin
      ...
      SQL.Add('select testno,Article,TBReceive,Finish,lace_get from shoetest where Testno='''+edit3.text+'''');
      Active:=true;
    end;
    Edit3.Clear;
  end;
...
begin
  ...
  begin
    Active:=false;
    SQL.Clear;
    SQL.Add('select testno,Article,TBReceive,Finish,insole_get from shoetest where CONVERT(varchar(100), insole_get, 112) = CONVERT(varchar(100), GETDATE(), 112)');
    Active:=true;
  end;
end;
...
begin
  if PageControl1.ActivePageIndex = 0 then begin
    ...
    begin
      Active:=false;
      SQL.Clear;
      SQL.Add('select testno,Article,TBReceive,Finish,lace_get from shoetest where CONVERT(varchar(100), lace_get, 112) = CONVERT(varchar(100), GETDATE(), 112) ');
      Active:=true;
    end;
  end
