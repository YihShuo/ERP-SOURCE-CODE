  ...
  object Query2: TQuery
    ...
    SQL.Strings = (
      ''
        ...
        'select Testno,Article,TBReceive,Pending_S,StitchingDate,convert(' +
        'varchar, StitchingDate_first, 111) as StitchingDate_first from s' +
        'hoetest')
    Left = 316
    Top = 240
    ...
    object Query2StitchingDate_first: TStringField
