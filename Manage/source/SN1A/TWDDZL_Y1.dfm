object TWDDZL_Y: TTWDDZL_Y
  ...
  object DDZL_YQry: TQuery
    AfterOpen = DDZL_YQryAfterOpen
    DatabaseName = 'DB'
    SQL.Strings = (
      
        'Select DDZL_Y.*,DDZL.Article,case when DDZL.YN=1 then '#39'N'#39' else '#39 +
        'Y'#39' end as Finhish   from DDZL_Y '
      'Left join DDZL on DDZL.DDBH=DDZL_Y.DDBH '
      'where 1=1')
    UpdateObject = UpSQL1
    Left = 168
    Top = 144
    object DDZL_YQryDDBH: TStringField
      FieldName = 'DDBH'
      Origin = 'DB.DDZL_Y.DDBH'
      FixedChar = True
      Size = 15
    end
    object DDZL_YQryYN: TStringField
      FieldName = 'YN'
      Origin = 'DB.DDZL_Y.YN'
      FixedChar = True
      Size = 1
    end
    object DDZL_YQryDDBZ: TStringField
      FieldName = 'DDBZ'
      Origin = 'DB.DDZL_Y.DDBZ'
      FixedChar = True
      Size = 200
    end
    object DDZL_YQryUSERID: TStringField
      FieldName = 'USERID'
      Origin = 'DB.DDZL_Y.USERID'
      FixedChar = True
    end
    object DDZL_YQryUSERDATE: TStringField
      FieldName = 'USERDATE'
      Origin = 'DB.DDZL_Y.USERDATE'
      FixedChar = True
      Size = 8
    end
    object DDZL_YQryArticle: TStringField
      FieldName = 'Article'
      FixedChar = True
    end
    object DDZL_YQryFinhish: TStringField
      FieldName = 'Finhish'
      FixedChar = True
      Size = 1
    end
