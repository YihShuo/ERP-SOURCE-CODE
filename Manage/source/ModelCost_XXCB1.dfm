object ModelCost_XXCB: TModelCost_XXCB
  Left = 333
  Top = 190
  Width = 755
  Height = 449
  BorderIcons = [biSystemMenu]
  Caption = 'ModelCost_XXCB'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'union'
        ...
        'select #PF.XieXing,#PF.SheHao,'#39'Wchem'#39' as BWBH,substring(CLZLSL.C' +
        'LDHZ,2,15) as CLBH'
      '         ,sum(#PF.Qty*CLZLSL.CLYL/CLZL.TotKGs)/1000  as CLSL'
      'from #PF'
      'left join LIY_DD.dbo.CLZLSL  CLZLSL on CLZLSL.CLDH=#PF.CLDH '
      
        'left join LIY_DD.dbo.CLZL      CLZL     on CLZL.CLDH=#PF.CLDH an' +
        'd CLZL.CLLB='#39'V'#39
      'where #PF.XieXing=:XieXing'
      '          and #PF.SheHao=:SheHao'
      'group by #PF.XieXing,#PF.SheHao,substring(CLZLSL.CLDHZ,2,15)'
      'union'
      ...
      'left join BWZL on BWZL.BWDH=XXZLS.BWBH'
        ...
        'left join CWXXCBS on CWXXCBS.XieXing=XXZLS.XieXing  and CWXXCBS.' +
        'BWBH=XXZLS.BWBH'
      
        '                                   and CWXXCBS.SheHao=XXZLS.SheH' +
        'ao and CWXXCBS.SB='#39'2'#39
      'order by XXZLS.BWBH')
  ...
  object UpCWXXCBS: TUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      'values'
        ...
        '  (:XieXing, :SheHao, '#39'2'#39', :BWBH, :CLBH, :CLSL, :USPrice, getdat' +
