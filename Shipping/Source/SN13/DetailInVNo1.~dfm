object DetailInVNo: TDetailInVNo
  Left = 190
  Top = 158
  Width = 1746
  Height = 750
  ...
  object HGQuery: TQuery
    ...
    object HGQueryCNO: TStringField
      FieldName = 'CNO'
      Size = 15
    end
    object HGQueryHGPM: TStringField
      FieldName = 'HGPM'
      Size = 200
    end
    object HGQueryUnitC: TStringField
      FieldName = 'UnitC'
      Size = 40
    end
    ...
    object HGQueryNK1: TCurrencyField
      FieldName = 'NK1'
      DisplayFormat = '#0.000000'
    end
    object HGQueryTC1: TCurrencyField
      FieldName = 'TC1'
      DisplayFormat = '#0.000000'
    end
    object HGQueryHD1: TCurrencyField
      FieldName = 'HD1'
      DisplayFormat = '#0.000000'
    end
    object HGQueryKD1: TCurrencyField
      FieldName = 'KD1'
      DisplayFormat = '#0.000000'
    end
    object HGQueryH11: TCurrencyField
      FieldName = 'H11'
      DisplayFormat = '#0.000000'
    end
    object HGQueryRateNK: TFloatField
      FieldName = 'RateNK'
      DisplayFormat = '#,##0.00%'
    end
    object HGQueryRateTC: TFloatField
      FieldName = 'RateTC'
      DisplayFormat = '#,##0.00%'
    end
    object HGQueryRate: TFloatField
      FieldName = 'Rate'
      DisplayFormat = '#,##0.00%'
    end
    object HGQueryNQ: TCurrencyField
      FieldName = 'NQ'
      DisplayFormat = '#0.000000'
    end
    object HGQueryNKNQ: TCurrencyField
      FieldName = 'NKNQ'
      DisplayFormat = '#0.000000'
    end
  end
