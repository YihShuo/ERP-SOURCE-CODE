object MaHaiQuan_KD: TMaHaiQuan_KD
  Left = 192
  Top = 125
  Width = 928
  Height = 480
  Caption = 'MaHaiQuan_KD1'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select top 1000 CLZL.CLDH,CLKD.clbh,clzl.ywpm,clzl.dwbh,CLKD.HGB' +
        'H,CLKD.HGPM,CLKD.UNitC,CLKD.Ratec,CLKD.userid,CLKD.userdate,CLKD' +
        '.YN'
      'from CLZL'
      'left join CLKD1 CLKD on CLKD.clbh = CLZL.cldh'
      'Where 1=1'
      '       and clzl.ywpm like '#39'%%'#39
      'and CLKD.CLBH is not null'
      'order by CLKD.clbh')
