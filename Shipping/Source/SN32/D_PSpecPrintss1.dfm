object D_PSpecPrintss: TD_PSpecPrintss
  Left = 222
  Top = 353
  Width = 1116
  Height = 590
  HorzScrollBar.Position = 2200
  Caption = 'D_PSpecPrintss'
  Color = clBtnFace
  ...
  object QMatList: TQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'select zlzls2.ZLBH,zlzls2.XH,zlzls2. bwbh, zlzls2.clbh, zlzls2.m' +
        'jbh,zlzls2.clsl,'
      
        #9#9'zlzls2.usage, zlzls2.BWMCY, zlzls2.CLMCY, zlzls2.dwbh, zlzls2.' +
        'LOSS,zlzls2.CQDH, zlzls2.JGYWSM,zlzls2.XieXing, zlzls2.Shehao,zl' +
        'zls2.CCQQ, zlzls2.CCQZ'
      'into #Material'
      'from ('
      
        'SELECT zlzls2.ZLBH,ZLZLS2.XH,ZLZLS2.bwbh ,zlzls2.clbh AS clbh ,m' +
        'ax(zlzls2.mjbh) AS mjbh ,'
        ...
        'ZLS.LOSS  ,CLZL.CQDH,XXZLS.JGYWSM,DDZL.XieXing ,DDZL.SheHao'
      ...
      'LEFT JOIN XXZLS AS XXZLS ON DDZL.XIEXING = XXZLS.XIEXING'
        ...
        'LEFT join SHIP_XXZLS on SHIP_XXZLS.XieXing=DDZL.XieXing and SHIP' +
        '_XXZLS.SheHao=DDZL.SheHao and ZLZLS2.BWBH=SHIP_XXZLS.BWBH'
      ...
      '      and (SHIP_XXZLS.tyjh is null or SHIP_XXZLS.tyjh='#39'N'#39')'
        ...
        'L,CLZL.CQDH,XXZLS.LOSS,XXZLS.JGYWSM ,DDZL.XieXing ,DDZL.SheHao,X' +
        'XZLS.CCQQ,XXZLS.CCQZ,ddzl.pairs'
      'union all'
      
        'Select zlzls2.ZLBH,zlzls2.xh,ZLZLS2.bwbh+'#39'-'#39' as bwbh,zlzls2.clbh' +
        ',max(zlzls2.mjbh) AS mjbh ,'
      ...
      'union all'
        ...
        'select zlzls3.ZLBH1 as ZLBH,'#39'ZZZ'#39' as XH, '#39'ZZZ'#39' as BWBH,substring' +
        '(zlzls3.cldhz,2,10) as CLBH,max(substring(zlzls3.cldhz,2,10)) as' +
        ' MJBH, sum(zlzls3.tclyl)as CLSL,'
      
        '      (sum(zlzls3.tclyl)/DDZL.Pairs) as Usage,'#39'OUTSOLE'#39' as BWMCY' +
        ',max(CLZL.YWPM)as CLMCY,max(CLZL.DWBH)as DWBH,NULL as LOSS,ERP_C' +
        'LZL.CQDH,'#39#39' as JGYWSM,max(DDZL.XieXing) as XieXing,'
      '      max(DDZL.SheHao) as SheHao,'#39#39' as CCQQ,'#39#39' as CCQZ'
      'from LIY_DD.DBO.ZLZLS3 ZLZLS3'
      'left join LIY_DD.DBO.CLZL CLZL on CLZL.CLDH=ZLZLS3.cldhz'
      'left join DDZL on DDZL.DDBH=ZLZLS3.ZLBH1'
      'LEFT JOIN CLZL as ERP_CLZL ON zlzls3.cldhz = '#39'A'#39'+ERP_CLZL.cldh'
      'where zlzls3.zlbh1=:ZLBH'
      
        'group by substring(zlzls3.cldhz,2,10),zlzls3.ZLBH1,DDZL.Pairs,ER' +
        'P_CLZL.CQDH'
      'having sum(zlzls3.tclyl)<>0'
      'Union all'
      
        'SELECT ZLZLS2_YM.ZLBH,ZLZLS2_YM.XH,ZLZLS2_YM.bwbh ,ZLZLS2_YM.clb' +
        'h AS clbh ,max(ZLZLS2_YM.mjbh) AS mjbh ,'
      
        '              sum(ZLZLS2_YM.clsl) AS clsl ,(sum(ZLZLS2_YM.clsl)/' +
        'ddzl.pairs) AS USAGE,IsNull(max(BWZL.ywsm),'#39'Print'#39') AS BWMCY ,'
      
        '              max(CLZL.ywpm) AS CLMCY ,max(CLZL.dwbh) AS dwbh,NU' +
        'LL as LOSS  ,CLZL.CQDH,'#39#39' as JGYWSM,max(DDZL.XieXing) as XieXing' +
        ','
      '              max(DDZL.SheHao) as SheHao,'#39#39' as CCQQ,'#39#39' as CCQZ'
      ' from ZLZLS2_YM'
      ' LEFT JOIN BWZL AS BWZL ON ZLZLS2_YM.BWBH = BWZL.bwdh'
      ' LEFT JOIN CLZL AS CLZL ON ZLZLS2_YM.CLBH = CLZL.cldh'
      ' left join DDZL on DDZL.DDBH=ZLZLS2_YM.ZLBH'
      ' where ZLZLS2_YM.ZLBH=:ZLBH'
      
        ' GROUP BY ZLZLS2_YM.ZLBH,ZLZLS2_YM.XH,ZLZLS2_YM.bwbh ,ZLZLS2_YM.' +
        'clbh,ddzl.pairs,CLZL.CQDH'
      ')zlzls2'
      
        'group by  zlzls2.ZLBH,zlzls2.XH,zlzls2.bwbh , zlzls2.clbh, zlzls' +
        '2.mjbh,zlzls2.clsl,'
      
        #9#9'zlzls2.usage, zlzls2.BWMCY, zlzls2.CLMCY, zlzls2.dwbh, zlzls2.' +
        'LOSS,zlzls2.CQDH, zlzls2.JGYWSM,zlzls2.XieXing, zlzls2.Shehao,zl' +
        'zls2.CCQQ, zlzls2.CCQZ'
      'ORDER BY zlzls2.XH,zlzls2.bwbh asc'
      ''
      'update #Material'
    ...
    object QMatListZLBH: TStringField
      FieldName = 'ZLBH'
      FixedChar = True
      Size = 15
    end
    ...
    object QMatListXieXing: TStringField
      FieldName = 'XieXing'
      FixedChar = True
      Size = 15
    end
    object QMatListShehao: TStringField
      FieldName = 'Shehao'
      FixedChar = True
      Size = 5
    end
  ...
  object MemoTemp: TQuery
    ...
    SQL.Strings = (
      ...
      'end'
        ...
        ',CLZL.DWBH'
      'into #Memo from DDZL_ZLZLS2 as ZLZLS2'
