object YPZL_BOMM: TYPZL_BOMM
  ...
  object YPZL: TQuery
    ...
    SQL.Strings = (
        ...
        'Select ypzl.YPDH,ypzl.XieXing,ypzl.SheHao,ypzl.Article,kfxxzl.Ji' +
        'Jie,ypzl.KFJD,'
      
        '       ypzl.YPCC,ypzl.SDRQ,ypzl.JHRQ,ypzl.Quantity,ypzl.PFC,ypzl' +
        '.GSDH,kfxxzl.DEVCODE,KFXXZL.FD'
      'FROM ypzl ypzl '
      
        'LEFT JOIN kfxxzl kfxxzl ON ypzl.XieXing = kfxxzl.XieXing AND ypz' +
        'l.SheHao = kfxxzl.SheHao '
      'where  ypzl.YPDH like  '#39'%ALTV200700001%'#39' '
      '   and (GSDH='#39'TBDC'#39' or GSDH='#39'LAI'#39') '
      '   and YPZL.YPDH like '#39'%ALTV200700001%'#39' '
  ...
  object YPZLS: TQuery
    ...
    SQL.Strings = (
      ...
      'WHERE YPDH =:YPDH    and YPZL_NoNeedPart.bwbh is null'
