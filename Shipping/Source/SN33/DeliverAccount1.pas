...
begin
  ...
  begin
      ...
      sql.add('             sum(ZLZLS2.CLSL)   CLSL,CLZL.YWPM,CLZL.DWBH,XXZL.Article,XXZL.XieMing,DDZL.Pairs,Max(ZLZLS2.USERDATE) as CalDate ');
      ...
      //
      sql.add('      group by ZLZLS2.ZLBH,ZLZLS2.CLBH,CLZL.YWPM,CLZL.DWBH,XXZL.Article,XXZL.XieMing,DDZL.Pairs ) OrdCL');
...
begin
  ...
  begin
    ...
    begin
      ...
      sql.Add('      and (SHIP_XXZLS.tyjh is null or SHIP_XXZLS.tyjh=''N'')');
      //
      sql.add('      group by ZLZLS2.ZLBH,ZLZLS2.CLBH,CLZL.YWPM,CLZL.DWBH,XXZL.Article,XXZL.XieMing,DDZL.Pairs ');
      sql.add('union all ');
      sql.add('      select * from (');
      if MergeExtraCK.Checked=false then
         sql.add('   select ZLZLS2.ZLBH,ZLZLS2.MJBH,(select top 1 Case when  A.MJBH<>''ZZZZZZZZZZ'' then A.MJBH else ZLZLS2.MJBH end as MJBH from '+ZLZLS2_TB+' A where A.CLBH=ZLZLS2.MJBH and A.ZLBH=ZLZLS2.ZLBH  ) as Parent,''Gia cong'' as DType,ZLZLS2.CLBH,')
      else
         sql.add('   select ZLZLS2.ZLBH,ZLZLS2.MJBH,''ZZZZZZZZZZ'' as Parent,''Gia cong'' as DType,ZLZLS2.CLBH,');
      sql.add('             sum(ZLZLS2.CLSL)   CLSL,CLZL.YWPM,CLZL.DWBH,XXZL.Article,XXZL.XieMing,DDZL.Pairs,Max(ZLZLS2.USERDATE) as CalDate ');
      if OldCK.Checked=true then
      ...
      //
      if MergeExtraCK.Checked=false then
        sql.add('    group by ZLZLS2.ZLBH,ZLZLS2.MJBH,ZLZLS2.CLBH,CLZL.YWPM,CLZL.DWBH,XXZL.Article,XXZL.XieMing,DDZL.Pairs ')
      else
        sql.add('    group by ZLZLS2.ZLBH,ZLZLS2.MJBH,ZLZLS2.CLBH,CLZL.YWPM,CLZL.DWBH,XXZL.Article,XXZL.XieMing,DDZL.Pairs ');
      sql.add('      ) ZLZLS2 where   ZLZLS2.Parent like '+''''+edit1.Text+'%'+'''');
      sql.add(') OrdCL');
