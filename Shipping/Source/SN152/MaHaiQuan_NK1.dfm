object MaHaiQuan_NK: TMaHaiQuan_NK
  Left = 192
  Top = 125
  Width = 928
  Height = 480
  Caption = 'MaHaiQuan_NK1'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select top 1000 CLZL.CLDH,CLHG.clbh,clzl.ywpm,clzl.dwbh,clhg.HGB' +
        'H,clhg.HGPM,clhg.UNitC,clhg.Ratec,clhg.userid,clhg.userdate,clhg' +
        '.YN'
      'from CLZL '
      'left join CLHG1 CLHG on CLHG.clbh = CLZL.cldh  '
      'Where 1=1 '
      '       and clzl.ywpm like '#39'%%'#39
      'and CLHG.CLBH is not null '
      'order by clhg.clbh')
