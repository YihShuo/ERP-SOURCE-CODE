object Bill_Info: TBill_Info
  ...
  object Query1: TQuery
    ...
    object Query1DocNo: TStringField
      FieldName = 'DocNo'
      Origin = 'DB.Bill_Info.DocNo'
      FixedChar = True
      Size = 40
    end
    object Query1BillNo: TStringField
      FieldName = 'BillNo'
      Origin = 'DB.Bill_Info.BillNo'
      FixedChar = True
      Size = 50
    end
    object Query1LoadingDate: TDateTimeField
      FieldName = 'LoadingDate'
      Origin = 'DB.Bill_Info.LoadingDate'
    end
    object Query1ArivalDate: TDateTimeField
      FieldName = 'ArivalDate'
      Origin = 'DB.Bill_Info.ArivalDate'
    end
    ...
    object Query1PlaceLading: TStringField
      FieldName = 'PlaceLading'
      Origin = 'DB.Bill_Info.PlaceLading'
      FixedChar = True
      Size = 150
    end
    object Query1PortExport: TStringField
      FieldName = 'PortExport'
      Origin = 'DB.Bill_Info.PortExport'
      FixedChar = True
      Size = 150
    end
    object Query1PlaceDischarge: TStringField
      FieldName = 'PlaceDischarge'
      Origin = 'DB.Bill_Info.PlaceDischarge'
      FixedChar = True
      Size = 150
    end
    object Query1PlaceDelivery: TStringField
      FieldName = 'PlaceDelivery'
      Origin = 'DB.Bill_Info.PlaceDelivery'
      FixedChar = True
      Size = 150
    end
    object Query1FWD: TStringField
      FieldName = 'FWD'
      Origin = 'DB.Bill_Info.FWD'
      FixedChar = True
      Size = 100
    end
    ...
    object Query1Carrier: TStringField
      FieldName = 'Carrier'
      Origin = 'DB.Bill_Info.Carrier'
      FixedChar = True
      Size = 100
    end
    object Query1Shipper: TStringField
      FieldName = 'Shipper'
      Origin = 'DB.Bill_Info.Shipper'
      FixedChar = True
      Size = 100
    end
    object Query1Container: TStringField
      FieldName = 'Container'
      Origin = 'DB.Bill_Info.Container'
      FixedChar = True
      Size = 30
    end
    object Query1VersselIdentification: TStringField
      FieldName = 'VersselIdentification'
      Origin = 'DB.Bill_Info.VersselIdentification'
      FixedChar = True
      Size = 100
    end
    object Query1UserID: TStringField
      FieldName = 'UserID'
      Origin = 'DB.Bill_Info.UserID'
      FixedChar = True
      Size = 15
    end
    object Query1UserDate: TDateTimeField
      FieldName = 'UserDate'
      Origin = 'DB.Bill_Info.UserDate'
    end
    object Query1YN: TStringField
      FieldName = 'YN'
      Origin = 'DB.Bill_Info.YN'
      FixedChar = True
      Size = 1
    end
  end
  ...
  object UpSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  PlaceLading = :PlaceLading,'
      '  PortExport = :PortExport,'
      '  PlaceDischarge = :PlaceDischarge,'
      ...
      '  Shipper = :Shipper,'
      '  Container = :Container,'
      '  VersselIdentification = :VersselIdentification,'
      '  USERID = :USERID,'
      '  USERDATE = :USERDATE,'
      '  YN = :YN'
      'where'
    ...
    InsertSQL.Strings = (
      'insert into Bill_Info'
        ...
        '  (DocNo, BillNo, LoadingDate, ArivalDate,DeliverDate, PlaceLadi' +
        'ng, PortExport, PlaceDischarge, PlaceDelivery, FWD, Country, Car' +
        'rier, Shipper, Container, VersselIdentification, UserID, UserDat' +
        'e, YN)'
      'values'
      
        '  (:DocNo, :BillNo, :LoadingDate, :ArivalDate, :DeliverDate, :Pl' +
        'aceLading, :PortExport, :PlaceDischarge, :PlaceDelivery, :FWD, :' +
        'Country, :Carrier, :Shipper, :Container, :VersselIdentification,' +
        ' :UserID, :UserDate, :YN)')
    DeleteSQL.Strings = (
      'delete from KCZL'
      'where'
