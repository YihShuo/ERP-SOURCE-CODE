object MaiHaiQuan1416: TMaiHaiQuan1416
  Left = 812
  Top = 302
  Width = 1004
  Height = 535
  Caption = 'Mai Hai Quan (14~16)'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select top 1000 CLZL.CLDH,clhg_1416.clbh,clzl.ywpm,clzl.dwbh,clh' +
        'g_1416.HGBH,clhg_1416.HGPM,clhg_1416.UNitC,clhg_1416.Ratec,clhg_' +
        '1416.userid,clhg_1416.userdate,clhg_1416.YN'
      'from CLZL '
      'left join clhg_1416 on clhg_1416.clbh = CLZL.cldh  '
      'Where 1=1 '
      '       and clzl.ywpm like '#39'%%'#39
      'and clhg_1416.CLBH is not null '
      'order by clhg_1416.clbh')
    ...
    object Query1UnitC: TStringField
      FieldName = 'UnitC'
      Origin = 'DB.CLHG.UnitC'
      FixedChar = True
      Size = 40
    end
    object Query1RateC: TFloatField
      FieldName = 'RateC'
      Origin = 'DB.CLHG.RateC'
    end
    object Query1UserID: TStringField
      FieldName = 'UserID'
      Origin = 'DB.CLHG.UserID'
      FixedChar = True
      Size = 10
    end
    object Query1UserDate: TDateTimeField
      FieldName = 'UserDate'
      Origin = 'DB.CLHG.UserDate'
      DisplayFormat = 'yyyy/MM/dd'
    end
  ...
  object UpdateSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '')
    InsertSQL.Strings = (
      'insert into clhg_1416'
      '  (clbh,HGBH,HGPM,UnitC,RateC,USERID,Userdate,YN)'
      'values'
      '  (:clbh,:HGBH,:HGPM,:UnitC,:RateC,:USERID,:Userdate,:YN)'
      ''
      ''
