...
procedure TMaHaiQuanKD.GetSubSQL(var SQL:string;BtnObj:TSpeedButton;EditObj:TEdit;FieldNM:string;Flag:string);
...
procedure TMaHaiQuanKD.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TMaHaiQuanKD.FormDestroy(Sender: TObject);
begin
  MaHaiQuanKD:=nil;
end;

procedure TMaHaiQuanKD.BB1Click(Sender: TObject);
begin
  Panel1.Visible:=true;
end;

procedure TMaHaiQuanKD.Button1Click(Sender: TObject);
var i:integer;
    tmpList:TStringlist;
    MatNoSQL:string;
begin
  ...
  begin
    ...
    sql.add('from CLZL ');
    sql.add('left join CLKD on CLKD.clbh = CLZL.cldh  ');
    sql.add('Where 1=1 ');
...
procedure TMaHaiQuanKD.FormShow(Sender: TObject);
begin
  main.FormLanguage(Pointer(self),self.Name);
end;

procedure TMaHaiQuanKD.BB2Click(Sender: TObject);
begin
  with Query1 do
  begin
    requestlive:=true;
...
procedure TMaHaiQuanKD.BB3Click(Sender: TObject);
begin
  BB2.enabled:=false;
  BB4.enabled:=false;
  BB5.enabled:=true;
...
procedure TMaHaiQuanKD.BB4Click(Sender: TObject);
begin
  BB2.Enabled:= false;
  BB3.Enabled:= false;
  BB5.Enabled:=true;
...
procedure TMaHaiQuanKD.BB5Click(Sender: TObject);
var i:integer;
begin
  try
    Query1.first;
...
procedure TMaHaiQuanKD.BB6Click(Sender: TObject);
begin
  with Query1 do
  begin
  Active:=false;
...
procedure TMaHaiQuanKD.bbt6Click(Sender: TObject);
var i,j,k:integer;
...
procedure TMaHaiQuanKD.DBGrid1GetCellParams(Sender: TObject;
...
procedure TMaHaiQuanKD.DBGrid1EditButtonClick(Sender: TObject);
begin
  TimMaKD:=TTimMaKD.create(self);
  TimMaKD.show;
end;

procedure TMaHaiQuanKD.btImportClick(Sender: TObject);
...
begin
  ...
  begin
    ...
    begin
      ...
      Qtemp.active:=false;
      Qtemp.SQL.Clear;
      Qtemp.SQL.Add('select * from CLKD');
      ...
      begin
         Qtemp.active:=false;
         Qtemp.SQL.Clear;
         Qtemp.SQL.Add(' insert into CLKD(CLBH,HGBH,HGPM,UnitC,RateC,UserID,UserDate,YN)');
