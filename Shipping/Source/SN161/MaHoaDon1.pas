...
uses TimMaHQ1, main1, TimMaHD1;

{$R *.dfm}

procedure TMaHoaDon.GetSubSQL(var SQL:string;BtnObj:TSpeedButton;EditObj:TEdit;FieldNM:string;Flag:string);
...
procedure TMaHoaDon.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TMaHoaDon.FormDestroy(Sender: TObject);
begin
  MaHoaDon:=nil;
end;

procedure TMaHoaDon.BB1Click(Sender: TObject);
begin
  Panel1.Visible:=true;
end;

procedure TMaHoaDon.Button1Click(Sender: TObject);
var i:integer;
    tmpList:TStringlist;
    MatNoSQL:string;
begin
...
procedure TMaHoaDon.DBGrid1EditButtonClick(Sender: TObject);
begin
  TimMaHD:=TTimMaHD.create(self);
  TimMaHD.show;
end;

procedure TMaHoaDon.FormShow(Sender: TObject);
begin
  main.FormLanguage(Pointer(self),self.Name);
end;

procedure TMaHoaDon.BitBtn1Click(Sender: TObject);
begin
  with Query1 do
  begin
    requestlive:=true;
...
procedure TMaHoaDon.BB3Click(Sender: TObject);
begin
  BB2.enabled:=false;
  BB4.enabled:=false;
  BB5.enabled:=true;
...
procedure TMaHoaDon.BB4Click(Sender: TObject);
begin
  BB2.Enabled:= false;
  BB3.Enabled:= false;
  BB5.Enabled:=true;
...
procedure TMaHoaDon.BB5Click(Sender: TObject);
var i:integer;
begin
  try
    Query1.first;
...
procedure TMaHoaDon.BB2Click(Sender: TObject);
begin
  with Query1 do
  begin
    requestlive:=true;
...
procedure TMaHoaDon.BB6Click(Sender: TObject);
begin
  with Query1 do
  begin
  Active:=false;
...
procedure TMaHoaDon.bbt6Click(Sender: TObject);
var i,j,k:integer;
...
procedure TMaHoaDon.DBGrid1GetCellParams(Sender: TObject;
...
procedure TMaHoaDon.btImportClick(Sender: TObject);
var
  ExcelApp: Variant;
...
begin
  ...
  begin
    ...
    begin
      ...
      Qtemp.active:=false;
      Qtemp.SQL.Clear;
      Qtemp.SQL.Add('select * from CLHD');
      ...
      begin
         Qtemp.active:=false;
         Qtemp.SQL.Clear;
         Qtemp.SQL.Add(' insert into CLHD(CLBH,HGBH,HGPM,UnitC,RateC,UserID,UserDate,YN)');
