object MaHaiQuan_TC: TMaHaiQuan_TC
  Left = 192
  Top = 125
  Width = 928
  Height = 480
  Caption = 'MaHaiQuan_TC1'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select top 1000 CLZL.CLDH,CLTC.clbh,clzl.ywpm,clzl.dwbh,CLTC.HGB' +
        'H,CLTC.HGPM,CLTC.UNitC,CLTC.Ratec,CLTC.userid,CLTC.userdate,CLTC' +
        '.YN'
      'from CLZL'
      'left join CLTC1 CLTC on CLTC.clbh = CLZL.cldh'
      'Where 1=1'
      '       and clzl.ywpm like '#39'%%'#39
      'and CLTC.CLBH is not null'
      'order by CLTC.clbh')
