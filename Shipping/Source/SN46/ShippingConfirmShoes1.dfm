object ShippingConfirmShoes: TShippingConfirmShoes
  Left = 2143
  Top = 123
  Width = 1159
  Height = 480
  Caption = 'Shipping Confirm Shoes'
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        Footers = <>
        Title.Caption = 'CFMShoesShippingTeamReceive'
        Width = 106
      end
      item
        EditButtons = <>
        ...
        Footers = <>
        Title.Caption = 'CFMShoesShippingTeamReceiveDate'
        Width = 100
      end
      item
        EditButtons = <>
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        '  PC_Data.CFMShoesSPTeamReceive,PC_Data.CFMShoesSPTeamReceiveDat' +
        'e,  '
      
        '  PC_Data.CFMShoesShipping,PC_Data.CFMShoesShippingDate,PC_Data.' +
        'UserID_SP,PC_Data.Userdate_SP,  '
      
        '  KFXXZL.SheHao,KFXXZL.XieXing, ISNULL(PC_Data.XieXing, '#39'X'#39') AS ' +
        'Exist, ISNULL(XXZLKF.ImgNameCfm, '#39#39') AS ImgNameCFM  '
      '  FROM PC_Data  '
      
        '  LEFT JOIN KFXXZL ON PC_Data.XieXing = KFXXZL.XieXing AND PC_Da' +
        'ta.SheHao = KFXXZL.SheHao  '
      ...
      '  and KFXXZL.ARTICLE like '#39'A03661C%'#39'  '
        ...
        'ZL.ARTICLE,kfxxzl.KFLX,xxzlkf.SS,  '
    ...
    object Query1CFMShoesSPTeamReceive: TBooleanField
      FieldName = 'CFMShoesSPTeamReceive'
      OnChange = Query1CFMShoesSPTeamReceiveChange
    end
    object Query1CFMShoesSPTeamReceiveDate: TDateTimeField
      FieldName = 'CFMShoesSPTeamReceiveDate'
    end
    object Query1CFMShoesShipping: TBooleanField
      FieldName = 'CFMShoesShipping'
      OnChange = Query1CFMShoesShippingChange
    end
  ...
  object UpdateSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  SheHao=:SheHao,'
      '  RiskLevel=:RiskLevel,'
      '  CFMShoesSPTeamReceive=:CFMShoesSPTeamReceive,'
      '  CFMShoesSPTeamReceiveDate=:CFMShoesSPTeamReceiveDate,'
      '  CFMShoesShipping=:CFMShoesShipping,'
      '  CFMShoesShippingDate=:CFMShoesShippingDate,'
      '  UserID_SP=:UserID_SP,'
      '  Userdate_SP=:Userdate_SP'
      'where'
    ...
    InsertSQL.Strings = (
      'insert into PC_Data'
        ...
        '( XieXing,SheHao,RiskLevel,CFMShoesShippingTeamReceive,CFMShoesS' +
        'hippingTeamReceiveDate,CFMShoesShipping,CFMShoesShippingDate,Use' +
        'rID_SP,Userdate_SP)'
      'values'
      
        '( :XieXing,:SheHao,:RiskLevel,:CFMShoesShippingTeamReceive,:CFMS' +
        'hoesShippingTeamReceiveDate,:CFMShoesShipping,'
      '  :CFMShoesShippingDate,:UserID_SP,:Userdate_SP)')
    Left = 111
    Top = 353
  end
