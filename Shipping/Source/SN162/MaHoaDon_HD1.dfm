object MaHoaDon_HD: TMaHoaDon_HD
  Left = 192
  Top = 125
  Width = 928
  Height = 480
  Caption = 'MaHoaDon_HD1'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select top 1000 CLZL.CLDH,CLHD.clbh,clzl.ywpm,clzl.dwbh,CLHD.HGB' +
        'H,CLHD.HGPM,CLHD.UNitC,CLHD.Ratec,CLHD.userid,CLHD.userdate,CLHD' +
        '.YN'
      'from CLZL'
      'left join CLHD1 CLHD on CLHD.clbh = CLZL.cldh'
      'Where 1=1'
      '       and clzl.ywpm like '#39'%%'#39
      'and CLHD.CLBH is not null'
      'order by CLHD.clbh')
