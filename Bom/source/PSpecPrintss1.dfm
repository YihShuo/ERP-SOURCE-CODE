object PSpecPrintss: TPSpecPrintss
  ...
  object QMatList: TQuery
    DatabaseName = 'DB'
    DataSource = Shipbom.DataSource1
    SQL.Strings = (
      ...
      'where ZLZLS2.ZLBH=:DDBH and ZLZLS2.MJBH='#39'ZZZZZZZZZZ'#39
  ...
  object MemoTemp: TQuery
    ...
    SQL.Strings = (
      ...
      'left join CLZL on CLZL.CLDH=ZLZLS2.CLBH'
        ...
        'LS2.MJBH'
      'where ZLBH=:DDBH and MJBH<>'#39'ZZZZZZZZZZ'#39
      ''
      ''
      'alter table #Memo'
