object RSLChemical: TRSLChemical
  Left = 191
  Top = 143
  Width = 1172
  Height = 632
  Caption = 'Material Chemical/Carton RSL'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CLDH, CLLB, ZWPM, YWPM, DWBH, DCYN, PDYN, USERID, USERDAT' +
        'E'
      'FROM CLZL'
      'WHERE CLDH LIKE '#39'W%'#39' or CLDH Like '#39'U%'#39
      'ORDER BY CLDH')
