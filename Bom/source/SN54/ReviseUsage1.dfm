object ReviseUsage: TReviseUsage
  Left = 351
  Top = 227
  Width = 1345
  Height = 697
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        Font.Style = []
        Footers = <>
        Title.Caption = #27597#26448#26009#21697#21517'|YWPM'
        Width = 268
      end>
  end
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select ZLZLS2.*, BWZL.ywsm BWMC,CLZL.YWPM as CLMC,CLZL.DWBH,ZSZL' +
        '.ZSYWJC AS ZSMC,DDZL.ARTICLE,DDZL.YN,CLZL1.YWPM,ZLZLS2All.CLSLQt' +
        'y ,IsNull(Round(KCLLS.Qty,2),0) as Qty,DDZL.YN as LockYN'
      'FROM ZLZLS2 LEFT JOIN BWZL ON BWZL.BWDH=ZLZLS2.BWBH'
      '            LEFT JOIN CLZL ON ZLZLS2.CLBH=CLZL.CLDH'
      '            LEFT JOIN ZSZL ON ZSZL.ZSDH=ZLZLS2.CSBH'
      '            LEFT JOIN DDZL ON DDZL.DDBH=ZLZLS2.ZLBH'
      '            LEFT JOIN CLZL CLZL1 ON ZLZLS2.MJBH=CLZL1.CLDH '
      
        'left join (Select ZLBH,CLBH,MJBH,IsNull(Sum(CLSL),0) as CLSLQty ' +
        'from ZLZLS2 '
      
        '           where ZLZLS2.ZLBH like '#39'Y1801-0967%'#39' and ZLZLS2.CLBH ' +
        'like '#39'%'#39' '
      
        '           Group by ZLBH,CLBH,MJBH) ZLZLS2All on ZLZLS2.ZLBH=ZLZ' +
        'LS2All.ZLBH and ZLZLS2.CLBH=ZLZLS2All.CLBH and ZLZLS2.MJBH=ZLZLS' +
        '2All.MJBH '
      ...
      '            Left Join KCLL on KCLL.LLNO=KCLLS.LLNO '
        ...
        '            where  KCLLS.SCBH like '#39'Y1801-0967%'#39'  and KCLLS.CLBH' +
        ' like '#39'%'#39'  '
      ...
      '            Left Join JGZL  on JGZL.JGNO=JGZLS.JGNO '
        ...
        '            where JGZLSS.ZLBH like '#39'Y1801-0967%'#39' and JGZLS.ZMLB ' +
        'like '#39'%'#39' and JGZLS.CLBH like '#39'%'#39'  '
      ...
      '            Group by KCLLS.SCBH, KCLLS.CLBH,KCLLS.DFL'
        ...
        'ZLZLS2.CLBH and KCLLS.SCBH=ZLZLS2.ZLBH  and KCLLS.MJBH=ZLZLS2.MJ' +
        'BH '
      ...
      '          and DDZL.YN in('#39'2'#39','#39'5'#39')'
      '            and ZLZLS2.CLBH not like '#39'W%'#39' '
      
        'order by ZLZLS2.ZLBH,ZLZLS2.CLBH asc,ZLZLS2.MJBH,ZLZLS2.BWBH des' +
        'c')
    ...
    object Query1LockYN: TStringField
      FieldName = 'LockYN'
      FixedChar = True
      Size = 1
    end
  ...
  object UpdateSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'Insert into ZLZLS2'
        ...
        '   (ZLBH, XH ,BWBH, CSBH, MJBH, CLBH, ZMLB, SIZE, CLSL, USAGE, U' +
        'SERID, USERDATE, YN)'
      'Values'
      
        '   (:ZLBH, :XH ,:BWBH, :CSBH, :MJBH, :CLBH, :ZMLB, :SIZE, :CLSL,' +
        ' :USAGE, :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
      'Delete From ZLZLS2'
      'WHERE'
      '   ZLBH=:OLD_ZLBH AND'
  ...
  object UpdateQry: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select ZLZLS2.*, BWZL.ywsm BWMC,CLZL.YWPM as CLMC,'
      '       CLZL.DWBH,ZSZL.ZSYWJC AS ZSMC,DDZL.ARTICLE'
      'FROM ZLZLS2 LEFT JOIN BWZL ON BWZL.BWDH=ZLZLS2.BWBH'
      'LEFT JOIN CLZL ON ZLZLS2.CLBH=CLZL.CLDH'
      'LEFT JOIN ZSZL ON ZSZL.ZSDH=ZLZLS2.CSBH'
      'LEFT JOIN DDZL ON DDZL.DDBH=ZLZLS2.ZLBH'
      'WHERE ZLZLS2.ZLBH='#39'SD1511-108'#39'AND ZLZLS2.CLBH='#39'L090000993'#39
      'order by ZLZLS2.ZLBH, ZLZLS2.BWBH')
    Left = 176
    Top = 248
  end
  object KCLLSQry: TQuery
    ...
    DataSource = DataSource1
    SQL.Strings = (
      'select SCBH,CLBH,MJBH,IsNull(Sum(Qty),0) as Qty from ('
      ...
      '            Left Join KCLL on KCLL.LLNO=KCLLS.LLNO '
        ...
        '            where  KCLLS.SCBH like '#39'Y1712-0001%'#39'  and KCLLS.CLBH' +
        ' like '#39'C030002309%'#39'  '
      '                 and KCLL.GSBH='#39'VA12'#39' '
      '                 and KCLL.SCBH<>'#39'JJJJJJJJJJ'#39' '
      '            Group by KCLLS.SCBH, KCLLS.CLBH'
      '            Union all'
      ...
      '            Left Join JGZL  on JGZL.JGNO=JGZLS.JGNO '
        ...
        '            where JGZLSS.ZLBH like '#39'Y1712-0001%'#39' and JGZLS.ZMLB ' +
        'like '#39'C030002309%'#39' and JGZLS.CLBH like '#39'%'#39'  '
      '                  and JGZL.GSBH='#39'VA12'#39' '
    ...
    object KCLLSQryMJBH: TStringField
      FieldName = 'MJBH'
      FixedChar = True
      Size = 15
    end
