...
type
  TPSpecPrintssTW_Price = class(TForm)
    QuickRep2: TQuickRep;
    DetailBand1: TQRBand;
    QRShape1: TQRShape;
    Q1: TQRDBText;
    ...
    QRLabel72: TQRLabel;
    QRLabel73: TQRLabel;
    TitlememoPrice: TCurrencyField;
    QRShape34: TQRShape;
    QRShape44: TQRShape;
    QRLabel74: TQRLabel;
    QRDBText58: TQRDBText;
    QMatListCGNO: TStringField;
    QMatListCountry: TStringField;
    QRShape45: TQRShape;
    QRShape46: TQRShape;
    QRLabel75: TQRLabel;
...
var
  PSpecPrintssTW_Price: TPSpecPrintssTW_Price;
...
{$R *.dfm}
procedure TPSpecPrintssTW_Price.ReadIni();
var MyIni :Tinifile;
...
procedure TPSpecPrintssTW_Price.QRCompositeReport1AddReports(Sender: TObject);
begin
...
procedure TPSpecPrintssTW_Price.FormClose(Sender: TObject;
...
procedure TPSpecPrintssTW_Price.TitlememoAfterOpen(DataSet: TDataSet);
...
procedure TPSpecPrintssTW_Price.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
 Quickrep4.NewPage;
end;

procedure TPSpecPrintssTW_Price.MemoTempAfterOpen(DataSet: TDataSet);
var a,b,c:string;
i,j:integer;
begin                   //加MEO說明文檔
...
procedure TPSpecPrintssTW_Price.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
// Quickrep3.NewPage;
end;

procedure TPSpecPrintssTW_Price.FormDestroy(Sender: TObject);
begin
PSpecPrintssTW_Price:=nil;
end;

procedure TPSpecPrintssTW_Price.QRCompositeReport1Finished(Sender: TObject);
begin
   PSpecPrintssTW_Price.QRLabel22.Caption:=SpecISO;
   PSpecPrintssTW_Price.QRLabel4.Caption:=SpecISO;
   PageHeaderBand1.Frame.DrawBottom:= true;
   PSpecPrintssTW_Price.QRLabel60.Caption:=ComName;
   PSpecPrintssTW_Price.QRLabel18.Caption:=ComName;
   PSpecPrintssTW_Price.QRLabel23.Caption:=ComName;
   PSpecPrintssTW_Price.QRLabel46.Caption:=ComFullName;
   PSpecPrintssTW_Price.QRLabel54.Caption:=ComFullName;
   PSpecPrintssTW_Price.QRLabel61.Caption:=ComFullName;
end;

procedure TPSpecPrintssTW_Price.FormCreate(Sender: TObject);
begin
  ReadIni();
end;
