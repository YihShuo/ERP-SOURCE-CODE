...
type
  TPSpecPrintss_Price = class(TForm)
...
var
  PSpecPrintss_Price: TPSpecPrintss_Price;
...
{$R *.dfm}
procedure TPSpecPrintss_Price.ReadIni();
var MyIni :Tinifile;
...
procedure TPSpecPrintss_Price.QRCompositeReport1AddReports(Sender: TObject);
begin
...
procedure TPSpecPrintss_Price.FormClose(Sender: TObject;
...
procedure TPSpecPrintss_Price.TitlememoAfterOpen(DataSet: TDataSet);
...
procedure TPSpecPrintss_Price.ColumnHeaderBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
 Quickrep4.NewPage;
end;

procedure TPSpecPrintss_Price.MemoTempAfterOpen(DataSet: TDataSet);
var a,b,c:string;
i,j:integer;
begin                   //加MEO說明文檔
...
procedure TPSpecPrintss_Price.FormDestroy(Sender: TObject);
begin
  PSpecPrintss_Price:=nil;
end;

procedure TPSpecPrintss_Price.QRCompositeReport1Finished(Sender: TObject);
begin
   PSpecPrintss_Price.QRLabel4.Caption:=SpecISO;
   PSpecPrintss_Price.QRLabel22.Caption:=SpecISO;
   PageHeaderBand1.Frame.DrawBottom:= true;
   PSpecPrintss_Price.QRLabel60.Caption:=ComName;
   PSpecPrintss_Price.QRLabel18.Caption:=ComName;
   PSpecPrintss_Price.QRLabel23.Caption:=ComName;
   PSpecPrintss_Price.QRLabel61.Caption:=ComFullName;
   PSpecPrintss_Price.QRLabel54.Caption:=ComFullName;
   PSpecPrintss_Price.QRLabel46.Caption:=ComFullName;
end;

procedure TPSpecPrintss_Price.FormCreate(Sender: TObject);
begin
  ReadIni();
end;
