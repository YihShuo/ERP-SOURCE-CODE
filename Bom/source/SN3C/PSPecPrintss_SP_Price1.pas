...
type
  TPSPecPrintss_SP_Price = class(TForm)
    QuickRep2: TQuickRep;
    DetailBand1: TQRBand;
    QRShape1: TQRShape;
    Q1: TQRDBText;
...
var
  PSPecPrintss_SP_Price: TPSPecPrintss_SP_Price;
...
{$R *.dfm}
procedure TPSPecPrintss_SP_Price.ReadIni();
var MyIni :Tinifile;
...
procedure TPSPecPrintss_SP_Price.QRCompositeReport1AddReports(Sender: TObject);
begin
...
procedure TPSPecPrintss_SP_Price.FormClose(Sender: TObject;
...
procedure TPSPecPrintss_SP_Price.TitlememoAfterOpen(DataSet: TDataSet);
...
procedure TPSPecPrintss_SP_Price.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
Quickrep4.NewPage;
end;

procedure TPSPecPrintss_SP_Price.MemoTempAfterOpen(DataSet: TDataSet);
var a,b,c:string;
i,j:integer;
begin
...
procedure TPSPecPrintss_SP_Price.FormDestroy(Sender: TObject);
begin
  PSPecPrintss_SP_Price:=nil;
end;

procedure TPSPecPrintss_SP_Price.QRCompositeReport1Finished(Sender: TObject);
begin
   PSpecPrintss_SP_Price.QRLabel4.Caption:=SpecISO;
   PSpecPrintss_SP_Price.QRLabel22.Caption:=SpecISO;
   PageHeaderBand1.Frame.DrawBottom:= true;
   PSpecPrintss_SP_Price.QRLabel60.Caption:=ComName;
   PSpecPrintss_SP_Price.QRLabel18.Caption:=ComName;
   PSpecPrintss_SP_Price.QRLabel23.Caption:=ComName;
   PSpecPrintss_SP_Price.QRLabel46.Caption:=ComFullName;
   PSpecPrintss_SP_Price.QRLabel54.Caption:=ComFullName;
   PSpecPrintss_SP_Price.QRLabel61.Caption:=ComFullName;
end;

procedure TPSPecPrintss_SP_Price.FormCreate(Sender: TObject);
begin
  ReadIni();
end;
