object ModelStatus: TModelStatus
  Left = 454
  Top = 253
  Width = 1001
  Height = 555
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT XXZL.XieXing, XXZL.SheHao, XXZL.Article, KFXXZL.DEVCODE a' +
        's SR# ,XXZLPD.Dropped ,XXZLPD.UserID, XXZLPD.UserDate, XXZLPD.YN' +
        ' FROM XXZL'
  ...
  object UpdateSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO XXZLPD'
      '(XieXing, SheHao, Dropped, UserID, UserDate, YN)'
      'VALUES'
      '(:XieXing, :SheHao, :Dropped, :UserID, :UserDate, :YN)')
    Left = 16
    Top = 288
