object KhuonIn_PX_Print_B: TKhuonIn_PX_Print_B
  Left = 379
  Top = 155
  Width = 995
  Height = 675
  Caption = 'KhuonIn_PX_Print_B'
  Color = clBtnFace
  ...
  object InB: TQuery
    ...
    SQL.Strings = (
        ...
        'select KHUONIN_PXHS.HinhThe,CLZL.ywpm,'#39'('#39'+CONVERT(varchar,KHUONI' +
        'N_PXHS.Length)+'#39'+'#39'+CONVERT(varchar,KHUONIN_PXHS.Width)+'#39')'#39'+'#39'*'#39'+C' +
        'ONVERT(varchar,KHUONIN_PXHS.VNPrice)+'#39'+'#39'+isnull(CONVERT(varchar,' +
        'KHUONIN_PXHS.FilmPrice),0) as QuyCach'
      
        ',KHUONIN_PXHS.Qty,sum ((KHUONIN_PXHS.Length+KHUONIN_PXHS.Width)*' +
        'KHUONIN_PXHS.VNPrice+KHUONIN_PXHS.FilmPrice) as DonGia,KHUONIN_P' +
        'XHS.VNACC'
      'from KHUONIN_PXHS'
      'left join CLZL on CLZL.CLDH=KHUONIN_PXHS.CLBH'
      'where KHUONIN_PXHS.LLNO=:LLNO'
      
        'group by KHUONIN_PXHS.HinhThe,CLZL.ywpm,KHUONIN_PXHS.VNACC,KHUON' +
        'IN_PXHS.Length,KHUONIN_PXHS.Width,KHUONIN_PXHS.VNPrice,KHUONIN_P' +
        'XHS.FilmPrice,KHUONIN_PXHS.Qty,KHUONIN_PXHS.VNACC'
      '')
    Left = 228
    Top = 53
    ParamData = <
    ...
    object InBHinhThe: TStringField
      FieldName = 'HinhThe'
      FixedChar = True
      Size = 50
    end
    object InBywpm: TStringField
      FieldName = 'ywpm'
      FixedChar = True
      Size = 200
    end
    object InBQuyCach: TStringField
      FieldName = 'QuyCach'
      FixedChar = True
      Size = 125
    end
    object InBQty: TCurrencyField
      FieldName = 'Qty'
      DisplayFormat = '##,#0.00'
    end
    object InBDonGia: TFloatField
      FieldName = 'DonGia'
    end
    object InBVNACC: TCurrencyField
      FieldName = 'VNACC'
      DisplayFormat = '##,#0.00'
    end
  end
