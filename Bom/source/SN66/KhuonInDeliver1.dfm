object KhuonInDeliver: TKhuonInDeliver
  Left = 357
  Top = 181
  Width = 1305
  Height = 675
  Caption = 'Khuon In Deliver'
  Color = clBtnFace
  ...
  object DelMas: TQuery
    ...
    DatabaseName = 'DB'
    SQL.Strings = (
      'select * from KHUONIN_PXH ')
    UpdateObject = UpMas
    Left = 396
    Top = 388
    object DelMasLLNO: TStringField
      FieldName = 'LLNO'
      Origin = 'DB.KHUONIN_PXH.LLNO'
      FixedChar = True
      Size = 11
    end
    object DelMasGSBH: TStringField
      FieldName = 'GSBH'
      Origin = 'DB.KHUONIN_PXH.GSBH'
      FixedChar = True
      Size = 4
    end
    object DelMasSupplier: TStringField
      FieldName = 'Supplier'
      Origin = 'DB.KHUONIN_PXH.Supplier'
      FixedChar = True
      Size = 50
    end
    object DelMasMemo: TStringField
      FieldName = 'Memo'
      Origin = 'DB.KHUONIN_PXH.Memo'
      FixedChar = True
      Size = 50
    end
    object DelMasUserID: TStringField
      FieldName = 'UserID'
      Origin = 'DB.KHUONIN_PXH.UserID'
      FixedChar = True
      Size = 15
    end
    object DelMasUserDate: TDateTimeField
      FieldName = 'UserDate'
      Origin = 'DB.KHUONIN_PXH.UserDate'
      DisplayFormat = 'yyyy/mm/dd'
    end
    object DelMasYN: TStringField
      FieldName = 'YN'
      Origin = 'DB.KHUONIN_PXH.YN'
      FixedChar = True
      Size = 1
    end
  end
  object UpMas: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  LLNO = :OLD_LLNO')
    InsertSQL.Strings = (
      'insert into KHUONIN_PXH'
      '  (LLNO, GSBH, Supplier, Memo,  USERDATE, USERID,  YN)'
      'values'
      '  (:LLNO, :GSBH, :Supplier, :Memo,  :USERDATE, :USERID, :YN)')
    DeleteSQL.Strings = (
      'delete from KHUONIN_PXH'
      'where'
      '  LLNO = :OLD_LLNO')
    Left = 396
    Top = 420
  ...
  object DelDet: TQuery
    ...
    object DelDetHinhThe: TStringField
      FieldName = 'HinhThe'
      FixedChar = True
      Size = 50
    end
    object DelDetLength: TFloatField
      FieldName = 'Length'
    end
    object DelDetWidth: TFloatField
      FieldName = 'Width'
    end
    ...
    object DelDetFilmPrice: TCurrencyField
      FieldName = 'FilmPrice'
      currency = False
    end
  ...
  object UPDet: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  HinhThe =:OLD_HinhThe')
    InsertSQL.Strings = (
      'insert into KHUONIN_PXHS'
      
        '  (LLNO, CLBH, HinhThe, Length, Width, Qty, Memo, VNPrice, FilmP' +
        'rice, VNACC,'
      '   USERDATE, USERID, YN)'
      'values'
      
        '  (:LLNO, :CLBH, :HinhThe, :Length, :Width, :Qty, :Memo, :VNPric' +
        'e, :FilmPrice,'
      '   :VNACC, :USERDATE, :USERID, :YN)')
    DeleteSQL.Strings = (
      'delete from KHUONIN_PXHS'
      'where'
      '  LLNO = :OLD_LLNO and'
      '  CLBH = :OLD_CLBH and'
      '  HinhThe = :HinhThe')
