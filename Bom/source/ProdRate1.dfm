object ProdRate: TProdRate
  ...
  object XXZL: TQuery
    ...
    SQL.Strings = (
      ...
      'from simpleshoes '
        ...
        'left join xxzl on xxzl.xiexing=simpleshoes.xiexing and xxzl.SheH' +
        'ao=simpleshoes.SheHao'
      'where  xxzl.KHDH='#39'P'#39
      ' order by simpleshoes.XieXing')
    Left = 20
    Top = 276
    ...
    object XXZLSimpleSize: TFloatField
      FieldName = 'SimpleSize'
      Origin = 'DB.simpleshoes.SimpleSize'
    end
    object XXZLSignature: TStringField
      FieldName = 'Signature'
      Origin = 'DB.simpleshoes.Signature'
      FixedChar = True
      Size = 50
    end
    object XXZLSingDate: TDateTimeField
      FieldName = 'SingDate'
      Origin = 'DB.simpleshoes.SingDate'
    end
    object XXZLExpireDate: TDateTimeField
      FieldName = 'ExpireDate'
  ...
  object xxzlfrom: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select * from xxzl')
    Left = 108
    Top = 240
    object xxzlfromXieXing: TStringField
      FieldName = 'XieXing'
      Origin = 'DB.xxzl.XieXing'
      FixedChar = True
      Size = 15
    end
    object xxzlfromSheHao: TStringField
      FieldName = 'SheHao'
      Origin = 'DB.xxzl.SheHao'
      FixedChar = True
      Size = 5
    end
    object xxzlfromXieMing: TStringField
      FieldName = 'XieMing'
      Origin = 'DB.xxzl.XieMing'
      FixedChar = True
      Size = 50
    end
    object xxzlfromARTICLE: TStringField
      FieldName = 'ARTICLE'
  ...
  object Query1: TQuery
    ...
    object Query1SimpleSize: TFloatField
      FieldName = 'SimpleSize'
      Origin = 'DB.simpleshoes.SimpleSize'
    end
    object Query1Signature: TStringField
      FieldName = 'Signature'
      Origin = 'DB.simpleshoes.Signature'
      FixedChar = True
      Size = 50
    end
    object Query1SingDate: TDateTimeField
      FieldName = 'SingDate'
      Origin = 'DB.simpleshoes.SingDate'
    end
  ...
  object skumap: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select * from skumap')
    Left = 132
    Top = 240
    object skumapSKU: TStringField
      FieldName = 'SKU'
      Origin = 'DB.skumap.SKU'
      FixedChar = True
    end
    object skumapARTICLE: TStringField
      FieldName = 'ARTICLE'
