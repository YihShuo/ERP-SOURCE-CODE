object D_PSpecPrintssTW: TD_PSpecPrintssTW
  Left = 265
  Top = 172
  Width = 1069
  Height = 529
  HorzScrollBar.Position = 325
  Caption = 'D_PSpecPrintssTW'
  Color = clBtnFace
  ...
  object QMatList: TQuery
    ...
    SQL.Strings = (
      ...
      'into #Material'
        ...
        'from(SELECT ZLZLS2.XH,ZLZLS2.bwbh ,zlzls2.clbh AS clbh ,max(zlzl' +
        's2.mjbh) AS mjbh ,'
      ...
      '                 XXZLS.CCQQ,XXZLS.CCQZ,ddzl.pairs'
      'union all'
      
        'select '#39'ZZZ'#39' as XH, '#39'ZZZ'#39' as BWBH,substring(zlzls3.cldhz,2,10) a' +
        's CLBH,max(substring(zlzls3.cldhz,2,10)) as MJBH, sum(zlzls3.tcl' +
        'yl)as CLSL,'
      
        '      (sum(zlzls3.tclyl)/DDZL.Pairs) as Usage,'#39#22823#24213#39' as BWMCY,max(' +
        'CLZL.ZWPM)as CLMCY,max(CLZL.DWBH)as DWBH,NULL as LOSS,'#39#39'as CQDH,' +
        #39#39' as JGYWSM,'
      '      '#39#39' as CCQQ,'#39#39' as CCQZ'
      ...
      'group by substring(zlzls3.cldhz,2,10),zlzls3.ZLBH1,DDZL.Pairs'
      'having sum(zlzls3.tclyl)<>0'
      'union all                 '
      
        'SELECT ZLZLS2_YM.XH,ZLZLS2_YM.bwbh ,ZLZLS2_YM.clbh AS clbh ,max(' +
        'ZLZLS2_YM.mjbh) AS mjbh ,'
      
        '              sum(ZLZLS2_YM.clsl) AS clsl ,(sum(ZLZLS2_YM.clsl)/' +
        'ddzl.pairs) AS USAGE,IsNull(max(BWZL.zwsm),'#39'Print'#39') AS BWMCY ,'
      
        '              max(CLZL.zwpm) AS CLMCY ,max(CLZL.dwbh) AS dwbh,NU' +
        'LL as LOSS  ,CLZL.CQDH,'#39#39' as JGYWSM'
      '              ,'#39#39' as CCQQ,'#39#39' as CCQZ'
      ' from ZLZLS2_YM'
      ...
      ' where ZLZLS2_YM.ZLBH=:ZLBH'
        ...
        ' GROUP BY ZLZLS2_YM.XH,ZLZLS2_YM.bwbh ,ZLZLS2_YM.clbh,ddzl.pairs' +
        ',CLZL.CQDH'
      ')ZLZLS2'
