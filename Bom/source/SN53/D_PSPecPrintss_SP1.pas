unit D_PSPecPrintss_SP1;

interface

uses
  {Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, QRExport, QRPDFFilt, DBTables, DB, QuickRpt, QRCtrls, ExtCtrls;   }
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, ExtCtrls, QuickRpt, QRCtrls, DB, DBTables, jpeg, QRXMLSFilt,
  QRExport, QRPDFFilt, StdCtrls,IniFiles;

type
  TD_PSpecPrintss_SP = class(TForm)
    QuickRep2: TQuickRep;
    DetailBand1: TQRBand;
    QRShape1: TQRShape;
    Q1: TQRDBText;
...
var
  D_PSpecPrintss_SP: TD_PSpecPrintss_SP;
...
procedure TD_PSpecPrintss_SP.ReadIni();
var MyIni :Tinifile;
...
procedure TD_PSpecPrintss_SP.QRCompositeReport1AddReports(Sender: TObject);
begin
...
procedure TD_PSpecPrintss_SP.FormClose(Sender: TObject;
...
procedure TD_PSpecPrintss_SP.TitlememoAfterOpen(DataSet: TDataSet);
...
procedure TD_PSpecPrintss_SP.ColumnHeaderBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
Quickrep4.NewPage;
end;

procedure TD_PSpecPrintss_SP.MemoTempAfterOpen(DataSet: TDataSet);
var a,b,c:string;
i,j:integer;
begin
...
procedure TD_PSpecPrintss_SP.FormDestroy(Sender: TObject);
begin
  D_PSPecPrintss_SP:=nil;
end;

procedure TD_PSpecPrintss_SP.QRCompositeReport1Finished(Sender: TObject);
begin
     D_PSpecPrintss_SP.QRLabel60.Caption:=ComName;
     D_PSpecPrintss_SP.QRLabel18.Caption:=ComName;
     D_PSpecPrintss_SP.QRLabel23.Caption:=ComName;
     D_PSpecPrintss_SP.QRLabel54.Caption:=ComFullName;
     D_PSpecPrintss_SP.QRLabel46.Caption:=ComFullName;
     D_PSpecPrintss_SP.QRLabel61.Caption:=ComFullName;
     D_PSPecPrintss_SP.QRLabel4.Caption:=BomN53_ISO;
     D_PSPecPrintss_SP.QRLabel22.Caption:=BomN53_ISO;
end;

procedure TD_PSpecPrintss_SP.FormCreate(Sender: TObject);
begin
  ReadIni();
end;
