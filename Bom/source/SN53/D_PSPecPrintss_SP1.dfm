object D_PSpecPrintss_SP: TD_PSpecPrintss_SP
  Left = 336
  Top = 202
  Width = 1072
  Height = 450
  HorzScrollBar.Position = 1556
  Caption = 'D_PSpecPrintss_SP'
  Color = clBtnFace
  ...
  object QMatList: TQuery
    ...
    SQL.Strings = (
      ...
      '      and (SHIP_XXZLS.tyjh is null or SHIP_XXZLS.tyjh='#39'N'#39')'
        ...
        'L,CLZL.CQDH,XXZLS.LOSS,XXZLS.JGYWSM ,XXZLS.CCQQ,XXZLS.CCQZ,ddzl.' +
        'pairs'
      'union all'
      ...
      'union all'
        ...
        ',max(CLZL.YWPM)as CLMCY,max(CLZL.DWBH)as DWBH,NULL as LOSS,'#39#39'as ' +
        'CQDH,'#39#39' as JGYWSM,'
