...
var
  InkRevise_CLZL: TInkRevise_CLZL;

implementation
  uses InkReviseUsage1;
{$R *.dfm}

procedure TInkRevise_CLZL.Button1Click(Sender: TObject);
begin
  with query1 do
  begin
    active:=false;
...
procedure TInkRevise_CLZL.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure TInkRevise_CLZL.DBGridEh1KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key=#13 then
