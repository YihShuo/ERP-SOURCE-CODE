...
type
  TOrderKhuonIn = class(TForm)
    ...
    procedure KHUONIN_XXZLSAfterOpen(DataSet: TDataSet);
    procedure KHUONIN_XXZLSAfterScroll(DataSet: TDataSet);
    procedure KHUONIN_DDZLAfterOpen(DataSet: TDataSet);
    procedure KHUONIN_DDZLAfterScroll(DataSet: TDataSet);
...
procedure TOrderKhuonIn.KHUONIN_XXZLSAfterOpen(DataSet: TDataSet);
begin
  BA2.Enabled:=true;
  BA3.Enabled:=true;
  BA4.Enabled:=true;
...
procedure TOrderKhuonIn.KHUONIN_XXZLSAfterScroll(DataSet: TDataSet);
begin
  BA2.Enabled:=true;
  BA3.Enabled:=true;
  BA4.Enabled:=true;
...
procedure TOrderKhuonIn.KHUONIN_DDZLAfterOpen(DataSet: TDataSet);
begin
  BD2.Enabled:=true;
  BD3.Enabled:=true;
  BD4.Enabled:=true;
...
procedure TOrderKhuonIn.KHUONIN_DDZLAfterScroll(DataSet: TDataSet);
begin
  BD2.Enabled:=true;
  BD3.Enabled:=true;
  BD4.Enabled:=true;
