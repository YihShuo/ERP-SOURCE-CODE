object QuotationConCheckList: TQuotationConCheckList
  Left = 344
  Top = 232
  Width = 1170
  Height = 436
  Caption = 'QuotationConCheckList'
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'ZSJC'
        Footers = <>
        Title.Caption = #21407#24288#21830'|ZSJC'
        Width = 94
      end
      item
        EditButtons = <>
        FieldName = 'ZSJC_TW'
        Footers = <>
        Title.Caption = #19979#21934#24288#21830'|ZSJC_TW'
        Width = 88
      end
      item
        EditButtons = <>
  ...
  object BJDet: TQuery
    ...
    SQL.Strings = (
        ...
        'select CGBJ.BJNO,CGBJ.ZSBH,ZSZL.ZSJC,ZSZL_DEV.Zsdh_TW,ZSZLTW.ZSJ' +
        'C as ZSJC_TW,CGBJ.CLBH,CLZL.YWPM,CLZL.DWBH,CGBJ.USPRICE,CGBJ.VNP' +
        'RICE,XXZL.Article,CGBJ.Discount,CGBJ.SuppEx,'
      
        '       IsNull((select top 1 CWHL from CWHLS  where HLYEAR=Year(G' +
        'etDate()) and HLMONTH=Month(GetDate()) and HLDay=1),0) as ErpEx,' +
        'ZSZL.PayVN,CGBJ.USERID,CGBJ.USERDATE,CGBJ.EXPDATE,CGBJ.File_NAME' +
        ',CGBJ.Season,CGBJ.CFMID,CGBJ.CFMDATE from ('
      ''
    ...
    object BJDetZsdh_TW: TStringField
      FieldName = 'Zsdh_TW'
      FixedChar = True
      Size = 6
    end
    object BJDetZSJC_TW: TStringField
      FieldName = 'ZSJC_TW'
      FixedChar = True
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object UploadFN1: TMenuItem
      Caption = 'Upload Report'
      Enabled = False
      OnClick = UploadFN1Click
    end
    ...
    object DeleteFN1: TMenuItem
      Caption = 'Delete Report'
      Enabled = False
      OnClick = DeleteFN1Click
    end
  end
