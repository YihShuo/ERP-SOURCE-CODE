object MaterialMOQ: TMaterialMOQ
  ...
  object Panel1: TPanel
    ...
    object DTP1: TDateTimePicker
      ...
      Width = 89
      Height = 24
      Date = 45059.435438240740000000
      Format = 'yyyy/MM/dd'
      Time = 45059.435438240740000000
      TabOrder = 18
    end
      ...
      object DBGrid1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'MatRemark'
            Footers = <>
            Title.Caption = 'Purchase|Mat.Remark'
            Title.TitleButton = True
            Width = 120
          end
          item
            ...
            FieldName = 'FlexCode'
            Footers = <>
            Title.Caption = 'Purchase|FlexCode'
            Title.TitleButton = True
          end
          item
            EditButtons = <>
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'select SEASON ,main.CLBH,ZSBH,ZSBH_Old,YWPM,MatRemark,FlexCode,D' +
        'WBH,ZSYWJC,'
      
        '       SampleLeadTime,ProdLeadTime,AddTLeadtime,SampleMOQ,ProdMO' +
        'Q,'
      '       SamplePrice,SamplePriceVN,ProdPrice,SamplePurchaser_Name,'
      
        '       main.REMARK,main.USERDATE,main.USERID,EffectiveDate,Effec' +
        'tiveDate_Old'
      '       ,Location,Forecast_Leadtime,'
      
        '       case when TotalLT is not null then TotalLT else TotalLT1 ' +
        'end as TotalLT,'
      '       case when FLT is not null then FLT else FLT1 end as FLT,'
      '       old_SampleLeadTime,old_ProdLeadTime'
      
        '       ,old_Forecast_Leadtime,Skin_Size,Skin_Quality,ExtraPrice,' +
        'country,Surcharge,Dyingfee,ShippedDate,AWB,Brand,BankAccount,ZSY' +
        'YZS,PAYMENTTERM,FlexDescription,PurDate,ColorGroup,CLZL_ColorGro' +
        'up.Remark as Remark_Color'
      'from ('
      
        'select CG.SEASON,CG.CLBH,CG.ZSBH,CG.ZSBH as ZSBH_Old,CLZL.YWPM,c' +
        'lbzzl.bz as MatRemark,CLZL_FLEX.CLDHFLEX AS FlexCode,CLZL.DWBH,Z' +
        'SZL.ZSYWJC, '
      
        '       MaterialMOQ.SampleLeadTime,MaterialMOQ.ProdLeadTime,Mater' +
        'ialMOQ.ADDTLeadtime,MaterialMOQ.SampleMOQ,MaterialMOQ.ProdMOQ,'
      ...
      '       ,MaterialMOQ.Skin_Quality  '
        ...
        'WB,Brand,zszl_dev.BankAccount,zszl_dev.ZSYYZS,zszl_dev.PAYMENTTE' +
        'RM '
      '       ,cldhflexdes as FlexDescription '
      'from ( select season,clbh,zsbh,brand from ( '
      
        'select kfxxzl.jijie as season,ypzls.clbh,ypzls.csbh as zsbh,kfxx' +
        'zl.KHDH as brand from ypzls'
      ...
      'where kfxxzl.khdh in ('#39'036'#39')'
      'and ypzls.clbh  like '#39'A010009233%'#39' '
      
        ' and ypzls.CSBH not in ('#39'JNG'#39','#39'JNGR1'#39','#39'JNGR2'#39','#39'JNGR3'#39','#39'T006'#39','#39'P1' +
        '54'#39') '
      'and ypzls.Userdate between '#39'2023/07/28'#39' and '#39'2023/08/07'#39' '
      'union all '
      
        'select kfxxzl.jijie as season,clzhzl.cldh1 as clbh,clzhzl.zsdh  ' +
        'as zsbh,kfxxzl.KHDH as brand from ypzls'
      ...
      'where kfxxzl.khdh in ('#39'036'#39')   and CLZHZL.SYL>0 '
      'and clzhzl.cldh1  like '#39'A010009233%'#39' '
      ...
      'union all '
        ...
        ',brand from ('
      'select kfxxzl.jijie,clzhzl.cldh,kfxxzl.KHDH as brand from ypzls '
      ...
      'left JOIN clzl clzl ON CLZHZL.cldh1 = clzl.cldh'
        ...
        'where kfxxzl.khdh in ('#39'036'#39') and CLZHZL.SYL>0   and clzl.clzmlb=' +
        #39'Y'#39
      ...
      'and clzhzl.cldh1  like '#39'A010009233%'#39' '
      ') YPZLS '
      'Group by season,clbh,zsbh,brand '
      'union all '
      
        'select cgzl.season,cgzlss.clbh,cgzl.zsbh,kfxxzl.KHDH as brand fr' +
        'om cgzl'
      ...
      'left join YPZL on YPZL.YPDH = CGZLSS.ZLBH'
        ...
        'Hao = YPZL.SheHao'
      'where 1=1 and CGZL.GSBH = '#39'CDC'#39' '
      
        ' and CGZL.ZSBH not in ('#39'JNG'#39','#39'JNGR1'#39','#39'JNGR2'#39','#39'JNGR3'#39','#39'T006'#39','#39'P15' +
        '4'#39') '
      'and cgzlss.clbh  like '#39'A010009233%'#39' '
      'and cgzl.Userdate between '#39'2023/07/28'#39' and '#39'2023/08/07'#39' '
      'group by cgzl.season,cgzlss.clbh ,cgzl.zsbh,kfxxzl.KHDH'
      '  ) CG  '
      ...
      'left join BUSERS  on BUSERS.USERID=ZSZL_DEV.SamplePurchaser  '
        ...
        '=MaterialMOQ.SEASON and  CG.zsbh=MaterialMOQ.ZSBH  '
      'left join Country on Country.Country=ZSZL_DEV.country'
      'left join CGZL_Color2 on CGZL_Color2.clbh=CLZl.CLDH'
      'where CG.CLBH is not null and ZSZL_DEV.GSBH='#39'CDC'#39' '
      ' and CG.CLBH  like '#39'A010009233%'#39' '
      'union all  '
      
        'select MaterialMOQ.SEASON AS SEASON,MaterialMOQ.CLBH,MaterialMOQ' +
        '.ZSBH AS ZSBH,MaterialMOQ.ZSBH AS ZSBH_Old,CLZL.YWPM,clbzzl.bz a' +
        's MatRemark,CLZL_FLEX.CLDHFLEX AS FlexCode,CLZL.DWBH,ZSZL.ZSYWJC' +
        ', '
      ...
      '       ,MaterialMOQ.Skin_Quality  '
        ...
        '       ,MaterialMOQ.ExtraPrice,ZSZL_DEV.country,MaterialMOQ.Surc' +
        'harge,MaterialMOQ.Dyingfee,CGZL_Color2.ShippedDate,CGZL_Color2.A' +
        'WB,'#39#39' as Brand,zszl_dev.BankAccount,zszl_dev.ZSYYZS,zszl_dev.PAY' +
        'MENTTERM  '
      '       ,cldhflexdes as FlexDescription '
      ' from MaterialMOQ '
      ...
      ' left join Country on Country.Country=ZSZL_DEV.country '
      'left join CGZL_Color2 on CGZL_Color2.clbh=CLZl.CLDH'
      'where MaterialMOQ.clbh is not null and ZSZL_DEV.GSBH='#39'CDC'#39' '
      ...
      'and MaterialMOQ.CLBH  like '#39'A010009233%'#39' '
      
        '   and MaterialMOQ.CLBH not in (select CLBH from ( select CLBH,R' +
        'OW_NUMBER() over (PARTITION BY CLBH ORDER BY Substring(Season,1,' +
        '2) DESC,Substring(Season,3,1) ASC) as  rn from MaterialMOQ ) A w' +
        'here A.rn=1 )'
      ' ) main '
      
        ' left join  (select CLBH,MAX (USERDATE) as PurDate from cgzls gr' +
        'oup by CLBH) cgzls on cgzls.clbh=main.clbh'
      ' left join CLZL_ColorGroup on CLZL_ColorGroup.CLDH = main.CLBH'
      
        ' where ZSBH not in ('#39'JNG'#39','#39'JNGR1'#39','#39'JNGR2'#39','#39'JNGR3'#39','#39'T006'#39','#39'P154'#39')' +
        ' '
      
        ' group by SEASON ,main.CLBH,ZSBH,ZSBH_Old,YWPM,MatRemark,FlexCod' +
        'e,DWBH,ZSYWJC,'
      ' SampleLeadTime,ProdLeadTime,ADDTLeadtime,SampleMOQ,ProdMOQ,'
      ' SamplePrice,SamplePriceVN,ProdPrice,SamplePurchaser_Name,'
      
        ' main.REMARK,main.USERDATE,main.USERID,EffectiveDate,EffectiveDa' +
        'te_Old'
        ...
        'LT1,FLT1,country,Surcharge,Dyingfee,ShippedDate,AWB,Brand,BankAc' +
        'count,ZSYYZS,PAYMENTTERM,FlexDescription,PurDate,ColorGroup,CLZL' +
        '_ColorGroup.Remark'
      ' order by season,main.CLBH'
      '')
    ...
    object Query1AddTLeadtime: TIntegerField
      FieldName = 'AddTLeadtime'
    end
    ...
    object Query1Remark_Color: TStringField
      FieldName = 'Remark_Color'
      FixedChar = True
      Size = 250
    end
    object Query1CLBH_Status: TStringField
      FieldName = 'CLBH_Status'
    end
  end
  ...
  object Pop_Quotation: TPopupMenu
    ...
    object S4: TMenuItem
      Caption = 'Color Group Updated History'
      OnClick = S4Click
    end
  end
  ...
  object Qry_Policy: TQuery
    ...
    SQL.Strings = (
      ...
      '      ,zszlSamplePayment.Average'
        ...
        'priceHG,ZSZL_DEV.BankAccount,ZSZL_DEV.ZSYYZS,ZSZL_DEV.PAYMENTTER' +
        'M'
      'from MaterialMOQ'
      'left join zszl on zszl.zsdh=MaterialMOQ.zsbh'
    ...
    object Qry_PolicyMatRemark: TStringField
      FieldName = 'MatRemark'
      Size = 80
    end
    ...
    object Qry_PolicyBankAccount: TStringField
      FieldName = 'BankAccount'
      FixedChar = True
      Size = 30
    end
    object Qry_PolicyZSYYZS: TStringField
      FieldName = 'ZSYYZS'
      FixedChar = True
      Size = 30
    end
    object Qry_PolicyPAYMENTTERM: TStringField
      FieldName = 'PAYMENTTERM'
      FixedChar = True
      Size = 40
    end
