object CountryLeadtime: TCountryLeadtime
  Left = 344
  Top = 159
  Width = 982
  Height = 768
  Caption = 'CountryLeadtime'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    object Query1Country: TStringField
      FieldName = 'Country'
      Origin = 'DB.Country.Country'
      FixedChar = True
      Size = 50
    end
    object Query1ShippingleadtimeAIR: TIntegerField
      FieldName = 'ShippingleadtimeAIR'
      Origin = 'DB.Country.ShippingleadtimeAIR'
    end
    object Query1ShippingleadtimeSEA: TIntegerField
      FieldName = 'ShippingleadtimeSEA'
      Origin = 'DB.Country.ShippingleadtimeSEA'
    end
    object Query1Customclearanceday: TIntegerField
      FieldName = 'Customclearanceday'
      Origin = 'DB.Country.Customclearanceday'
    end
    object Query1USERDATE: TDateTimeField
      FieldName = 'USERDATE'
      Origin = 'DB.Country.USERDATE'
    end
    object Query1USERID: TStringField
      FieldName = 'USERID'
      Origin = 'DB.Country.USERID'
      FixedChar = True
      Size = 15
    end
    object Query1YN: TStringField
      FieldName = 'YN'
      Origin = 'DB.Country.YN'
      FixedChar = True
      Size = 1
    end
    object Query1Remark: TStringField
      FieldName = 'Remark'
      Origin = 'DB.Country.Remark'
      FixedChar = True
      Size = 200
    end
  end
