...
var
  PurTotal_BJ: TPurTotal_BJ;

implementation

uses main1, PurTotal1;

{$R *.dfm}
procedure TPurTotal_BJ.ReadIni();
var MyIni :Tinifile;
    AppDir:string;
begin
  //
...
//
procedure TPurTotal_BJ.FormCreate(Sender: TObject);
begin
  ...
  begin
    ...
    sql.Add('where CGBJS.CLBH='+''''+PurTotal.CGDet.fieldbyname('CLBH').Value+''''+'');
...
procedure TPurTotal_BJ.DBGrid1DblClick(Sender: TObject);
begin
...
procedure TPurTotal_BJ.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TPurTotal_BJ.FormDestroy(Sender: TObject);
begin
PurTotal_BJ:=nil;
end;

procedure TPurTotal_BJ.FormClose(Sender: TObject;
...
procedure TPurTotal_BJ.FormShow(Sender: TObject);
begin
