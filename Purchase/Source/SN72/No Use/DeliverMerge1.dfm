object DeliverMerge: TDeliverMerge
  Left = 255
  Top = 193
  Width = 870
  Height = 500
  Caption = 'DeliverMerge'
  Color = clBtnFace
  ...
  object YPZLZLS: TQuery
    ...
    SQL.Strings = (
        ...
        'select   YPZLZLS.YPZLBH, YPZLZLS.YPDH, YPZLZLS.PAIRS, YPZLZLS.US' +
        'ERID,'
      ' YPZLZLS.USERDATE, YN,'#13
      'ypzl.ARTICLE,ypzl.KFJD,kfxxzl.JiJie'#10
      'from YPZLZLS'
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into YPZLZL'
      '  (YPZLBH, INSDATE, KFJD, JiJie, USERID, USERDATE, YN,PD)'
      'values'
  ...
  object YPZLZLS11: TQuery
    ...
    SQL.Strings = (
        ...
        '           CLZL.DWBH,CLZL.LYCC,LBZLS.BZ,ZSZL.ZSYWJC,YPZLZLS1.LOS' +
        'S,YPZLZLS1.CLSL,CLZL.CLZMLB'
      ' FROM YPZLZLS1'
        ...
        'LEFT JOIN LBZLS ON SUBSTRING(YPZLZLS1.CLBH,1,1) = LBZLS.lbdh AND' +
        ' LBZLS.LB='#39'05'#39'                             '
      'LEFT JOIN ZSZL on ZSZL.ZSDH=YPZLZLS1.CSBH'
      'where YPZLZLS1.YPZLBH=:YPZLBH'
  ...
  object YPZLZLS2: TQuery
    ...
    SQL.Strings = (
        ...
        '           CLZL.DWBH,CLZL.LYCC,LBZLS.BZ,ZSZL.ZSYWJC,YPZLZLS2.CLS' +
        'L,CLZL.CLZMLB,YPZLZLS2.USAGE,'
      '            YPZLZLS2.MJBH,YPZLZLS2.CSBH'
      ' FROM YPZLZLS2'
        ...
        'LEFT JOIN LBZLS ON SUBSTRING(YPZLZLS2.CLBH,1,1) = LBZLS.lbdh AND' +
        ' LBZLS.LB='#39'05'#39'                             '
      'LEFT JOIN ZSZL on ZSZL.ZSDH=YPZLZLS2.CSBH'
      'where YPZLZLS2.YPZLBH=:YPZLBH'
