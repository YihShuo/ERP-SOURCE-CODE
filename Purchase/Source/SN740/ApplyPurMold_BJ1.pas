...
var
  ApplyPurMold_BJ: TApplyPurMold_BJ;
...
{$R *.dfm}
procedure TApplyPurMold_BJ.ReadIni();
var MyIni :Tinifile;
    AppDir:string;
begin
  //
...
//
procedure TApplyPurMold_BJ.FormCreate(Sender: TObject);
begin
  ...
  begin
    ...
    sql.Add('where CGBJS.CLBH='+''''+ApplyMold.SGDet.fieldbyname('CLBH').Value+''''+'');
...
procedure TApplyPurMold_BJ.DBGrid1DblClick(Sender: TObject);
begin
...
procedure TApplyPurMold_BJ.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
  DBGrid1dblclick(nil);
end;

procedure TApplyPurMold_BJ.FormDestroy(Sender: TObject);
begin
  ApplyPurMold_BJ:=nil;
end;

procedure TApplyPurMold_BJ.FormClose(Sender: TObject;
...
procedure TApplyPurMold_BJ.FormShow(Sender: TObject);
begin
