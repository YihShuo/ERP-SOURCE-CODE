...
var
  ApplyMoldMatNo: TApplyMoldMatNo;

implementation

uses ApplyMold1, FunUnit;

{$R *.dfm}


procedure TApplyMoldMatNo.Button1Click(Sender: TObject);
begin
  with query1 do
  begin
    active:=false;
...
procedure TApplyMoldMatNo.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure TApplyMoldMatNo.FormDestroy(Sender: TObject);
begin
  ApplyMoldMatNo:=nil;
end;

procedure TApplyMoldMatNo.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action:=CaFree;
end;

procedure TApplyMoldMatNo.FormCreate(Sender: TObject);
begin
