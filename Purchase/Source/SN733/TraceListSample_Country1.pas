...
uses main1,SupplierSample1 , TraceListSample1, TraceListSample_Style1,
  TraceList1;
...
procedure TTraceListSample_Country.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure TTraceListSample_Country.DBGridEh1KeyPress(Sender: TObject;
  var Key: Char);
begin
  if key=#13 then
