...
type
  TPurNoSizeTW_Print_TW = class(TForm)
    QuickRep1: TQuickRep;
...
var
  PurNoSizeTW_Print_TW: TPurNoSizeTW_Print_TW;
...
{$R *.dfm}
procedure TPurNoSizeTW_Print_TW.ReadIni();
var MyIni :Tinifile;
...
procedure TPurNoSizeTW_Print_TW.FormCreate(Sender: TObject);
var i:integer;
...
procedure TPurNoSizeTW_Print_TW.FormDestroy(Sender: TObject);
begin
  PurNoSizeTW_Print_TW:=nil;
end;

procedure TPurNoSizeTW_Print_TW.FormClose(Sender: TObject;
