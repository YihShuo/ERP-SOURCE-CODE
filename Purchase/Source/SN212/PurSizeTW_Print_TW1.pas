...
type
  TPurSizeTW_Print_TW = class(TForm)
    QuickRep1: TQuickRep;
    TempSize: TQuery;
    MasSize: TQuery;
...
var
  PurSizeTW_Print_TW: TPurSizeTW_Print_TW;
...
procedure TPurSizeTW_Print_TW.ReadIni();
var MyIni :Tinifile;
...
procedure TPurSizeTW_Print_TW.FormCreate(Sender: TObject);
...
procedure TPurSizeTW_Print_TW.FormDestroy(Sender: TObject);
begin
  PurSizeTW_Print_TW:=nil;
end;

procedure TPurSizeTW_Print_TW.FormClose(Sender: TObject;
