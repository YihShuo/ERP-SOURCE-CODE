...
var
  PurSizeTW_Print: TPurSizeTW_Print;
...
procedure TPurSizeTW_Print.ReadIni();
var MyIni :Tinifile;
...
procedure TPurSizeTW_Print.FormCreate(Sender: TObject);
...
procedure TPurSizeTW_Print.FormDestroy(Sender: TObject);
begin
PurSizeTW_Print:=nil;
end;

procedure TPurSizeTW_Print.FormClose(Sender: TObject;
