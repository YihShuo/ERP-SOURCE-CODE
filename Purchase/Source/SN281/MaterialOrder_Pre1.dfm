object MaterialOrder_Pre: TMaterialOrder_Pre
  Left = 428
  Top = 312
  Width = 1101
  Height = 585
  ...
  object Query1: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select MatList.*,IsNull(KCCLMONTH_Remain.Qty,0) as Remain from ('
      
        'select CLBH,YWPM,ZWPM,CQDH,DWBH,Sum(CLSL) as CLSL,Sum(CGQty) as ' +
        'CGQty,Sum(RKQty) as RKQty,ZSBH from ('
      'Select * from ( '
      ...
      '        CGZl.CGDate,CGZL.YQDate,CGZL.CFMDate,CGZL.CGNO,'
        ...
        '        DDZL.ShipDate,Max(ZLZLS2.CSBH) as ZSBH ,RKZL.RKQty,RKZL.' +
        'RKNO,RKZL.RKDate,'#39'Y'#39' as DelFlag   '
      'from ZLZLS2 with (nolock)  '
      
        'inner join DDZl  with (nolock) on DDZl.DDBH=ZLZLS2.ZLBH  and DDZ' +
        'L.DDBH  like '#39'Y2106-0001%'#39' '
      ...
      '                 and CGZLSS.ZLBH  like '#39'Y2106-0001%'#39' '
      ...
      '           from  KCRKS with (nolock)  '
        ...
        'H  like '#39'Y2106-0001%'#39' '
      
        '           left join KCRK with (nolock)  on KCRK.RKNO=KCRKS.RKNO' +
        ' '
      '           where DDZL.GSBH='#39'VA12'#39
      '                 and KCRKS.CGBH  like '#39'Y2106-0001%'#39' '
      ...
      '       and ZLZLS2.CLBH not like '#39'W%'#39
        ...
        'ZLZLS2.CLBH )'
      '       and ZLZLS2.ZLBH  like '#39'Y2106-0001%'#39' '
      ...
      'union all'
        ...
        'GNO) as CGNO,DDZLTW.ShipDate,Max(CGZL.ZSBH) as ZSBH '
      'from CGZLSS with (nolock)'
      ...
      '           from  KCRKS with (nolock)  '
        ...
        'DZL.DDBH  like '#39'Y2106-0001%'#39' '
      ...
      '           group by KCRKS.CGBH,KCRKS.CLBH ) RKZL'
        ...
        'LBH '
      'where 1=1'
      ' ) MatList Group by CLBH,YWPM,ZWPM,CQDH,DWBH,ZSBH ) MatList '
      
        'Left join KCCLMONTH_Remain on KCCLMONTH_Remain.CLBH=MatList.CLBH' +
        ' and KCCLMONTH_Remain.CKBH='#39'VA12'#39)
    Left = 328
    Top = 209
