...
procedure TQuotation_ZS.DBGrid1DblClick(Sender: TObject);
begin
...
procedure TQuotation_ZS.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
if key=#13 then
  DBGrid1Dblclick(nil);
end;
