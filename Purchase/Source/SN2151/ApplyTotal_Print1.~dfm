object ApplyTotal_Print: TApplyTotal_Print
  ...
  object QuickRep2: TQuickRep
    ...
    object PageFooterBand1: TQRBand
      ...
      object QR_HardwareDate: TQRDBText
        Left = 295
        Top = 37
        Width = 60
        Height = 15
      ...
      object QR_HardwareMDate: TQRDBText
        Left = 291
        Top = 71
        Width = 67
        Height = 15
  ...
  object SGNOQry: TQuery
    ...
    SQL.Strings = (
      ...
      'where SGDHS.SGNO=:SGNO  and SGDHS.Qty>0'
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'left join ZSZL on ZSZL.ZSDH = CGBJ.ZSBH'
      'Left join LBZLS on LBZLS.LBDH=CLZL.dwbh and LBZLS.LB='#39'02'#39
      'where SGDHS.SGNO=:SGNO and ZSZL.ZSDH=:ZSDH  and SGDHS.Qty>0'
      'order by SGDHS.SGNO')
    Left = 124
    Top = 400
    ParamData = <
  ...
  object QApprover: TADOQuery
    ...
    SQL.Strings = (
        ...
        '  MAX(CASE WHEN S_STEP_DESC = '#39#30828#39636#23529#26680#39' THEN S_USER_ID END) AS Hard' +
        'wareID,  '
      
        '  MAX(CASE WHEN S_STEP_DESC = '#39#30828#39636#23529#26680#39' THEN USERNAME END) AS Hardw' +
        'are,  '
      
        '  MAX(CASE WHEN S_STEP_DESC = '#39#30828#39636#23529#26680#39' THEN ApproveDate END) AS Ha' +
        'rdwareDate,  '
      
        '  MAX(CASE WHEN S_STEP_DESC = '#39'IT'#30828#39636#20027#31649#39' THEN S_USER_ID END) AS Ha' +
        'rdwareMID,  '
      
        '  MAX(CASE WHEN S_STEP_DESC = '#39'IT'#30828#39636#20027#31649#39' THEN USERNAME END) AS Har' +
        'dwareM,  '
      
        '  MAX(CASE WHEN S_STEP_DESC = '#39'IT'#30828#39636#20027#31649#39' THEN ApproveDate END) AS ' +
        'HardwareMDate  '
      '       FROM (  '
      '      '
        ...
        'M_PRESENTATION LIKE '#39'%20240300404%'#39'  '
    ...
    object QApproverHardwareID: TWideStringField
      FieldName = 'HardwareID'
      ReadOnly = True
    end
    object QApproverHardware: TWideStringField
      FieldName = 'Hardware'
      ReadOnly = True
      Size = 30
    end
    object QApproverHardwareDate: TStringField
      FieldName = 'HardwareDate'
      ReadOnly = True
      Size = 30
    end
    object QApproverHardwareMID: TWideStringField
      FieldName = 'HardwareMID'
      ReadOnly = True
    end
    object QApproverHardwareM: TWideStringField
      FieldName = 'HardwareM'
      ReadOnly = True
      Size = 30
    end
    object QApproverHardwareMDate: TStringField
      FieldName = 'HardwareMDate'
      ReadOnly = True
      Size = 30
    end
  end
