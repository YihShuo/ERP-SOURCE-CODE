...
type
  TPurOther_PrintTW_TW = class(TForm)
    QuickRep1: TQuickRep;
...
var
  PurOther_PrintTW_TW: TPurOther_PrintTW_TW;

implementation

uses PurOther1, main1;

procedure TPurOther_PrintTW_TW.ReadIni();
var MyIni :Tinifile;
    SuperVisorID:string;
...
procedure TPurOther_PrintTW_TW.FormCreate(Sender: TObject);
  var surea,i:integer;
...
procedure TPurOther_PrintTW_TW.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TPurOther_PrintTW_TW.FormDestroy(Sender: TObject);
begin
  PurOther_PrintTW_TW:=nil;
end;
