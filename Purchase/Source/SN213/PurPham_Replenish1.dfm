object PurPham_Replenish: TPurPham_Replenish
  Left = 154
  Top = 194
  Width = 1631
  Height = 711
  Caption = 'PurPham_Replenish'
  Color = clBtnFace
  ...
  object SGDHS: TQuery
    ...
    SQL.Strings = (
      ''
        ...
        'select SGDHSS.SGNO,SGDHSS.CLBH,SGDHSS.XXCC,SGDHSS.Qty,IsNull(CGZ' +
        'LSS.okQty,0) as okQty,isnull(SGDHSS.Qty,0)-isnull(CGZLSS.okQty,0' +
        ') as Diff,'
      
        '       CLZL.YWPM,CLZL.ZWPM,BDepartment.DepName,ZSZL.ZSDH,ZSZL.zs' +
        'ywjc,SGDH.LB,SGDH.CFMID,SGDH.CFMDate,SGDH.CFMID1,SGDH.CFMDate1,S' +
        'GDH.GSBH,SGDH.USERID  '
      'from SGDHSS '
      'left join SGDH on SGDH.SGNO=SGDHSS.SGNO  '
      'left join SGDHS on SGDHS.SGNO=SGDHSS.SGNO  '
      'left join CLZL on CLZL.CLDH = SGDHSS.CLBH  '
      'Left join CGBJ on CGBJ.BJNO=SGDHS.BJNO  '
      'left join ZSZL on ZSZL.ZSDH = CGBJ.ZSBH  '
      'left join (select ZLBH,CLBH,Sum(Qty) as okQty   '
      '  '#9#9'     from CGZLSS where 1=1 Group by ZLBH,CLBH)   '
      
        '           CGZLSS on CGZLSS.CLBH=SGDHSS.CLBH and CGZLSS.ZLBH=SGD' +
        'HSS.SGNO  '
      'left join BDepartment on BDepartment.ID=SGDH.DepID  '
      'where 1=1 and  SGDHS.CLBH='#39'VD01000390'#39
      
        'and convert(smalldatetime,convert(varchar,SGDH.SGDate,111)) betw' +
        'een '
      #39'2024/04/13'#39
      ' and '
      #39'2024/05/13'#39
      'and SGDH.SGNO like '#39'20240500300%'#39' '
      'and SGDH.CFMID1<>'#39'NO'#39' '
      'and SGDH.LB='#39'05'#39' ')
    Left = 916
    Top = 274
