...
type
  TPurOtherSizeTW_Print_VN = class(TForm)
    QuickRep1: TQuickRep;
    TempSize: TQuery;
    MasSize: TQuery;
...
var
  PurOtherSizeTW_Print_VN: TPurOtherSizeTW_Print_VN;
...
procedure TPurOtherSizeTW_Print_VN.ReadIni();
var MyIni :Tinifile;
...
procedure TPurOtherSizeTW_Print_VN.FormCreate(Sender: TObject);
...
procedure TPurOtherSizeTW_Print_VN.FormDestroy(Sender: TObject);
begin
  PurOtherSizeTW_Print_VN:=nil;
end;

procedure TPurOtherSizeTW_Print_VN.FormClose(Sender: TObject;
