...
var
  Exchange_PurSize: TExchange_PurSize;
...
{$R *.dfm}
procedure TExchange_PurSize.ReadIni();
var MyIni :Tinifile;
    AppDir:string;
begin
  //
...
procedure TExchange_PurSize.FormCreate(Sender: TObject);
...
procedure TExchange_PurSize.FormDestroy(Sender: TObject);
begin
   Exchange_PurSize:=nil;
end;

procedure TExchange_PurSize.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TExchange_PurSize.Button1Click(Sender: TObject);
begin
 with query1 do
  begin
    active:=false;
...
procedure TExchange_PurSize.DBGridEh1DblClick(Sender: TObject);
begin
if query1.RecordCount>0 then
  begin
    with PurOther_BJ.Query1  do
    begin
       edit;
