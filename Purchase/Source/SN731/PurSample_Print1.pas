...
var
  PurSample_Print: TPurSample_Print;

implementation

uses PurSample1, main1;

{$R *.dfm}

procedure TPurSample_Print.FormCreate(Sender: TObject);
var i:integer;
begin
Mas.Active:=true;
Det.Active:=true;
...
if messagedlg('Just for Print not for Mail?',mtinformation,[mbYes,mbNo],0)=mrYes then
  begin
    ...
    L7.Caption:='';  
    L8.Caption:='';
    //L9.Caption:='';  //SAMPLE PURCHASE ORDER
    L10.Caption:='';
    L11.Caption:='';
    L12.Caption:='';
    L13.Caption:='';
...
procedure TPurSample_Print.FormDestroy(Sender: TObject);
begin
PurSample_Print:=nil;
end;
