object PurSample_Print_Tw_Normal: TPurSample_Print_Tw_Normal
  Left = 504
  Top = 253
  Width = 1251
  Height = 731
  Caption = 'PurSample_Print_Tw_Normal'
  Color = clBtnFace
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      #9#9',CGZL_color2.ColorWindow'
        ...
        'xpired ,#CGZLP.CLBH as CLBH ,CGZLS.Memo as Remark,#CGZLP.MatRema' +
        'rk,#CGZLP.MemoAll,#CGZLP.ZLBH'
      'from #CGZLP '
