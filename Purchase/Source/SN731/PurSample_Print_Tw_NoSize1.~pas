unit PurSample_Print_Tw_NoSize1;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, ADODB, QRPDFFilt, DBTables, DB, QRCtrls, QuickRpt, ExtCtrls, IniFiles;

type
  TPurSample_Print_Tw_NoSize = class(TForm)
    QuickRep1: TQuickRep;
...
var
  PurSample_Print_Tw_NoSize: TPurSample_Print_Tw_NoSize;
...
procedure TPurSample_Print_Tw_NoSize.ReadIni();
var MyIni :Tinifile;
...
Function TPurSample_Print_Tw_NoSize.GetConverse_ColorMemo(var Memo:String;YWPM:String):boolean;
...
procedure TPurSample_Print_Tw_NoSize.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TPurSample_Print_Tw_NoSize.FormDestroy(Sender: TObject);
begin
  PurSample_Print_Tw_NoSize:= nil;
end;

procedure TPurSample_Print_Tw_NoSize.FormCreate(Sender: TObject);
var i,j:integer;
    PartALl,FD_ALL,MemoAll:string;
