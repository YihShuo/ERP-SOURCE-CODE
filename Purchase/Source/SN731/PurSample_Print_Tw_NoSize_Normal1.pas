unit PurSample_Print_Tw_NoSize_Normal1;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, QRPDFFilt, DBTables, DB, QRCtrls, QuickRpt, ExtCtrls, IniFiles,
  ADODB;

type
  TPurSample_Print_Tw_NoSize_Normal = class(TForm)
    QuickRep1: TQuickRep;
    ...
    Query3zlbh: TStringField;
    Query4: TQuery;
    DataSource1: TDataSource;
    UpdateSQL1: TUpdateSQL;
    QRPDFFilter1: TQRPDFFilter;
    TmpQuery: TQuery;
    Query1CATEGORY: TMemoField;
    Query1Shoename: TMemoField;
...
var
  PurSample_Print_Tw_NoSize_Normal: TPurSample_Print_Tw_NoSize_Normal;
...
procedure TPurSample_Print_Tw_NoSize_Normal.ReadIni();
var MyIni :Tinifile;
...
Function TPurSample_Print_Tw_NoSize_Normal.GetConverse_ColorMemo(var Memo:String;YWPM:String):boolean;
...
procedure TPurSample_Print_Tw_NoSize_Normal.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TPurSample_Print_Tw_NoSize_Normal.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=caFree;
end;

procedure TPurSample_Print_Tw_NoSize_Normal.FormDestroy(Sender: TObject);
begin
  PurSample_Print_Tw_NoSize_Normal:=nil;
end;
