unit PurSample_Print_Tw_Normal1;
...
type
  TPurSample_Print_Tw_Normal = class(TForm)
    QuickRep1: TQuickRep;
...
var
  PurSample_Print_Tw_Normal: TPurSample_Print_Tw_Normal;
...
procedure TPurSample_Print_Tw_Normal.ReadIni();
var MyIni :Tinifile;
...
Function TPurSample_Print_Tw_Normal.GetConverse_ColorMemo(var Memo:String;YWPM:String):boolean;
...
procedure TPurSample_Print_Tw_Normal.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TPurSample_Print_Tw_Normal.FormDestroy(Sender: TObject);
begin
  PurSample_Print_Tw_Normal:=nil;
end;

procedure TPurSample_Print_Tw_Normal.FormClose(Sender: TObject;
