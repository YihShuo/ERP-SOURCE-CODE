  ...
  object Mas: TQuery
    ...
    SQL.Strings = (
      ...
      ''
        ...
        'select  ROUND(#cgzlp.qty,0)as QtyPrint,#CGZLP.*,CGZL.MEMO,CLZL.Y' +
        'WPM,CLZL.DWBH,Convert(varchar(200),'#39#39') as PartAll'
      'from #CGZLP'
    ...
    object MasQtyPrint: TCurrencyField
      FieldName = 'QtyPrint'
    end
  end
  object Det: TQuery
    ...
    SQL.Strings = (
        ...
        '.XIEMING,IsNull(KFXXZL.ARTICLE,'#39'ALL'#39') as ARTICLE,KFXXZL.FD'
      'from CGZLSS'
