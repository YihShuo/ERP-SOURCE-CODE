unit PurSampleInvoice_PrintALL1;
...
type
  TPurSampleInvoice_PrintALL = class(TForm)
    QuickRep1: TQuickRep;
...
var
  PurSampleInvoice_PrintALL: TPurSampleInvoice_PrintALL;
...
procedure TPurSampleInvoice_PrintALL.FormCreate(Sender: TObject);
var i:integer;
begin
...
procedure TPurSampleInvoice_PrintALL.FormDestroy(Sender: TObject);
begin
PurSampleInvoice_PrintALL:=nil;
end;
