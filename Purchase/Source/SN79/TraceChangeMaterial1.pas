...
//2021/03/06 Kevin 加上JiJie  KFJD 季節，階段兩個資料
    sql.Add('YPZL_log.ypcco,YPZL_log.ypccl,YPZL_log.userdate,YPZL_log.userID,kfxxzl.JiJie,YPZL.KFJD,YPZL.FD,kfxxzl.YSSM,');
...
//2021/03/06 Kevin 加上JiJie  KFJD 季節，階段兩個資料
    ...
    sql.Add('where 1=1 and YPZL.GSDH = '''+ main.Edit2.Text +'''');
...
//2021/03/06 Kevin 加上JiJie  KFJD 季節，階段兩個資料
    ...
    sql.Add('left join (select zsdh,gsbh,Samplepurchaser from zszl_dev where gsbh='''+main.edit2.text+''')zszl_dev on main.CSBH=zszl_dev.zsdh');
...
//2021/03/06 Kevin 加上JiJie  KFJD 季節，階段兩個資料
    sql.Add('main.JiJie,main.KFJD,main.FD,main.YSSM');
