...
with Qry_Copy do
  begin
    ...
    if MaterialMOQ.edit3.Text<>'' then
       sql.add(' and ZSZL.ZSYWJC like '''+'%'+MaterialMOQ.edit3.Text+'%'+'''');
    if MaterialMOQ.edit5.Text<>'' then
       sql.add(' and ZSZL.zsdh='+''''+MaterialMOQ.edit5.Text+'''');
