...
uses main1, funUnit, CBYtoSpec_XXZL1;
...
procedure TCBYSizeComparison.QColorAfterOpen(DataSet: TDataSet);
begin
  BB2.Enabled:=true;
  BB3.Enabled:=true;
  BB4.Enabled:=true;
...
procedure TCBYSizeComparison.DBGridEh1EditButtonClick(Sender: TObject);
begin
  CBYtoSpec_XXZL:=TCBYtoSpec_XXZL.Create(self);
  CBYtoSpec_XXZL.ShowModal();
  CBYtoSpec_XXZL.Free;
end;
