  ...
  object U_USERGROUPS: TMyADOUpdateSQL
    ...
    ZInsertCommandObj.SQL.Strings = (
      'INSERT INTO LYN_USERGROUPS'
        ...
        '   (UserID, UserNameTW, UserName, Factory, Department, Position,' +
        ' JoinDate, CFMID, CFMNAME, CFMID1, CFMNAME1, Nation, ID, DATE, Y' +
        'N)'
      'VALUES'
      
        '   (:UserID, :UserNameTW, :UserName, :Factory, :Department, :Pos' +
        'ition, :JoinDate, :CFMID, :CFMNAME, :CFMID1, :CFMNAME1, :Nation,' +
        ' :ID, GETDATE(), '#39'1'#39')')
    ...
    SQLInsert = 
      ...
      'ctory, Department, Position, JoinDate, CFMID, CFMNAME, CFMID1, C' +
      'FMNAME1, Nation, ID, DATE, YN)'#13#10'VALUES'#13#10'   (:UserID, :UserNameTW' +
      ', :UserName, :Factory, :Department, :Position, :JoinDate, :CFMID' +
      ', :CFMNAME, :CFMID1, :CFMNAME1, :Nation, :ID, GETDATE(), '#39'1'#39')'
    SQLModify = 
      ...
      'Department =:Department,'#13#10'  Position =:Position,'#13#10'  JoinDate=:Jo' +
      'inDate,'#13#10'  CFMID =:CFMID,'#13#10'  CFMNAME = :CFMNAME,'#13#10'  CFMID1 =:CFM' +
      'ID1,'#13#10'  CFMNAME1 =:CFMNAME1,'#13#10'  Nation =:Nation,'#13#10'  ID = :ID,'#13#10' ' +
      ' DATE = GETDATE()'#13#10' WHERE'#13#10'  UserID = :OLD_UserID'
    Left = 88
    Top = 408
  end
