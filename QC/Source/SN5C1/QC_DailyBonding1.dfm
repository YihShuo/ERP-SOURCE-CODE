object QC_DailyBonding: TQC_DailyBonding
  ...
  object LabTS: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'Select QC_LabTS.*,XXZL.XieMing,BDepartment.DepName from QC_LabTS'
      
        'left join XXZL on QC_LabTS.XieXing=XXZL.XieMing and QC_LabTS.She' +
        'Hao=XXZL.SheHao'
      'left join BDepartment on BDepartment.ID=QC_LabTS.DepNO')
    UpdateObject = UpdLabTS
    Left = 232
    Top = 176
    object LabTSTSNO: TStringField
      FieldName = 'TSNO'
      FixedChar = True
      Size = 10
    end
    ...
    object LabTSMemo1: TStringField
      FieldName = 'Memo1'
      FixedChar = True
      Size = 30
    end
    object LabTSMemo2: TStringField
      FieldName = 'Memo2'
      FixedChar = True
      Size = 30
    end
  ...
  object LabTSS: TQuery
    ...
    DataSource = MasDS
    SQL.Strings = (
      'Select * from QC_LabTSS where TSNO=:TSNO')
    Left = 704
    Top = 224
    ParamData = <
      item
    ...
    object LabTSSTSNO: TStringField
      FieldName = 'TSNO'
      Origin = 'DB.QC_LabTSS.TSNO'
      FixedChar = True
      Size = 10
    end
    object LabTSSSCBH: TStringField
      FieldName = 'SCBH'
      Origin = 'DB.QC_LabTSS.SCBH'
      FixedChar = True
      Size = 10
    end
    object LabTSSUserID: TStringField
      FieldName = 'UserID'
      Origin = 'DB.QC_LabTSS.UserID'
      FixedChar = True
      Size = 10
    end
    object LabTSSUserDate: TDateTimeField
      FieldName = 'UserDate'
      Origin = 'DB.QC_LabTSS.UserDate'
    end
  end
