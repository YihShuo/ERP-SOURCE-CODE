object TestItem: TTestItem
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'Select GSBH,Brand,TestID,TestReason,UserID,UserDate,YN from Lab_' +
        'TestReason where 1=2')
  ...
  object UpdateSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'UserID=:UserID,'
      'UserDate=:UserDate'
      'where TestID=:OLD_TestID and GSBH=:OLD_GSBH'
      '')
    InsertSQL.Strings = (
      'insert into Lab_TestReason'
      '(GSBH,Brand,TestID,TestReason,UserID,UserDate,YN)'
      'Values'
      '(:GSBH,:Brand,:TestID,:TestReason,:UserID,:UserDate,:YN)'
      '')
    DeleteSQL.Strings = (
      'delete  Lab_TestReason'
      'where  testID=:OLD_testID and GSBH=:OLD_GSBH'
      '')
    Left = 265
    Top = 321
