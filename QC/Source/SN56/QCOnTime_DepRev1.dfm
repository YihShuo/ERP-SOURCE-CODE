object QCOnTime_DepRev: TQCOnTime_DepRev
  Left = 458
  Top = 304
  Width = 766
  Height = 545
  BorderIcons = []
  Caption = 'PickProdRyForm'
  Color = clBtnFace
  ...
  object qry1: TQuery
    ...
    SQL.Strings = (
        ...
        'select distinct smdd.ysbh ,x.XieXing,x.SheHao,x.DAOMH,x.XieMing ' +
        'from smdd '
      'left join zlzl on zlzl.zlbh=smdd.ysbh  '
      'left join ddzl on ddzl.ddbh=smdd.ysbh  '
      
        'inner join xxzl x on x.XieXing =ddzl.XieXing and x.SheHao=ddzl.S' +
        'heHao '
      'where 1 = 2;')
    Left = 422
    Top = 345
    object qry1ysbh: TStringField
      FieldName = 'ysbh'
      FixedChar = True
      Size = 15
    end
