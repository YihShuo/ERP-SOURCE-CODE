...
begin
  ...
  SourceFile := '\\192.168.71.11\FileServer\WebData\upload-QC\' + main.Edit2.Text + '\N93\' + FileName;
...
begin
  ...
  BasePath := '\\192.168.71.11\FileServer\WebData\upload-QC\' + main.Edit2.Text + '\N93\';
