...
uses
  ...
  Dialogs, DB, DBTables, GridsEh, DBGridEh, StdCtrls, Buttons;
...
procedure TN721Detail1.BitBtn1Click(Sender: TObject);
begin
  with Qmc do
    begin
      active := false;
  ...
  begin
    ...
    begin
      ...
      begin
          ...
          FieldByName('Supplier').AsString := Qmc.FieldByName('SupplierName').AsString;
          FieldByName('CLBH').AsString := Qmc.FieldByName('CLBH').AsString;
          FieldByName('MatName').AsString := Qmc.FieldByName('MaterialName').AsString;
          ...
          FieldByName('DeReason').AsString := Qmc.FieldByName('QC_Reason').AsString;
