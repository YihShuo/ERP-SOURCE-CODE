object LeatherMatInspection: TLeatherMatInspection
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
      ...
      'ThickStand, Reality, Color, AA, BB, CC, DD, '
  ...
  object QDetail: TQuery
    ...
    SQL.Strings = (
        ...
        'select *, CONVERT(numeric(18,2), TotalSF*PercentGrade/100) as Us' +
        'eSF,'
      
        'CONVERT(numeric(18,2), (PercentGrade-PercentNCU)*TotalSF/100) as' +
        ' CompenSF '
      'from QC_LeatherInspecDetail'
    ...
    object QDetailGrade: TStringField
      FieldName = 'Grade'
      FixedChar = True
    end
    object QDetailTotalSF: TCurrencyField
      FieldName = 'TotalSF'
      currency = False
    end
    object QDetailPercentGrade: TIntegerField
      FieldName = 'PercentGrade'
    end
    ...
    object QDetailYN: TIntegerField
      FieldName = 'YN'
    end
    object QDetailPercentNCU: TIntegerField
      FieldName = 'PercentNCU'
    end
    object QDetailUseSF: TFloatField
      FieldName = 'UseSF'
    end
    object QDetailCompenSF: TFloatField
      FieldName = 'CompenSF'
    end
  end
  ...
  object UpDetail: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  Grade = :OLD_Grade')
    InsertSQL.Strings = (
      'insert into QC_LeatherInspecDetail'
      
        '  (ReportID, Grade, TotalSF, PercentGrade, USERID, USERDate, YN,' +
        ' PercentNCU)'
      'values'
      
        '  (:ReportID, :Grade, :TotalSF, :PercentGrade, :USERID, :USERDat' +
        'e, :YN, '
      '   :PercentNCU)')
    DeleteSQL.Strings = (
      'delete from QC_LeatherInspecDetail'
      'where'
      '  ReportID = :OLD_ReportID and'
      '  Grade = :OLD_Grade')
    Left = 432
