object VOC_List: TVOC_List
  Left = 317
  Top = 118
  Width = 1024
  Height = 633
  Caption = 'VOC Tracking Report'
  Color = clBtnFace
  ...
  object UpSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into QIPVOC'
        ...
        '  (DepNo, ProdDate, Pairs, PU45311NT1, WPL01, WH03, T6127T, Prim' +
        'er297, '
      
        '   P311FT_6primer, Hotmelt1438A, Hotmelt3173H, NCwhitetransparen' +
        't, MWaterbase, '
      
        '   Latex, A102, ABwhitetransparent, RB13F, C237F, AD752S, A5, A3' +
        ', AD5500, '
      '   A05W1A, HM401hotmelt, A722, USERID, USERDATE, YN)'
      'values'
      
        '  (:DepNo, :ProdDate, :Pairs, :PU45311NT1, :WPL01, :WH03, :T6127' +
        'T, :Primer297, '
      
        '   :P311FT_6primer, :Hotmelt1438A, :Hotmelt3173H, :NCwhitetransp' +
        'arent, '
      
        '   :MWaterbase, :Latex, :A102, :ABwhitetransparent, :RB13F, :C23' +
        '7F, :AD752S, '
      
        '   :A5, :A3, :AD5500, :A05W1A, :HM401hotmelt, :A722, :USERID, :U' +
        'SERDATE, '
      '   :YN)')
    DeleteSQL.Strings = (
      'delete from QIPVOC'
