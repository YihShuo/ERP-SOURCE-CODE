object StockOut_BC: TStockOut_BC
  ...
  object QKCLLS: TQuery
    ...
    SQL.Strings = (
        ...
        ' KCLLS_BC.YN,KCBH,Carton_No,RKNO,DefectID,RorL'
      ' FROM KCLLS_BC'
    ...
    object QKCLLSRorL: TStringField
      FieldName = 'RorL'
      FixedChar = True
      Size = 5
    end
  ...
  object Qry_rupdate: TQuery
    ...
    SQL.Strings = (
      ...
      ',Qty,ISNULL(RemainQty, Qty) as RemainQty,KCRK_BC.CFMDate, RorL'
      'from KCRKS_BC'
    ...
    object Qry_rupdateRorL: TStringField
      FieldName = 'RorL'
      FixedChar = True
      Size = 5
    end
