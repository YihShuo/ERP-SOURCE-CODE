object ShoeTest: TShoeTest
        ...
        object DBGridEh2: TDBGridEh
          ...
          Columns = <
            ...
            item
              ...
              PickList.Strings = (
                'Material failure'
                'Upper to foxing tape get delamination'
                'Foxing tape to friction tape get delamination'
                'Friction tape to textile get delamination'
                'Rubber broken'
                'Printing cracking'
                'Varnish peel off'
                'Poor bonding'
  ...
  object Query2: TQuery
    ...
    SQL.Strings = (
        ...
        'lab_shoetests.Times,Sampleroom,Materialteam,Outsolefactory,Rubbe' +
        'rfactory,Printingfacory from lab_shoetests'
    ...
    object Query2UserID1: TStringField
      FieldName = 'UserID1'
    end
  ...
  object UpdateSQL2: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'Materialteam=:Materialteam,'
      'Outsolefactory=:Outsolefactory,'
      'Rubberfactory=:Rubberfactory,'
      'Printingfacory=:Printingfacory,'
    ...
    InsertSQL.Strings = (
      'insert into Lab_ShoeTests'
        ...
        ',UserDate,ApprovedUserID,InspectedID,Standard,Times,Sampleroom,M' +
        'aterialteam,Outsolefactory,Rubberfactory,Printingfacory)'
      'Values'
      
        '(:TestNO,:TestID,:serial,:Result,:Comment,:FailureReason,:Remark' +
        ',:UserID ,:UserDate ,:ApprovedUserID,:InspectedID,:Standard,:Tim' +
        'es,:Sampleroom,:Materialteam,:Outsolefactory,:Rubberfactory,:Pri' +
        'ntingfacory)')
    DeleteSQL.Strings = (
