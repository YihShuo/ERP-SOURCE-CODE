object Deliver_EquipmentT: TDeliver_EquipmentT
  Left = 397
  Top = 331
  Caption = 'Deliver EquipmentT'
  ClientHeight = 540
  ClientWidth = 1025
  Color = clBtnFace
      ...
      object DBGrid1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'Memo'
            Footers = <>
            Title.Caption = #20511#20837#21934#34399'|Memo'
            Width = 98
          end
          item
            CellButtons = <>
  ...
  object DelMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCTT.*,BDepartment.DepName'
      'from TSCD_KCTT'
      'left join BDepartment on TSCD_KCTT.DepID=BDepartment.ID'
      'where TSCD_KCTT.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCTT.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCTTS.LLNO,TSCD_KCTTS.TSID'
        ...
        'Memo,TSCD_KCTTS.USERID,TSCD_KCTTS.USERDATE,TSCD_KCTTS.YN'
