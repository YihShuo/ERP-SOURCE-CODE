object EquipmentT: TEquipmentT
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'JRBDATE'
        Footers = <>
        Title.Caption = #20511#20837#26085#26399'|JRBDATE'
      end
      item
        CellButtons = <>
        DynProps = <>
        ...
        FieldName = 'JREDATE'
        Footers = <>
        Title.Caption = #20511#20837#27512#36996'|JREDATE'
      end
      item
        CellButtons = <>
        DynProps = <>
  ...
  object Query1: TQuery
    ...
    SQL.Strings = (
        ...
        'SBH,TSCD.NSX,TSCD.InDATE,TSCD.JRBDATE,TSCD.JREDATE,IsNull(TSCD.J' +
        'RTS,TSCD.DepID) as DepID,TSCD.DepID_Memo,IsNull(JDBDep.DepName,B' +
      ...
      'left join BDepartment JDBDep on JDBDep.ID=TSCD.JRTS '
      'where TSCD.SBBH like '#39'%'#39' and TSCD.LB=1'
      
        'and TSCD.TSID in (select TSID from TSCD_KCLLS where LLNO='#39'202212' +
        '00001'#39') '
      'order by TSID')
    Left = 232
    Top = 192
    ...
    object Query1JRBDATE: TStringField
      FieldName = 'JRBDATE'
      FixedChar = True
      Size = 12
    end
    object Query1JREDATE: TStringField
      FieldName = 'JREDATE'
      FixedChar = True
      Size = 12
    end
