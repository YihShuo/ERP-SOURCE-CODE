...
begin
  ...
  begin
    ...
    begin
      ...
      SQl.Add('Select ROW_NUMBER() OVER(ORDER BY TSCD.TSID ) AS STT,TSCD.* into #tmp from (');
      //資產設備入庫單TSCD
      SQL.Add('Select TSCD.*');
      ...
      SQL.Add('select * from #tmp order by TSID');
      ...
      try
        ...
        try
          ...
          DataQuery.SQL.Text :=
            ...
            '    SELECT ROW_NUMBER() OVER (ORDER BY TSID) as Seq, ' +
            '           TSBH, ' +
