object DeliveryConfirm: TDeliveryConfirm
  Left = 0
  Top = 0
  Caption = 'DeliveryConfirm'
  ClientHeight = 479
  ClientWidth = 1132
  Color = clBtnFace
  ...
  object DelMas: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'select TSCD_KCLL.*,BDepartment.DepName'
      'from TSCD_KCLL'
      'left join BDepartment on TSCD_KCLL.DepID=BDepartment.ID'
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCLLS.LLNO,TSCD_KCLLS.TSID'
        ...
        ',TSCD.SBBH,TSCD_SB.YWPM,TSCD_SB.ZWPM,IsNull(JDBDep.DepName,BDepa' +
        'rtment.DepName) as DepName,TSCD.DepID_Memo,TSCD_KCLLS.USERID,TSC' +
        'D_KCLLS.USERDATE,TSCD_KCLLS.YN'
