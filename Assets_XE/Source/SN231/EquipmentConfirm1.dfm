object EquipmentConfirm: TEquipmentConfirm
  Left = 394
  Top = 297
  Caption = 'Equipment Confirm'
  ClientHeight = 574
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelMas: TQuery
    ...
    SQL.Strings = (
      ...
      'and '#39'2033/02/15'#39
      'and TSCD_KCLL.LLNO like '#39'%'#39
      'and BDepartment.GSBH='#39'VDH'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCLLS.LLNO,TSCD_KCLLS.TSID'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCLLS.USERID,TSCD_KCLLS.USE' +
        'RDATE,TSCD_KCLLS.YN'
