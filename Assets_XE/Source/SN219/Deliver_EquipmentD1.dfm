object Deliver_EquipmentD: TDeliver_EquipmentD
  Left = 397
  Top = 331
  Caption = 'Deliver EquipmentD'
  ClientHeight = 753
  ClientWidth = 1346
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object NOTSBH: TCheckBox
      Left = 872
      Top = 8
      Width = 121
      Height = 17
      Caption = 'Kh'#244'ng M'#227' T'#224'i S'#7843'n   '
      TabOrder = 12
    end
  end
  ...
  object PC1: TPageControl
        ...
        object DBGrid2: TDBGridEh
          ...
          Columns = <
            item
              ...
              Footers = <>
              ReadOnly = True
              Title.Caption = #36001#29986#32232#34399'|TSID'
            end
            item
              CellButtons = <>
              DynProps = <>
            ...
            item
              ...
              FieldName = 'Maintain'
              Footers = <>
              Title.Caption = #20445#39178'|Maintain'
            end
            item
              CellButtons = <>
              DynProps = <>
              ...
              Footers = <>
              Title.Caption = #25925#38556'|Malfunction'
            end
            item
              CellButtons = <>
              DynProps = <>
    ...
    object SearchSheet: TTabSheet
      ...
      object Panel7: TPanel
        ...
        object dtSearch1: TDateTimePicker
          Left = 228
          Top = 64
          Width = 113
          Height = 25
        ...
        object dtSearch2: TDateTimePicker
          Left = 372
          Top = 64
          Width = 113
          Height = 25
  ...
  object DelMas: TQuery
    ...
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCDD.*,BDepartment.DepName'
      'from TSCD_KCDD'
      'left join BDepartment on TSCD_KCDD.DepID=BDepartment.ID'
      'where TSCD_KCDD.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCDD.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCDDS.LLNO,TSCD_KCDDS.TSID'
        ...
        '.ZWPM,clzl.zwpm) as ZWPM,TSCD_SB.DWBH,IsNull(JDBDep.DepName,BDep' +
        'artment.DepName) as DepName,TSCD.DepID_Memo,TSCD_KCDDS.USERID,TS' +
        'CD_KCDDS.USERDATE,TSCD_KCDDS.YN'
      
        ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCDDS.Qty,TS' +
        'CD_KCDDS.Maintain,TSCD_KCDDS.Malfunction'
      'from TSCD_KCDDS'
    ...
    object DelDetMaintain: TBooleanField
      FieldName = 'Maintain'
    end
    object DelDetMalfunction: TBooleanField
      FieldName = 'Malfunction'
    end
  end
  object UPDet: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into TSCD_KCDDS'
        ...
        'MENT6, VALUE6, COLUMN6, USERDATE, USERID, YN, Maintain, Malfunct' +
        'ion)'
      'values'
        ...
        ' :PARAMENT6, :VALUE6, :COLUMN6, :USERDATE, :USERID, :YN, :Mainta' +
        'in, :Malfunction)')
    DeleteSQL.Strings = (
      'delete from TSCD_KCDDS'
      'where'
      '  LLNO = :OLD_LLNO AND'
      '  TSID = :OLD_TSID'
      '')
  ...
  object UpKCPK: TUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      '(LLNO, TSID, CLBH, Qty, UserID, UserDate)'
      'values'
      '(:LLNO, :TSID, :CLBH, :Qty, :UserID, :UserDate)')
    DeleteSQL.Strings = (
      'Delete TSCD_KCLLSS'
  ...
  object KCPK: TQuery
    ...
    DataSource = DS2
    SQL.Strings = (
      'SELECT [SNO],[LLNO],[TSID],[CLBH],[Qty]'
      '      ,[USERID],[USERDATE],[YN]'
      'FROM [TSCD_KCLLSS] '
      'where [TSID]=:TSID and LLNO=:LLNO')
    UpdateObject = UpKCPK
    Left = 40
    Top = 533
    ParamData = <
  ...
  object KCPKSearch: TQuery
    ...
    object KCPKSearchYWPM: TStringField
      FieldName = 'YWPM'
    end
    object KCPKSearchVWPM: TStringField
      FieldName = 'VWPM'
    end
    object KCPKSearchZWPM: TStringField
      FieldName = 'ZWPM'
    end
