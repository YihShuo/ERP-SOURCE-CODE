object EquipmentConfirm_MM: TEquipmentConfirm_MM
  Left = 394
  Top = 297
  Caption = 'Lend Equipment Confirm'
  ClientHeight = 574
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'select TSCD_KCMMS.LLNO,TSCD_KCMMS.TSID'
      
        ',TSCD_KCMMS.PARAMENT1,TSCD_KCMMS.PARAMENT2,TSCD_KCMMS.PARAMENT3,' +
        'TSCD_KCMMS.PARAMENT4,TSCD_KCMMS.PARAMENT5,TSCD_KCMMS.PARAMENT6'
      
        ',TSCD_KCMMS.VALUE1,TSCD_KCMMS.VALUE2,TSCD_KCMMS.VALUE3,TSCD_KCMM' +
        'S.VALUE4,TSCD_KCMMS.VALUE5,TSCD_KCMMS.VALUE6'
      
        ',TSCD_KCMMS.COLUMN1,TSCD_KCMMS.COLUMN2,TSCD_KCMMS.COLUMN3,TSCD_K' +
        'CMMS.COLUMN4,TSCD_KCMMS.COLUMN5,TSCD_KCMMS.COLUMN6'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCMMS.USERID,TSCD_KCMMS.USE' +
        'RDATE,TSCD_KCMMS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCMMS.Qty'
      'from TSCD_KCMMS'
      'left join TSCD on TSCD.TSID=TSCD_KCMMS.TSID'
      ...
      'where TSCD_KCMMS.LLNO=:LLNO'
      'order by TSCD_KCMMS.LLNO'
      '')
    UpdateObject = UPDet
    Left = 468
    Top = 132
