object Deliver_EquipmentS: TDeliver_EquipmentS
  Left = 406
  Top = 334
  Caption = 'Deliver EquipmentS'
  ClientHeight = 740
  ClientWidth = 1126
  Color = clBtnFace
  ...
  object DelMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCSS.*,BDepartment.DepName'
      'from TSCD_KCSS'
      'left join BDepartment on TSCD_KCSS.DepID=BDepartment.ID'
      'where TSCD_KCSS.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCSS.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCSSS.LLNO,TSCD_KCSSS.TSID'
        ...
        '       ,TSCD_KCSSS.PARAMENT1,TSCD_KCSSS.PARAMENT2,TSCD_KCSSS.PAR' +
        'AMENT3,TSCD_KCSSS.PARAMENT4,TSCD_KCSSS.PARAMENT5'
      
        '       ,TSCD_KCSSS.VALUE1,TSCD_KCSSS.VALUE2,TSCD_KCSSS.VALUE3,TS' +
        'CD_KCSSS.VALUE4,TSCD_KCSSS.VALUE5'
      
        '       ,TSCD_KCSSS.COLUMN1,TSCD_KCSSS.COLUMN2,TSCD_KCSSS.COLUMN3' +
        ',TSCD_KCSSS.COLUMN4,TSCD_KCSSS.COLUMN5'
      
        '       ,TSCD.SBBH,IsNull(TSCD_SB.YWPM,CLZL.YWPM) as YWPM,IsNull(' +
        'TSCD_SB.ZWPM,CLZL.ZWPM) as ZWPM,IsNull(TSCD_SB.VWPM,CLZL.YWPM) a' +
        's VWPM,IsNull(JDBDep.DepName,BDepartment.DepName) as DepName,TSC' +
        'D.DepID_Memo,TSCD_KCSSS.USERID,TSCD_KCSSS.USERDATE,TSCD_KCSSS.YN'
      '       ,TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX'
      '       ,TSCD.TSBH'
      '       ,TSCD_KCSSS.Qty'
      'from TSCD_KCSSS'
