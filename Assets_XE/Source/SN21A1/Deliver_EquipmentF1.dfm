object Deliver_EquipmentF: TDeliver_EquipmentF
  Left = 330
  Top = 272
  Caption = 'Deliver EquipmentF'
  ClientHeight = 642
  ClientWidth = 1025
  Color = clBtnFace
  ...
  object DelMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCFF.*,BDepartment.DepName'
      'from TSCD_KCFF'
      'left join BDepartment on TSCD_KCFF.DepID=BDepartment.ID'
      'where TSCD_KCFF.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCFF.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCFFS.LLNO,TSCD_KCFFS.TSID'
        ...
        'Memo,TSCD_KCFFS.USERID,TSCD_KCFFS.USERDATE,TSCD_KCFFS.YN'
  ...
  object UpdTSCD: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into TSCD'
        ...
        '  (TSID , TSBH  , SBBH, Qty, XSBH, NSX, Status, InDate, DepID, D' +
        'epID_Memo,'
      '   USERID ,USERDATE ,YN , CFMID, CFMID_RK, CFMID_LL, RKNO, LB)'
      'values'
      
        '  (:TSID , :TSBH  , :SBBH, :Qty, :XSBH, :NSX, :Status, :InDate, ' +
        ':DepID, :DepID_Memo,'
