object ChangeEquipmentC: TChangeEquipmentC
  Left = 0
  Top = 0
  Caption = 'Change DepIDMemo EquipmentC'
  ClientHeight = 540
  ClientWidth = 1025
  Color = clBtnFace
      ...
      object Panel3: TPanel
        ...
        object CC_GBox: TGroupBox
          ...
          object Label21: TLabel
            ...
            Width = 111
            Height = 13
            Caption = 'Thay doi ghi chu don vi'
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clBlue
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
          ...
          object Label27: TLabel
            ...
            Width = 138
            Height = 13
            Caption = 'Nhap Ghi chu = DepIDMemo'
            Font.Charset = DEFAULT_CHARSET
  ...
  object DelMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCCC.*,BDepartment.DepName'
      'from TSCD_KCCC'
      'left join BDepartment on TSCD_KCCC.DepID=BDepartment.ID'
      'where TSCD_KCCC.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCCC.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object UpMas: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  LLNO = :OLD_LLNO')
    InsertSQL.Strings = (
      'insert into TSCD_KCCC'
      '  (LLNO, GSBH, DepID, LB, USERID, USERDATE, CFMID, CFMDate, YN)'
      'values'
      
        '  (:LLNO, :GSBH, :DepID, :LB, :USERID, :USERDATE, :CFMID, :CFMDa' +
        'te, :YN)'
      '')
    DeleteSQL.Strings = (
      'delete from TSCD_KCCC'
      'where'
      '  LLNO = :OLD_LLNO')
    Left = 212
    Top = 434
  ...
  object UPDet: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '')
    InsertSQL.Strings = (
      'insert into TSCD_KCCCS'
      
        '  (LLNO, TSID, Qty, PARAMENT1, VALUE1, COLUMN1, PARAMENT2, VALUE' +
        '2, COLUMN2, PARAMENT3, VALUE3, COLUMN3,  PARAMENT4, VALUE4, COLU' +
        'MN4,  PARAMENT5, VALUE5, COLUMN5, COLUMN6,'
      '   USERDATE, USERID, YN)'
      'values'
      
        '  (:LLNO, :TSID, :Qty, :PARAMENT1, :VALUE1, :COLUMN1, :PARAMENT2' +
        ', :VALUE2, :COLUMN2,  :PARAMENT3, :VALUE3, :COLUMN3, :PARAMENT4,' +
        ' :VALUE4, :COLUMN4, :PARAMENT5, :VALUE5, :COLUMN5, :COLUMN6,'
      '    :USERDATE, :USERID, :YN)')
    DeleteSQL.Strings = (
      'delete from TSCD_KCCCS'
      'where'
      '  LLNO = :OLD_LLNO AND'
      '  TSID = :OLD_TSID'
      '')
  ...
  object DelDet: TQuery
    ...
    DataSource = DS1
    SQL.Strings = (
      'select TSCD_KCCCS.LLNO,TSCD_KCCCS.TSID'
      
        ',TSCD_KCCCS.PARAMENT1,TSCD_KCCCS.PARAMENT2,TSCD_KCCCS.PARAMENT3,' +
        'TSCD_KCCCS.PARAMENT4,TSCD_KCCCS.PARAMENT5,TSCD_KCCCS.PARAMENT6'
      
        ',TSCD_KCCCS.VALUE1,TSCD_KCCCS.VALUE2,TSCD_KCCCS.VALUE3,TSCD_KCCC' +
        'S.VALUE4,TSCD_KCCCS.VALUE5,TSCD_KCCCS.VALUE6'
      
        ',TSCD_KCCCS.COLUMN1,TSCD_KCCCS.COLUMN2,TSCD_KCCCS.COLUMN3,TSCD_K' +
        'CCCS.COLUMN4,TSCD_KCCCS.COLUMN5,TSCD_KCCCS.COLUMN6'
      
        ',TSCD.SBBH,IsNull(TSCD_SB.YWPM,CLZL.YWPM) as YWPM,IsNull(TSCD_SB' +
        '.ZWPM,CLZL.ZWPM) as ZWPM,IsNull(TSCD_SB.VWPM,CLZL.YWPM) as VWPM,' +
        'IsNull(JDBDep.DepName,BDepartment.DepName) as DepName,TSCD.DepID' +
        '_Memo,TSCD_KCCCS.USERID,TSCD_KCCCS.USERDATE,TSCD_KCCCS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCCCS.Qty'
      'from TSCD_KCCCS'
      'left join TSCD on TSCD.TSID=TSCD_KCCCS.TSID'
      ...
      'where TSCD_KCCCS.LLNO=:LLNO'
      'order by TSCD_KCCCS.LLNO')
    UpdateObject = UPDet
    Left = 404
    Top = 388
    ParamData = <
