...
var
  EquipmentB: TEquipmentB;

implementation

uses Deliver_EquipmentB1, main1, FunUnit;

{$R *.dfm}


procedure TEquipmentB.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure TEquipmentB.Button1Click(Sender: TObject);
var SubSQL:String;
begin
  //
  with Query1 do
...
procedure TEquipmentB.FormDestroy(Sender: TObject);
begin
  EquipmentB:=nil;
end;

procedure TEquipmentB.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=Cafree;
end;

procedure TEquipmentB.Button2Click(Sender: TObject);
var i,j:integer;
    bm:Tbookmark;
