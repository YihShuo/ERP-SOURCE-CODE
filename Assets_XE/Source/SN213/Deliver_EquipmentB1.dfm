object Deliver_EquipmentB: TDeliver_EquipmentB
  Left = 425
  Top = 321
  ...
  object DelMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCBB.*,BDepartment.DepName'
      'from TSCD_KCBB'
      'left join BDepartment on TSCD_KCBB.DepID=BDepartment.ID'
      'where TSCD_KCBB.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCBB.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCBBS.LLNO,TSCD_KCBBS.TSID'
        ...
        'TSCD_KCBBS.PARAMENT4,TSCD_KCBBS.PARAMENT5'
      
        ',TSCD_KCBBS.VALUE1,TSCD_KCBBS.VALUE2,TSCD_KCBBS.VALUE3,TSCD_KCBB' +
        'S.VALUE4,TSCD_KCBBS.VALUE5'
        ...
        '_Memo,TSCD_KCBBS.USERID,TSCD_KCBBS.USERDATE,TSCD_KCBBS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX'
      
        ',case when left(TSCD.LABEL_Tag,1)='#39'A'#39' then TSCD.LABEL_Tag else T' +
        'SCD.TSBH end as TSBH'
      ',TSBH as TSBH1'
      ',TSCD_KCBBS.Qty'
      'from TSCD_KCBBS'
    ...
    object DelDetTSBH1: TStringField
      FieldName = 'TSBH1'
      FixedChar = True
      Size = 15
    end
