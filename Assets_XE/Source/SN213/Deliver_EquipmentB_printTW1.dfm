object Deliver_EquipmentB_printTW: TDeliver_EquipmentB_printTW
  Left = 532
  Top = 259
  Caption = 'Deliver_EquipmentB_printTW'
  ClientHeight = 699
  ClientWidth = 835
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object PageHeaderBand1: TQRBand
      ...
      object QRLabel20: TQRLabel
        ...
        Alignment = taLeftJustify
        AlignToBand = False
        Caption = 'S'#7889' '#273#417'n v'#7883' '#32232' '#34399
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
    ...
    object QRBand2: TQRBand
      ...
      object QRLabel22: TQRLabel
        ...
        AlignToBand = False
        AutoSize = False
        Caption = 'Nguy'#234'n nh'#226'n b'#225'o ph'#7871' '#22577#24290#21407#22240' Ng'#432#7901'i xin '#30003#35531#20154
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel23: TQRLabel
        ...
        AlignToBand = False
        AutoSize = False
        Caption = 'K'#7871't qu'#7843' gi'#225'm '#273#7883'nh '#37969#23450#32080#26524' Ch'#7911' qu'#7843'n '#273#417'n v'#7883' '#21934#20301#20027#31649
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel26: TQRLabel
        ...
        AutoSize = False
        Caption = 
          'Ghi ch'#250' '#20633#35387':S'#7917' d'#7909'ng cho khu'#244'n, gi'#225', t'#224'i s'#7843'n c'#7889' '#273#7883'nh, d'#7909'ng c'#7909' '#273'o l' +
          #432#7901'ng'#8230'v'#224' c'#225'i kh'#225'c '#27169#27835#20855#65292#22266#23450#36039#29986#65292#37327#35215#20736#22120#12289#27298#20855#65292#20854#20182#20351#29992
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
  ...
  object KCLLSQry: TQuery
    ...
    SQL.Strings = (
        ...
        'select   CAST(substring (( select '#39','#39' + IsNull(TSCD_SB.VWPM,CLZL' +
        '.YWPM)'
      ...
      #9#9#9#9#9#9'for XML Path ('#39#39')),2,1000) as varchar(1000))  as ZWPM'
        ...
        '    ,CAST(substring (( select '#39','#39' + case when left(TSCD.LABEL_Ta' +
        'g,1)='#39'A'#39' then TSCD.LABEL_Tag else TSCD.TSBH end'
