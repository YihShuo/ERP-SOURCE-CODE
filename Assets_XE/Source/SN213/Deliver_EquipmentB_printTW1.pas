unit Deliver_EquipmentB_printTW1;
...
type
  TDeliver_EquipmentB_printTW = class(TForm)
    QuickRep1: TQuickRep;
...
var
  Deliver_EquipmentB_printTW: TDeliver_EquipmentB_printTW;

implementation
  uses Deliver_EquipmentB1, main1;
{$R *.dfm}

procedure TDeliver_EquipmentB_printTW.Readini();
var MyIni :Tinifile;
...
procedure TDeliver_EquipmentB_printTW.FormCreate(Sender: TObject);
begin
  ReadIni();
  qry_id.Active:=true;
...
procedure TDeliver_EquipmentB_printTW.FormDestroy(Sender: TObject);
begin
  Deliver_EquipmentB_printTW:=nil;
end;

procedure TDeliver_EquipmentB_printTW.FormClose(Sender: TObject;
