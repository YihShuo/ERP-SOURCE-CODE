object NewDepartment: TNewDepartment
  Left = 0
  Top = 0
  Caption = 'NewDepartment'
  ClientHeight = 555
  ClientWidth = 923
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'ProYN'
        Footers = <>
        Title.Caption = #21462#29992'|ProYN'
      end
      item
        CellButtons = <>
        DynProps = <>
  ...
  object Query1: TQuery
    ...
    object Query1ID: TStringField
      FieldName = 'ID'
      Origin = 'DB.TSCD_BDepartment.ID'
      FixedChar = True
      Size = 10
    end
    object Query1GSBH: TStringField
      FieldName = 'GSBH'
      Origin = 'DB.TSCD_BDepartment.GSBH'
      FixedChar = True
      Size = 4
    end
    ...
    object Query1DepMemo: TStringField
      FieldName = 'DepMemo'
      Origin = 'DB.TSCD_BDepartment.DepMemo'
      FixedChar = True
      Size = 50
    end
    object Query1ProYN: TBooleanField
      FieldName = 'ProYN'
      Origin = 'DB.TSCD_BDepartment.ProYN'
    end
    object Query1UserID: TStringField
      FieldName = 'UserID'
      Origin = 'DB.TSCD_BDepartment.UserID'
      FixedChar = True
      Size = 10
    end
    object Query1UserDate: TDateTimeField
      FieldName = 'UserDate'
      Origin = 'DB.TSCD_BDepartment.UserDate'
      DisplayFormat = 'yyyy/mm/dd'
    end
    object Query1YN: TStringField
      FieldName = 'YN'
      Origin = 'DB.TSCD_BDepartment.YN'
      FixedChar = True
      Size = 1
    end
  end
  object UpSQL1: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  GSBH = :OLD_GSBH')
    InsertSQL.Strings = (
      'insert into TSCD_BDepartment'
      '  (ID, GSBH, DepName, DepMemo, ProYN,  UserID, UserDate, YN)'
      'values'
      
        '  (:ID, :GSBH, :DepName, :DepMemo, :ProYN, :UserID, :UserDate,:Y' +
        'N)')
    DeleteSQL.Strings = (
      'delete from TSCD_BDepartment'
      'where'
      '  ID = :OLD_ID and'
      '  GSBH = :OLD_GSBH')
    Left = 352
