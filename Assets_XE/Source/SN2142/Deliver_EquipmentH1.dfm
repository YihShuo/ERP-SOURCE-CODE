object Deliver_EquipmentH: TDeliver_EquipmentH
  Left = 397
  Top = 331
  Caption = 'Deliver EquipmentH'
  ClientHeight = 540
  ClientWidth = 1025
  Color = clBtnFace
      ...
      object DBGrid1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'Memo'
            Footers = <>
            Title.Caption = #20511#20986#21934#34399'|Memo'
            Width = 98
          end
          item
            CellButtons = <>
  ...
  object DelMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCHH.*,BDepartment.DepName'
      'from TSCD_KCHH'
      'left join BDepartment on TSCD_KCHH.DepID=BDepartment.ID'
      'where TSCD_KCHH.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCHH.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCHHS.LLNO,TSCD_KCHHS.TSID'
        ...
        'Memo,TSCD_KCHHS.USERID,TSCD_KCHHS.USERDATE,TSCD_KCHHS.YN'
