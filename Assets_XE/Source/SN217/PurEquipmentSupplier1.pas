...
type
  TPurEquipmentSupplier = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
    Label2: TLabel;
    Button1: TButton;
...
var
  PurEquipmentSupplier: TPurEquipmentSupplier;
...
procedure TPurEquipmentSupplier.Button1Click(Sender: TObject);
begin
  with query1 do
  begin
    active:=false;
...
procedure TPurEquipmentSupplier.FormDestroy(Sender: TObject);
begin
  PurEquipmentSupplier:=nil;
end;

procedure TPurEquipmentSupplier.DBGrid1DblClick(Sender: TObject);
begin
