...
var
  EquipmentM: TEquipmentM;

implementation

uses Deliver_EquipmentM1, main1, FunUnit;

{$R *.dfm}


procedure TEquipmentM.DBGridEh1DblClick(Sender: TObject);
begin
  ...
  begin
    ...
    begin
      ...
      //
      FieldByName('Value1').Value:=query1.fieldbyname('DepID').Value;
      FieldByName('Column1').Value:=query1.fieldbyname('DepName').Value;
      Insert;
    end;
    close;
  end;
...
procedure TEquipmentM.Button1Click(Sender: TObject);
var SubSQL:String;
begin
  //
  with query1 do
...
procedure TEquipmentM.FormDestroy(Sender: TObject);
begin
  EquipmentM:=nil;
end;

procedure TEquipmentM.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=Cafree;
end;

procedure TEquipmentM.Button2Click(Sender: TObject);
var i,j:integer;
    bm:Tbookmark;
