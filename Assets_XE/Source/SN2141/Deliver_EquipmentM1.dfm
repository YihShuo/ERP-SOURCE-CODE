object Deliver_EquipmentM: TDeliver_EquipmentM
  Left = 330
  Top = 272
  Caption = 'Deliver EquipmentM'
  ClientHeight = 642
  ClientWidth = 1025
  Color = clBtnFace
  ...
  object DelMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select TSCD_KCMM.*,BDepartment.DepName'
      'from TSCD_KCMM'
      'left join BDepartment on TSCD_KCMM.DepID=BDepartment.ID'
      'where TSCD_KCMM.LLNO like '#39'%'#39
      
        'and convert(smalldatetime,convert(varchar,TSCD_KCMM.USERDATE,111' +
        ')) between'
      #39'2018/07/20'#39
      ' and  '
      #39'2018/07/23'#39
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCMMS.LLNO,TSCD_KCMMS.TSID'
        ...
        'Memo,TSCD_KCMMS.USERID,TSCD_KCMMS.USERDATE,TSCD_KCMMS.YN'
