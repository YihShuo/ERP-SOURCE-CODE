object EquipmentConfirm_FF: TEquipmentConfirm_FF
  Left = 394
  Top = 297
  Caption = 'Borrow Equipment Confirm'
  ClientHeight = 574
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'select TSCD_KCFFS.LLNO,TSCD_KCFFS.TSID'
      
        ',TSCD_KCFFS.PARAMENT1,TSCD_KCFFS.PARAMENT2,TSCD_KCFFS.PARAMENT3,' +
        'TSCD_KCFFS.PARAMENT4,TSCD_KCFFS.PARAMENT5,TSCD_KCFFS.PARAMENT6'
      
        ',TSCD_KCFFS.VALUE1,TSCD_KCFFS.VALUE2,TSCD_KCFFS.VALUE3,TSCD_KCFF' +
        'S.VALUE4,TSCD_KCFFS.VALUE5,TSCD_KCFFS.VALUE6'
      
        ',TSCD_KCFFS.COLUMN1,TSCD_KCFFS.COLUMN2,TSCD_KCFFS.COLUMN3,TSCD_K' +
        'CFFS.COLUMN4,TSCD_KCFFS.COLUMN5,TSCD_KCFFS.COLUMN6'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCFFS.USERID,TSCD_KCFFS.USE' +
        'RDATE,TSCD_KCFFS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCFFS.Qty'
      'from TSCD_KCFFS'
      'left join TSCD on TSCD.TSID=TSCD_KCFFS.TSID'
      ...
      'where TSCD_KCFFS.LLNO=:LLNO'
      'order by TSCD_KCFFS.LLNO'
      '')
    UpdateObject = UPDet
    Left = 468
    Top = 132
