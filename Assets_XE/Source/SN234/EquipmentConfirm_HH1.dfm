object EquipmentConfirm_HH: TEquipmentConfirm_HH
  Left = 394
  Top = 297
  Caption = 'Lend Equipment Return Confirm'
  ClientHeight = 574
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'select TSCD_KCHHS.LLNO,TSCD_KCHHS.TSID'
      
        ',TSCD_KCHHS.PARAMENT1,TSCD_KCHHS.PARAMENT2,TSCD_KCHHS.PARAMENT3,' +
        'TSCD_KCHHS.PARAMENT4,TSCD_KCHHS.PARAMENT5,TSCD_KCHHS.PARAMENT6'
      
        ',TSCD_KCHHS.VALUE1,TSCD_KCHHS.VALUE2,TSCD_KCHHS.VALUE3,TSCD_KCHH' +
        'S.VALUE4,TSCD_KCHHS.VALUE5,TSCD_KCHHS.VALUE6'
      
        ',TSCD_KCHHS.COLUMN1,TSCD_KCHHS.COLUMN2,TSCD_KCHHS.COLUMN3,TSCD_K' +
        'CHHS.COLUMN4,TSCD_KCHHS.COLUMN5,TSCD_KCHHS.COLUMN6'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCHHS.USERID,TSCD_KCHHS.USE' +
        'RDATE,TSCD_KCHHS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCHHS.Qty'
      'from TSCD_KCHHS'
