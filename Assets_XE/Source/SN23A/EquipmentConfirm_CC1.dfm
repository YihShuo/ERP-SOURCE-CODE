object EquipmentConfirm_CC: TEquipmentConfirm_CC
  Left = 394
  Top = 297
  Caption = 'Change DepID Memo Equipment Confirm'
  ClientHeight = 574
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select TSCD_KCCCS.LLNO,TSCD_KCCCS.TSID'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCCCS.USERID,TSCD_KCCCS.USE' +
        'RDATE,TSCD_KCCCS.YN'
