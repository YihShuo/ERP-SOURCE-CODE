object EquipmentConfirm_SS: TEquipmentConfirm_SS
  Left = 394
  Top = 297
  Caption = 'Moving Equipment Confirm'
  ClientHeight = 574
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'select TSCD_KCSSS.LLNO,TSCD_KCSSS.TSID'
      
        ',TSCD_KCSSS.PARAMENT1,TSCD_KCSSS.PARAMENT2,TSCD_KCSSS.PARAMENT3,' +
        'TSCD_KCSSS.PARAMENT4,TSCD_KCSSS.PARAMENT5,TSCD_KCSSS.PARAMENT6'
      
        ',TSCD_KCSSS.VALUE1,TSCD_KCSSS.VALUE2,TSCD_KCSSS.VALUE3,TSCD_KCSS' +
        'S.VALUE4,TSCD_KCSSS.VALUE5,TSCD_KCSSS.VALUE6'
      
        ',TSCD_KCSSS.COLUMN1,TSCD_KCSSS.COLUMN2,TSCD_KCSSS.COLUMN3,TSCD_K' +
        'CSSS.COLUMN4,TSCD_KCSSS.COLUMN5,TSCD_KCSSS.COLUMN6'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCSSS.USERID,TSCD_KCSSS.USE' +
        'RDATE,TSCD_KCSSS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCSSS.Qty'
      'from TSCD_KCSSS'
      ...
      'where TSCD_KCSSS.LLNO=:LLNO'
      'order by TSCD_KCSSS.LLNO'
      '')
    UpdateObject = UPDet
    Left = 468
    Top = 132
