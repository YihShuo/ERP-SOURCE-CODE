object Deliver_Equipment: TDeliver_Equipment
  Left = 384
  Top = 233
  Caption = 'Deliver Equipment'
  ClientHeight = 540
  ClientWidth = 1222
  Color = clBtnFace
  ...
  object DelMas: TQuery
    ...
    SQL.Strings = (
      ...
      'where TSCD_KCLL.LLNO like '#39'%'#39
