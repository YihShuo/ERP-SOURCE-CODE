              ...
              begin
                ...
                case StrToIntDef(Copy(ComboBox1.Text, 1, 2), 0) of
                  ...
                  22:
                    begin
                      X := 'MATB';
                      sql.Add('SELECT TOP 1 TSBH FROM TSCD WHERE TSBH LIKE ''MATB%''');
                      sql.Add('ORDER BY TSBH DESC');
                    end;
                else
                    begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              begin
                if ((NDate-TSCD.FieldByName('USERDATE').value)<=30) or (main.edit1.text='321541') or (main.edit1.text='316503') then
                begin
                  TSCD.edit;
                  TSCD.FieldByName('userID').Value:=main.edit1.text;
                  TSCD.FieldByName('userdate').Value:=Ndate;
...
var eclApp,WorkBook:olevariant;
    ...
    TSBH,Label_Tag,RFID_Tag,Memo:String;
begin
