object NewEquipment: TNewEquipment
  Left = 0
  Top = 0
    ...
    object TS1: TTabSheet
      ...
      object Panel3: TPanel
        ...
        object Label12: TLabel
          ...
          Width = 97
          Height = 25
          Caption = 'Lo'#7841'i thi'#7871't b'#7883
          Font.Charset = ANSI_CHARSET
          Font.Color = clWindowText
          Font.Height = -19
        ...
        object ComboBox1: TComboBox
          ...
          TabOrder = 16
          Items.Strings = (
            '01-Camera - '#31995#32479
            '02-Th'#249'ng m'#225'y t'#237'nh - '#30005#33041#26426#31665
            '03-Tivi c'#7843'm '#7913'ng - '#35302#25511#30005#35270
            '04-M'#225'y in kim - '#21150#20844#23460#25171#21360#26426
            '05-M'#224'n h'#236'nh m'#225'y t'#237'nh - '#30005#33041#23631#24149
            '06-B'#7897' l'#432'u tr'#7919' DATA - NASS'
            '07-M'#225'y '#233'p nh'#7921'a - '#20445#40092#33180#26426
            '08-M'#225'y in v'#259'n ph'#242'ng - '#21150#20844#23460#25171#21360#26426
            '09-M'#225'y chi'#7871'u - '#25237#24433#26426
            '10-Thi'#7871't b'#7883' t'#432#7901'ng l'#7917'a - '#160#38450#28779#22681
            '11-M'#225'y scan - '#25195#25551#22120
            '12-M'#225'y ch'#7911' v'#259'n ph'#242'ng - '#21150#20844#26381#21153#22120
            '13-'#272#7847'u ghi camera - '#31995#32479
            '14-Tivi - '#30005#35270
            '15-B'#7897' l'#432'u tr'#7919' '#273'i'#7879'n - Server UPS'
            '16-Thi'#7871't b'#7883' ph'#225't wifi - WIFI AP'
            '17-Policom - POLICOM'
            '18-M'#225'y ch'#7845'm c'#244'ng - '#35745#26102#21592
            '19-M'#225'y in nh'#227'n - '#26631#31614#25171#21360#26426
            '20-M'#225'y t'#237'nh x'#225'ch tay - '#31508#30005
            '21-Web cam h'#7897'i ngh'#7883' - WEBCAM'
            '22-M'#225'y t'#237'nh b'#7843'ng'
            '23-Loa h'#7897'i ngh'#7883' - '#21895#21485
            '24-Ch'#432'a ph'#226'n lo'#7841'i - '#35774#22791)
        end
      end
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into TSCD'
        ...
        '  (TSID,TSBH,SBBH,Qty,DepID,DepID_Memo, Status, USERID, USERDATE' +
        ', YN, LLNO, RKNO, LB , Memo, MSBBH, Machine_Type, Lean_ID, Unit_' +
        'Name )'
      'values'
      
        '  (:TSID, :TSBH, :SBBH, :Qty, :DepID, :DepID_Memo,:Status, :USER' +
        'ID, :USERDATE, :YN, :LLNO, :RKNO, :LB, :Memo, :MSBBH, :Machine_T' +
        'ype, :Lean_ID, 1)')
    DeleteSQL.Strings = (
      'delete from TSCD'
      'where'
  ...
  object TSBHAllQry: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'Select TSBH from TSCD'
      'where UserID='#39'21191'#39
      'Group by TSBH'
      '')
    Left = 496
    Top = 305
