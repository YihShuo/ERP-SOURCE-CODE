object EquipmentConfirm_TT: TEquipmentConfirm_TT
  Left = 394
  Top = 297
  Caption = 'Borrow Equipment Return Confirm'
  ClientHeight = 574
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'select TSCD_KCTTS.LLNO,TSCD_KCTTS.TSID'
      
        ',TSCD_KCTTS.PARAMENT1,TSCD_KCTTS.PARAMENT2,TSCD_KCTTS.PARAMENT3,' +
        'TSCD_KCTTS.PARAMENT4,TSCD_KCTTS.PARAMENT5,TSCD_KCTTS.PARAMENT6'
      
        ',TSCD_KCTTS.VALUE1,TSCD_KCTTS.VALUE2,TSCD_KCTTS.VALUE3,TSCD_KCTT' +
        'S.VALUE4,TSCD_KCTTS.VALUE5,TSCD_KCTTS.VALUE6'
      
        ',TSCD_KCTTS.COLUMN1,TSCD_KCTTS.COLUMN2,TSCD_KCTTS.COLUMN3,TSCD_K' +
        'CTTS.COLUMN4,TSCD_KCTTS.COLUMN5,TSCD_KCTTS.COLUMN6'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCTTS.USERID,TSCD_KCTTS.USE' +
        'RDATE,TSCD_KCTTS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCTTS.Qty'
      'from TSCD_KCTTS'
      'left join TSCD on TSCD.TSID=TSCD_KCTTS.TSID'
      ...
      'where TSCD_KCTTS.LLNO=:LLNO'
      'order by TSCD_KCTTS.LLNO'
      '')
    UpdateObject = UPDet
    Left = 468
    Top = 132
