object EquipmentConfirm_DD: TEquipmentConfirm_DD
  Left = 394
  Top = 297
  Caption = 'Repair Equipment Confirm'
  ClientHeight = 696
  ClientWidth = 1137
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    RequestLive = True
    SQL.Strings = (
      'select TSCD_KCDDS.LLNO,TSCD_KCDDS.TSID'
      
        ',TSCD_KCDDS.PARAMENT1,TSCD_KCDDS.PARAMENT2,TSCD_KCDDS.PARAMENT3,' +
        'TSCD_KCDDS.PARAMENT4,TSCD_KCDDS.PARAMENT5,TSCD_KCDDS.PARAMENT6'
      
        ',TSCD_KCDDS.VALUE1,TSCD_KCDDS.VALUE2,TSCD_KCDDS.VALUE3,TSCD_KCDD' +
        'S.VALUE4,TSCD_KCDDS.VALUE5,TSCD_KCDDS.VALUE6'
      
        ',TSCD_KCDDS.COLUMN1,TSCD_KCDDS.COLUMN2,TSCD_KCDDS.COLUMN3,TSCD_K' +
        'CDDS.COLUMN4,TSCD_KCDDS.COLUMN5,TSCD_KCDDS.COLUMN6'
        ...
        'ame) as DepName,TSCD.DepID_Memo,TSCD_KCDDS.USERID,TSCD_KCDDS.USE' +
        'RDATE,TSCD_KCDDS.YN'
      ',TSCD_SB.QUCBH,TSCD_SB.LSBH,TSCD.NSX,TSCD.TSBH,TSCD_KCDDS.Qty'
      'from TSCD_KCDDS'
