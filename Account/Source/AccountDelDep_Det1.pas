...
type
  TAccountDelDep_Det = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
    Query1: TQuery;
...
var
  AccountDelDep_Det: TAccountDelDep_Det;
...
procedure TAccountDelDep_Det.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
action:=cafree;
end;

procedure TAccountDelDep_Det.FormCreate(Sender: TObject);
begin
with query1 do
  begin
    active:=false;
    ...
    sql.add(''''+formatdatetime('yyyy/MM/dd',AccountDelDep.DTP1.Date)+'''');
    sql.add(' and '+''''+ formatdatetime('yyyy/MM/dd',AccountDelDep.DTP2.Date)+'''');
...
procedure TAccountDelDep_Det.Excel1Click(Sender: TObject);
var
...
procedure TAccountDelDep_Det.Query1CalcFields(DataSet: TDataSet);
begin 
with query1 do
  begin
...
procedure TAccountDelDep_Det.FormDestroy(Sender: TObject);
begin
AccountDelDep_Det:=nil;
end;
