object AccountBank: TAccountBank
  Left = 491
  Top = 224
  Width = 744
  Height = 500
  ...
  object UpSQL1: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into CWZH'
        ...
        '  (ZHBH, BankNo, ZHJC, BankName, ADDRESS, Telphone, FAX, USERDAT' +
        'E, '
      'USERID, '
      '   YN)'
      'values'
      
        '  (:ZHBH, :BankNo, :ZHJC, :BankName, :ADDRESS, :Telphone, :FAX, ' +
        ':USERDATE, '
      '   :USERID, :YN)')
    DeleteSQL.Strings = (
      'delete from CWZH'
