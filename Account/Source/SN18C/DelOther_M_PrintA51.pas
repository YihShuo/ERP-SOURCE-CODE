...
type
  TDelOther_M_PrintA5 = class(TForm)
    Quickrep1: TQuickRep;
    Qry_DelDet: TQuery;
...
var
  DelOther_M_PrintA5: TDelOther_M_PrintA5;
  sPaperSize: string;
  sHeight: Real;
...
procedure TDelOther_M_PrintA5.FormDestroy(Sender: TObject);
begin
  DelOther_M_PrintA5 := nil;
end;

procedure TDelOther_M_PrintA5.Formclose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TDelOther_M_PrintA5.ReadIni();
var MyIni :Tinifile;
...
procedure TDelOther_M_PrintA5.FormCreate(Sender: TObject);
var i,j:integer;
...
procedure TDelOther_M_PrintA5.UpLoadQRImg(QRdata:string);
var
...
procedure TDelOther_M_PrintA5.Qry_DelDetCalcFields(DataSet: TDataSet);
begin
  Qry_DelDetS.Close;
  Qry_DelDetS.Open;
  Qry_DelDetS.First;
...
procedure TDelOther_M_PrintA5.DetailBand1AfterPrint(Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  sHeight := sHeight + DetailBand1.size.Height + DetailBand1.Expanded;
end;

procedure TDelOther_M_PrintA5.Quickrep1EndPage(Sender: TCustomQuickRep);
begin
