object PayableLit: TPayableLit
      ...
      object DBGrid3: TDBGridEh
        ...
        Columns = <
          item
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = #25972#24115#21934#34399'|FKBH'
            Width = 82
          end
          item
            EditButtons = <>
          ...
          item
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = #21934#25818#26085#26399'|FKDate'
            Width = 73
          end
          item
            Color = 16761281
      ...
      object DBGrid4: TDBGridEh
        ...
        Columns = <
          item
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = #39006#21029'|DJLX'
            Width = 41
          end
          item
            EditButtons = <>
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = #21934#25818#32232#34399'|DJNO'
            Width = 87
          end
          item
            EditButtons = <>
          ...
          item
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = #21934#25818#26085#26399'|DJDATE'
            Width = 79
          end
          item
            EditButtons = <>
          ...
          item
            ...
            Footers = <>
            ReadOnly = True
            Title.Caption = #37096#20301'|DWBH'
            Width = 50
          end
          item
            EditButtons = <>
            FieldName = 'CKBH'
            Footers = <>
            Title.Caption = #20489#24235#32232#34399'|CKBH'
            Width = 60
          end>
      end
    end
  ...
  object PayDet: TQuery
    AfterOpen = PayDetAfterOpen
    AfterScroll = PayDetAfterScroll
    DatabaseName = 'DB'
    DataSource = DS3
    SQL.Strings = (
      'select CWYF.*,CLZL.YWPM,CLZL.DWBH,KCRK.CKBH'
      'from CWYF'
    ...
    object PayDetCWHL: TCurrencyField
      FieldName = 'CWHL'
    end
    object PayDetVNPrice: TCurrencyField
      FieldName = 'VNPrice'
    end
    object PayDetVNACC: TCurrencyField
      FieldName = 'VNACC'
    end
    object PayDetVNQty: TCurrencyField
      FieldName = 'VNQty'
    end
    ...
    object PayDetCKBH: TStringField
      FieldName = 'CKBH'
      FixedChar = True
      Size = 4
    end
  ...
  object UPDet: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into CWYF'
        ...
        '  (ZSBH, DJNO, DJLX, CGBH, CLBH, DJDATE, Qty, USPrice, USACC, US' +
        'Qty, CWHL, '
      '   VNPrice, VNACC, VNQty, CostID, FKBH, USERDATE, USERID, YN)'
      'values'
      
        '  (:ZSBH, :DJNO, :DJLX, :CGBH, :CLBH, :DJDATE, :Qty, :USPrice, :' +
        'USACC, '
      
        '   :USQty, :CWHL, :VNPrice, :VNACC, :VNQty, :CostID, :FKBH, :USE' +
        'RDATE, '
      '   :USERID, :YN)')
    DeleteSQL.Strings = (
      'delete from CWYF'
  ...
  object PayMas: TQuery
    ...
    object PayMasVNQty: TCurrencyField
      FieldName = 'VNQty'
    end
    object PayMasVNACC: TCurrencyField
      FieldName = 'VNACC'
    end
    object PayMasCWHL: TCurrencyField
      FieldName = 'CWHL'
    end
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into CWFK'
        ...
        '  (FKBH, GSBH, USACC, VNACC, CWHL, USQty, VNQty, ZHBH, ZSBH, FKD' +
        'ate, '
      'USERDATE, '
      '   USERID, YN)'
      'values'
      
        '  (:FKBH, :GSBH, :USACC, :VNACC, :CWHL, :USQty, :VNQty, :ZHBH, :' +
        'ZSBH, '
      ':FKDate, '
      '   :USERDATE, :USERID, :YN)')
    DeleteSQL.Strings = (
