object CBY_AdjustDeliver: TCBY_AdjustDeliver
  Left = 586
  Top = 193
  Width = 1363
  Height = 509
  Caption = 'CBY_AdjustDeliver'
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    SQL.Strings = (
      'select KCLLS.*,CLZL.YWPM,CLZL.dwbh'
        ...
        'from CBY_LineStock_KCLLs KCLLS inner join CBY_LineStock_KCLL kcl' +
        'l on kclls.llno=kcll.llno'
