object PaymentVATNO_PrintTTTU_USD: TPaymentVATNO_PrintTTTU_USD
  Left = 480
  Top = 203
  Width = 1305
  Height = 675
  Caption = 'PaymentVATNO_PrintTTTU_USD'
  Color = clBtnFace
  ...
  object QuickRep5: TQuickRep
    ...
    object QRBand20: TQRBand
      ...
      object QRLabel285: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'THUE(USD) '#26410#31237#37329
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
    ...
    object QRBand22: TQRBand
      ...
      object QRExpr21: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'##,#0.00'#39',SUM(SOTIEN_CHUATHUE))'
        FontSize = 9
      end
      object QRExpr22: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'##,#0.00'#39',SUM(SOTIEN_THUE))'
        FontSize = 9
      end
      object QRExpr23: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'##,#0.00'#39',SUM(SOTIEN_TT))'
        FontSize = 9
      end
      ...
      object QRExpr24: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'##,#0.00'#39',VNACC_PTU-SUM(SOTIEN_TT))'
        FontSize = 9
      end
      object QRExpr25: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'FORMATNUMERIC('#39'##,#0.00'#39',SUM(SOTIEN_TT)-VNACC_PTU)'
        FontSize = 9
      end
    ...
    object QRBand24: TQRBand
      ...
      object QRLabel276: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'I/ So tien tam ung'#38928#20184#37329#38989':(USD)'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -17
