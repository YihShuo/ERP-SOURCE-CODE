object PaymentVATNO_Print: TPaymentVATNO_Print
  Left = 308
  Top = 23
  Width = 837
  Height = 788
  VertScrollBar.Position = 332
  Caption = 'PaymentVATNO_Print'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    DataSet = PaymentVATNO.qry_CGPaymentS
    ...
    object QRBand4: TQRBand
      ...
      object QRExpr11: TQRExpr
        ...
        Expression = 
          ...
          'SACC_THANHTOAN1-qry_TTT.USACC_TTT)'
        FontSize = 10
      end
      ...
      object QRExpr7: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'FORMATNUMERIC('#39'#,##0.00'#39',SUM(USACC_NHATHAU)-qry_CGPaymentSTT.USA' +
          'CC_NHATHAU1)'
        FontSize = 8
      end
      ...
      object QRExpr9: TQRExpr
        ...
        WordWrap = True
        Expression = 
          'FORMATNUMERIC('#39'#,##0'#39',SUM(VNACC_NHATHAU)-qry_CGPaymentSTT.VNACC_' +
          'NHATHAU1)'
        FontSize = 8
      end
  ...
  object qry_CGPaymentSTT: TQuery
    ...
    SQL.Strings = (
        ...
        'TRIGIA_HOADON USACC_CHUATHUE1, isnull(a.MEMO,'#39'Tru tien vat tu kh' +
        'ong dat'#39') MEMO,'
  ...
  object qry_Xuatxu: TQuery
    DatabaseName = 'DB'
    DataSource = PaymentVATNO.DS_CGPayment
    SQL.Strings = (
      
        'SELECT '#39#39' +(CAST((SELECT aa.DECLARATION+'#39' ('#39'+convert(varchar,aa.' +
        'USACC_THANHTOAN)+'#39') ; '#39
      'FROM( '
      #9'SELECT a.DECLARATION,'
      #9#9'isnull(b.TRIGIANT,0) USACC_THANHTOAN'
      #9'FROM CGZL_Payments a'
      #9'INNER  JOIN (SELECT DECLARATION,sum(TRIGIANT) TRIGIANT'
      
        #9#9#9#9'FROM CGZL_DeclarationS WHERE CGZL_DeclarationS.XUATXU='#39'VIETN' +
        'AM'#39
      #9#9#9#9'--AND  DECLARATION='#39'105701349130'#39'  '
      #9#9#9#9'GROUP BY DECLARATION) b ON a.DECLARATION  =b.DECLARATION  '
      #9'WHERE  FKBH=:FKBH'
      ')aa FOR XML PATH('#39#39'))AS VARCHAR(MAX))) +'#39#39' AS DECLARATION')
    Left = 600
    Top = 47
    ParamData = <
      item
    ...
    object qry_XuatxuDECLARATION: TMemoField
