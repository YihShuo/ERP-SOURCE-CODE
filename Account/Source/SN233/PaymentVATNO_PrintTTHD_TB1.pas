unit PaymentVATNO_PrintTTHD_TB1;
...
type
  TPaymentVATNO_PrintTTHD_TB = class(TForm)
...
var
  PaymentVATNO_PrintTTHD_TB: TPaymentVATNO_PrintTTHD_TB;
...
function TPaymentVATNO_PrintTTHD_TB.RMBFloatToChinese(ARMBCash: Real): string;
const
...
function TPaymentVATNO_PrintTTHD_TB.RMBFloatToVietnam(inputNumber: Real): string;
const
...
procedure TPaymentVATNO_PrintTTHD_TB.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TPaymentVATNO_PrintTTHD_TB.FormDestroy(Sender: TObject);
begin
  PaymentVATNO_PrintTTHD_TB:=nil;
end;

procedure TPaymentVATNO_PrintTTHD_TB.VN_WORDPrint(sender: TObject;
  var Value: String);
  var acc:string;
begin
...
procedure TPaymentVATNO_PrintTTHD_TB.TW_WORDPrint(sender: TObject;
  var Value: String);
  var acc:string;
begin
  acc:=StringReplace(QRExpr20.Value.strResult,',','',[rfReplaceAll, rfIgnoreCase]);
...
procedure TPaymentVATNO_PrintTTHD_TB.DatePrint(sender: TObject;
  var Value: String);
begin
  date3.Caption:=PaymentVATNO.GetChineseDate(PaymentVATNO.qry_CGPayment.FieldByName('USERDATE').value);
end;

procedure TPaymentVATNO_PrintTTHD_TB.FormCreate(Sender: TObject);
begin
