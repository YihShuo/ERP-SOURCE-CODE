...
var
  LYV_RAPborrow: TLYV_RAPborrow;
  sdate, edate, NDate: Tdate;

implementation

uses main1, RAPBorrow_Dep1, RAPBorrow_CL1, LYV_RAPborrow_PrintA41,
  LYV_RAPborrow_S1, RAPBorrow_RY1, FunUnit;

{$R *.dfm}

procedure TLYV_RAPborrow.FormClose(Sender: TObject;
...
procedure TLYV_RAPborrow.btn2Click(Sender: TObject);
var
  y, m: word;
begin
  ...
  begin
    ...
    sql.add('where LTLL.SB=''R'' and isnull(LTLL.flowflag,'''') <>''X'' ');
    if Edt1.TEXT <> '' then
...
procedure TLYV_RAPborrow.BB1Click(Sender: TObject);
begin
  pgcPC1.ActivePage := TSTS1;
  pnl2.Visible := true;
  Edt1.SetFocus;
...
procedure TLYV_RAPborrow.BB7Click(Sender: TObject);
begin
  close;
end;

procedure TLYV_RAPborrow.BBT1Click(Sender: TObject);
begin
  DelMas.First;
end;

procedure TLYV_RAPborrow.BBT2Click(Sender: TObject);
begin
  DelMas.Prior;
end;

procedure TLYV_RAPborrow.BBT3Click(Sender: TObject);
begin
  DelMas.Next;
end;

procedure TLYV_RAPborrow.BBT4Click(Sender: TObject);
begin
  DelMas.Last;
end;

procedure TLYV_RAPborrow.FormCreate(Sender: TObject);
var
  year, month, day: word;
  i: integer;
  ayear, amonth: string;
begin
  ...
  begin
    active := false;
    sql.Clear;
    sql.add('select CKBH from LastKCCK WHERE GSBH=''' + main.Edit2.text + ''' and LB=''02'' order by CKBH');
    active := true;
  ...
  begin
    ...
    SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO  and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH=''' +
    ...
    SQL.Add('left join ( ');
    SQL.Add('   select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH=''' + main.Edit2.Text + ''' )  and KCYEAR=''' + ayear + ''' and KCMonth=''' + amonth +
...
procedure TLYV_RAPborrow.DelMasAfterOpen(DataSet: TDataSet);
begin
  BB2.Enabled := true;
  BB3.Enabled := true;
  BB4.Enabled := true;
...
procedure TLYV_RAPborrow.BB2Click(Sender: TObject);
begin
  with DelMas do
  begin
    requestlive := true;
...
procedure TLYV_RAPborrow.BB3Click(Sender: TObject);
begin
...
procedure TLYV_RAPborrow.BB4Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_RAPborrow.BB5Click(Sender: TObject);
var
  y, m, a: string;
  i: integer;
begin
...
procedure TLYV_RAPborrow.btnBBTT1Click(Sender: TObject);
begin
  RAPBorrow_Dep := TRAPBorrow_Dep.Create(self);
  RAPBorrow_Dep.Show;
end;

procedure TLYV_RAPborrow.BB6Click(Sender: TObject);
begin
  with DelMas do
  begin
    active := false;
...
procedure TLYV_RAPborrow.DBGridh3EditButtonClick(Sender: TObject);
begin
  RAPBorrow_Dep := TRAPBorrow_Dep.Create(self);
  RAPBorrow_Dep.Show;
end;

procedure TLYV_RAPborrow.DelDetAfterOpen(DataSet: TDataSet);
begin
  BD2.Enabled := true;
  BD3.Enabled := true;
  BD4.Enabled := true;
...
procedure TLYV_RAPborrow.pgcPC1Change(Sender: TObject);
begin
...
procedure TLYV_RAPborrow.BD7Click(Sender: TObject);
begin
  close;
end;

procedure TLYV_RAPborrow.BD2Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_RAPborrow.BD3Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_RAPborrow.LTLLSS_ZLBH_Value();
begin
...
procedure TLYV_RAPborrow.BD5Click(Sender: TObject);
var
  i: integer;
begin
...
procedure TLYV_RAPborrow.BD4Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_RAPborrow.BD6Click(Sender: TObject);
begin
...
procedure TLYV_RAPborrow.btnBBTT2Click(Sender: TObject);
begin
  RAPBorrow_CL := TRAPBorrow_CL.create(self);
  RAPBorrow_CL.show;
end;

procedure TLYV_RAPborrow.dbgrdh4EditButtonClick(Sender: TObject);
begin
  btnBBTT2Click(nil);
end;

procedure TLYV_RAPborrow.BDT1Click(Sender: TObject);
begin
  DelDet.First;
end;

procedure TLYV_RAPborrow.BDT2Click(Sender: TObject);
begin
  DelDet.prior;
end;

procedure TLYV_RAPborrow.BDT3Click(Sender: TObject);
begin
  DelDet.next;
end;

procedure TLYV_RAPborrow.BDT4Click(Sender: TObject);
begin
  DelDet.last;
end;

procedure TLYV_RAPborrow.BDT5Click(Sender: TObject);
begin
  ...
  begin
    LYV_RAPborrow_PrintA4 := TLYV_RAPborrow_PrintA4.create(nil);
    LYV_RAPborrow_PrintA4.quickrep1.prepare;
    LYV_RAPborrow_PrintA4.Qpage1.caption := inttostr(LYV_RAPborrow_PrintA4.quickrep1.QRPrinter.pagecount);
    LYV_RAPborrow_PrintA4.quickrep1.preview;
    LYV_RAPborrow_PrintA4.free;
  end;
...
procedure TLYV_RAPborrow.DBGridh3DblClick(Sender: TObject);
begin
...
procedure TLYV_RAPborrow.FormDestroy(Sender: TObject);
begin
  LYV_RAPborrow := nil;
end;

procedure TLYV_RAPborrow.btnBE1Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_RAPborrow.btnBE5Click(Sender: TObject);
begin
  with KCLLSS do
  begin
    active := false;
...
procedure TLYV_RAPborrow.btnBE2Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_RAPborrow.btnBE3Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_RAPborrow.btnBE4Click(Sender: TObject);
var
  i: integer;
  Qty: real;
begin
...
procedure TLYV_RAPborrow.pgcPC1Changing(Sender: TObject;
...
procedure TLYV_RAPborrow.DBGridh3GetCellParams(Sender: TObject;
...
procedure TLYV_RAPborrow.dbgrdh4GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
  if DelDet.FieldByName('YN').value = '0' then
...
procedure TLYV_RAPborrow.DBGrid6Columns2NotInList(Sender: TObject;
...
procedure TLYV_RAPborrow.DBGrid6Columns3NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
...
procedure TLYV_RAPborrow.DBGrid6Columns4NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
  showmessage('Pls select Size from list ,can not alter by manually.');
  abort;
...
procedure TLYV_RAPborrow.dbgrdh6Columns0NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
  showmessage('Pls select Size from list ,can not alter by manually.');
  abort;
...
procedure TLYV_RAPborrow.BDT7Click(Sender: TObject);
begin
  ...
  begin
    LYV_RAPborrow_S := TLYV_RAPborrow_S.create(nil);
    LYV_RAPborrow_S.quickrep1.prepare;
    LYV_RAPborrow_S.Qpage1.caption := inttostr(LYV_RAPborrow_S.quickrep1.QRPrinter.pagecount);
    LYV_RAPborrow_S.quickrep1.preview;
    LYV_RAPborrow_S.free;
  end;
  with DelMas do
  begin
    requestlive := true;
...
procedure TLYV_RAPborrow.dbgrdh6GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
...
procedure TLYV_RAPborrow.btnBE6Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
