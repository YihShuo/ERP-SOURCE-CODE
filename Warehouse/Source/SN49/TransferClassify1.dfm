object TransferClassify: TTransferClassify
  Left = 192
  Top = 122
  Width = 1120
  Height = 475
  Caption = 'TransferClassify'
  Color = clBtnFace
  ...
  object TLFLDBGridEh: TDBGridEh
    ...
    TitleFont.Style = []
    OnEditButtonClick = TLFLDBGridEhEditButtonClick
  ...
  object DC_TLFLRpt: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      '   select DC_TLFL.*,CLZL.YWPM from DC_TLFL'
      '   Left join CLZL on CLZL.CLDH=DC_TLFL.CLBH'
      
        '   where DC_TLFL.YN=1 and DC_TLFL.LB=1 and DC_TLFL.DFL1='#39'TRANS'#39' ' +
        'and DC_TLFL.DFL2='#39'TRANS'#39)
    UpdateObject = UPDetFL
    Left = 376
    Top = 177
    ...
    object DC_TLFLRptLB: TIntegerField
      FieldName = 'LB'
    end
    object DC_TLFLRptDJBH: TStringField
      FieldName = 'DJBH'
      FixedChar = True
      Size = 11
    end
    object DC_TLFLRptGSBH: TStringField
      FieldName = 'GSBH'
      FixedChar = True
      Size = 4
    end
    object DC_TLFLRptDFL1: TStringField
      FieldName = 'DFL1'
      FixedChar = True
      Size = 15
    end
    object DC_TLFLRptDFL2: TStringField
      FieldName = 'DFL2'
      FixedChar = True
      Size = 15
    end
    ...
    object DC_TLFLRptLYOU: TStringField
      FieldName = 'LYOU'
      FixedChar = True
      Size = 50
    end
    ...
    object DC_TLFLRptYN: TStringField
      FieldName = 'YN'
      FixedChar = True
      Size = 1
    end
  ...
  object UPDetFL: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into DC_TLFL'
        ...
        '   (CLBH, LB , DJBH, GSBH, DFL1, DFL2, TQty, AQty, BQty, CQty, D' +
        'Qty, EQty, FQty, GQty, LYOU, UserID, UserDate, YN)'
      'Values'
      
        '   (:CLBH, :LB, :DJBH, :GSBH, :DFL1, :DFL2, :TQty, :AQty, :BQty,' +
        ' :CQty, :DQty, :EQty, :FQty, :GQty, :LYOU, :UserID, :UserDate, :' +
        'YN)')
    DeleteSQL.Strings = (
      'delete from DC_TLFL'
      'where'
