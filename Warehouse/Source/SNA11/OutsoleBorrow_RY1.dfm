object OutsoleBorrow_RY: TOutsoleBorrow_RY
  Left = 241
  Top = 154
  Width = 985
  Height = 532
  Caption = 'OutsoleBorrow_RY'
  Color = clBtnFace
  ...
  object RYQuery: TQuery
    ...
    SQL.Strings = (
        ...
        '  Select DDZL.DDBH,XXZL.DDMH,CLZL.CLDH,null as T1, null as T2  f' +
        'rom DDZL'
      
        '  left join XXZL on DDZL.XieXing=XXZL.XieXing and DDZL.SheHao=XX' +
        'ZL.SheHao '
      '  left join CLZL on CLZL.YWPM=XXZL.DDMH and CLDH like '#39'VF%'#39' '
      '  where 1=2')
    ...
    object RYQueryDDMH: TStringField
      FieldName = 'DDMH'
      FixedChar = True
      Size = 30
    end
