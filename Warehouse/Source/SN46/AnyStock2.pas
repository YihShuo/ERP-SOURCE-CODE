          ...
          begin
            ...
            begin
              ...
              begin
                ...
                begin
                SQL.Add('Update KCCLMONTH_HG  Set LBBH='''+Query1.fieldByName('LBBH').AsString+''',UserID='''+main.Edit1.Text+''',UserDate=GetDate() ');
                SQL.Add('where CKBH='''+main.Edit2.Text+''' and CLBH='''+Query1.fieldByName('CLDH').AsString+''' ');
                end;  }
                ExecSQL;
              end;
            end;
