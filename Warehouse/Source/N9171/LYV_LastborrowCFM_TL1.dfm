object LYV_LastborrowCFM_TL: TLYV_LastborrowCFM_TL
  Left = 467
  Top = 196
  Width = 1055
  Height = 475
  Caption = 'LYV_LastborrowCFM_TL'
  Color = clBtnFace
  ...
  object qryDelMas: TQuery
    ...
    object qryDelMasCFMID1: TStringField
      FieldName = 'CFMID1'
      Size = 15
    end
    object qryDelMasCFMDate1: TDateTimeField
      FieldName = 'CFMDate1'
    end
  end
