  ...
  object qry1: TQuery
    ...
    SQL.Strings = (
      ...
      '   -----------------------'
        ...
        'select #CLZLKC_Last.CLBH,CLZL.YWPM,CLZL.ZWPM, SUM(Qty) as Total,' +
        '0 as RowNum,'
      ...
      'left join CLZL on CLZL.cldh=#CLZLKC_Last.CLBH  where 1=2 '
        ...
        'Group by #CLZLKC_Last.CLBH,CLZL.YWPM,CLZL.ZWPM,CLZL.CQDH, CLZL.D' +
        'WBH '
      'HAVING SUM(Qty) > 0'
      ''
      ''
    ...
    object qry1ZWPM: TStringField
      FieldName = 'ZWPM'
      FixedChar = True
      Size = 200
    end
    object qry1RowNum: TIntegerField
      FieldName = 'RowNum'
    end
  end
