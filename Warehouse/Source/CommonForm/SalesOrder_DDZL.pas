...
type
  ...
  private
    ...
    //ReturnType=1      回傳給母Form TAdoquery
    parentQuery:TQuery;
    parentFieldNM:string;
    //ReturnType=2      回傳給母Form TStringlist;
...
begin
  ...
  with DDZLQuery do
    begin
      ...
      sql.add('      and ((DDZL.GSBH = ''VA12'') or (DDZL.GSBH = ''VB2'') or (DDZL.GSBH=''VA3'') or (DDZL.GSBH=''VB1''))') ; //20140506增加VB2 和VA3
