object Containerlist: TContainerlist
  Left = 335
  Top = 275
  Width = 1042
  Height = 563
  Caption = 'Containerlist'
  Color = clBtnFace
  ...
  object ENDet: TQuery
    ...
    DataSource = DS3
    SQL.Strings = (
      'select HG_INVS.*,CLZL.YWPM,CLZL.DWBH,HG_INVS.Qty as oldQty'
      'from HG_INVS'
      'left join CLZL on CLZL.CLDH=HG_INVS.CLBH'
      'where HG_INVS.RKNO=:RKNO'
      'order by HG_INVS.RKSB ,HG_INVS.CGBH,HG_INVS.CLBH')
    UpdateObject = UPDet
    Left = 540
    Top = 388
    ParamData = <
  ...
  object UPDet: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into HG_INVS'
        ...
        'VNACC, '
      '   CWHL, CostID, USERID, USERDATE, YN)'
      'values'
      
        '  (:RKNO, :CLBH, :CGBH, :RKSB, :Qty, :PaQty, :USPrice, :USACC, :' +
        'VNPrice, '
      '   :VNACC, :CWHL, :CostID, :USERID, :USERDATE, :YN)'
      '')
    DeleteSQL.Strings = (
      'delete from HG_INVS'
      'where'
  ...
  object ENMas: TQuery
    DatabaseName = 'DB'
    SQL.Strings = (
      'select top 100 HG_INV.*,ZSZL.ZSYWJC  '
      'from  HG_INV'
      'left join ZSZL on HG_INV.ZSBH=ZSZL.ZSDH')
    UpdateObject = UpMas
    Left = 428
    Top = 388
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into HG_INV'
        ...
        '  (RKNO, GSBH, CKBH, ZSBH, ZSNO, DOCNO,HGRK, USERID, USERDATE, C' +
        'FMID, SHIPDATE,YN)'
      'values'
      
        '  (:RKNO, :GSBH, :CKBH, :ZSBH, :ZSNO, :DOCNO, :HGRK, :USERID, :U' +
        'SERDATE, :CFMID, '
      ':SHIPDATE,:YN)')
    DeleteSQL.Strings = (
      'delete from HG_INV'
