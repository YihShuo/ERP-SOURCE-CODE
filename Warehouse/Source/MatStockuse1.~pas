...
with query1 do
  begin
    ...
    if cbr.ItemIndex=1 then
      begin
        sql.add('      and (  isnull(KCCLMONTH1.LBBH,'+''''+'A'+''''+')<>isnull(KCCLMONTH2.LBBH,'+''''+'A'+''''+')');
        sql.add('           or isnull(KCCLMONTH1.Qty,0)<>isnull(KCCLMONTH2.Qty,0) ) ');
      end;
    if cbr.ItemIndex=2 then
      begin
        sql.add('      and isnull(KCCLMONTH1.LBBH,'+''''+'A'+''''+')<>isnull(KCCLMONTH2.LBBH,'+''''+'A'+''''+')');
        sql.add('           and KCCLMONTH2.lbbh is not null');
      end;
    if cbr.ItemIndex=3 then
      begin
        sql.add('      and isnull(KCCLMONTH1.Qty,0)<>isnull(KCCLMONTH2.Qty,0)');
      end;
    if cbr.ItemIndex=4 then
      begin
        sql.add('      and (KCCLMONTH1.LBBH='+''''+'A'+''''+' and KCCLMONTH2.LBBH='+''''+'B'+''''+')');
      end;
    if cbr.ItemIndex=5 then
      begin
        sql.add('      and (KCCLMONTH1.LBBH='+''''+'B'+''''+' and KCCLMONTH2.LBBH='+''''+'C'+''''+')');
      end;
    if cbr.ItemIndex=6 then
      begin
        sql.add('      and (KCCLMONTH1.LBBH='+''''+'C'+''''+' and KCCLMONTH2.LBBH='+''''+'D'+''''+')');
      end;
