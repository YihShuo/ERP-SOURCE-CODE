object ShippingRep_Det: TShippingRep_Det
  Left = 321
  Top = 218
  Width = 513
  Height = 433
  BorderIcons = [biSystemMenu]
  Caption = 'ShippingRep_Det'
  Color = clBtnFace
  ...
  object SCSMCH: TQuery
    DatabaseName = 'DB'
    DataSource = ShippingRep.DS1
    SQL.Strings = (
      'select SCSMCH.*,SCSMRK.Qty'
      'from SCSMCH'
      
        'left join SCSMRK on SCSMRK.DDBH=SCSMCH.DDBH and SCSMRK.CTNO=SCSM' +
        'CH.CTNO'
      'where SCSMCH.DDBH=:DDBH'
      'order by SCSMCH.CTNO')
    Left = 8
    Top = 24
    ParamData = <
      item
    ...
    object SCSMCHUSERDate: TDateTimeField
      FieldName = 'USERDate'
