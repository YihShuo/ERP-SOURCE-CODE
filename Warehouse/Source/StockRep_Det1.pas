...
var
  StockRep_Det: TStockRep_Det;

implementation

{$R *.dfm}

procedure TStockRep_Det.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
action:=cafree;
end;

procedure TStockRep_Det.FormCreate(Sender: TObject);
begin
SCSMRK.Active:=true;
SCSMRKS.Active:=true;
end;

procedure TStockRep_Det.Excel1Click(Sender: TObject);
var
...
procedure TStockRep_Det.FormDestroy(Sender: TObject);
begin
StockRep_Det:=nil;
end;
