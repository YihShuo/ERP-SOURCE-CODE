...
var
  ShippingRep_Det: TShippingRep_Det;

implementation

{$R *.dfm}

procedure TShippingRep_Det.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
action:=cafree;
end;

procedure TShippingRep_Det.FormCreate(Sender: TObject);
begin
SCSMCH.Active:=true;
SCSMRKS.Active:=true;
end;

procedure TShippingRep_Det.Excel1Click(Sender: TObject);
var
...
procedure TShippingRep_Det.FormDestroy(Sender: TObject);
begin
ShippingRep_Det:=nil;
end;
