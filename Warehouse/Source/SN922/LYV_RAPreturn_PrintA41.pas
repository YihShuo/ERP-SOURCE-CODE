...
type
  TLYV_RAPreturn_PrintA4 = class(TForm)
    QuickRep1: TQuickRep;
...
var
  LYV_RAPreturn_PrintA4: TLYV_RAPreturn_PrintA4;
...
procedure TLYV_RAPreturn_PrintA4.FormDestroy(Sender: TObject);
begin
  LYV_RAPreturn_PrintA4:=nil;
end;

procedure TLYV_RAPreturn_PrintA4.FormCreate(Sender: TObject);
begin
...
procedure TLYV_RAPreturn_PrintA4.FormClose(Sender: TObject;
