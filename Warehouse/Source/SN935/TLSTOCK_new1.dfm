object TLstock: TTLstock
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      Caption = 'Truc Talon Toan'#20840#37096
      ImageIndex = 1
    ...
    object TabSheet1: TTabSheet
      Caption = 'Truc Talon Kho'#24235#23384
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object TabSheet3: TTabSheet
      Caption = 'Truc Talon Ra'#20511#20986
      ImageIndex = 2
    ...
    object TabSheet4: TTabSheet
      Caption = 'Truc Talon Bao Phe('#22577#24290')'
      ImageIndex = 3
  ...
  object qry1: TQuery
    ...
    SQL.Strings = (
      ...
      '  select CKBH,CLBH,SIZ,Sum(RKQty) as NowRKQty from ('
        ...
        '.CKBH in (Select CKBH from LastKCCK where LB='#39'05'#39' and GSBH='#39'VA12' +
        #39') and convert(smalldatetime,convert(varchar,LTRK.UserDate,111))' +
        ' between '#39'2024/01/01'#39' and '#39'2024/01/31'#39' '
      '  Group by LTRK.CKBH,LTRKSS.CLBH,LTRKSS.SIZ '
      '  Union All '
      
        '  select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where KCYEA' +
        'R='#39'2023'#39' and KCMonth='#39'12'#39'  and CKBH in (Select CKBH from LastKCC' +
        'K where LB='#39'05'#39' and GSBH='#39'VA12'#39')  '
      '  and CKBH not like '#39'%#L'#39' '
      '  ) as tmpRKTLFL '
      '  group by CKBH,CLBH,SIZ ) as NowKC'
      'left join ( '
      
        '   select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where KCYE' +
        'AR='#39'2023'#39' and KCMonth='#39'12'#39'  and CKBH in (Select CKBH from LastKC' +
        'CK where LB='#39'05'#39' and GSBH='#39'VA12'#39')  '
      ...
      'left join ( '
        ...
        ' LB='#39'05'#39' and GSBH='#39'VA12'#39')   and convert(smalldatetime,convert(va' +
        'rchar,LTLL.CFMDate,111)) between '#39'2024/01/01'#39' and '#39'2024/01/31'#39' '
