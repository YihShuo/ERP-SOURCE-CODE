object LabelCarton: TLabelCarton
  Left = 289
  Top = 192
  Width = 846
  Height = 451
  ...
  object ZLList: TQuery
    AfterScroll = ZLListAfterScroll
    DatabaseName = 'DB'
    SQL.Strings = (
      'select SCZLDate.*,DDZL.XieXing,DDZL.SheHao,XXZL.XieMing,'
      'XXZL.Article,DDZL.ShipDate,DDZL.Pairs'
      'from SCZLDate'
  ...
  object Cartton: TQuery
    ...
    Left = 664
    Top = 184
    object CarttonCODENO: TStringField
      FieldName = 'CODENO'
      Origin = 'DB.SCSMPRINT.CODENO'
      FixedChar = True
      Size = 25
    end
  end
  object UpCode: TUpdateSQL
    ModifySQL.Strings = (
      'update SCSMPRINT'
      'set'
      '  CODENO = :CODENO'
      ...
      '  CODENO = :OLD_CODENO')
    InsertSQL.Strings = (
      'insert into SCSMPRINT'
      '  (CODENO)'
      'values'
      '  (:CODENO)')
    DeleteSQL.Strings = (
      'delete from SCSMPRINT'
      'where'
      '  CODENO = :OLD_CODENO')
    Left = 696
    Top = 184
