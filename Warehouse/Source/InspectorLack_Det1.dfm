object InspectorLack_Det: TInspectorLack_Det
  Left = 287
  Top = 235
  Width = 515
  Height = 442
  BorderIcons = [biSystemMenu]
  Caption = 'InspectorLack_Det'
  Color = clBtnFace
  ...
  object SCSMYW: TQuery
    DatabaseName = 'DB'
    DataSource = InspectorLack.DS1
    SQL.Strings = (
      'select SCSMRK.*'
      'from SCSMRK'
      'where SCSMRK.DDBH=:DDBH'
      'and SCSMRK.YN='#39'4'#39
      'order by SCSMRK.CTNO')
    Left = 8
    Top = 24
    ParamData = <
      item
    ...
    object SCSMYWUSERID: TStringField
      FieldName = 'USERID'
      Origin = 'DB.SCSMRK.USERID'
      FixedChar = True
      Size = 15
    end
    object SCSMYWYN: TStringField
      FieldName = 'YN'
      Origin = 'DB.SCSMRK.YN'
      FixedChar = True
      Size = 1
