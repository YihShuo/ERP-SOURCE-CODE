...
var
  DAOPurchase_CL: TDAOPurchase_CL;

implementation
  uses main1, LYV_DAOreturn1;
{$R *.dfm}

procedure TDAOPurchase_CL.FormDestroy(Sender: TObject);
begin
  DAOPurchase_CL:=nil;
end;

procedure TDAOPurchase_CL.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TDAOPurchase_CL.Button1Click(Sender: TObject);
begin
  ...
  begin
    ...
    SQL.Add('where CLZL.CLDH like ''V1%'' ');
...
procedure TDAOPurchase_CL.dbgrdh1DblClick(Sender: TObject);
begin
