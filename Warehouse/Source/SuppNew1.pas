...
uses
  ...
  Dialogs, DBTables, DB, Buttons, StdCtrls, Grids, DBGrids, ExtCtrls,comobj,
             ...
             begin
               if query1.fieldbyname('YN').value='0' then
                 begin
                   ...
                   begin
                     if query1.fieldbyname('USERDATE').value>=(date-1000) then
                       begin
                         query1.edit;
                         query1.FieldByName('ZSDH').Value:=Uppercase(query1.FieldByName('ZSDH').Value);
                         query1.FieldByName('ZSYWJC').Value:=Uppercase(query1.FieldByName('ZSYWJC').Value);
                         ...
                         begin
                           showmessage(query1.FieldByName('ZSDH').Value+' >1000 days,can not modify.');
                         end;
                   end;
             end;
        end;
