object LabelInbox: TLabelInbox
  ...
  object XXCC: TQuery
    ...
    SQL.Strings = (
        ...
        'select DDZLs.DDBH,ZLLH.LHLabel,XXZLS3.UK_Size as DDCC,XXZLS3.UK_' +
        'Size as XXCC,DDZLs.Quantity '
      'from DDZLs '
      
        'left join XXZLS3  on  XXZLS3.XieXing='#39'T201C-B0'#39' and DDZLS.CC=XXZ' +
        'LS3.UK_Size'
      
        'left join SCLH on SCLH.DDBH=DDZLS.DDBH and SCLH.XXCC=XXZLS3.UK_S' +
        'ize'
      'where DDZLs.DDBH='#39'LT0706066'#39
      'and DDZLs.Quantity<>0  ')
    UpdateObject = UpSQL1
    Left = 616
    Top = 186
    object XXCCDDBH: TStringField
      FieldName = 'DDBH'
      FixedChar = True
      Size = 15
    end
    object XXCCDDCC: TStringField
      FieldName = 'DDCC'
      FixedChar = True
      Size = 6
    end
    ...
    object XXCCQuantity: TIntegerField
      FieldName = 'Quantity'
      DisplayFormat = '##,#0.0'
    end
    object XXCCLHLabel: TStringField
      FieldName = 'LHLabel'
      FixedChar = True
      Size = 25
    end
  ...
  object DDZL: TQuery
    ...
    DatabaseName = 'DB'
    SQL.Strings = (
      'select DDZL.* ,XXZl.XieMing,XXZl.CCGB as XXCC'
      'from DDZL'
  ...
  object UpSQL2: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into SCLH'
      '  (DDBH, XXCC, LHLabel, USERID, USERDATE, YN)'
      'values'
      '  (:DDBH, :XXCC, :LHLabel, :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
      'delete from SCLH'
