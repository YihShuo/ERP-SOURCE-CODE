unit CarttonMoveLack_Det1;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs,comobj, Menus, DB, DBTables, ExtCtrls, Grids, DBGrids;

type
  TCarttonMoveLack_Det = class(TForm)
    DBGrid1: TDBGrid;
    Panel1: TPanel;
    DBGrid2: TDBGrid;
    SCSMCK: TQuery;
...
var
  CarttonMoveLack_Det: TCarttonMoveLack_Det;

implementation

{$R *.dfm}

procedure TCarttonMoveLack_Det.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
action:=cafree;
end;

procedure TCarttonMoveLack_Det.FormCreate(Sender: TObject);
begin
...
procedure TCarttonMoveLack_Det.Excel1Click(Sender: TObject);
var
...
procedure TCarttonMoveLack_Det.FormDestroy(Sender: TObject);
begin
CarttonMoveLack_Det:=nil;
end;
