...
uses main1, MonthStock_Print1, FunUnit ;
...
begin
  ...
  begin
    ...
    begin
      active:=false;
      sql.Clear;
      sql.Add('select KCCLMONTH.*,CLZL.ZWPM as YWPM,CLZL.DWBH ,KCZLS.KCBH ,KCZLS.CWBH');
  ...
  begin
    ...
    begin
      active:=false;
      sql.Clear;
      sql.Add('select KCCLMONTH.KCYEAR,KCCLMONTH.KCMONTH,KCCLMONTH.CKBH,KCCLMONTH.CLBH,KCCLMONTH.HGLB,case when CNO=''ZZZZ'' then null else CNO end as CNO,KCCLMONTH.Qty,CLZL.ZWPM as YWPM,CLZL.DWBH ,KCZLS.KCBH ,KCZLS.CWBH');
