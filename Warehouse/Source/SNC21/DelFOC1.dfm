object DelFOC: TDelFOC
  ...
  object UpMas: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'WHERE LLNO = :OLD_LLNO')
    InsertSQL.Strings = (
      'INSERT INTO KCLL_FOC'
      
        '(LLNO, GSBH,CKBH, DepID, MEMO, USERID, USERDATE, CFMID, CFMDATE,' +
        ' YN, BP)'
      'VALUES'
      
        '(:LLNO, :GSBH, :CKBH, :DepID, :MEMO, :USERID, :USERDATE, :CFMID,' +
        ' :CFMDATE, :YN, :BP)')
    DeleteSQL.Strings = (
      'DELETE FROM KCLL_FOC'
      'WHERE LLNO = :OLD_LLNO')
    Left = 316
    Top = 392
  end
  object DelDet: TQuery
    ...
    DataSource = DS3
    SQL.Strings = (
      'SELECT KCLLS_FOC.*, CLZL.ZWPM, CLZL.YWPM, CLZL.DWBH'
      'FROM KCLLS_FOC'
      'LEFT JOIN CLZL ON CLZL.CLDH=KCLLS_FOC.CLBH'
      'WHERE KCLLS_FOC.LLNO = :LLNO')
    UpdateObject = UPDet
    Left = 476
    Top = 364
    ParamData = <
  ...
  object UPDet: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'CLBH = :OLD_CLBH')
    InsertSQL.Strings = (
      'INSERT INTO KCLLS_FOC'
      '(LLNO, CLBH, TempQty,Qty, Memo,USERID, USERDATE, YN)'
      'VALUES'
      '(:LLNO, :CLBH, :TempQty, :Qty, :Memo, :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
      'DELETE FROM KCLLS_FOC'
      'WHERE'
      'LLNO = :OLD_LLNO AND'
      'CLBH = :OLD_CLBH')
    Left = 476
