...
type
  Tmain = class(TForm)
    ...
    procedure SN8FClick(Sender: TObject);
    procedure SNND1Click(Sender: TObject);
...
uses Sitearea1, Firststock1, MaterialArea1, DeliverList1, EntryList1,
  ...
  Deliverdet_R1, Scrap_Material1, EntryDayOff1, WarehouseLimit1,
  ChemicalStockIns, ChemicalStockOuts;
...
procedure Tmain.SN8FClick(Sender: TObject);
begin
  showFm(Pointer(warehouselimit), Twarehouselimit, TMenuItem(Sender).Name);
end;

procedure Tmain.SNND1Click(Sender: TObject);
begin
  showFm(Pointer(ChemicalStockIn), TChemicalStockIn, TMenuItem(Sender).Name);
end;

procedure Tmain.SND2Click(Sender: TObject);
begin
    showFm(Pointer(ChemicalStockOut), TChemicalStockOut, TMenuItem(Sender).Name);
end;
