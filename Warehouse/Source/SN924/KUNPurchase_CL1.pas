...
var
  KUNPurchase_CL: TKUNPurchase_CL;

implementation
  uses main1, LYV_KUNreturn1;
{$R *.dfm}

procedure TKUNPurchase_CL.FormDestroy(Sender: TObject);
begin
  KUNPurchase_CL:=nil;
end;

procedure TKUNPurchase_CL.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TKUNPurchase_CL.Button1Click(Sender: TObject);
begin
  ...
  begin
    ...
    begin
      SQL.Add('where CLZL.CLDH like ''VB%'' ');
    end;
...
procedure TKUNPurchase_CL.dbgrdh1DblClick(Sender: TObject);
begin
