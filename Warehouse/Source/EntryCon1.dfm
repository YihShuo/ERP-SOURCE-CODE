object EntryCon: TEntryCon
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into KCRK'
      '  (RKNO, ZSBH, USERID, USERDATE, CFMID, CFMDATE, YN)'
      'values'
      '  (:RKNO, :ZSBH, :USERID, :USERDATE, :CFMID, :CFMDATE, :YN)')
    DeleteSQL.Strings = (
      'delete from KCRK'
  ...
  object UPDet: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into KCRKS'
        ...
        '  (RKNO, CLBH, CGBH, RKSB, Qty, USPrice, VNPrice, CWHL, CostID, ' +
        'USERID, '
      '   USERDATE, YN)'
      'values'
      
        '  (:RKNO, :CLBH, :CGBH, :RKSB, :Qty, :USPrice, :VNPrice, :CWHL, ' +
        ':CostID, '
      '   :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
      'delete from KCRKS'
