...
var
  LYV_DAOborrow: TLYV_DAOborrow;
  sdate, edate, NDate: Tdate;

implementation

uses main1, DAOBorrow_Dep1, DAOBorrow_CL1, LYV_DAOborrow_PrintA41,
  LYV_DAOborrow_S1, DAOBorrow_RY1, FunUnit;

{$R *.dfm}

procedure TLYV_DAOborrow.FormClose(Sender: TObject;
...
procedure TLYV_DAOborrow.btn2Click(Sender: TObject);
var
  y, m: word;
begin
  ...
  begin
    ...
    sql.add('where LTLL.SB=''D'' and isnull(LTLL.flowflag,'''') <>''X'' ');
    if Edt1.TEXT <> '' then
...
procedure TLYV_DAOborrow.BB1Click(Sender: TObject);
begin
  pgcPC1.ActivePage := TSTS1;
  pnl2.Visible := true;
  Edt1.SetFocus;
...
procedure TLYV_DAOborrow.BB7Click(Sender: TObject);
begin
  close;
end;

procedure TLYV_DAOborrow.BBT1Click(Sender: TObject);
begin
  DelMas.First;
end;

procedure TLYV_DAOborrow.BBT2Click(Sender: TObject);
begin
  DelMas.Prior;
end;

procedure TLYV_DAOborrow.BBT3Click(Sender: TObject);
begin
  DelMas.Next;
end;

procedure TLYV_DAOborrow.BBT4Click(Sender: TObject);
begin
  DelMas.Last;
end;

procedure TLYV_DAOborrow.FormCreate(Sender: TObject);
var
  year, month, day: word;
  i: integer;
  ayear, amonth: string;
begin
  ...
  begin
    active := false;
    sql.Clear;
    sql.add('select CKBH from LastKCCK WHERE GSBH=''' + main.Edit2.text + ''' and LB=''03'' order by CKBH');
    active := true;
  ...
  begin
    ...
    SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO  and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''03'' and GSBH=''' +
    ...
    SQL.Add('  Union All ');
    SQL.Add('  select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH in (Select CKBH from LastKCCK where LB=''03'' and GSBH=''' + main.Edit2.Text + ''' )   and KCYEAR=''' + ayear + ''' and KCMonth=''' + amonth + ''' ) as tmpRKTLFL ');
    SQL.Add('  group by CKBH,CLBH,SIZ ) as NowKC');
    SQL.Add('left join ( ');
    SQL.Add('   select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH in (Select CKBH from LastKCCK where LB=''03'' and GSBH=''' + main.Edit2.Text + ''' )  and KCYEAR=''' + ayear + ''' and KCMonth=''' + amonth +
    ...
    SQL.Add('   where LTLLSS.LLNO=LTLL.LLNO  and LTLL.CFMID<>''NO'' and LTLL.CKBH in (Select CKBH from LastKCCK where LB=''03'' and GSBH=''' +
      main.Edit2.Text + ''' ) and convert(smalldatetime,convert(varchar,LTLL.CFMDate,111)) between ''' + formatdatetime('yyyy/MM/dd',
...
procedure TLYV_DAOborrow.DelMasAfterOpen(DataSet: TDataSet);
begin
  BB2.Enabled := true;
  BB3.Enabled := true;
  BB4.Enabled := true;
...
procedure TLYV_DAOborrow.BB2Click(Sender: TObject);
begin
  with DelMas do
  begin
    requestlive := true;
...
procedure TLYV_DAOborrow.BB3Click(Sender: TObject);
begin
...
procedure TLYV_DAOborrow.BB4Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_DAOborrow.BB5Click(Sender: TObject);
var
  y, m, a: string;
  i: integer;
begin
...
procedure TLYV_DAOborrow.btnBBTT1Click(Sender: TObject);
begin
  DAOBorrow_Dep := TDAOBorrow_Dep.Create(self);
  DAOBorrow_Dep.Show;
end;

procedure TLYV_DAOborrow.BB6Click(Sender: TObject);
begin
  with DelMas do
  begin
    active := false;
...
procedure TLYV_DAOborrow.DBGridh3EditButtonClick(Sender: TObject);
begin
  DAOBorrow_Dep := TDAOBorrow_Dep.Create(self);
  DAOBorrow_Dep.Show;
end;

procedure TLYV_DAOborrow.DelDetAfterOpen(DataSet: TDataSet);
begin
  BD2.Enabled := true;
  BD3.Enabled := true;
  BD4.Enabled := true;
...
procedure TLYV_DAOborrow.pgcPC1Change(Sender: TObject);
begin
...
procedure TLYV_DAOborrow.BD7Click(Sender: TObject);
begin
  close;
end;

procedure TLYV_DAOborrow.BD2Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_DAOborrow.BD3Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_DAOborrow.LTLLSS_ZLBH_Value();
begin
...
procedure TLYV_DAOborrow.BD5Click(Sender: TObject);
var
  i: integer;
begin
...
procedure TLYV_DAOborrow.BD4Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_DAOborrow.BD6Click(Sender: TObject);
begin
...
procedure TLYV_DAOborrow.btnBBTT2Click(Sender: TObject);
begin
  DAOBorrow_CL := TDAOBorrow_CL.create(self);
  DAOBorrow_CL.show;
end;

procedure TLYV_DAOborrow.dbgrdh4EditButtonClick(Sender: TObject);
begin
  btnBBTT2Click(nil);
end;

procedure TLYV_DAOborrow.BDT1Click(Sender: TObject);
begin
  DelDet.First;
end;

procedure TLYV_DAOborrow.BDT2Click(Sender: TObject);
begin
  DelDet.prior;
end;

procedure TLYV_DAOborrow.BDT3Click(Sender: TObject);
begin
  DelDet.next;
end;

procedure TLYV_DAOborrow.BDT4Click(Sender: TObject);
begin
  DelDet.last;
end;

procedure TLYV_DAOborrow.BDT5Click(Sender: TObject);
begin
  ...
  begin
    LYV_DAOborrow_PrintA4 := TLYV_DAOborrow_PrintA4.create(nil);
    LYV_DAOborrow_PrintA4.quickrep1.prepare;
    LYV_DAOborrow_PrintA4.Qpage1.caption := inttostr(LYV_DAOborrow_PrintA4.quickrep1.QRPrinter.pagecount);
    LYV_DAOborrow_PrintA4.quickrep1.preview;
    LYV_DAOborrow_PrintA4.free;
  end;
...
procedure TLYV_DAOborrow.DBGridh3DblClick(Sender: TObject);
begin
...
procedure TLYV_DAOborrow.FormDestroy(Sender: TObject);
begin
  LYV_DAOborrow := nil;
end;

procedure TLYV_DAOborrow.btnBE1Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_DAOborrow.btnBE5Click(Sender: TObject);
begin
  with KCLLSS do
  begin
    active := false;
...
procedure TLYV_DAOborrow.btnBE2Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_DAOborrow.btnBE3Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_DAOborrow.btnBE4Click(Sender: TObject);
var
  i: integer;
  Qty: real;
begin
...
procedure TLYV_DAOborrow.pgcPC1Changing(Sender: TObject;
...
procedure TLYV_DAOborrow.DBGridh3GetCellParams(Sender: TObject;
...
procedure TLYV_DAOborrow.dbgrdh4GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
  if DelDet.FieldByName('YN').value = '0' then
...
procedure TLYV_DAOborrow.DBGrid6Columns2NotInList(Sender: TObject;
...
procedure TLYV_DAOborrow.DBGrid6Columns3NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
...
procedure TLYV_DAOborrow.DBGrid6Columns4NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
  showmessage('Pls select Size from list ,can not alter by manually.');
  abort;
...
procedure TLYV_DAOborrow.dbgrdh6Columns0NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
  showmessage('Pls select Size from list ,can not alter by manually.');
  abort;
...
procedure TLYV_DAOborrow.BDT7Click(Sender: TObject);
begin
  ...
  begin
    LYV_DAOborrow_S := TLYV_DAOborrow_S.create(nil);
    LYV_DAOborrow_S.quickrep1.prepare;
    LYV_DAOborrow_S.Qpage1.caption := inttostr(LYV_DAOborrow_S.quickrep1.QRPrinter.pagecount);
    LYV_DAOborrow_S.quickrep1.preview;
    LYV_DAOborrow_S.free;
  end;
  with DelMas do
  begin
    requestlive := true;
...
procedure TLYV_DAOborrow.dbgrdh6GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
...
procedure TLYV_DAOborrow.btnBE6Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
