object KUNstock: TKUNstock
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      Caption = 'Khuan in Toan'#20840#37096
      ImageIndex = 1
      object dbgrdh2: TDBGridEh
        ...
        Columns = <
          item
            ...
            Title.Caption = #32178#29256#26009#34399'|MatNo'
            Width = 79
          end
          item
            EditButtons = <>
            FieldName = 'YWPM'
            Footers = <>
            Title.Caption = #32178#29256#21517#31281'|MatName'
            Width = 131
          end
          item
            EditButtons = <>
    ...
    object TabSheet1: TTabSheet
      Caption = 'Khuan in Kho'#24235#23384
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object TabSheet3: TTabSheet
      Caption = 'Khuan in Ra'#20511#20986
      ImageIndex = 2
    ...
    object TabSheet4: TTabSheet
      Caption = 'Khuan in Bao Phe('#22577#24290')'
      ImageIndex = 3
  ...
  object qry1: TQuery
    ...
    SQL.Strings = (
      ...
      '  Union All '
        ...
        'K where LB='#39'04'#39' and GSBH='#39'VR3'#39')  '
      '  and CKBH='#39'KR3'#39' '
      '  ) as tmpRKTLFL '
      ...
      'left join ( '
        ...
        'CK where LB='#39'04'#39' and GSBH='#39'VR3'#39')  '
      '  and CKBH='#39'KR3'#39' '
      ...
      'left join ( '
        ...
        ' LB='#39'04'#39' and GSBH='#39'VR3'#39')   and convert(smalldatetime,convert(var' +
        'char,LTLL.CFMDate,111)) between '#39'2024/06/01'#39' and '#39'2024/06/12'#39' '
      ' and LTLL.CKBH='#39'KR3'#39' '
      
        '   Group by LTLL.CKBH,LTLLSS.CLBH,LTLLSS.SIZ ) LL on NowKC.CKBH=' +
        'LL.CKBH and NowKC.CLBH=LL.CLBH and NowKC.SIZ=LL.SIZ'
      'select #CLZLKC_Last.CLBH,CLZL.YWPM, SUM(Qty) as Total,CLZL.dwbh,'
      ...
      '   Max(case when SIZ='#39'ZZZ'#39' then Qty end) as '#39'[ZZZ]'#39', '
        ...
        '   Max(case when SIZ='#39' 10.5-03.0'#39' then Qty end) as '#39'[ 10.5-03.0]' +
        #39', '
      
        '   Max(case when SIZ='#39' 10.5-06.0'#39' then Qty end) as '#39'[ 10.5-06.0]' +
        #39', '
        ...
        '   Max(case when SIZ='#39'02.5-03.0'#39' then Qty end) as '#39'[02.5-03.0]'#39',' +
        ' '
        ...
        '   Max(case when SIZ='#39'03.0-05.5'#39' then Qty end) as '#39'[03.0-05.5]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'03.0-06.0'#39' then Qty end) as '#39'[03.0-06.0]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'03.0-06.5'#39' then Qty end) as '#39'[03.0-06.5]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'03.0-07.0'#39' then Qty end) as '#39'[03.0-07.0]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'03.0-07.5'#39' then Qty end) as '#39'[03.0-07.5]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'03.0-08.5'#39' then Qty end) as '#39'[03.0-08.5]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'03.0-09.5'#39' then Qty end) as '#39'[03.0-09.5]'#39',' +
        ' '
        ...
        '   Max(case when SIZ='#39'03.0-15.0'#39' then Qty end) as '#39'[03.0-15.0]'#39',' +
        ' '
        ...
        '   Max(case when SIZ='#39'05.0-08.5'#39' then Qty end) as '#39'[05.0-08.5]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'05.0-09.0'#39' then Qty end) as '#39'[05.0-09.0]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'05.5-06.0'#39' then Qty end) as '#39'[05.5-06.0]'#39',' +
        ' '
        ...
        ' '
      '   Max(case when SIZ='#39'050-08.0'#39' then Qty end) as '#39'[050-08.0]'#39', '
        ...
        '   Max(case when SIZ='#39'06.0-08.0'#39' then Qty end) as '#39'[06.0-08.0]'#39',' +
        ' '
        ...
        '   Max(case when SIZ='#39'07.5-12.0'#39' then Qty end) as '#39'[07.5-12.0]'#39',' +
        ' '
        ...
        '   Max(case when SIZ='#39'09.0-12.0'#39' then Qty end) as '#39'[09.0-12.0]'#39',' +
        ' '
        ...
        '   Max(case when SIZ='#39'10.0-16.0'#39' then Qty end) as '#39'[10.0-16.0]'#39',' +
        ' '
      
        '   Max(case when SIZ='#39'10.0-18.0'#39' then Qty end) as '#39'[10.0-18.0]'#39',' +
        ' '
        ...
        '   Max(case when SIZ='#39'13.0-16.0'#39' then Qty end) as '#39'[13.0-16.0]'#39',' +
        ' '
    ...
    object qry1BDEDesigner105060: TFloatField
      FieldName = '[ 10.5-06.0]'
    end
    ...
    object qry1BDEDesigner025030: TFloatField
      FieldName = '[02.5-03.0]'
    end
    ...
    object qry1BDEDesigner030055: TFloatField
      FieldName = '[03.0-05.5]'
    end
    object qry1BDEDesigner030060: TFloatField
      FieldName = '[03.0-06.0]'
    end
    object qry1BDEDesigner030065: TFloatField
      FieldName = '[03.0-06.5]'
    end
    object qry1BDEDesigner030070: TFloatField
      FieldName = '[03.0-07.0]'
    end
    object qry1BDEDesigner030075: TFloatField
      FieldName = '[03.0-07.5]'
    end
    object qry1BDEDesigner030085: TFloatField
      FieldName = '[03.0-08.5]'
    end
    object qry1BDEDesigner030095: TFloatField
      FieldName = '[03.0-09.5]'
    end
    ...
    object qry1BDEDesigner030150: TFloatField
      FieldName = '[03.0-15.0]'
    end
    ...
    object qry1BDEDesigner045050: TFloatField
      FieldName = '[04.5-05.0]'
    end
    ...
    object qry1BDEDesigner050085: TFloatField
      FieldName = '[05.0-08.5]'
    end
    object qry1BDEDesigner050090: TFloatField
      FieldName = '[05.0-09.0]'
    end
    object qry1BDEDesigner055060: TFloatField
      FieldName = '[05.5-06.0]'
    end
    ...
    object qry1BDEDesigner0500802: TFloatField
      FieldName = '[050-08.0]'
    end
    ...
    object qry1BDEDesigner060080: TFloatField
      FieldName = '[06.0-08.0]'
    end
    ...
    object qry1BDEDesigner075120: TFloatField
      FieldName = '[07.5-12.0]'
    end
    ...
    object qry1BDEDesigner090120: TFloatField
      FieldName = '[09.0-12.0]'
    end
    ...
    object qry1BDEDesigner100160: TFloatField
      FieldName = '[10.0-16.0]'
    end
    object qry1BDEDesigner100180: TFloatField
      FieldName = '[10.0-18.0]'
    end
    object qry1BDEDesigner1050302: TFloatField
      FieldName = '[10.5-03.0]'
    end
    ...
    object qry1BDEDesigner130160: TFloatField
      FieldName = '[13.0-16.0]'
    end
