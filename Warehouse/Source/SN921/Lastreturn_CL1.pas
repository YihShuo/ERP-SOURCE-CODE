...
begin
  ...
  begin
    ...
    sql.add('where LTLLS.CLBH=CLZL.CLDH and LTLL.SFL=''1''');
    sql.add('      and  LTLLS.LLNO like '''+LLEdit.Text+'%'' ');
    sql.add('      and CLZL.YWPM like ''%'+LastEdit.Text+'%'+'''');
    sql.add('      and LTLL.YN=''5'' and LTLL.SB=''L''');
    sql.Add('      and LTLL.CKBH='''+LYV_Lastreturn.DelMas.fieldbyname('CKBH').AsString+''' ');
