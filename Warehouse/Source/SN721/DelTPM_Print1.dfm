object DelTPM_Print: TDelTPM_Print
  Left = 364
  Top = 223
  Width = 987
  Height = 594
  Caption = 'DelTPM_Print'
  Color = clBtnFace
  ...
  object DelDet: TQuery
    ...
    DatabaseName = 'DB'
    DataSource = DelTPM.DS3
    SQL.Strings = (
      'SELECT KCLLS_TPM.*, CLZL.ZWPM, CLZL.YWPM, CLZL.DWBH'
      'FROM KCLLS_TPM'
      'LEFT JOIN CLZL ON CLZL.CLDH=KCLLS_TPM.CLBH'
