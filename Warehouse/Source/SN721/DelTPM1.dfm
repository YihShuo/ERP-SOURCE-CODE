object DelTPM: TDelTPM
      ...
      object DBGridEh1: TDBGridEh
        ...
        Columns = <
          ...
          item
            ...
            Footers = <>
            Title.Caption = #32173#20462#20154#21729'|MaintenanceID'
            Width = 100
          end
          item
            EditButtons = <>
          ...
          item
            ...
            FieldName = 'USERDATE'
            Footers = <>
            Title.Caption = #32173#20462#26085#26399'|USERDATE'
            Width = 100
          end
          item
            EditButtons = <>
            FieldName = 'CFMID'
            Footers = <>
            Title.Caption = #30906#35469#20154'|CFMID'
            Width = 65
          end
          item
            EditButtons = <>
  ...
  object DelMas: TQuery
    ...
    object DelMasMaintenanceID: TStringField
      FieldName = 'MaintenanceID'
    end
  ...
  object UpMas: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'WHERE LLNO = :OLD_LLNO')
    InsertSQL.Strings = (
      'INSERT INTO KCLL_TPM'
      
        '(LLNO, GSBH, DepID, MEMO, MaintenanceID, USERID, USERDATE, CFMID' +
        ', CFMDATE, YN)'
      'VALUES'
      
        '(:LLNO, :GSBH, :DepID, :MEMO, :MaintenanceID, :USERID, :USERDATE' +
        ', :CFMID, :CFMDATE, :YN)')
    DeleteSQL.Strings = (
      'DELETE FROM KCLL_TPM'
      'WHERE LLNO = :OLD_LLNO')
    Left = 316
    Top = 392
  end
  ...
  object UPDet: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'CLBH = :OLD_CLBH')
    InsertSQL.Strings = (
      'INSERT INTO KCLLS_TPM'
      '(LLNO, CLBH, Qty, USERID, USERDATE, YN)'
      'VALUES'
      '(:LLNO, :CLBH, :Qty, :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
      'DELETE FROM KCLLS_TPM'
      'WHERE'
      'LLNO = :OLD_LLNO AND'
      'CLBH = :OLD_CLBH')
    Left = 476
