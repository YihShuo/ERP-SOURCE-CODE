object EntryFOC: TEntryFOC
  ...
  object ENDet: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT KCRKS_FOC.*,CLZL.DWBH,CLZL.YWPM,CLZL.DWBH,KCRKS_FOC.Qty a' +
        's oldQty'
      'FROM KCRKS_FOC'
      'LEFT JOIN CLZL ON CLZL.CLDH=KCRKS_FOC.CLBH'
      'WHERE KCRKS_FOC.RKNO=:RKNO')
    UpdateObject = UPDet
    Left = 572
    Top = 396
    ParamData = <
  ...
  object UPDet: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'INSERT INTO KCRKS_FOC'
      '(RKNO, CLBH,Qty, Memo,USERID, USERDATE, YN)'
      'VALUES'
      '(:RKNO, :CLBH, :Qty,:Memo, :USERID, :USERDATE, :YN)')
    DeleteSQL.Strings = (
      'DELETE FROM KCRKS_FOC'
  ...
  object UpMas: TUpdateSQL
    ModifySQL.Strings = (
      ...
      'RKNO = :OLD_RKNO')
    InsertSQL.Strings = (
      'INSERT INTO KCRK_FOC'
      '(RKNO, GSBH, CKBH, ZSBH,ZSNO,MEMO, USERID, USERDATE, YN)'
      'VALUES'
      
        '(:RKNO, :GSBH, :CKBH, :ZSBH,:ZSNO,:MEMO, :USERID, :USERDATE, :YN' +
        ')')
    DeleteSQL.Strings = (
      'DELETE FROM KCRK_FOC'
      'WHERE RKNO = :OLD_RKNO')
    Left = 380
    Top = 436
  end
