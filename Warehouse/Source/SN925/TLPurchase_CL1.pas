...
var
  TLPurchase_CL: TTLPurchase_CL;

implementation
  uses main1, LYV_TLreturn1;
{$R *.dfm}

procedure TTLPurchase_CL.FormDestroy(Sender: TObject);
begin
  TLPurchase_CL:=nil;
end;

procedure TTLPurchase_CL.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TTLPurchase_CL.Button1Click(Sender: TObject);
begin
...
procedure TTLPurchase_CL.dbgrdh1DblClick(Sender: TObject);
begin
