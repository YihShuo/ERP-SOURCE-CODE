...
type
  TLYV_TLreturn_PrintA4 = class(TForm)
    QuickRep1: TQuickRep;
...
var
  LYV_TLreturn_PrintA4: TLYV_TLreturn_PrintA4;
...
procedure TLYV_TLreturn_PrintA4.FormDestroy(Sender: TObject);
begin
  LYV_TLreturn_PrintA4:=nil;
end;

procedure TLYV_TLreturn_PrintA4.FormCreate(Sender: TObject);
begin
...
procedure TLYV_TLreturn_PrintA4.FormClose(Sender: TObject;
