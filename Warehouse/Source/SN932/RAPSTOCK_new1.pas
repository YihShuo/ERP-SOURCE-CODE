...
type
  TRAPSTOCK = class(TForm)
    ...
    qry1ZZZ: TFloatField;
    qry1BDEDesigner010015: TFloatField;
    qry1BDEDesigner010035: TFloatField;
    qry1BDEDesigner010130: TFloatField;
    qry1BDEDesigner015030: TFloatField;
    qry1BDEDesigner020025: TFloatField;
    qry1BDEDesigner020030: TFloatField;
    qry1BDEDesigner020040: TFloatField;
    qry1BDEDesigner020100: TFloatField;
    qry1BDEDesigner030035: TFloatField;
    qry1BDEDesigner030040: TFloatField;
    qry1BDEDesigner030045: TFloatField;
    qry1BDEDesigner030050: TFloatField;
    qry1BDEDesigner030070: TFloatField;
    qry1BDEDesigner030130: TFloatField;
    qry1BDEDesigner030135: TFloatField;
    qry1BDEDesigner030160: TFloatField;
    qry1BDEDesigner030180: TFloatField;
    qry1BDEDesigner03085: TFloatField;
    qry1BDEDesigner035050: TFloatField;
    qry1BDEDesigner035070: TFloatField;
    qry1BDEDesigner03055: TFloatField;
    qry1BDEDesigner03065: TFloatField;
    qry1BDEDesigner03075: TFloatField;
    qry1BDEDesigner040045: TFloatField;
    qry1BDEDesigner040050: TFloatField;
    qry1BDEDesigner040055: TFloatField;
    qry1BDEDesigner040060: TFloatField;
    qry1BDEDesigner045055: TFloatField;
    qry1BDEDesigner045065: TFloatField;
    qry1BDEDesigner045075: TFloatField;
    qry1BDEDesigner045105: TFloatField;
    qry1BDEDesigner045130: TFloatField;
    qry1BDEDesigner050055: TFloatField;
    qry1BDEDesigner050060: TFloatField;
    qry1BDEDesigner050065: TFloatField;
    qry1BDEDesigner050070: TFloatField;
    qry1BDEDesigner050080: TFloatField;
    qry1BDEDesigner05070: TFloatField;
    qry1BDEDesigner055065: TFloatField;
    qry1BDEDesigner055070: TFloatField;
    qry1BDEDesigner055075: TFloatField;
    qry1BDEDesigner060065: TFloatField;
    qry1BDEDesigner060070: TFloatField;
    qry1BDEDesigner060085: TFloatField;
    qry1BDEDesigner060095: TFloatField;
    qry1BDEDesigner065070: TFloatField;
    qry1BDEDesigner065075: TFloatField;
    qry1BDEDesigner070075: TFloatField;
    qry1BDEDesigner070080: TFloatField;
    qry1BDEDesigner070085: TFloatField;
    qry1BDEDesigner070090: TFloatField;
    qry1BDEDesigner070095: TFloatField;
    qry1BDEDesigner070100: TFloatField;
    qry1BDEDesigner070105: TFloatField;
    qry1BDEDesigner075080: TFloatField;
    qry1BDEDesigner075085: TFloatField;
    qry1BDEDesigner080085: TFloatField;
    qry1BDEDesigner080090: TFloatField;
    qry1BDEDesigner080100: TFloatField;
    qry1BDEDesigner080130: TFloatField;
    qry1BDEDesigner085095: TFloatField;
    qry1BDEDesigner090095: TFloatField;
    qry1BDEDesigner090100: TFloatField;
    qry1BDEDesigner090105: TFloatField;
    qry1BDEDesigner090115: TFloatField;
    qry1BDEDesigner090130: TFloatField;
    qry1BDEDesigner090160: TFloatField;
    qry1BDEDesigner095105: TFloatField;
    qry1BDEDesigner100105: TFloatField;
    qry1BDEDesigner100110: TFloatField;
    qry1BDEDesigner100115: TFloatField;
    qry1BDEDesigner100120: TFloatField;
    qry1BDEDesigner100130: TFloatField;
    qry1BDEDesigner105030: TFloatField;
    qry1BDEDesigner105070: TFloatField;
    qry1BDEDesigner105115: TFloatField;
    qry1BDEDesigner105120: TFloatField;
    qry1BDEDesigner105125: TFloatField;
    qry1BDEDesigner105130: TFloatField;
    qry1BDEDesigner105135: TFloatField;
    qry1BDEDesigner110115: TFloatField;
    qry1BDEDesigner110120: TFloatField;
    qry1BDEDesigner110130: TFloatField;
    qry1BDEDesigner110135: TFloatField;
    qry1BDEDesigner110140: TFloatField;
    qry1BDEDesigner115120: TFloatField;
    qry1BDEDesigner120010: TFloatField;
    qry1BDEDesigner120125: TFloatField;
    qry1BDEDesigner120130: TFloatField;
    qry1BDEDesigner120140: TFloatField;
    qry1BDEDesigner125010: TFloatField;
    qry1BDEDesigner130135: TFloatField;
    qry1BDEDesigner130140: TFloatField;
    qry1BDEDesigner130150: TFloatField;
    qry1BDEDesigner140150: TFloatField;
    qry1BDEDesigner140160: TFloatField;
    qry1BDEDesigner150160: TFloatField;
    qry1BDEDesigner150180: TFloatField;
    ...
    qry2ZZZ: TFloatField;
    qry2BDEDesigner010015: TFloatField;
    qry2BDEDesigner010035: TFloatField;
    qry2BDEDesigner010130: TFloatField;
    qry2BDEDesigner015030: TFloatField;
    qry2BDEDesigner020025: TFloatField;
    qry2BDEDesigner020030: TFloatField;
    qry2BDEDesigner020040: TFloatField;
    qry2BDEDesigner020100: TFloatField;
    qry2BDEDesigner030035: TFloatField;
    qry2BDEDesigner030040: TFloatField;
    qry2BDEDesigner030045: TFloatField;
    qry2BDEDesigner030050: TFloatField;
    qry2BDEDesigner030070: TFloatField;
    qry2BDEDesigner030130: TFloatField;
    qry2BDEDesigner030135: TFloatField;
    qry2BDEDesigner030160: TFloatField;
    qry2BDEDesigner030180: TFloatField;
    qry2BDEDesigner03085: TFloatField;
    qry2BDEDesigner035050: TFloatField;
    qry2BDEDesigner035070: TFloatField;
    qry2BDEDesigner03055: TFloatField;
    qry2BDEDesigner03065: TFloatField;
    qry2BDEDesigner03075: TFloatField;
    qry2BDEDesigner040045: TFloatField;
    qry2BDEDesigner040050: TFloatField;
    qry2BDEDesigner040055: TFloatField;
    qry2BDEDesigner040060: TFloatField;
    qry2BDEDesigner045055: TFloatField;
    qry2BDEDesigner045065: TFloatField;
    qry2BDEDesigner045075: TFloatField;
    qry2BDEDesigner045105: TFloatField;
    qry2BDEDesigner045130: TFloatField;
    qry2BDEDesigner050055: TFloatField;
    qry2BDEDesigner050060: TFloatField;
    qry2BDEDesigner050065: TFloatField;
    qry2BDEDesigner050070: TFloatField;
    qry2BDEDesigner050080: TFloatField;
    qry2BDEDesigner05070: TFloatField;
    qry2BDEDesigner055065: TFloatField;
    qry2BDEDesigner055070: TFloatField;
    qry2BDEDesigner055075: TFloatField;
    qry2BDEDesigner060065: TFloatField;
    qry2BDEDesigner060070: TFloatField;
    qry2BDEDesigner060085: TFloatField;
    qry2BDEDesigner060095: TFloatField;
    qry2BDEDesigner065070: TFloatField;
    qry2BDEDesigner065075: TFloatField;
    qry2BDEDesigner070075: TFloatField;
    qry2BDEDesigner070080: TFloatField;
    qry2BDEDesigner070085: TFloatField;
    qry2BDEDesigner070090: TFloatField;
    qry2BDEDesigner070095: TFloatField;
    qry2BDEDesigner070100: TFloatField;
    qry2BDEDesigner070105: TFloatField;
    qry2BDEDesigner075080: TFloatField;
    qry2BDEDesigner075085: TFloatField;
    qry2BDEDesigner080085: TFloatField;
    qry2BDEDesigner080090: TFloatField;
    qry2BDEDesigner080100: TFloatField;
    qry2BDEDesigner080130: TFloatField;
    qry2BDEDesigner085095: TFloatField;
    qry2BDEDesigner090095: TFloatField;
    qry2BDEDesigner090100: TFloatField;
    qry2BDEDesigner090105: TFloatField;
    qry2BDEDesigner090115: TFloatField;
    qry2BDEDesigner090130: TFloatField;
    qry2BDEDesigner090160: TFloatField;
    qry2BDEDesigner095105: TFloatField;
    qry2BDEDesigner100105: TFloatField;
    qry2BDEDesigner100110: TFloatField;
    qry2BDEDesigner100115: TFloatField;
    qry2BDEDesigner100120: TFloatField;
    qry2BDEDesigner100130: TFloatField;
    qry2BDEDesigner105030: TFloatField;
    qry2BDEDesigner105070: TFloatField;
    qry2BDEDesigner105115: TFloatField;
    qry2BDEDesigner105120: TFloatField;
    qry2BDEDesigner105125: TFloatField;
    qry2BDEDesigner105130: TFloatField;
    qry2BDEDesigner105135: TFloatField;
    qry2BDEDesigner110115: TFloatField;
    qry2BDEDesigner110120: TFloatField;
    qry2BDEDesigner110130: TFloatField;
    qry2BDEDesigner110135: TFloatField;
    qry2BDEDesigner110140: TFloatField;
    qry2BDEDesigner115120: TFloatField;
    qry2BDEDesigner120010: TFloatField;
    qry2BDEDesigner120125: TFloatField;
    qry2BDEDesigner120130: TFloatField;
    qry2BDEDesigner120140: TFloatField;
    qry2BDEDesigner125010: TFloatField;
    qry2BDEDesigner130135: TFloatField;
    qry2BDEDesigner130140: TFloatField;
    qry2BDEDesigner130150: TFloatField;
    qry2BDEDesigner140150: TFloatField;
    qry2BDEDesigner140160: TFloatField;
    qry2BDEDesigner150160: TFloatField;
    qry2BDEDesigner150180: TFloatField;
...
uses  main1, RAPSTOCK_Det1, FunUnit, RAPSTOCK_Print1, RAPSTOCK_PrintTong1;
...
//取得時間參數
procedure TRAPSTOCK.GetDateParam();
...
procedure TRAPSTOCK.DBGridInit();
var i:integer;
    objColumn:TColumnEh;
begin
    DS1.DataSet:=nil;
    ...
    begin
      Active:=false;
      SQL.Clear;
      SQL.Add('Select Siz from LastSize where LB=''02'' ');
...
procedure TRAPSTOCK.btn1Click(Sender: TObject);
...
begin
 ...
 begin
   ...
   begin
      ...
      SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO and isnull(LTRK.flowflag,'''') <>''X'' and LTRK.SFL in (''1'',''2'') and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''') and convert(smalldatetime,convert(varchar,LTRK.UserDate,111)) between '''+formatdatetime('yyyy/MM/dd',startofthemonth(DTP1.date))+''' and '''+formatdatetime('yyyy/MM/dd',DTP1.date)+''' ');
      if CBX1.Text <> '' then
        SQL.Add('  and LTRK.CKBH='''+CBX1.Text+''' ');
      SQL.Add('  Group by LTRK.CKBH,LTRKSS.CLBH,LTRKSS.SIZ ');
      SQL.Add('  Union All ');
      SQL.Add('  select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where KCYEAR='''+ayear+''' and KCMonth='''+amonth+'''  and CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  ');
      if CBX1.Text <> '' then
 ...
 begin
   ...
   begin
      ...
      SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO and LTRK.SFL=''2'' and isnull(LTRK.flowflag,'''') <>''X'' and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''') and convert(smalldatetime,convert(varchar,LTRK.UserDate,111)) between '''+formatdatetime('yyyy/MM/dd',startofthemonth(DTP1.date))+''' and '''+formatdatetime('yyyy/MM/dd',DTP1.date)+''' ');
      if CBX1.Text <> '' then
        SQL.Add(' and LTRK.CKBH='''+CBX1.Text+''' ');
      SQL.Add('  Group by LTRK.CKBH,LTRKSS.CLBH,LTRKSS.SIZ ');
      SQL.Add('  Union All ');
      SQL.Add('  select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where KCYEAR='''+ayear+''' and KCMonth='''+amonth+'''  and CKBH in (Select CKBH+''#L'' from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')   ');
      if CBX1.Text <> '' then
 ...
 begin
   ...
   begin
      ...
      sql.add('Union All ');
      sql.add('select DepID,CLBH,SIZ,QTY as LastRem from Lastmonth_Out where KCYEAR='''+ayear+''' and KCMonth='''+amonth+''' and CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  ');
      if CBX1.Text <> '' then
        SQL.Add(' and CKBH='''+CBX1.Text+''' ');
      sql.add(') as tmpRKTLFL ');
      ...
      sql.add('where LTRKSS.RKNO=LTRK.RKNO and isnull(LTRK.flowflag,'''') <>''X'' and LTRK.SFL=''1'' and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')   and convert(smalldatetime,convert(varchar,LTRK.UserDate,111)) between '''+formatdatetime('yyyy/MM/dd',startofthemonth(DTP1.date))+''' and '''+formatdatetime('yyyy/MM/dd',DTP1.date)+''' ');
      if CBX1.Text <> '' then
        SQL.Add(' and LTRK.CKBH='''+CBX1.Text+''' ');
 ...
 begin
   ...
   begin
      ...
      SQL.Add('   where LTLLSS.LLNO=LTLL.LLNO and isnull(LTLL.flowflag,'''') <>''X'' and LTLL.CFMID<>''NO'' and LTLL.SFL in (''2'') and LTLL.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  ');
...
procedure TRAPSTOCK.FormClose(Sender: TObject; var Action: TCloseAction);
begin

  action:=cafree;
end;

procedure TRAPSTOCK.FormDestroy(Sender: TObject);
begin
  RAPSTOCK:=nil;
end;

procedure TRAPSTOCK.S1Click(Sender: TObject);
begin
      RAPSTOCK_Det:=TRAPSTOCK_Det.create(self);
      RAPSTOCK_Det.show;
end;
//Last Size Range
procedure TRAPSTOCK.Last_Size_Range_Init();
...
begin
  ...
  Qtemp1.Active:=false;
  Qtemp1.SQL.Clear;
  Qtemp1.SQL.Add('Select CLBH from LastSizeR where LB=''02'' Group by CLBH Order by CLBH ');
  Qtemp1.Active:=true;
  //
...
//
procedure TRAPSTOCK.FormCreate(Sender: TObject);
var NDate:TDate;
begin
  with Qtemp1 do
  begin
    ...
    sql.add('where GSBH='''+main.edit2.text+''' and LB=''02'' ');
...
procedure TRAPSTOCK.OutputExcel(Query:TQuery);
...
procedure TRAPSTOCK.bbt6Click(Sender: TObject);
begin
  if PageControl1.ActivePage=TabSheet1 then
    OutputExcel(Qry1);
...
procedure TRAPSTOCK.BB1Click(Sender: TObject);
begin
  panel2.Visible:=true;
end;

//檢查上個月是否結算資料
function TRAPSTOCK.CheckLastMonthEnding():boolean;
begin
...
procedure TRAPSTOCK.BB2Click(Sender: TObject);
var IsCal:boolean;
begin
  ...
  begin
      ...
      begin
        ...
        SQL.Add('  select CKBH,CLBH,SIZ,Sum(RKQty) as NowRKQty from (');
        SQL.Add('  select LTRK.CKBH,LTRKSS.CLBH,LTRKSS.SIZ,SUM(LTRKSS.Qty) as RKQty from LTRKSS,LTRK ');
        SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO  and isnull(LTRK.flowflag,'''') <>''X'' and LTRK.CKBH='''+CBX1.Text+''' and LTRK.SFL in (''1'',''2'') and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  and convert(smalldatetime,convert(varchar,LTRK.UserDate,111)) between '''+STLastMonDate+''' and '''+EDLastMonDate+''' ');
        SQL.Add('  Group by LTRK.CKBH,LTRKSS.CLBH,LTRKSS.SIZ ');
        SQL.Add('  Union All ');
        SQL.Add('  select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH='''+CBX1.Text+''' and KCYEAR='''+LastYear2+''' and KCMonth='''+LastMon2+'''  and CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''') ) as tmpRKTLFL ');
        SQL.Add('  group by CKBH,CLBH,SIZ ) as NowKC');
        SQL.Add('left join ( ');
        SQL.Add('   select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH='''+CBX1.Text+''' and KCYEAR='''+LastYear2+''' and KCMonth='''+LastMon2+''' and CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''') ) as LastKC on NowKC.CKBH=LastKC.CKBH and NowKC.CLBH=LastKC.CLBH and NowKC.SIZ=LastKC.SIZ');
        SQL.Add('left join ( ');
        SQL.Add('  select LTRK.CKBH,LTRKSS.CLBH,LTRKSS.SIZ,SUM(LTRKSS.Qty) as RKQty from LTRKSS,LTRK ');
        SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO and isnull(LTRK.flowflag,'''') <>''X'' and LTRK.CKBH='''+CBX1.Text+''' and LTRK.SFL in (''1'',''2'') and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''') and convert(smalldatetime,convert(varchar,LTRK.UserDate,111)) between '''+STLastMonDate+''' and '''+EDLastMonDate+''' ');
        SQL.Add('  Group by LTRK.CKBH,LTRKSS.CLBH,LTRKSS.SIZ  ) RK on NowKC.CKBH=RK.CKBH and NowKC.CLBH=RK.CLBH and NowKC.SIZ=RK.SIZ');
        ...
        SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO and isnull(LTRK.flowflag,'''') <>''X'' and LTRK.CKBH='''+CBX1.Text+''' and LTRK.SFL=''2'' and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''') and convert(smalldatetime,convert(varchar,LTRK.UserDate,111)) between '''+STLastMonDate+''' and '''+EDLastMonDate+''' ');
        SQL.Add('  Group by LTRKSS.CLBH,LTRKSS.SIZ ');
        SQL.Add('  Union All ');
        SQL.Add('  select CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH='''+CBX1.Text+'#L'' and KCYEAR='''+LastYear2+''' and KCMonth='''+LastMon2+''' and CKBH in (Select CKBH+''#L'' from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  ) as tmpRKTLFL ');
        SQL.Add('  group by CLBH,SIZ) as NowKC');
        SQL.Add('left join ( ');
        SQL.Add('   select LTLLSS.CLBH,LTLLSS.SIZ,SUM(LTLLSS.Qty) as LLQty from LTLLSS,LTLL ');
        SQL.Add('   where LTLLSS.LLNO=LTLL.LLNO and isnull(LTLL.flowflag,'''') <>''X'' and LTLL.CFMID<>''NO'' and LTLL.CKBH='''+CBX1.Text+''' and LTLL.SFL=''2'' and LTLL.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''') and convert(smalldatetime,convert(varchar,LTLL.CFMDate,111)) between '''+STLastMonDate+''' and '''+EDLastMonDate+''' ');
        ...
        sql.add('select DepID,CLBH,SIZ,Sum(LLQty) as NowLLQty from (');
        sql.add('select LTLL.DepID,LTLLSS.CLBH,LTLLSS.SIZ,SUM(LTLLSS.Qty) as LLQty from LTLLSS,LTLL ');
        sql.add('where LTLLSS.LLNO=LTLL.LLNO and isnull(LTLL.flowflag,'''') <>''X'' and LTLL.CFMID<>''NO'' and LTLL.CKBH='''+CBX1.Text+''' and LTLL.SFL=''1'' and LTLL.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  and convert(smalldatetime,convert(varchar,LTLL.CFMDate,111)) between '''+STLastMonDate+''' and '''+EDLastMonDate+'''  ');
        sql.add('Group by LTLL.DepID,LTLLSS.CLBH,LTLLSS.SIZ ');
        sql.add('Union All ');
        sql.add('select DepID,CLBH,SIZ,QTY as LastRem from Lastmonth_Out where  KCYEAR='''+LastYear2+''' and KCMonth='''+LastMon2+''' and CKBH='''+CBX1.Text+''' and CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  ) as tmpRKTLFL ');
        sql.add('group by DepID,CLBH,SIZ ) as NowKC ');
        sql.add('left join ( select LTRK.DepID,LTRKSS.CLBH,LTRKSS.SIZ,SUM(LTRKSS.Qty) as RKQty from LTRKSS,LTRK  ');
        sql.add('where LTRKSS.RKNO=LTRK.RKNO and isnull(LTRK.flowflag,'''') <>''X'' and LTRK.CKBH='''+CBX1.Text+''' and LTRK.SFL=''1''  and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''02'' and GSBH='''+main.Edit2.Text+''')  and convert(smalldatetime,convert(varchar,LTRK.UserDate,111)) between '''+STLastMonDate+''' and '''+EDLastMonDate+''' ');
        sql.add('Group by LTRK.DepID,LTRKSS.CLBH,LTRKSS.SIZ )  RK on NowKC.DepID=RK.DepID and NowKC.CLBH=RK.CLBH and NowKC.SIZ=RK.SIZ ');
        sql.add('where  IsNull(NowKC.NowLLQty,0)-IsNull(RK.RKQty,0) >0 ');
        ExecSQL();
      end;
...
procedure TRAPSTOCK.DTP1Change(Sender: TObject);
begin
  //取得時間參數
  GetDateParam();
end;
//
procedure TRAPSTOCK.dbgrdh1DrawColumnCell(Sender: TObject;
...
procedure TRAPSTOCK.dbgrdh2DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumnEh;
  State: TGridDrawState);
var i:integer;
begin
...
procedure TRAPSTOCK.dbgrdh4DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumnEh;
  State: TGridDrawState);
var i:integer;
begin
...
procedure TRAPSTOCK.GroupBox1Click(Sender: TObject);
begin
  DBGridInit();
end;

procedure TRAPSTOCK.RB2Click(Sender: TObject);
begin
  DBGridInit();
end;

procedure TRAPSTOCK.RB3Click(Sender: TObject);
begin
  DBGridInit();
end;

procedure TRAPSTOCK.RB1Click(Sender: TObject);
begin
  DBGridInit();
end;

procedure TRAPSTOCK.btn_Print_KhoClick(Sender: TObject);
begin
  with Qtemp1 do
  begin
    active:=false;
    sql.Clear;
    sql.add('select CKBH,Memo from LastKCCK WHERE GSBH='''+main.Edit2.text+''' and LB =''02'' and CKBH ='''+CBX1.Text+''' order by CKBH');
    active:=true;
  end;
  RAPSTOCK_Print:=TRAPSTOCK_Print.Create(self);
  RAPSTOCK_Print.quickrep1.prepare;
  RAPSTOCK_Print.QRLabel39.Caption:=Qtemp1.FieldByName('CKBH').AsString+'-'+Qtemp1.FieldByName('Memo').AsString;
  RAPSTOCK_Print.QRLabel35.Caption:=main.Edit2.text;
  RAPSTOCK_Print.PageN.caption:=inttostr(RAPSTOCK_Print.quickrep1.QRPrinter.pagecount);
  RAPSTOCK_Print.quickrep1.preview;
  RAPSTOCK_Print.free;
end;

procedure TRAPSTOCK.btn_Print_TongClick(Sender: TObject);
begin
  with Qtemp1 do
  begin
    active:=false;
  ...
  RAPSTOCK_PrintTong:=TRAPSTOCK_PrintTong.Create(self);
  RAPSTOCK_PrintTong.quickrep1.prepare;
  RAPSTOCK_PrintTong.QRLabel39.Caption:=Qtemp1.FieldByName('CKBH').AsString+'-'+Qtemp1.FieldByName('Memo').AsString;
  RAPSTOCK_PrintTong.QRLabel35.Caption:=main.Edit2.text;
  RAPSTOCK_PrintTong.PageN.caption:=inttostr(RAPSTOCK_PrintTong.quickrep1.QRPrinter.pagecount);
  RAPSTOCK_PrintTong.quickrep1.preview;
  RAPSTOCK_PrintTong.free;
end;
