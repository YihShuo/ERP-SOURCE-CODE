...
var CKBH:String;
begin
  CKBH:=MaterialArea.CBX1.Text;
  if CKBH='' then CKBH:=MaterialArea.MatArea.FieldByName('CKBH').AsString;
  with query1 do
  begin
    active:=false;
    sql.Clear;
...
procedure TMatArea_KC.DBGridEh1DblClick(Sender: TObject);
begin
...
procedure TMatArea_KC.DBGridEh1KeyPress(Sender: TObject; var Key: Char);
begin
  if key=#13 then
  DBGridEh1DblClick(nil);
end;

procedure TMatArea_KC.FormShow(Sender: TObject);
begin
