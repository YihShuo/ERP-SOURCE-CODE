...
var
  LYV_KUNborrow: TLYV_KUNborrow;
  sdate, edate, NDate: Tdate;

implementation

uses main1, KUNBorrow_Dep1, KUNBorrow_CL1, LYV_KUNborrow_PrintA41,
  LYV_KUNborrow_S1, KUNBorrow_RY1, FunUnit;

{$R *.dfm}

procedure TLYV_KUNborrow.FormClose(Sender: TObject;
...
procedure TLYV_KUNborrow.btn2Click(Sender: TObject);
var
  y, m: word;
begin
  ...
  begin
    ...
    sql.add('where LTLL.SB=''K'' and isnull(LTLL.flowflag,'''') <>''X'' ');
    if Edt1.TEXT <> '' then
...
procedure TLYV_KUNborrow.BB1Click(Sender: TObject);
begin
  pgcPC1.ActivePage := TSTS1;
  pnl2.Visible := true;
  Edt1.SetFocus;
...
procedure TLYV_KUNborrow.BB7Click(Sender: TObject);
begin
  close;
end;

procedure TLYV_KUNborrow.BBT1Click(Sender: TObject);
begin
  DelMas.First;
end;

procedure TLYV_KUNborrow.BBT2Click(Sender: TObject);
begin
  DelMas.Prior;
end;

procedure TLYV_KUNborrow.BBT3Click(Sender: TObject);
begin
  DelMas.Next;
end;

procedure TLYV_KUNborrow.BBT4Click(Sender: TObject);
begin
  DelMas.Last;
end;

procedure TLYV_KUNborrow.FormCreate(Sender: TObject);
var
  year, month, day: word;
  i: integer;
  ayear, amonth: string;
begin
  ...
  begin
    active := false;
    sql.Clear;
    sql.add('select CKBH from LastKCCK WHERE GSBH=''' + main.Edit2.text + ''' and LB=''04'' order by CKBH');
    active := true;
  ...
  begin
    ...
    SQL.Add('  where LTRKSS.RKNO=LTRK.RKNO  and LTRK.CKBH in (Select CKBH from LastKCCK where LB=''04'' and GSBH=''' +
    ...
    SQL.Add('  Union All ');
    SQL.Add('  select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH in (Select CKBH from LastKCCK where LB=''04'' and GSBH=''' + main.Edit2.Text + ''' )  and KCYEAR=''' + ayear + ''' and KCMonth=''' + amonth + ''' ) as tmpRKTLFL ');
    SQL.Add('  group by CKBH,CLBH,SIZ ) as NowKC');
    SQL.Add('left join ( ');
    SQL.Add('   select CKBH,CLBH,SIZ,QTY as LastRem from Lastmonth where CKBH in (Select CKBH from LastKCCK where LB=''04'' and GSBH=''' + main.Edit2.Text + ''' )  and KCYEAR=''' + ayear + ''' and KCMonth=''' + amonth +
...
procedure TLYV_KUNborrow.DelMasAfterOpen(DataSet: TDataSet);
begin
  BB2.Enabled := true;
  BB3.Enabled := true;
  BB4.Enabled := true;
...
procedure TLYV_KUNborrow.BB2Click(Sender: TObject);
begin
  with DelMas do
  begin
    requestlive := true;
...
procedure TLYV_KUNborrow.BB3Click(Sender: TObject);
begin
...
procedure TLYV_KUNborrow.BB4Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.BB5Click(Sender: TObject);
var
  y, m, a: string;
  i: integer;
begin
...
procedure TLYV_KUNborrow.btnBBTT1Click(Sender: TObject);
begin
  KUNBorrow_Dep := TKUNBorrow_Dep.Create(self);
  KUNBorrow_Dep.Show;
end;

procedure TLYV_KUNborrow.BB6Click(Sender: TObject);
begin
  with DelMas do
  begin
    active := false;
...
procedure TLYV_KUNborrow.DBGridh3EditButtonClick(Sender: TObject);
begin
  KUNBorrow_Dep := TKUNBorrow_Dep.Create(self);
  KUNBorrow_Dep.Show;
end;

procedure TLYV_KUNborrow.DelDetAfterOpen(DataSet: TDataSet);
begin
  BD2.Enabled := true;
  BD3.Enabled := true;
  BD4.Enabled := true;
...
procedure TLYV_KUNborrow.pgcPC1Change(Sender: TObject);
begin
...
procedure TLYV_KUNborrow.BD7Click(Sender: TObject);
begin
  close;
end;

procedure TLYV_KUNborrow.BD2Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.BD3Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.LTLLSS_ZLBH_Value();
begin
...
procedure TLYV_KUNborrow.BD5Click(Sender: TObject);
var
  i: integer;
begin
...
procedure TLYV_KUNborrow.BD4Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.BD6Click(Sender: TObject);
begin
...
procedure TLYV_KUNborrow.btnBBTT2Click(Sender: TObject);
begin
  KUNBorrow_CL := TKUNBorrow_CL.create(self);
  if main.Edit2.Text = 'SKX' then
  begin
     KUNBorrow_CL.EDIT1.Text :='V';
  end else
  begin
     KUNBorrow_CL.EDIT1.Text :='VB';
  end;
  KUNBorrow_CL.show;
end;

procedure TLYV_KUNborrow.dbgrdh4EditButtonClick(Sender: TObject);
begin
  btnBBTT2Click(nil);
end;

procedure TLYV_KUNborrow.BDT1Click(Sender: TObject);
begin
  DelDet.First;
end;

procedure TLYV_KUNborrow.BDT2Click(Sender: TObject);
begin
  DelDet.prior;
end;

procedure TLYV_KUNborrow.BDT3Click(Sender: TObject);
begin
  DelDet.next;
end;

procedure TLYV_KUNborrow.BDT4Click(Sender: TObject);
begin
  DelDet.last;
end;

procedure TLYV_KUNborrow.BDT5Click(Sender: TObject);
begin
  ...
  begin
    LYV_KUNborrow_PrintA4 := TLYV_KUNborrow_PrintA4.create(nil);
    LYV_KUNborrow_PrintA4.quickrep1.prepare;
    LYV_KUNborrow_PrintA4.Qpage1.caption := inttostr(LYV_KUNborrow_PrintA4.quickrep1.QRPrinter.pagecount);
    LYV_KUNborrow_PrintA4.quickrep1.preview;
    LYV_KUNborrow_PrintA4.free;
  end;
...
procedure TLYV_KUNborrow.DBGridh3DblClick(Sender: TObject);
begin
...
procedure TLYV_KUNborrow.FormDestroy(Sender: TObject);
begin
  LYV_KUNborrow := nil;
end;

procedure TLYV_KUNborrow.btnBE1Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.btnBE5Click(Sender: TObject);
begin
  with KCLLSS do
  begin
    active := false;
...
procedure TLYV_KUNborrow.btnBE2Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.btnBE3Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.btnBE4Click(Sender: TObject);
var
  i: integer;
  Qty: real;
begin
...
procedure TLYV_KUNborrow.pgcPC1Changing(Sender: TObject;
...
procedure TLYV_KUNborrow.DBGridh3GetCellParams(Sender: TObject;
...
procedure TLYV_KUNborrow.dbgrdh4GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
  if DelDet.FieldByName('YN').value = '0' then
...
procedure TLYV_KUNborrow.DBGrid6Columns2NotInList(Sender: TObject;
...
procedure TLYV_KUNborrow.DBGrid6Columns3NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
...
procedure TLYV_KUNborrow.DBGrid6Columns4NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
  showmessage('Pls select Size from list ,can not alter by manually.');
  abort;
...
procedure TLYV_KUNborrow.dbgrdh6Columns0NotInList(Sender: TObject;
  NewText: string; var RecheckInList: Boolean);
begin
  showmessage('Pls select Size from list ,can not alter by manually.');
  abort;
...
procedure TLYV_KUNborrow.BDT7Click(Sender: TObject);
begin
  ...
  begin
    LYV_KUNborrow_S := TLYV_KUNborrow_S.create(nil);
    LYV_KUNborrow_S.quickrep1.prepare;
    LYV_KUNborrow_S.Qpage1.caption := inttostr(LYV_KUNborrow_S.quickrep1.QRPrinter.pagecount);
    LYV_KUNborrow_S.quickrep1.preview;
    LYV_KUNborrow_S.free;
  end;
  with DelMas do
  begin
    requestlive := true;
...
procedure TLYV_KUNborrow.dbgrdh6GetCellParams(Sender: TObject;
  Column: TColumnEh; AFont: TFont; var Background: TColor;
  State: TGridDrawState);
begin
...
procedure TLYV_KUNborrow.btnBE6Click(Sender: TObject);
begin
  if (DelMas.FieldByName('CFMID').value <> 'NO') then
  begin
    ShowMessage('Already Comfirm.');
...
procedure TLYV_KUNborrow.BDT6Click(Sender: TObject);
