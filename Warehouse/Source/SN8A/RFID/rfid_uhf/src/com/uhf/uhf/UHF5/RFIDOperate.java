...
import static com.tyxuan.rfid_uhf.Comm.UHF5MESSAGE_TEXT;
import static com.tyxuan.rfid_uhf.Comm.btTarget;
import static com.tyxuan.rfid_uhf.Comm.comm_callback;
import static com.tyxuan.rfid_uhf.Comm.lsTagList;
import static com.tyxuan.rfid_uhf.Comm.operateType;
import static com.tyxuan.rfid_uhf.Comm.playSound;
import static com.tyxuan.rfid_uhf.Comm.session;
...
import static com.tyxuan.rfid_uhf.Comm.uhf5outpouwer;
import static com.uhf.uhf.UHF5helper.ReaderHelper.setContext;
...
public class RFIDOperate {
    ...
    public Handler mHandler;//嚙賣�伐蕭嚙賢�����蕭��蕭
...
//                    Comm.Str2Hex(s2, (Integer.valueOf(operaCount) * 2)-6, rdata2);
                    ...
                    //weston test
                    //Log.e("RFID", "RFID Opeaate strData:"+strData);
                    Bundle b = new Bundle();
