...
procedure TPrintLabel.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action:=cafree;
end;

procedure TPrintLabel.FormDestroy(Sender: TObject);
begin
  PrintLabel:=nil;
  QRCodeBitmap.Free;
end;

procedure TPrintLabel.UpLoadQRImg(QRdata:string);
var
...
procedure TPrintLabel.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
