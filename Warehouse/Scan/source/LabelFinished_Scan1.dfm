object LabelFinished_Scan: TLabelFinished_Scan
  Left = 301
  Top = 180
  Width = 763
  Height = 500
  BorderIcons = [biSystemMenu]
  Caption = 'LabelFinished_Scan'
  Color = clBtnFace
  ...
  object SCSMRK: TQuery
    ...
    object SCSMRKQty: TIntegerField
      FieldName = 'Qty'
    end
  ...
  object UpSCSMRK: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into SCSMRK'
      '  (DDBH, CTNO, Qty, USERDate, USERID, YN)'
      'values'
      '  (:DDBH, :CTNO, :Qty, :USERDate, :USERID, :YN)')
    DeleteSQL.Strings = (
      'delete from SCSMRK'
