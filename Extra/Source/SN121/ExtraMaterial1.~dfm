object ExtraMaterial: TExtraMaterial
  ...
  object JGS: TQuery
    ...
    SQL.Strings = (
        ...
        'select JGZLSS.*,IsNull(DDZL.Article,YPZL.Article) as Article,IsN' +
        'ull(DDZL.BUYNO,YPZL.KFJD) as BUYNO'
      'from JGZLSS'
  ...
  object JGDetZ: TQuery
    ...
    SQL.Strings = (
        ...
        'select JGZLS.*,CLZL.YWPM,CLZL.DWBH,KCZLS.NK,KCZLS.TC,KCZLS.HD,KC' +
        'ZLS.KD,KCZLS.XT,KCZLS.GC,KCZLS.ZZZZ'
      
        '       ,KCZLS.NK1,KCZLS.TC1,KCZLS.HD1,KCZLS.KD1,KCZLS.H11, KCZLS' +
        '.NQ, KCZLS.NKNQ'
      'from JGZLS'
      'left join CLZL on CLZL.CLDH=JGZLS.ZMLB'
      'Left join KCZLS on KCZLS.CLBH=JGZLS.ZMLB and KCZLS.CKBH=:ckbh '
    ...
    object JGDetZNK: TCurrencyField
      FieldName = 'NK'
    end
    object JGDetZHD: TCurrencyField
      FieldName = 'HD'
    end
    object JGDetZKD: TCurrencyField
      FieldName = 'KD'
    end
    object JGDetZXT: TCurrencyField
      FieldName = 'XT'
    end
    object JGDetZGC: TCurrencyField
      FieldName = 'GC'
    end
    object JGDetZZZZZ: TCurrencyField
      FieldName = 'ZZZZ'
    end
    object JGDetZCWHL: TCurrencyField
      FieldName = 'CWHL'
    end
    object JGDetZVNPrice: TCurrencyField
      FieldName = 'VNPrice'
    end
    object JGDetZVNACC: TCurrencyField
      FieldName = 'VNACC'
    end
    object JGDetZTC: TCurrencyField
      FieldName = 'TC'
    end
    object JGDetZNK1: TCurrencyField
      FieldName = 'NK1'
      DisplayFormat = '#,##0.##'
    end
    object JGDetZTC1: TCurrencyField
      FieldName = 'TC1'
      DisplayFormat = '#,##0.##'
    end
    object JGDetZHD1: TCurrencyField
      FieldName = 'HD1'
      DisplayFormat = '#,##0.##'
    end
    object JGDetZKD1: TCurrencyField
      FieldName = 'KD1'
      DisplayFormat = '#,##0.##'
    end
    object JGDetZH11: TCurrencyField
      FieldName = 'H11'
    end
    object JGDetZNQ: TCurrencyField
      FieldName = 'NQ'
    end
    object JGDetZNKNQ: TCurrencyField
      FieldName = 'NKNQ'
    end
  end
