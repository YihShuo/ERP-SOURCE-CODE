...
uses
  ...
  Buttons, ExtCtrls, GridsEh, DBGridEh;
...
uses main1, Quotation_ZS1, Quotation_CL1, Quotation_Print1;
                ...
                begin
                  BJMas.delete;
                   ...
                   begin
                     ...
                     BJMas.FieldByName('userdate').Value:=date;
                ...
                begin
                  BJDet.delete;
                   ...
                   begin
                     ...
                     BJDet.FieldByName('userdate').Value:=date;
                     BJDet.FieldByName('Discount').Value:='1';
