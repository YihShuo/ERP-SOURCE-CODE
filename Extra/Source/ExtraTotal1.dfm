object ExtraTotal: TExtraTotal
  ...
  object UpMas: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into JGZL'
        ...
        '1, '
      'CFMDate1, '
      '   CFMID2, CFMDate2, YN, SB)'
      'values'
      
        '  (:JGNO, :GSBH, :CKBH, :ZSBH, :JGDate, :JGLX, :USERDATE, :USERI' +
        'D, :CFMID1, '
      '   :CFMDate1, :CFMID2, :CFMDate2, :YN, :SB)')
    DeleteSQL.Strings = (
      'delete from JGZL'
      'where'
      '  JGNO = :OLD_JGNO')
  ...
  object JGDet: TQuery
    ...
    DataSource = DS3
    SQL.Strings = (
      'select JGZLS.*,CLZL.YWPM,CLZL.ZWPM,CLZL.DWBH'
      'from JGZLS'
  ...
  object JGDetZ: TQuery
    ...
    object JGDetZZWPM: TStringField
      FieldName = 'ZWPM'
      FixedChar = True
      Size = 200
    end
